...
class PyDeviceContext:
    @staticmethod
    def open_canfd(baudrate:BaudrateCAN, master_id:builtins.int, slave_id:builtins.int) -> PyDeviceContext: ...
    @staticmethod
    ...
    def start_touch_sensor_stream(self, slave_id:builtins.int, interval_read:builtins.int, interval_cb:builtins.int) -> typing.Any: ...
    def stop_touch_sensor_stream(self, slave_id:builtins.int) -> typing.Any: ...
...
class RegisterAddressV1(Enum):
    ...
    SetRingCalibration = ...
    SetPinkyCalibration = ...
    SetTouchEnabledThumb = ...
    SetTouchEnabledIndex = ...
    SetTouchEnabledMiddle = ...
    SetTouchEnabledRing = ...
    SetTouchEnabledPinky = ...
    GetTouchFwVersion = ...
...
class RegisterAddressV2(Enum):
    ...
    FingerMaxSpeed = ...
    FingerMaxCurrent = ...
    FingerMinPositionRead = ...
    FingerMaxPositionRead = ...
    FingerMaxSpeedRead = ...
    FingerMaxCurrentRead = ...
    SlaveId = ...
    Baudrate = ...
    BaudrateCAN = ...
    SetReboot = ...
...
def can_open(baudrate:BaudrateCAN, master_id:builtins.int, slave_id:builtins.int) -> typing.Any: ...

def canfd_open(baudrate:BaudrateCAN, master_id:builtins.int, slave_id:builtins.int) -> typing.Any: ...

def get_sdk_version() -> builtins.str: ...

def init_config(fw_type:StarkHardwareType, protocol_type:typing.Optional[StarkProtocolType]=StarkProtocolType.Modbus, level:typing.Optional[LogLevel]=LogLevel.Info, max_bytes:typing.Optional[builtins.int]=None) -> None: ...
