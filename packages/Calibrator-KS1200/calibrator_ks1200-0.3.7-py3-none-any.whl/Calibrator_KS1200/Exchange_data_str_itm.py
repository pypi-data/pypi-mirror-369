...
# fa=[] # список float array
# for i in  range(50):
#     fa.append([i+0.1]) #список float array
# ia=[] # список integer array
# for i in  range(50):
#     ia.append([i]) #список integer array
...
def exchange_data_itm(MainWindow, str_received, portname = 'COM5', boud = 19200):
    ...
    numish2C0=str_change.find('ish2C0') # - полином 9-й степени. Данные свидетельства.
    numish2C1=str_change.find('ish2C1') # вещественные числа
    numish2C2=str_change.find('ish2C2') # чтение\запись
    numish2C3=str_change.find('ish2C3')
    numish2C4=str_change.find('ish2C4')
    numish2C5=str_change.find('ish2C5')
    numish2C6=str_change.find('ish2C6')
    numish2C7=str_change.find('ish2C7')
    numish2C8=str_change.find('ish2C8')
    numish2C9=str_change.find('ish2C9')
    ...
    numish4tPROAl=str_change.find('ish4tPROAl') # темоЭДС от температуры ПPО.
    numish4tPROCu=str_change.find('ish4tPROCu') # Размерность миливольт, градус.
    numish4tPROPd=str_change.find('ish4tPROPd') # Данные свидетельства.
    numish4tPROPt=str_change.find('ish4tPROPt') # Вещественные числа
    numish4uPROAl=str_change.find('ish4uPROAl') # чтение\запись
    numish4uPROCu=str_change.find('ish4uPROCu')
    numish4uPROPd=str_change.find('ish4uPROPd')
    numish4uPROPt=str_change.find('ish4uPROPt')
    ...
    if str_change[0]=='R':  #read data
        ...
        if numsen1>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x108,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen1=sen[0]
        ...
        if numsen2>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x109,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen2=sen[0]
        ...
        if numsen3>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10a,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen3=sen[0]
        ...
        if numsen4>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10b,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen4=sen[0]
        ...
        if numsen5>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10c,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen5=sen[0]
        ...
        if numsen6>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10d,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen6=sen[0]
        ...
        if numsen7>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10e,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen7=sen[0]
        ...
        if numsen8>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x10f,1,ia,MainWindow)
            if inbuff:
                sen=inbuff[0]
                sen8=sen[0]
        ...
        if numhk1>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x45,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]
                hk1=hk[0]
                if hk1==0: parhk='ON'
        ...
        if numhk2>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x46,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0] 
                hk2=hk[0]
                if hk2==0: parhk='ON'
        ...
        if numhk3>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x47,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]   
                hk3=hk[0]
                if hk3==0: parhk='ON'
        ...
        if numhk4>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x48,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]   
                hk4=hk[0]
                if hk4==0: parhk='ON'
        ...
        if numhk5>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x49,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]   
                hk5=hk[0]
                if hk5==0: parhk='ON'
        ...
        if numhk6>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x4a,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]   
                hk6=hk[0]
                if hk6==0: parhk='ON'
        ...
        if numhk7>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x4b,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]
                hk7=hk[0]
                if hk7==0: parhk='ON'
        ...
        if numhk8>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x4c,1,ia,MainWindow)
            if inbuff:
                hk=inbuff[0]
                hk8=hk[0]
                if hk8==0: parhk='ON'
        ...
        if numvalch1>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0208,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch2>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0209,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch3>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020a,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch4>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020b,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch5>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020c,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch6>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020d,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch7>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020e,1,ia,MainWindow)
            if inbuff:
        ...
        if numvalch8>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x020f,1,ia,MainWindow)
            if inbuff:
        ...
        if numdopch1>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0210,1,ia,MainWindow)
            if inbuff:
                floatch1=TuplToFloat(inbuff[0])
                floatch1/=10000
        ...
        if numdopch2>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0211,1,ia,MainWindow)
            if inbuff:
                floatch2=TuplToFloat(inbuff[0])
                floatch2/=10000
        ...
        if numdopch3>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0212,1,ia,MainWindow)
            if inbuff:
                floatch3=TuplToFloat(inbuff[0])
                floatch3/=10000
        ...
        if numdopch4>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0213,1,ia,MainWindow)
            if inbuff:
                floatch4=TuplToFloat(inbuff[0])
                floatch4/=10000
        ...
        if numdopch5>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0214,1,ia,MainWindow)
            if inbuff:
                floatch5=TuplToFloat(inbuff[0])
                floatch5/=10000
        ...
        if numdopch6>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0215,1,ia,MainWindow)
            if inbuff:
                floatch6=TuplToFloat(inbuff[0])
                floatch6/=10000
        ...
        if numdopch7>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0216,1,ia,MainWindow)
            if inbuff:
                floatch7=TuplToFloat(inbuff[0])
                floatch7/=10000
        ...
        if numdopch8>-1:
            inbuff=ReadIntMBus(portname,boud,0x4d,0x0217,1,ia,MainWindow)
            if inbuff:
                floatch8=TuplToFloat(inbuff[0])
                floatch8/=10000
        ...
        if numvalrefu>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x44,1,fa,MainWindow)
            if inbuff:
        ...
        if numish2C0>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x55,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C0',inbuff[0]) 
        if numish2C1>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x56,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C1',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C1')  
        if numish2C2>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x57,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C2',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C2')  
        if numish2C3>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x58,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C3',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C3')  
        if numish2C4>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x59,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C4',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C4')  
        if numish2C5>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x5a,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C5',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C5')  
        if numish2C6>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x5b,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C6',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C6')  
        if numish2C7>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x5c,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C7',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C7')  
        if numish2C8>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x5d,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C8',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish2C8')  
        if numish2C9>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x5e,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish2C9',inbuff[0]) 
            else:
                str_change=insert_err_param(str_change,'ish2C9') 
           
        if numish3tPPOZn>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x60,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish3tPPOZn',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish3tPPOZn')
        if numish3tPPOAl>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x61,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish3tPPOAl',inbuff[0]) 
            else:
                str_change=insert_err_param(str_change,'ish3tPPOAl')
        if numish3tPPOCu>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x62,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish3tPPOCu',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish3tPPOCu') 
        if numish3uPPOZn>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x63,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish3uPPOZn',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish3uPPOZn') 
        if numish3uPPOAl>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x64,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish3uPPOAl',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish3uPPOAl')  
        if numish3uPPOCu>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x65,1,fa,MainWindow)
            if inbuff:
        ...
        if numish4tPROAl>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x66,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4tPROAl',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4tPROAl')   
        if numish4tPROCu>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x67,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4tPROCu',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4tPROCu')    
        if numish4tPROPd>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x68,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4tPROPd',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4tPROPd')     
        if numish4tPROPt>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x69,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4tPROPt',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4tPROPt')     
        if numish4uPROAl>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x6a,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4uPROAl',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4uPROAl')     
        if numish4uPROCu>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x6b,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4uPROCu',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4uPROCu')      
        if numish4uPROPd>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x6c,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4uPROPd',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4uPROPd')      
        if numish4uPROPt>-1:
            inbuff=ReadFloatMBus(portname,boud,0x4d,0x6d,1,fa,MainWindow)
            if inbuff:
                str_change=insert_equ_param(str_change,'ish4uPROPt',inbuff[0])
            else:
                str_change=insert_err_param(str_change,'ish4uPROPt')      

        if numrewerseChan>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x55,1,ia,MainWindow)
            if inbuff:
        ...
        if numrewerseI>-1:
            inbuff=ReadUShortMBus(portname,boud,0x4d,0x56,1,ia,MainWindow)
            if inbuff:
                rewerseI=inbuff[0]
                rewerseI=rewerseI[0]
        ...
        if numsen1>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x108,1,ia,MainWindow):
                    strout+=',sen1-OK'
                else:
                    strout+=',sen1-Err'
        ...
        if numsen2>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x109,1,ia,MainWindow):
                    strout+=',sen2-OK'
                else:
                    strout+=',sen2-Err'
        ...
        if numsen3>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10a,1,ia,MainWindow):
                    strout+=',sen3-OK'
                else:
                    strout+=',sen3-Err'
        ...
        if numsen4>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10b,1,ia,MainWindow):
                    strout+=',sen4-OK'
                else:
                    strout+=',sen4-Err'
        ...
        if numsen5>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10c,1,ia,MainWindow):
                    strout+=',sen5-OK'
                else:
                    strout+=',sen5-Err'
        ...
        if numsen6>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10d,1,ia,MainWindow):
                    strout+=',sen6-OK'
                else:
                    strout+=',sen6-Err'
        ...
        if numsen7>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10e,1,ia,MainWindow):
                    strout+=',sen7-OK'
                else:
                    strout+=',sen7-Err'
        ...
        if numsen8>-1:
            ...
            if isinstance(senval,str):
                ...
                ia[0]=senval
                if WriteUint16_tMBus(portname,boud,0x4d,0x10f,1,ia,MainWindow):
                    strout+=',sen8-OK'
                else:
                    strout+=',sen8-Err'
        ...
        if numRr1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x40,1,fa,MainWindow)
                if wrf:
                    strout+=',Rr1-OK'
                else:
                    strout+=',Rr1-Err'
        ...
        if numRr2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x41,1,fa,MainWindow)
                if wrf:  
                    strout+=',Rr2-OK'
                else:
                    strout+=',Rr2-Err'
        ...
        if numRr3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x42,1,fa,MainWindow)
                if wrf:
                    strout+=',Rr3-OK'
                else:
                    strout+=',Rr3-Err'
        ...
        if numRp1>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x57,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp1-OK'
                else:
                    strout+=',Rp1-Err'
        if numRp2>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x58,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp2-OK'
                else:
                    strout+=',Rp2-Err'
        if numRp3>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x59,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp3-OK'
                else:
                    strout+=',Rp3-Err'
        if numRp4>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x5a,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp4-OK'
                else:
                    strout+=',Rp4-Err'
        if numRp5>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x5b,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp5-OK'
                else:
                    strout+=',Rp5-Err'
        if numRp6>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x5c,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp6-OK'
                else:
                    strout+=',Rp6-Err'
        if numRp7>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x5d,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp7-OK'
                else:
                    strout+=',Rp7-Err'
        if numRp8>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                wrf=WriteFloatMBus(portname,boud,0x4d,0x5e,1,fa,MainWindow)
                if wrf:
                    strout+=',Rp8-OK'
                else:
                    strout+=',Rp8-Err'
        ...
        if numish1A>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x4e,1,fa,MainWindow):
                    strout+=',ish1A-OK'
                else:
                    strout+=',ish1A-Err'
        if numish1B>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x4f,1,fa,MainWindow):
                    strout+=',ish1B-OK'
                else:
                    strout+=',ish1B-Err'
        if numish1C>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x50,1,fa,MainWindow):
                    strout+=',ish1C-OK'
                else:
                    strout+=',ish1C-Err'
        if numish1D>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x51,1,fa,MainWindow):
                    strout+=',ish1D-OK'
                else:
                    strout+=',ish1D-Err'
        if numish1Wal>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x52,1,fa,MainWindow):
                    strout+=',ish1Wal-OK'
                else:
                    strout+=',ish1Wal-Err'
        if numish1Rttb>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x53,1,fa,MainWindow):
                    strout+=',ish1Rttb-OK'
                else:
                    strout+=',ish1Rttb-Err'
        if numish1M>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x54,1,fa,MainWindow):
                    strout+=',ish1M-OK'
                else:
                    strout+=',ish1M-Err'
             
        if numish2C0>-1:
            parval=str_par_ToFloat(str_change,'ish2C0')
            if isinstance(parval,str):
                strout+=',ish2C0-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x55,1,fa,MainWindow):
                    strout+=',ish2C0-OK'
                else:
                    strout+=',ish2C0-Err'
        if numish2C1>-1:
            parval=str_par_ToFloat(str_change,'ish2C1')
            if isinstance(parval,str):
                strout+=',ish2C1-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x56,1,fa,MainWindow):
                    strout+=',ish2C1-OK'
                else:
                    strout+=',ish2C1-Err'
        if numish2C2>-1:
            parval=str_par_ToFloat(str_change,'ish2C2')
            if isinstance(parval,str):
                strout+=',ish2C2-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x57,1,fa,MainWindow):
                    strout+=',ish2C2-OK'
                else:
                    strout+=',ish2C2-Err'
        if numish2C3>-1:
            parval=str_par_ToFloat(str_change,'ish2C3')
            if isinstance(parval,str):
                strout+=',ish2C3-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x58,1,fa,MainWindow):
                    strout+=',ish2C3-OK'
                else:
                    strout+=',ish2C3-Err'
        if numish2C4>-1:
            parval=str_par_ToFloat(str_change,'ish2C4')
            if isinstance(parval,str):
                strout+=',ish2C4-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x59,1,fa,MainWindow):
                    strout+=',ish2C4-OK'
                else:
                    strout+=',ish2C4-Err'
        if numish2C5>-1:
            parval=str_par_ToFloat(str_change,'ish2C5')
            if isinstance(parval,str):
                strout+=',ish2C5-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5a,1,fa,MainWindow):
                    strout+=',ish2C5-OK'
                else:
                    strout+=',ish2C5-Err'
        if numish2C6>-1:
            parval=str_par_ToFloat(str_change,'ish2C6')
            if isinstance(parval,str):
                strout+=',ish2C6-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5b,1,fa,MainWindow):
                    strout+=',ish2C6-OK'
                else:
                    strout+=',ish2C6-Err'
        if numish2C7>-1:
            parval=str_par_ToFloat(str_change,'ish2C7')
            if isinstance(parval,str):
                strout+=',ish2C7-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5c,1,fa,MainWindow):
                    strout+=',ish2C7-OK'
                else:
                    strout+=',ish2C7-Err'
        if numish2C8>-1:
            parval=str_par_ToFloat(str_change,'ish2C8')
            if isinstance(parval,str):
                strout+=',ish2C8-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5d,1,fa,MainWindow):
                    strout+=',ish2C8-OK'
                else:
                    strout+=',ish2C8-Err'
        if numish2C9>-1:
            parval=str_par_ToFloat(str_change,'ish2C9')
            if isinstance(parval,str):
                strout+=',ish2C9-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x5e,1,fa,MainWindow):
                    strout+=',ish2C9-OK'
                else:
                    strout+=',ish2C9-Err'
        ...
        if numish3tPPOZn>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x60,1,fa,MainWindow):
        ...
        if numish3tPPOAl>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x61,1,fa,MainWindow):
        ...
        if numish3tPPOCu>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x62,1,fa,MainWindow):
        ...
        if numish3uPPOZn>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x63,1,fa,MainWindow):
        ...
        if numish3uPPOAl>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x64,1,fa,MainWindow):
        ...
        if numish3tPPOCu>-1:
            ...
            if isinstance(parval,str):
                ...
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x65,1,fa,MainWindow):
        ...
        if numish4tPROAl>-1:
            parval=str_par_ToFloat(str_change,'ish4tPROAl')
            if isinstance(parval,str):
                strout+=',ish4tPROAl-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x66,1,fa,MainWindow):
                    strout+=',ish4tPROAl-OK'
                else:
                    strout+=',ish4tPROAl-Err'
        if numish4tPROCu>-1:
            parval=str_par_ToFloat(str_change,'ish4tPROCu')
            if isinstance(parval,str):
                strout+=',ish4tPROCu-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x67,1,fa,MainWindow):
                    strout+=',ish4tPROCu-OK'
                else:
                    strout+=',ish4tPROCu-Err'
        if numish4tPROPd>-1:
            parval=str_par_ToFloat(str_change,'ish4tPROPd')
            if isinstance(parval,str):
                strout+=',ish4tPROPd-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x68,1,fa,MainWindow):
                    strout+=',ish4tPROPd-OK'
                else:
                    strout+=',ish4tPROPd-Err'
        if numish4tPROPt>-1:
            parval=str_par_ToFloat(str_change,'ish4tPROPt')
            if isinstance(parval,str):
                strout+=',ish4tPROPt-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x69,1,fa,MainWindow):
                    strout+=',ish4tPROPt-OK'
                else:
                    strout+=',ish4tPROPt-Err'
        if numish4uPROAl>-1:
            parval=str_par_ToFloat(str_change,'ish4uPROAl')
            if isinstance(parval,str):
                strout+=',ish4uPROAl-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6a,1,fa,MainWindow):
                    strout+=',ish4uPROAl-OK'
                else:
                    strout+=',ish4uPROAl-Err'
        if numish4uPROCu>-1:
            parval=str_par_ToFloat(str_change,'ish4uPROCu')
            if isinstance(parval,str):
                strout+=',ish4uPROCu-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6b,1,fa,MainWindow):
                    strout+=',ish4uPROCu-OK'
                else:
                    strout+=',ish4uPROCu-Err'
        if numish4uPROPd>-1:
            parval=str_par_ToFloat(str_change,'ish4uPROPd')
            if isinstance(parval,str):
                strout+=',ish4uPROPd-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6c,1,fa,MainWindow):
                    strout+=',ish4uPROPd-OK'
                else:
                    strout+=',ish4uPROPd-Err'
        if numish4uPROPt>-1:
            parval=str_par_ToFloat(str_change,'ish4uPROPt')
            if isinstance(parval,str):
                strout+=',ish4uPROPt-'
                strout+=parval
            else: 
                fa[0]=parval
                if WriteFloatMBus(portname,boud,0x4d,0x6d,1,fa,MainWindow):
                    strout+=',ish4uPPOPt-OK'
                else:
                    strout+=',ish4uPPOPt-Err'

        if numstartmeas>-1:
            fa[0]=1.0
            if WriteFloatMBus(portname,boud,0x4d,0x111,1,fa,MainWindow):
                strout+=',startmeas-OK'
            else:
        ...
        if numstopmeas>-1:
            fa[0]=1.0
            if WriteFloatMBus(portname,boud,0x4d,0x110,1,fa,MainWindow):
                strout+=',stopmeas-OK'
            else:
                strout+=',stopmeas-Err'
        ...
        if numzerocalibr>-1:
            fa[0]=1.0
            if WriteFloatMBus(portname,boud,0x4d,0x112,1,fa,MainWindow):
