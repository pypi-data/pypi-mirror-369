...
def main(argv=None) -> int:
  ...
  pv.add_argument("harvest", help="Harvest JSON file or source directory (if --watch)")
  pv.add_argument("--port", type=int, default=8787)
  pv.add_argument("--watch", action="store_true", help="Watch source directory for changes and auto-update")
  pv.add_argument("--debounce-ms", type=int, default=800, help="Debounce time in milliseconds (watch mode)")
  pv.add_argument("--poll", type=float, default=1.0, help="Polling interval in seconds (watch mode)")
  pv.add_argument("--only-ext", default=None, help="Comma-separated list of extensions to include (watch mode)")
  pv.add_argument("--skip-ext", default=None, help="Comma-separated list of extensions to exclude (watch mode)")
