...
# 创建FastMCP实例
fastmcp_stdio_mount_app = FastMCP()

# 将FastMCP挂载到独立应用
app.mount("/mcp", fastmcp_stdio_mount_app)  # 挂载子应用
...
if __name__ == "__main__":
    ...
    fastmcp_stdio_mount_app.run(transport="stdio")
    # fastmcp_stdio_mount_app.run(transport="streamable-http", host="127.0.0.1", port=8089, path="/mcp")