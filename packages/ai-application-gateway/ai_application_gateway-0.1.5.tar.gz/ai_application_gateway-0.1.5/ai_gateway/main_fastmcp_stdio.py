...
# 关键集成步骤，自动转换路由
fastmcp_stdio_app = FastMCP.from_fastapi(
    app=app,
...
if __name__ == "__main__":
    ...
    fastmcp_stdio_app.run(transport="stdio")
    # fastmcp_stdio_app.run(transport="streamable-http", host="127.0.0.1", port=8089, path="/mcp")