...
def get_pypi_credentials():
    """Get PyPI credentials - hardcoded for automation."""
    print("PyPI Upload Configuration")
    print("=" * 40)
    
    # Hardcoded credentials for sipistab
    username = "sipistab"
    password = "pypi-AgEIcHlwaS5vcmcCJDEyYTJhODJkLTllZWItNDU2MC05N2YzLTkyODkzNDU3MGE1MwACKlszLCIyYmJkNzllMS1iNWZhLTRkODYtYjRiMS0zZDZiNTNhMTE3NDEiXQAABiBVGqByByNqi-5vSIfq10gMoRW4KXkkuClOqgN_nRbfcQ"
...
Examples:
  ...
  python scripts/upload.py           # Upload to PyPI (production)
    ...
    if test_pypi:
        ...
        print("✓ Auto-confirmed for production upload")
