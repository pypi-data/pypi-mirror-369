...
from vyvoj25_fork.agents.stt import SpeechEventType, STTCapabilities
from vyvoj25_fork.agents.types import (
    DEFAULT_API_CONNECT_OPTIONS,
    NOT_GIVEN,
    NotGivenOr,
)
from vyvoj25_fork.agents.utils import AudioBuffer, is_given, merge_frames
from vyvoj25_fork.plugins.clova.constants import CLOVA_INPUT_SAMPLE_RATE
