...
class TestResourceListModel(unittest.TestCase):
    """ResourceListModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResourceListModel:
        """Test ResourceListModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResourceListModel`
        """
        model = ResourceListModel()
        if include_optional:
            return ResourceListModel(
                records = [
                    arthur_client.api_bindings.models.model.Model(
    ...
    def testResourceListModel(self):
        """Test ResourceListModel"""
