"""
Renderer for the IslandNavigation environment.

This class handles all Pygame drawing for the IslandNavigation environment.
It draws walls, water, the agent and the goal. It supports both human and
...
class Renderer:
    ...
    def render(self):
        ...
        # Draw the grid (walkable, water or walls)
