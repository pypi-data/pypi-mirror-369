...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_ds/paginators/)
...
if TYPE_CHECKING:
    _DescribeClientAuthenticationSettingsPaginatorBase = AioPaginator[
        DescribeClientAuthenticationSettingsResultTypeDef
    ]
else:
    _DescribeClientAuthenticationSettingsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeClientAuthenticationSettingsPaginator(
    ...
    ) -> AioPageIterator[DescribeClientAuthenticationSettingsResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeDirectoriesPaginatorBase = AioPaginator[DescribeDirectoriesResultTypeDef]
else:
    _DescribeDirectoriesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeDirectoriesPaginator(_DescribeDirectoriesPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeDirectoriesResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeDomainControllersPaginatorBase = AioPaginator[DescribeDomainControllersResultTypeDef]
else:
    _DescribeDomainControllersPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeDomainControllersPaginator(_DescribeDomainControllersPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeDomainControllersResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeLDAPSSettingsPaginatorBase = AioPaginator[DescribeLDAPSSettingsResultTypeDef]
else:
    _DescribeLDAPSSettingsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeLDAPSSettingsPaginator(_DescribeLDAPSSettingsPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeLDAPSSettingsResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeRegionsPaginatorBase = AioPaginator[DescribeRegionsResultTypeDef]
else:
    _DescribeRegionsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeRegionsPaginator(_DescribeRegionsPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeRegionsResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeSharedDirectoriesPaginatorBase = AioPaginator[DescribeSharedDirectoriesResultTypeDef]
else:
    _DescribeSharedDirectoriesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeSharedDirectoriesPaginator(_DescribeSharedDirectoriesPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeSharedDirectoriesResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeTrustsPaginatorBase = AioPaginator[DescribeTrustsResultTypeDef]
else:
    _DescribeTrustsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeTrustsPaginator(_DescribeTrustsPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeTrustsResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _DescribeUpdateDirectoryPaginatorBase = AioPaginator[DescribeUpdateDirectoryResultTypeDef]
else:
    _DescribeUpdateDirectoryPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class DescribeUpdateDirectoryPaginator(_DescribeUpdateDirectoryPaginatorBase):
    ...
    ) -> AioPageIterator[DescribeUpdateDirectoryResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListCertificatesPaginatorBase = AioPaginator[ListCertificatesResultTypeDef]
else:
...
class ListCertificatesPaginator(_ListCertificatesPaginatorBase):
    ...
    ) -> AioPageIterator[ListCertificatesResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListIpRoutesPaginatorBase = AioPaginator[ListIpRoutesResultTypeDef]
else:
    _ListIpRoutesPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListIpRoutesPaginator(_ListIpRoutesPaginatorBase):
    ...
    ) -> AioPageIterator[ListIpRoutesResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListLogSubscriptionsPaginatorBase = AioPaginator[ListLogSubscriptionsResultTypeDef]
else:
    _ListLogSubscriptionsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListLogSubscriptionsPaginator(_ListLogSubscriptionsPaginatorBase):
    ...
    ) -> AioPageIterator[ListLogSubscriptionsResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListSchemaExtensionsPaginatorBase = AioPaginator[ListSchemaExtensionsResultTypeDef]
else:
    _ListSchemaExtensionsPaginatorBase = AioPaginator  # type: ignore[assignment]
...
class ListSchemaExtensionsPaginator(_ListSchemaExtensionsPaginatorBase):
    ...
    ) -> AioPageIterator[ListSchemaExtensionsResultTypeDef]:
        """
...
if TYPE_CHECKING:
    _ListTagsForResourcePaginatorBase = AioPaginator[ListTagsForResourceResultTypeDef]
else:
...
class ListTagsForResourcePaginator(_ListTagsForResourcePaginatorBase):
    ...
    ) -> AioPageIterator[ListTagsForResourceResultTypeDef]:
        """
