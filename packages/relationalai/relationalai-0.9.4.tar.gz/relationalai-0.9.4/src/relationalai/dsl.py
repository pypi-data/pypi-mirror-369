...
class Context():
    def __init__(self, graph:'Graph', *args, behavior=Behavior.Query, op=None,
                 ...
                 attributes=None, read_only=False):
        self._id = next_id()
...
class Graph:
    ...
    def _exec(self, context:Context, task):
        ...
        if context._exec_type == TaskExecType.Rule:
            ...
            context.results = self._client.query(context._task, tag=context._tag, format=context._format, headers=headers, read_only=context._read_only)
