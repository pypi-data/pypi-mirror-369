...
CREATE TABLE Shipment (
    ...
    "days_btw_orders"                   NUMERIC NOT NULL DEFAULT 0,                 --@ Time interval between two subsequent orders (units: days)
    "use_distribution"                  INTEGER NOT NULL DEFAULT 0,                 --@ boolean flag - is this shipment using a distribution center?
