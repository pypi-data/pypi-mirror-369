...
class Progress:
    ...
    def render(self, *, throttle: bool = False) -> None:
        ...
        # 가드 컬럼은 TerminalIO에서 처리하므로 여기선 그대로 사용
        from .util import term_rows, visible_width, pad_to, cut_visible_preserve_ansi
        ...
        if len(self._order) > 0:
            ...
            r_lines = [" " * right_w for _ in range(max(1, body_rows))]
