...
from pydantic.dataclasses import dataclass, is_dataclass
...
@dataclass
class TextGenMessage(BaseModel):
    model_config = ConfigDict(extra="ignore")  # Ignore extra fields
...
@dataclass
class KagiSearchItem(BaseModel):
    model_config = ConfigDict(extra="ignore")  # Ignore extra fields
...
@dataclass
class KagiSearchOutput(BaseModel):
    model_config = ConfigDict(extra="ignore")  # Ignore extra fields
