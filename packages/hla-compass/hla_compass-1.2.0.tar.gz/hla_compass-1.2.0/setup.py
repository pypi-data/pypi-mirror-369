...
# Read version from __init__.py to single-source the version
def get_version():
    with open(os.path.join("hla_compass", "__init__.py"), "r") as f:
        content = f.read()
...
setup(    name="hla-compass",  # Shorter name for easier installation
    ...
    extras_require={
        ...
        "data": [
            "pandas>=1.3.0",     # For DataFrame export and Excel support
