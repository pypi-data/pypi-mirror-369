...
def ohlc_r2(o1, h1, l1, c1, c0, model = 'yz', alpha = None, short_range = None, long_range = None):
    """
...
def bar_r2(bar, o = 'open', h = 'high', l = 'low', c = 'close', model = 'yz', alpha = None, short_range = None, long_range = None):
    ...
    c1 = bar[c]
    c0 = shift(c1)
    return ohlc_r2(o1 = o1, h1 = h1, l1 = l1, c1 = c1, c0 = c0, model = model, alpha = alpha, short_range = short_range, long_range=long_range)
