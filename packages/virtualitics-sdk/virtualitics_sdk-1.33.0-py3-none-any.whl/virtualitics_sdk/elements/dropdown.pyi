...
class SingleDropdown(Dropdown):
    ...
    **EXAMPLE**
    ...
    '''
    def __init__(self, options: list[str | int | float], selected: int | float | str | None = None, include_nulls_visible: bool = True, include_nulls_value: bool = False, title: str = '', description: str = '', show_title: bool = True, show_description: bool = True, required: bool = True, label: str = '', placeholder: str = '', page_update: Callable | None = None) -> None: ...
        ...
        .. code-block:: python
            ...
            class ExStep(Step):
                def run(self, flow_metadata):
                    ...
                    page.add_card_to_section(card, "Ex Section")
    '''
    def __init__(self, options: list[str | int | float], selected: list[str | int | float] | None = None, include_nulls_visible: bool = True, include_nulls_value: bool = False, title: str = '', description: str = '', show_title: bool = True, show_description: bool = True, required: bool = True, label: str = '', placeholder: str = '', max_selections: int | None = None, page_update: Callable | None = None) -> None: ...
