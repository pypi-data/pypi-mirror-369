...
class PairProgrammingInterface:
    def __init__(self, repo_path: str = ".", output_dir: str = "output", enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = True, debug_mode: bool = False, reasoning_mode: bool = False, provider: str = "anthropic", model: str = None, openrouter_site_url: str = None, openrouter_site_name: str = None):
        self.console = Console(highlight=False)
        self.repo_path = Path(repo_path)
        self.output_dir = Path(output_dir)
        self.show_diffs = show_diffs
        self.debug_mode = debug_mode
        self.workflow = CleanSWEWorkflow(repo_path, output_dir, use_planner=False, enable_mcp=enable_mcp, show_diffs=show_diffs, debug_mode=debug_mode, provider=provider, model=model, openrouter_site_url=openrouter_site_url, openrouter_site_name=openrouter_site_name)
