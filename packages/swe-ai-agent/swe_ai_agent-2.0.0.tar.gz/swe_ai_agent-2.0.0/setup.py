...
setup(
    ...
    description="Headless Agentic IDE with True Iterative Reinforcement Learning and o1-like reasoning capabilities",
    ...
    entry_points={
        "console_scripts": [
            "swe-agent=swe_agent.cli.main:main",
            "swe=swe_agent.cli.main:main",
            "sweagent=swe_agent.cli.main:main",
        ],
    },
