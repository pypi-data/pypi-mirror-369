...
Examples:
    ...
    try:
        ...
        if args.task:
            execute_single_task(args.task, settings, args.use_planner, args.enable_mcp, settings.no_shell_approval, args.show_diffs, args.debug_mode, getattr(args, 'reasoning', False))
            return
        
        # Start pair programming interface
        if args.pair:
            start_pair_programming(settings, args.enable_mcp, settings.no_shell_approval, args.show_diffs, args.debug_mode, getattr(args, 'reasoning', False))
            return
        
        # Start Warp interface
        if args.warp:
            start_warp_interface(settings, args.enable_mcp, settings.no_shell_approval, args.show_diffs, args.debug_mode, getattr(args, 'reasoning', False))
            return
        
        # Start interactive mode
        if args.interactive:
            start_interactive_mode(settings, args.enable_mcp, settings.no_shell_approval, args.show_diffs, args.debug_mode, getattr(args, 'reasoning', False))
            return
...
def execute_single_task(task: str, settings: Settings, use_planner: bool = False, enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = True, debug_mode: bool = False, reasoning: bool = False):
    ...
    if reasoning:
        ...
        from swe_agent.rl_mode.true_rl_workflow import TrueRLWorkflow
...
def start_interactive_mode(settings: Settings, enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = True, debug_mode: bool = False, reasoning: bool = False):
    """Start interactive CLI mode"""
    cli = SWEInterface(settings, enable_mcp, no_shell_approval, show_diffs, debug_mode)
    cli.start_interactive_mode()


def start_pair_programming(settings: Settings, enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = True, debug_mode: bool = False, reasoning: bool = False):
    """Start pair programming interface"""
...
def start_warp_interface(settings: Settings, enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = True, debug_mode: bool = False, reasoning: bool = False):
