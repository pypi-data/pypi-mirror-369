...
class SWEInterface:
    ...
    def __init__(self, settings: Settings, enable_mcp: bool = False, no_shell_approval: bool = False, show_diffs: bool = True, debug_mode: bool = False):
        ...
        self.workflow = CleanSWEWorkflow(str(settings.repo_path), str(settings.output_dir), settings.use_planner, enable_mcp, show_diffs, debug_mode, "anthropic", None, None, None)
