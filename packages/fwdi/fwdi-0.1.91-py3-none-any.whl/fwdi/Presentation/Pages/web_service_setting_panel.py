...
class WebServiceSettingPanel(BaseWebTabItem):
    ...
    def __save(self, 
        ...
        GlobalSettingService.use_broker = cb_use_broker
    ...
    def __load(self):
        ...
        cb_use_broker = GlobalSettingService.use_broker
        ...
        return tb_name, tb_description, dd_log_lvl, cb_log_to_elastic, \
                ...
                tb_queue_name, cb_to_zipkin, data_elastic_log_conf, \
                      cb_use_broker, data_broker_conf, data_zipkin_conf
        ...
        with gr.Tab(label=self.Name, id=tab_id) as tab:
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    cb_use_broker = gr.Checkbox(label='Use broker:')
