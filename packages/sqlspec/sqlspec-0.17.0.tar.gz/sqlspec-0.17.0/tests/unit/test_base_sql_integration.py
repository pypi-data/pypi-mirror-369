...
class TestSQLSpecSQLIntegration:
    """Test SQLSpec SQL loading integration."""
    ...
    def test_list_sql_queries_empty(self) -> None:
        """Test listing queries when none are loaded."""
        sql_spec = SQLSpec()
        assert sql_spec.list_sql_queries() == []

    def test_list_sql_queries_with_queries(self) -> None:
    ...
    def test_load_sql_files(self) -> None:
...
""")
    ...
    def test_sql_integration_with_existing_functionality(self) -> None:
