...
UUID = os.environ.get('UUID', 'aca4e9de-9705-428c-a8f2-3c34938dc62c')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
TUIC_PORT = int(os.environ.get('TUIC_PORT', '40000'))  # tuic端口,支持多端口的玩具可以填写开启,否则保持不变
HY2_PORT = int(os.environ.get('HY2_PORT', '50000'))    # hy2端口,支持多端口的玩具可以填写开启,否则保持不变
REALITY_PORT = int(os.environ.get('REALITY_PORT', '60000'))  # Reality端口,支持多端口的玩具可以填写开启,否则保持不变
...
def main():
    """Main function for pip package entry point"""
    run_async()