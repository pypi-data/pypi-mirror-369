...
from ._backstage_casting import BackstageIcon1,BackstageCastingIcon
...
from ._handshake_protocol import HandshakeIcon1,HandshakeProtocolIcon
...
from ._hive import HiveIcon
from ._hive_blockchain import HiveIcon1,HiveBlockchainIcon
...
from ._mongoosedotws import MongooseIcon1,MongoosedotwsIcon
...
from ._spring_creators import SpringIcon1,SpringCreatorsIcon
...
from ._uniqlo import UniqloIcon
from ._uniqlo_ja import UniqloIcon1,UniqloJaIcon
...
ALL_ICONS: "Final[list[str]]" = [
    ...
    DotnetIcon.__name__,
    EIcon.__name__,
    OneDotOneDotOneDotOneIcon.__name__,
    OneAndOneIcon.__name__,
    OneThousandAndOneTracklistsIcon.__name__,
    OnePanelIcon.__name__,
    OnePasswordIcon.__name__,
    TwoFasIcon.__name__,
    TwoKIcon.__name__,
    ThirtySecondsOfCodeIcon.__name__,
    ThreeHundredAndSixtyFiveDataScienceIcon.__name__,
    ThreeMIcon.__name__,
    FortyTwoIcon.__name__,
    FourChanIcon.__name__,
    FourDIcon.__name__,
    FiveHundredPxIcon.__name__,
    SevenZipIcon.__name__,
    NinetyNineDesignsIcon.__name__,
    NineGagIcon.__name__,
    AframeIcon.__name__,
    AbDownloadManagerIcon.__name__,
    AbbIcon.__name__,
    AbbottIcon.__name__,
    AbbvieIcon.__name__,
    AboutdotmeIcon.__name__,
    AbstractIcon.__name__,
    AbusedotchIcon.__name__,
    AcademiaIcon.__name__,
    AccentureIcon.__name__,
    AccusoftIcon.__name__,
    AccuweatherIcon.__name__,
    AcerIcon.__name__,
    AcmIcon.__name__,
    ...
    AdguardIcon.__name__,
    AdidasIcon.__name__,
    AdminerIcon.__name__,
    AdonisjsIcon.__name__,
    AdpIcon.__name__,
    AdrollIcon.__name__,
    AdventOfCodeIcon.__name__,
    AdyenIcon.__name__,
    AegisAuthenticatorIcon.__name__,
    AerLingusIcon.__name__,
    AeroflotIcon.__name__,
    AeromexicoIcon.__name__,
    AerospikeIcon.__name__,
    AewIcon.__name__,
    AfdianIcon.__name__,
    AffineIcon.__name__,
    AffinityIcon.__name__,
    AffinityDesignerIcon.__name__,
    AffinityPhotoIcon.__name__,
    AffinityPublisherIcon.__name__,
    AfterpayIcon.__name__,
    AftershipIcon.__name__,
    AgoraIcon.__name__,
    AiDungeonIcon.__name__,
    AibIcon.__name__,
    AiohttpIcon.__name__,
    AiqfomeIcon.__name__,
    AirCanadaIcon.__name__,
    AirChinaIcon.__name__,
    AirFranceIcon.__name__,
    AirIndiaIcon.__name__,
    AirSerbiaIcon.__name__,
    AirTransatIcon.__name__,
    AirasiaIcon.__name__,
    AirbnbIcon.__name__,
    AirbrakeIcon.__name__,
    AirbusIcon.__name__,
    AirbyteIcon.__name__,
    AircallIcon.__name__,
    AirplayAudioIcon.__name__,
    AirplayVideoIcon.__name__,
    AirtableIcon.__name__,
    AirtelIcon.__name__,
    AjvIcon.__name__,
    AkamaiIcon.__name__,
    AkasaAirIcon.__name__,
    AkauntingIcon.__name__,
    AkiflowIcon.__name__,
    ...
    AldiSudIcon.__name__,
    AlfaRomeoIcon.__name__,
    AlfredIcon.__name__,
    AlgoliaIcon.__name__,
    AlgorandIcon.__name__,
    AlibabaCloudIcon.__name__,
    AlibabadotcomIcon.__name__,
    AlienwareIcon.__name__,
    AliexpressIcon.__name__,
    AlipayIcon.__name__,
    AlistIcon.__name__,
    AllegroIcon.__name__,
    AlliedmoddersIcon.__name__,
    AllocineIcon.__name__,
    AlltrailsIcon.__name__,
    AlmalinuxIcon.__name__,
    AlpineLinuxIcon.__name__,
    AlpinedotjsIcon.__name__,
    AlternativetoIcon.__name__,
    AlteryxIcon.__name__,
    AltiumDesignerIcon.__name__,
    AlwaysdataIcon.__name__,
    AlxIcon.__name__,
    AmdIcon.__name__,
    AmebaIcon.__name__,
    AmericanAirlinesIcon.__name__,
    AmericanExpressIcon.__name__,
    AmgIcon.__name__,
    AmpIcon.__name__,
    AmulIcon.__name__,
    AnaIcon.__name__,
    AnacondaIcon.__name__,
    AnalogueIcon.__name__,
    AndelaIcon.__name__,
    AndroidIcon.__name__,
    ...
    AnswerIcon.__name__,
    AnsysIcon.__name__,
    AntDesignIcon.__name__,
    AntaIcon.__name__,
    AntenaThreeIcon.__name__,
    AntennapodIcon.__name__,
    AnthropicIcon.__name__,
    AntvIcon.__name__,
    AnycubicIcon.__name__,
    AnydeskIcon.__name__,
    AnytypeIcon.__name__,
    ApacheIcon.__name__,
    ...
    ApacheFreemarkerIcon.__name__,
    ApacheGroovyIcon.__name__,
    ApacheGuacamoleIcon.__name__,
    ApacheHadoopIcon.__name__,
    ApacheHbaseIcon.__name__,
    ApacheHiveIcon.__name__,
    ApacheJmeterIcon.__name__,
    ApacheKafkaIcon.__name__,
    ApacheKylinIcon.__name__,
    ApacheLuceneIcon.__name__,
    ApacheMavenIcon.__name__,
    ApacheNetbeansIdeIcon.__name__,
    ...
    ApacheSparkIcon.__name__,
    ApacheStormIcon.__name__,
    ApacheSupersetIcon.__name__,
    ApacheTomcatIcon.__name__,
    AparatIcon.__name__,
    ApifoxIcon.__name__,
    ApmTerminalsIcon.__name__,
    ApolloGraphqlIcon.__name__,
    ...
    ApplePayIcon.__name__,
    ApplePodcastsIcon.__name__,
    AppleTvIcon.__name__,
    AppsignalIcon.__name__,
    AppsmithIcon.__name__,
    AppveyorIcon.__name__,
    AppwriteIcon.__name__,
    AquaIcon.__name__,
    AralIcon.__name__,
    ArangodbIcon.__name__,
    ArcIcon.__name__,
    ArcgisIcon.__name__,
    ArchLinuxIcon.__name__,
    ArchicadIcon.__name__,
    ArchiveOfOurOwnIcon.__name__,
    ArdourIcon.__name__,
    ArduinoIcon.__name__,
    ArgoIcon.__name__,
    ArgosIcon.__name__,
    ...
    ArloIcon.__name__,
    ArmIcon.__name__,
    ArmKeilIcon.__name__,
    ArsTechnicaIcon.__name__,
    ArtifactHubIcon.__name__,
    ArtixLinuxIcon.__name__,
    ArtstationIcon.__name__,
    ArxivIcon.__name__,
    AsahiLinuxIcon.__name__,
    AsanaIcon.__name__,
    AsciidoctorIcon.__name__,
    AsciinemaIcon.__name__,
    AsdaIcon.__name__,
    AsepriteIcon.__name__,
    AssemblyscriptIcon.__name__,
    AsteriskIcon.__name__,
    AstonMartinIcon.__name__,
    AstraIcon.__name__,
    AstralIcon.__name__,
    AstroIcon.__name__,
    AsusIcon.__name__,
    ...
    AudiIcon.__name__,
    AudibleIcon.__name__,
    AudiotechnicaIcon.__name__,
    AudiobookshelfIcon.__name__,
    AudioboomIcon.__name__,
    AudiomackIcon.__name__,
    AureliaIcon.__name__,
    AuthZeroIcon.__name__,
    AutheliaIcon.__name__,
    AuthentikIcon.__name__,
    AuthyIcon.__name__,
    AutocadIcon.__name__,
    AutocannonIcon.__name__,
    AutodeskIcon.__name__,
    AutodeskMayaIcon.__name__,
    AutodeskRevitIcon.__name__,
    AutohotkeyIcon.__name__,
    AutoitIcon.__name__,
    AutomatticIcon.__name__,
    ...
    AxiosIcon.__name__,
    AxisBankIcon.__name__,
    BandrAutomationIcon.__name__,
    BabelIcon.__name__,
    BabelioIcon.__name__,
    BabylondotjsIcon.__name__,
    BackblazeIcon.__name__,
    BackboneIcon.__name__,
    BackbonedotjsIcon.__name__,
    BackendlessIcon.__name__,
    BackstageIcon.__name__,
    BackstageIcon1.__name__,
    BackstageCastingIcon.__name__,
    BadooIcon.__name__,
    BaiduIcon.__name__,
    BakalariIcon.__name__,
    BambooIcon.__name__,
    BambuLabIcon.__name__,
    BandcampIcon.__name__,
    BandlabIcon.__name__,
    BandsintownIcon.__name__,
    BankOfAmericaIcon.__name__,
    ...
    BazelIcon.__name__,
    BeatportIcon.__name__,
    BeatsIcon.__name__,
    BeatsByDreIcon.__name__,
    BeatstarsIcon.__name__,
    BeekeeperStudioIcon.__name__,
    BehanceIcon.__name__,
    BeijingSubwayIcon.__name__,
    BemIcon.__name__,
    BentleyIcon.__name__,
    BentoIcon.__name__,
    BentoboxIcon.__name__,
    ...
    BevyIcon.__name__,
    BigCartelIcon.__name__,
    BigbasketIcon.__name__,
    BigbluebuttonIcon.__name__,
    BigcommerceIcon.__name__,
    ...
    BitIcon.__name__,
    BitbucketIcon.__name__,
    BitcoinIcon.__name__,
    BitcoinCashIcon.__name__,
    BitcoinSvIcon.__name__,
    BitcometIcon.__name__,
    ...
    BlazorIcon.__name__,
    BlenderIcon.__name__,
    BlibliIcon.__name__,
    BlockbenchIcon.__name__,
    BlockchaindotcomIcon.__name__,
    BloggerIcon.__name__,
    BloglovinIcon.__name__,
    BlueprintIcon.__name__,
    BlueskyIcon.__name__,
    BluesoundIcon.__name__,
    BluetoothIcon.__name__,
    BmcSoftwareIcon.__name__,
    BmwIcon.__name__,
    BnbChainIcon.__name__,
    BoardgamegeekIcon.__name__,
    BoatIcon.__name__,
    BoehringerIngelheimIcon.__name__,
    BoeingIcon.__name__,
    BohemiaInteractiveIcon.__name__,
    ...
    BoostyIcon.__name__,
    BootsIcon.__name__,
    BootstrapIcon.__name__,
    BorgbackupIcon.__name__,
    BoschIcon.__name__,
    BoseIcon.__name__,
    BotbleCmsIcon.__name__,
    BoulangerIcon.__name__,
    BowerIcon.__name__,
    BoxIcon.__name__,
    ...
    BrenntagIcon.__name__,
    BrevoIcon.__name__,
    BrexIcon.__name__,
    BricksIcon.__name__,
    BritishAirwaysIcon.__name__,
    BroadcomIcon.__name__,
    BrunoIcon.__name__,
    BsdIcon.__name__,
    BspwmIcon.__name__,
    BtIcon.__name__,
    BuddyIcon.__name__,
    BudibaseIcon.__name__,
    BuefyIcon.__name__,
    BufferIcon.__name__,
    BugattiIcon.__name__,
    BugcrowdIcon.__name__,
    BuhlIcon.__name__,
    BuildkiteIcon.__name__,
    ...
    BurtonIcon.__name__,
    BuyMeACoffeeIcon.__name__,
    BuyselladsIcon.__name__,
    BuzzfeedIcon.__name__,
    BvgIcon.__name__,
    ByjusIcon.__name__,
    BytedanceIcon.__name__,
    CIcon.__name__,
    ...
    CairoGraphicsIcon.__name__,
    CairoMetroIcon.__name__,
    CaixabankIcon.__name__,
    CakephpIcon.__name__,
    CaldotcomIcon.__name__,
    CalendlyIcon.__name__,
    CalibrewebIcon.__name__,
    CampaignMonitorIcon.__name__,
    CamundaIcon.__name__,
    CanonicalIcon.__name__,
    CanvaIcon.__name__,
    CanvasIcon.__name__,
    CapacitorIcon.__name__,
    ...
    CastboxIcon.__name__,
    CastoramaIcon.__name__,
    CastroIcon.__name__,
    CaterpillarIcon.__name__,
    CbcIcon.__name__,
    CbsIcon.__name__,
    CccIcon.__name__,
    CcleanerIcon.__name__,
    CdProjektIcon.__name__,
    CeIcon.__name__,
    CeleryIcon.__name__,
    CelestronIcon.__name__,
    CentosIcon.__name__,
    CephIcon.__name__,
    CesiumIcon.__name__,
    ChaiIcon.__name__,
    ChainguardIcon.__name__,
    ChainlinkIcon.__name__,
    ChakraUiIcon.__name__,
    ChangeDetectionIcon.__name__,
    ChannelFourIcon.__name__,
    CharlesIcon.__name__,
    ChartdotjsIcon.__name__,
    ChartmogulIcon.__name__,
    ChaseIcon.__name__,
    ChatbotIcon.__name__,
    ChatwootIcon.__name__,
    CheckioIcon.__name__,
    CheckmarxIcon.__name__,
    CheckmkIcon.__name__,
    ChedrauiIcon.__name__,
    CheerioIcon.__name__,
    ChefIcon.__name__,
    ChemexIcon.__name__,
    ChessdotcomIcon.__name__,
    ...
    ChryslerIcon.__name__,
    ChupaChupsIcon.__name__,
    CiliumIcon.__name__,
    ...
    CiscoIcon.__name__,
    CitrixIcon.__name__,
    CitroenIcon.__name__,
    CivicrmIcon.__name__,
    CivoIcon.__name__,
    ClarifaiIcon.__name__,
    ClarisIcon.__name__,
    ClarivateIcon.__name__,
    ClaudeIcon.__name__,
    ClerkIcon.__name__,
    ...
    CloudflareIcon.__name__,
    CloudflarePagesIcon.__name__,
    CloudflareWorkersIcon.__name__,
    CloudinaryIcon.__name__,
    CloudronIcon.__name__,
    CloudsmithIcon.__name__,
    CloudwaysIcon.__name__,
    ClubforceIcon.__name__,
    ClubhouseIcon.__name__,
    ClypIcon.__name__,
    CmakeIcon.__name__,
    CncfIcon.__name__,
    CnesIcon.__name__,
    ...
    CoopIcon.__name__,
    CobaltIcon.__name__,
    CocacolaIcon.__name__,
    CockpitIcon.__name__,
    CockroachLabsIcon.__name__,
    CocoapodsIcon.__name__,
    CocosIcon.__name__,
    CodaIcon.__name__,
    CodacyIcon.__name__,
    ...
    CodecovIcon.__name__,
    CodecraftersIcon.__name__,
    CodefactorIcon.__name__,
    CodeforcesIcon.__name__,
    CodefreshIcon.__name__,
    CodeigniterIcon.__name__,
    CodemagicIcon.__name__,
    CodementorIcon.__name__,
    CodemirrorIcon.__name__,
    CodenewbieIcon.__name__,
    CodepenIcon.__name__,
    CodeprojectIcon.__name__,
    CoderIcon.__name__,
    CoderabbitIcon.__name__,
    CodersrankIcon.__name__,
    CoderwallIcon.__name__,
    CodesandboxIcon.__name__,
    CodeshipIcon.__name__,
    CodesignalIcon.__name__,
    CodestreamIcon.__name__,
    CodewarsIcon.__name__,
    CodingNinjasIcon.__name__,
    CodingameIcon.__name__,
    CodioIcon.__name__,
    CoffeescriptIcon.__name__,
    CoggleIcon.__name__,
    CognizantIcon.__name__,
    CoinbaseIcon.__name__,
    CoinmarketcapIcon.__name__,
    CollaboraOnlineIcon.__name__,
    ComicfuryIcon.__name__,
    CommaIcon.__name__,
    CommerzbankIcon.__name__,
    CommitlintIcon.__name__,
    CommodoreIcon.__name__,
    CommonLispIcon.__name__,
    CommonWorkflowLanguageIcon.__name__,
    CompilerExplorerIcon.__name__,
    ComposerIcon.__name__,
    ComptiaIcon.__name__,
    ComsolIcon.__name__,
    ConanIcon.__name__,
    ConcourseIcon.__name__,
    CondaforgeIcon.__name__,
    ConektaIcon.__name__,
    ConfluenceIcon.__name__,
    ConstructThreeIcon.__name__,
    ConsulIcon.__name__,
    ContaboIcon.__name__,
    ContactlessPaymentIcon.__name__,
    ContainerdIcon.__name__,
    ContaoIcon.__name__,
    ContentfulIcon.__name__,
    ContentstackIcon.__name__,
    ContinenteIcon.__name__,
    ...
    CorsairIcon.__name__,
    CouchbaseIcon.__name__,
    CounterstrikeIcon.__name__,
    CountingworksProIcon.__name__,
    CourseraIcon.__name__,
    CoverallsIcon.__name__,
    CozeIcon.__name__,
    CpanelIcon.__name__,
    CraftCmsIcon.__name__,
    CraftsmanIcon.__name__,
    CratedbIcon.__name__,
    CrayonIcon.__name__,
    CrealityIcon.__name__,
    CreateReactAppIcon.__name__,
    CreativeCommonsIcon.__name__,
    CreativeTechnologyIcon.__name__,
    CredlyIcon.__name__,
    CrehanaIcon.__name__,
    CrewUnitedIcon.__name__,
    CrewaiIcon.__name__,
    CriticalRoleIcon.__name__,
    CrowdinIcon.__name__,
    CrowdsourceIcon.__name__,
    CrunchbaseIcon.__name__,
    CrunchyrollIcon.__name__,
    CryengineIcon.__name__,
    CryptomatorIcon.__name__,
    CryptpadIcon.__name__,
    CrystalIcon.__name__,
    CsdnIcon.__name__,
    CssIcon.__name__,
    CssDesignAwardsIcon.__name__,
    CssModulesIcon.__name__,
    CssWizardryIcon.__name__,
    CtsIcon.__name__,
    CucumberIcon.__name__,
    ...
    CypressIcon.__name__,
    CytoscapedotjsIcon.__name__,
    DIcon.__name__,
    DedgeIcon.__name__,
    DwaveSystemsIcon.__name__,
    DThreeIcon.__name__,
    DaciaIcon.__name__,
    DafIcon.__name__,
    DailydotdevIcon.__name__,
    DailymotionIcon.__name__,
    DaisyuiIcon.__name__,
    DaprIcon.__name__,
    DarkReaderIcon.__name__,
    DartIcon.__name__,
    DartyIcon.__name__,
    DasErsteIcon.__name__,
    DashIcon.__name__,
    DashlaneIcon.__name__,
    DaskIcon.__name__,
    DassaultSystemesIcon.__name__,
    DatadotaiIcon.__name__,
    DatabricksIcon.__name__,
    DatacampIcon.__name__,
    DatadogIcon.__name__,
    DatagripIcon.__name__,
    DataikuIcon.__name__,
    DatastaxIcon.__name__,
    DatefnsIcon.__name__,
    DatevIcon.__name__,
    DatocmsIcon.__name__,
    DattoIcon.__name__,
    DavinciResolveIcon.__name__,
    DazhongDianpingIcon.__name__,
    DaznIcon.__name__,
    DbeaverIcon.__name__,
    DblpIcon.__name__,
    DbtIcon.__name__,
    DcEntertainmentIcon.__name__,
    DelonghiIcon.__name__,
    DebianIcon.__name__,
    DebridlinkIcon.__name__,
    DecapCmsIcon.__name__,
    DecentralandIcon.__name__,
    DeepcoolIcon.__name__,
    ...
    DerSpiegelIcon.__name__,
    DeutscheBahnIcon.__name__,
    DeutscheBankIcon.__name__,
    DeutschePostIcon.__name__,
    DeutscheTelekomIcon.__name__,
    ...
    DinersClubIcon.__name__,
    DiorIcon.__name__,
    DirectusIcon.__name__,
    DiscogsIcon.__name__,
    DiscordIcon.__name__,
    DiscorddotjsIcon.__name__,
    DiscourseIcon.__name__,
    DiscoverIcon.__name__,
    DisqusIcon.__name__,
    DisrootIcon.__name__,
    DistroboxIcon.__name__,
    DistrokidIcon.__name__,
    DjangoIcon.__name__,
    DjiIcon.__name__,
    DlibIcon.__name__,
    DlnaIcon.__name__,
    ...
    DmmIcon.__name__,
    DockerIcon.__name__,
    DocsdotrsIcon.__name__,
    DocsifyIcon.__name__,
    DoctrineIcon.__name__,
    ...
    DoubanIcon.__name__,
    DoubanReadIcon.__name__,
    DovecotIcon.__name__,
    DovetailIcon.__name__,
    DowndetectorIcon.__name__,
    DoxygenIcon.__name__,
    DpdIcon.__name__,
    DragonframeIcon.__name__,
    DraugiemdotlvIcon.__name__,
    DreamstimeIcon.__name__,
    DribbbleIcon.__name__,
    DrizzleIcon.__name__,
    DroneIcon.__name__,
    DroobleIcon.__name__,
    DropboxIcon.__name__,
    DrupalIcon.__name__,
    DsAutomobilesIcon.__name__,
    DtsIcon.__name__,
    DtubeIcon.__name__,
    DucatiIcon.__name__,
    DuckdbIcon.__name__,
    DuckduckgoIcon.__name__,
    DungeonsandDragonsIcon.__name__,
    DunkedIcon.__name__,
    DunzoIcon.__name__,
    DuolingoIcon.__name__,
    DuplicatiIcon.__name__,
    DvcIcon.__name__,
    DwmIcon.__name__,
    DynatraceIcon.__name__,
    EdotleclercIcon.__name__,
    EThreeIcon.__name__,
    EaIcon.__name__,
    EacIcon.__name__,
    EagleIcon.__name__,
    EasyedaIcon.__name__,
    EasyjetIcon.__name__,
    EbayIcon.__name__,
    EboxIcon.__name__,
    EclipseAdoptiumIcon.__name__,
    EclipseCheIcon.__name__,
    EclipseIdeIcon.__name__,
    EclipseJettyIcon.__name__,
    EclipseMosquittoIcon.__name__,
    EclipseVertdotxIcon.__name__,
    EcosiaIcon.__name__,
    EcovacsIcon.__name__,
    EdekaIcon.__name__,
    EdgeImpulseIcon.__name__,
    ...
    EgnyteIcon.__name__,
    EightIcon.__name__,
    EightSleepIcon.__name__,
    EjsIcon.__name__,
    ElasticIcon.__name__,
    ElasticCloudIcon.__name__,
    ElasticStackIcon.__name__,
    ElasticsearchIcon.__name__,
    ElavonIcon.__name__,
    ElectronIcon.__name__,
    ElectronFiddleIcon.__name__,
    ElectronbuilderIcon.__name__,
    ElegooIcon.__name__,
    ElementIcon.__name__,
    ElementaryIcon.__name__,
    ElementorIcon.__name__,
    ...
    EmbarkIcon.__name__,
    EmberdotjsIcon.__name__,
    EmbyIcon.__name__,
    EmiratesIcon.__name__,
    EmlakjetIcon.__name__,
    ...
    EpelIcon.__name__,
    EpicGamesIcon.__name__,
    EpsonIcon.__name__,
    EquinixMetalIcon.__name__,
    EraserIcon.__name__,
    EricssonIcon.__name__,
    ErlangIcon.__name__,
    ErpnextIcon.__name__,
    EsbuildIcon.__name__,
    EseaIcon.__name__,
    EslgamingIcon.__name__,
    EslintIcon.__name__,
    EsotericSoftwareIcon.__name__,
    EsphomeIcon.__name__,
    EspressifIcon.__name__,
    EsriIcon.__name__,
    EtcdIcon.__name__,
    EthereumIcon.__name__,
    EthersIcon.__name__,
    EthiopianAirlinesIcon.__name__,
    EtihadAirwaysIcon.__name__,
    EtsyIcon.__name__,
    EuropeanUnionIcon.__name__,
    EventStoreIcon.__name__,
    EvernoteIcon.__name__,
    EverydotorgIcon.__name__,
    ExcalidrawIcon.__name__,
    ExercismIcon.__name__,
    ExordoIcon.__name__,
    ExoscaleIcon.__name__,
    ExpediaIcon.__name__,
    ExpensifyIcon.__name__,
    ExpertsExchangeIcon.__name__,
    ExpoIcon.__name__,
    ExpressIcon.__name__,
    ExpressdotcomIcon.__name__,
    ExpressvpnIcon.__name__,
    EyeemIcon.__name__,
    FdroidIcon.__name__,
    FSharpIcon.__name__,
    FOneIcon.__name__,
    FFiveIcon.__name__,
    FacebookIcon.__name__,
    FacebookGamingIcon.__name__,
    FacebookLiveIcon.__name__,
    FaceitIcon.__name__,
    ...
    FalconIcon.__name__,
    FampayIcon.__name__,
    FandangoIcon.__name__,
    FandomIcon.__name__,
    FanfouIcon.__name__,
    FantomIcon.__name__,
    FarcasterIcon.__name__,
    FareharborIcon.__name__,
    FarfetchIcon.__name__,
    FastapiIcon.__name__,
    FastifyIcon.__name__,
    ...
    FedoraIcon.__name__,
    FeedlyIcon.__name__,
    FerrariIcon.__name__,
    FerrariNdotvdotIcon.__name__,
    FerretdbIcon.__name__,
    FfmpegIcon.__name__,
    FiIcon.__name__,
    FiatIcon.__name__,
    FidoAllianceIcon.__name__,
    FifaIcon.__name__,
    FigIcon.__name__,
    FigmaIcon.__name__,
    FigshareIcon.__name__,
    FilaIcon.__name__,
    FilamentIcon.__name__,
    FiledotioIcon.__name__,
    FilenIcon.__name__,
    FilesIcon.__name__,
    ...
    FirefishIcon.__name__,
    FireflyIiiIcon.__name__,
    FirefoxIcon.__name__,
    FirefoxBrowserIcon.__name__,
    ...
    FlatpakIcon.__name__,
    FlickrIcon.__name__,
    FlightawareIcon.__name__,
    FlipboardIcon.__name__,
    FlipkartIcon.__name__,
    ...
    FontforgeIcon.__name__,
    FoobarTwoThousandIcon.__name__,
    FoodpandaIcon.__name__,
    FordIcon.__name__,
    ForgejoIcon.__name__,
    FormbricksIcon.__name__,
    FormikIcon.__name__,
    FormspreeIcon.__name__,
    FormstackIcon.__name__,
    FortinetIcon.__name__,
    FortniteIcon.__name__,
    FortranIcon.__name__,
    FossaIcon.__name__,
    FossilScmIcon.__name__,
    FoundryVirtualTabletopIcon.__name__,
    FoursquareIcon.__name__,
    FoxIcon.__name__,
    FoxtelIcon.__name__,
    FozzyIcon.__name__,
    FramerIcon.__name__,
    FrameworkIcon.__name__,
    FrameworkSevenIcon.__name__,
    FranprixIcon.__name__,
    FrappeIcon.__name__,
    FraunhofergesellschaftIcon.__name__,
    FreebsdIcon.__name__,
    FreecadIcon.__name__,
    FreecodecampIcon.__name__,
    FreedesktopdotorgIcon.__name__,
    FreelancerIcon.__name__,
    FreelancermapIcon.__name__,
    FreenasIcon.__name__,
    FreenetIcon.__name__,
    ...
    FrontifyIcon.__name__,
    FuboIcon.__name__,
    FuelerIcon.__name__,
    FugaCloudIcon.__name__,
    FujifilmIcon.__name__,
    FujitsuIcon.__name__,
    FurAffinityIcon.__name__,
    FurryNetworkIcon.__name__,
    FusionauthIcon.__name__,
    FuturelearnIcon.__name__,
    FyleIcon.__name__,
    GTwoIcon.__name__,
    GTwoAIcon.__name__,
    GTwoGIcon.__name__,
    GalaxusIcon.__name__,
    GameDeveloperIcon.__name__,
    GameJoltIcon.__name__,
    GameScienceIcon.__name__,
    GamebananaIcon.__name__,
    GameloftIcon.__name__,
    ...
    GiphyIcon.__name__,
    GitIcon.__name__,
    GitExtensionsIcon.__name__,
    GitForWindowsIcon.__name__,
    GitLfsIcon.__name__,
    GitbookIcon.__name__,
    GitcodeIcon.__name__,
    GitconnectedIcon.__name__,
    GiteaIcon.__name__,
    GiteeIcon.__name__,
    GithubIcon.__name__,
    GithubActionsIcon.__name__,
    GithubCopilotIcon.__name__,
    GithubPagesIcon.__name__,
    GithubSponsorsIcon.__name__,
    GitignoredotioIcon.__name__,
    GitkrakenIcon.__name__,
    GitlabIcon.__name__,
    GitpodIcon.__name__,
    GitterIcon.__name__,
    ...
    GmxIcon.__name__,
    GnomeIcon.__name__,
    GnomeTerminalIcon.__name__,
    GnuIcon.__name__,
    GnuBashIcon.__name__,
    GnuEmacsIcon.__name__,
    GnuIcecatIcon.__name__,
    GnuPrivacyGuardIcon.__name__,
    GnuSocialIcon.__name__,
    GoIcon.__name__,
    GocdIcon.__name__,
    ...
    GojekIcon.__name__,
    GolandIcon.__name__,
    GoldmanSachsIcon.__name__,
    GoodreadsIcon.__name__,
    GoogleIcon.__name__,
    GoogleAdmobIcon.__name__,
    GoogleAdsIcon.__name__,
    GoogleAdsenseIcon.__name__,
    GoogleAnalyticsIcon.__name__,
    GoogleAppsScriptIcon.__name__,
    GoogleAssistantIcon.__name__,
    GoogleAuthenticatorIcon.__name__,
    GoogleBigqueryIcon.__name__,
    GoogleBigtableIcon.__name__,
    GoogleCalendarIcon.__name__,
    GoogleCampaignManagerThreeHundredAndSixtyIcon.__name__,
    GoogleCardboardIcon.__name__,
    GoogleCastIcon.__name__,
    GoogleChatIcon.__name__,
    GoogleChromeIcon.__name__,
    GoogleChronicleIcon.__name__,
    GoogleClassroomIcon.__name__,
    GoogleCloudIcon.__name__,
    GoogleCloudComposerIcon.__name__,
    GoogleCloudSpannerIcon.__name__,
    GoogleCloudStorageIcon.__name__,
    GoogleColabIcon.__name__,
    GoogleContainerOptimizedOsIcon.__name__,
    GoogleDataflowIcon.__name__,
    GoogleDataprocIcon.__name__,
    GoogleDisplayandVideoThreeHundredAndSixtyIcon.__name__,
    GoogleDocsIcon.__name__,
    GoogleDriveIcon.__name__,
    GoogleEarthIcon.__name__,
    GoogleEarthEngineIcon.__name__,
    GoogleFitIcon.__name__,
    GoogleFontsIcon.__name__,
    ...
    GoogleMarketingPlatformIcon.__name__,
    GoogleMeetIcon.__name__,
    GoogleMessagesIcon.__name__,
    GoogleNearbyIcon.__name__,
    GoogleNewsIcon.__name__,
    GooglePayIcon.__name__,
    GooglePhotosIcon.__name__,
    GooglePlayIcon.__name__,
    GooglePubsubIcon.__name__,
    GoogleScholarIcon.__name__,
    GoogleSearchConsoleIcon.__name__,
    GoogleSheetsIcon.__name__,
    GoogleSlidesIcon.__name__,
    GoogleStreetViewIcon.__name__,
    GoogleSummerOfCodeIcon.__name__,
    GoogleTagManagerIcon.__name__,
    ...
    GrafanaIcon.__name__,
    GrammarlyIcon.__name__,
    ...
    GraylogIcon.__name__,
    GreasyForkIcon.__name__,
    ...
    GstreamerIcon.__name__,
    GtkIcon.__name__,
    GuangzhouMetroIcon.__name__,
    GuildedIcon.__name__,
    GuitarProIcon.__name__,
    GulpIcon.__name__,
    GumroadIcon.__name__,
    GumtreeIcon.__name__,
    GunicornIcon.__name__,
    GurobiIcon.__name__,
    GustoIcon.__name__,
    GutenbergIcon.__name__,
    HandmIcon.__name__,
    HTwoDatabaseIcon.__name__,
    HThreeIcon.__name__,
    HabrIcon.__name__,
    HackClubIcon.__name__,
    HackTheBoxIcon.__name__,
    HackadayIcon.__name__,
    ...
    HandshakeIcon.__name__,
    HandshakeIcon1.__name__,
    HandshakeProtocolIcon.__name__,
    HappycowIcon.__name__,
    HarborIcon.__name__,
    HarmonyosIcon.__name__,
    HashicorpIcon.__name__,
    HashnodeIcon.__name__,
    HaskellIcon.__name__,
    HasuraIcon.__name__,
    HatenaBookmarkIcon.__name__,
    ...
    HboMaxIcon.__name__,
    HclIcon.__name__,
    HdfcBankIcon.__name__,
    HeadlessUiIcon.__name__,
    HeadphoneZoneIcon.__name__,
    HeadspaceIcon.__name__,
    HearthIcon.__name__,
    HearthisdotatIcon.__name__,
    HederaIcon.__name__,
    ...
    HelmIcon.__name__,
    HelpScoutIcon.__name__,
    HelpdeskIcon.__name__,
    HepsiemlakIcon.__name__,
    HereIcon.__name__,
    HermesIcon.__name__,
    HeroicGamesLauncherIcon.__name__,
    HerokuIcon.__name__,
    HerouiIcon.__name__,
    HetznerIcon.__name__,
    HevyIcon.__name__,
    HexletIcon.__name__,
    HexoIcon.__name__,
    HeyIcon.__name__,
    HiBobIcon.__name__,
    HibernateIcon.__name__,
    HiltonIcon.__name__,
    HiltonHotelsandResortsIcon.__name__,
    HitachiIcon.__name__,
    HiveIcon.__name__,
    HiveIcon1.__name__,
    HiveBlockchainIcon.__name__,
    HivemqIcon.__name__,
    HomarrIcon.__name__,
    HomeAssistantIcon.__name__,
    HomeAssistantCommunityStoreIcon.__name__,
    HomeadvisorIcon.__name__,
    HomebrewIcon.__name__,
    HomebridgeIcon.__name__,
    HomepageIcon.__name__,
    HomifyIcon.__name__,
    HondaIcon.__name__,
    HoneyIcon.__name__,
    HoneybadgerIcon.__name__,
    HoneygainIcon.__name__,
    HonoIcon.__name__,
    HonorIcon.__name__,
    HootsuiteIcon.__name__,
    HoppscotchIcon.__name__,
    HostingerIcon.__name__,
    HotelsdotcomIcon.__name__,
    HotjarIcon.__name__,
    HotwireIcon.__name__,
    HoudiniIcon.__name__,
    HouzzIcon.__name__,
    HpIcon.__name__,
    HsbcIcon.__name__,
    HtcIcon.__name__,
    HtcViveIcon.__name__,
    HtmlAcademyIcon.__name__,
    HtmlFiveIcon.__name__,
    HtmxIcon.__name__,
    HtopIcon.__name__,
    HttpieIcon.__name__,
    HuaweiIcon.__name__,
    HubspotIcon.__name__,
    HuggingFaceIcon.__name__,
    HugoIcon.__name__,
    HumbleBundleIcon.__name__,
    HumhubIcon.__name__,
    HungryJacksIcon.__name__,
    ...
    IEighteenNextIcon.__name__,
    IThreeIcon.__name__,
    IataIcon.__name__,
    IbeaconIcon.__name__,
    IberiaIcon.__name__,
    IcedIcon.__name__,
    ...
    IcingaIcon.__name__,
    IcloudIcon.__name__,
    IcomoonIcon.__name__,
    IconIcon.__name__,
    IconfinderIcon.__name__,
    IconifyIcon.__name__,
    IconjarIcon.__name__,
    IconsEightIcon.__name__,
    IcqIcon.__name__,
    IeeeIcon.__name__,
    IfixitIcon.__name__,
    IfoodIcon.__name__,
    ...
    IndeedIcon.__name__,
    IndianSuperLeagueIcon.__name__,
    IndieHackersIcon.__name__,
    IndigoIcon.__name__,
    InductiveAutomationIcon.__name__,
    InertiaIcon.__name__,
    InfinitiIcon.__name__,
    InfinityfreeIcon.__name__,
    InfluxdbIcon.__name__,
    InfomaniakIcon.__name__,
    InfoqIcon.__name__,
    InformaticaIcon.__name__,
    InfosysIcon.__name__,
    InfracostIcon.__name__,
    IngressIcon.__name__,
    InkdropIcon.__name__,
    InkscapeIcon.__name__,
    InoreaderIcon.__name__,
    InquirerIcon.__name__,
    InsomniaIcon.__name__,
    InspireIcon.__name__,
    InstaThreeHundredAndSixtyIcon.__name__,
    InstacartIcon.__name__,
    InstagramIcon.__name__,
    InstapaperIcon.__name__,
    InstatusIcon.__name__,
    InstructablesIcon.__name__,
    InstructureIcon.__name__,
    IntelIcon.__name__,
    IntellijIdeaIcon.__name__,
    InteractionDesignFoundationIcon.__name__,
    InteractjsIcon.__name__,
    InterbaseIcon.__name__,
    IntercomIcon.__name__,
    IntermarcheIcon.__name__,
    InternetArchiveIcon.__name__,
    InternetComputerIcon.__name__,
    IntigritiIcon.__name__,
    IntuitIcon.__name__,
    InvidiousIcon.__name__,
    InvisionIcon.__name__,
    InvoiceNinjaIcon.__name__,
    IobrokerIcon.__name__,
    IonicIcon.__name__,
    IonosIcon.__name__,
    IosIcon.__name__,
    IotaIcon.__name__,
    ...
    IssuuIcon.__name__,
    IstioIcon.__name__,
    ItchdotioIcon.__name__,
    ItermTwoIcon.__name__,
    ItunesIcon.__name__,
    ItvxIcon.__name__,
    IvecoIcon.__name__,
    JabberIcon.__name__,
    JaegerIcon.__name__,
    JaguarIcon.__name__,
    JamesonIcon.__name__,
    JamstackIcon.__name__,
    JapanAirlinesIcon.__name__,
    JasmineIcon.__name__,
    JavascriptIcon.__name__,
    JblIcon.__name__,
    JcbIcon.__name__,
    JdoodleIcon.__name__,
    JeepIcon.__name__,
    JekyllIcon.__name__,
    JellyfinIcon.__name__,
    JenkinsIcon.__name__,
    JestIcon.__name__,
    JetIcon.__name__,
    JetblueIcon.__name__,
    JetbrainsIcon.__name__,
    JetpackComposeIcon.__name__,
    JfrogIcon.__name__,
    JfrogPipelinesIcon.__name__,
    JhipsterIcon.__name__,
    JinjaIcon.__name__,
    JioIcon.__name__,
    JiraIcon.__name__,
    JiraSoftwareIcon.__name__,
    JitpackIcon.__name__,
    JitsiIcon.__name__,
    JohnDeereIcon.__name__,
    JoomlaIcon.__name__,
    JoplinIcon.__name__,
    JordanIcon.__name__,
    JouavIcon.__name__,
    ...
    JpegIcon.__name__,
    JqueryIcon.__name__,
    JrGroupIcon.__name__,
    JsdelivrIcon.__name__,
    JsfiddleIcon.__name__,
    JsonIcon.__name__,
    JsonWebTokensIcon.__name__,
    JsrIcon.__name__,
    JssIcon.__name__,
    JuceIcon.__name__,
    JuejinIcon.__name__,
    ...
    KeycdnIcon.__name__,
    KeycloakIcon.__name__,
    KeystoneIcon.__name__,
    KfcIcon.__name__,
    KhanAcademyIcon.__name__,
    KhronosGroupIcon.__name__,
    KiaIcon.__name__,
    KibanaIcon.__name__,
    KicadIcon.__name__,
    KickIcon.__name__,
    ...
    KiwixIcon.__name__,
    KlarnaIcon.__name__,
    KleinanzeigenIcon.__name__,
    KlmIcon.__name__,
    KlookIcon.__name__,
    KnativeIcon.__name__,
    KnexdotjsIcon.__name__,
    KnimeIcon.__name__,
    KnipIcon.__name__,
    KnowledgebaseIcon.__name__,
    KnownIcon.__name__,
    KofiIcon.__name__,
    KoaIcon.__name__,
    KocIcon.__name__,
    ...
    KonamiIcon.__name__,
    KongIcon.__name__,
    KongregateIcon.__name__,
    KonvaIcon.__name__,
    KoreaderIcon.__name__,
    KotlinIcon.__name__,
    KoyebIcon.__name__,
    KredIcon.__name__,
    KritaIcon.__name__,
    KtmIcon.__name__,
    KtorIcon.__name__,
    KuaishouIcon.__name__,
    KubernetesIcon.__name__,
    KubesprayIcon.__name__,
    KubuntuIcon.__name__,
    KucoinIcon.__name__,
    KueskiIcon.__name__,
    KumaIcon.__name__,
    KununuIcon.__name__,
    ...
    LandRoverIcon.__name__,
    LangchainIcon.__name__,
    LangflowIcon.__name__,
    LanggraphIcon.__name__,
    LanguagetoolIcon.__name__,
    LapceIcon.__name__,
    LaragonIcon.__name__,
    LaravelIcon.__name__,
    LaravelHorizonIcon.__name__,
    LaravelNovaIcon.__name__,
    LastdotfmIcon.__name__,
    LastpassIcon.__name__,
    LatexIcon.__name__,
    LaunchpadIcon.__name__,
    LazarusIcon.__name__,
    LazyvimIcon.__name__,
    LbryIcon.__name__,
    LeaderPriceIcon.__name__,
    LeafletIcon.__name__,
    LeagueOfLegendsIcon.__name__,
    LeanpubIcon.__name__,
    LeetcodeIcon.__name__,
    LefthookIcon.__name__,
    LegacyGamesIcon.__name__,
    LeicaIcon.__name__,
    LemmyIcon.__name__,
    LemonSqueezyIcon.__name__,
    LenovoIcon.__name__,
    LensIcon.__name__,
    LeptosIcon.__name__,
    LernaIcon.__name__,
    LeroyMerlinIcon.__name__,
    LesLibrairesIcon.__name__,
    LessIcon.__name__,
    LetsEncryptIcon.__name__,
    LetterboxdIcon.__name__,
    LevelsdotfyiIcon.__name__,
    LgIcon.__name__,
    LiningIcon.__name__,
    LiberadotchatIcon.__name__,
    LiberapayIcon.__name__,
    LibrariesdotioIcon.__name__,
    LibrarythingIcon.__name__,
    LibreofficeIcon.__name__,
    LibreofficeBaseIcon.__name__,
    LibreofficeCalcIcon.__name__,
    LibreofficeDrawIcon.__name__,
    LibreofficeImpressIcon.__name__,
    LibreofficeMathIcon.__name__,
    LibreofficeWriterIcon.__name__,
    LibretranslateIcon.__name__,
    LibretubeIcon.__name__,
    LibrewolfIcon.__name__,
    LibuvIcon.__name__,
    LichessIcon.__name__,
    LidlIcon.__name__,
    LifxIcon.__name__,
    LightburnIcon.__name__,
    LighthouseIcon.__name__,
    LightningIcon.__name__,
    LimesurveyIcon.__name__,
    LineIcon.__name__,
    LineageosIcon.__name__,
    LinearIcon.__name__,
    LinkerdIcon.__name__,
    ...
    LinuxIcon.__name__,
    LinuxContainersIcon.__name__,
    LinuxFoundationIcon.__name__,
    LinuxMintIcon.__name__,
    ...
    MagicIcon.__name__,
    MagiskIcon.__name__,
    MahindraIcon.__name__,
    MaildotcomIcon.__name__,
    MaildotruIcon.__name__,
    MailboxdotorgIcon.__name__,
    MailchimpIcon.__name__,
    MailgunIcon.__name__,
    MailtrapIcon.__name__,
    MainwpIcon.__name__,
    MajorLeagueHackingIcon.__name__,
    MakeIcon.__name__,
    MakerbotIcon.__name__,
    MaltIcon.__name__,
    MalwarebytesIcon.__name__,
    MambaUiIcon.__name__,
    MampIcon.__name__,
    ManIcon.__name__,
    ...
    MapboxIcon.__name__,
    MapillaryIcon.__name__,
    MaplibreIcon.__name__,
    MaptilerIcon.__name__,
    MariadbIcon.__name__,
    MariadbFoundationIcon.__name__,
    MarkdownIcon.__name__,
    MarkoIcon.__name__,
    MarriottIcon.__name__,
    MarvelappIcon.__name__,
    MaseratiIcon.__name__,
    MastercardIcon.__name__,
    MastercomfigIcon.__name__,
    MastodonIcon.__name__,
    MaterialDesignIcon.__name__,
    MaterialDesignIconsIcon.__name__,
    MaterialForMkdocsIcon.__name__,
    MatillionIcon.__name__,
    MatomoIcon.__name__,
    MatrixIcon.__name__,
    MatterdotjsIcon.__name__,
    MattermostIcon.__name__,
    MatternetIcon.__name__,
    MauticIcon.__name__,
    MaxIcon.__name__,
    MaxplanckgesellschaftIcon.__name__,
    MaytagIcon.__name__,
    MazdaIcon.__name__,
    MazeIcon.__name__,
    McafeeIcon.__name__,
    McdonaldsIcon.__name__,
    MclarenIcon.__name__,
    MdbookIcon.__name__,
    MdnWebDocsIcon.__name__,
    MdxIcon.__name__,
    MealieIcon.__name__,
    MediafireIcon.__name__,
    MediamarktIcon.__name__,
    MediapipeIcon.__name__,
    MediatekIcon.__name__,
    MedibangPaintIcon.__name__,
    MediumIcon.__name__,
    MedusaIcon.__name__,
    MeetupIcon.__name__,
    MegaIcon.__name__,
    MeilisearchIcon.__name__,
    MeituanIcon.__name__,
    MeizuIcon.__name__,
    MendeleyIcon.__name__,
    MentorcruiseIcon.__name__,
    MercadoPagoIcon.__name__,
    MerckIcon.__name__,
    MercurialIcon.__name__,
    ...
    MetagerIcon.__name__,
    MetasploitIcon.__name__,
    MeteorIcon.__name__,
    MetroIcon.__name__,
    MetroDeLaCiudadDeMexicoIcon.__name__,
    MetroDeMadridIcon.__name__,
    MetroDeParisIcon.__name__,
    MeweIcon.__name__,
    MezmoIcon.__name__,
    MgIcon.__name__,
    MicroEditorIcon.__name__,
    MicrobitIcon.__name__,
    MicrodotblogIcon.__name__,
    MicropythonIcon.__name__,
    MicrostationIcon.__name__,
    MicrostrategyIcon.__name__,
    MidiIcon.__name__,
    MigaduIcon.__name__,
    MihonIcon.__name__,
    MihoyoIcon.__name__,
    MikrotikIcon.__name__,
    MilanoteIcon.__name__,
    MilvusIcon.__name__,
    MindsIcon.__name__,
    MinetestIcon.__name__,
    MingwwSixtyFourIcon.__name__,
    MiniIcon.__name__,
    MinioIcon.__name__,
    MintlifyIcon.__name__,
    MinutemailerIcon.__name__,
    ...
    MixpanelIcon.__name__,
    MlbIcon.__name__,
    MlflowIcon.__name__,
    MobxIcon.__name__,
    MobxstatetreeIcon.__name__,
    MochaIcon.__name__,
    ...
    ModxIcon.__name__,
    MojeekIcon.__name__,
    MoleculerIcon.__name__,
    MomenteoIcon.__name__,
    MoneroIcon.__name__,
    MoneygramIcon.__name__,
    MongodbIcon.__name__,
    MongooseIcon.__name__,
    MongooseIcon1.__name__,
    MongoosedotwsIcon.__name__,
    MonicaIcon.__name__,
    MonkeyTieIcon.__name__,
    MonkeytypeIcon.__name__,
    MonogameIcon.__name__,
    MonoprixIcon.__name__,
    MonsterIcon.__name__,
    MonzoIcon.__name__,
    MooIcon.__name__,
    MoodleIcon.__name__,
    ...
    MotorolaIcon.__name__,
    MovistarIcon.__name__,
    MozillaIcon.__name__,
    MpvIcon.__name__,
    MqttIcon.__name__,
    MsiIcon.__name__,
    MsiBusinessIcon.__name__,
    MtaIcon.__name__,
    MtrIcon.__name__,
    MubiIcon.__name__,
    MuiIcon.__name__,
    ...
    NEightNIcon.__name__,
    NamebaseIcon.__name__,
    NamecheapIcon.__name__,
    NamemcIcon.__name__,
    NamesiloIcon.__name__,
    NamuWikiIcon.__name__,
    NanoIcon.__name__,
    NanoStoresIcon.__name__,
    NapsterIcon.__name__,
    NasaIcon.__name__,
    NationalGridIcon.__name__,
    NationalRailIcon.__name__,
    NativescriptIcon.__name__,
    NatsdotioIcon.__name__,
    NaverIcon.__name__,
    NbaIcon.__name__,
    NbbIcon.__name__,
    NbcIcon.__name__,
    ...
    NetbsdIcon.__name__,
    NetcupIcon.__name__,
    NetdataIcon.__name__,
    NeteaseCloudMusicIcon.__name__,
    NetflixIcon.__name__,
    NetgearIcon.__name__,
    NetimIcon.__name__,
    NetlifyIcon.__name__,
    NetteIcon.__name__,
    NettoIcon.__name__,
    NeutralinojsIcon.__name__,
    NewBalanceIcon.__name__,
    NewJapanProwrestlingIcon.__name__,
    NewRelicIcon.__name__,
    NewYorkTimesIcon.__name__,
    NeweggIcon.__name__,
    NewpipeIcon.__name__,
    NexonIcon.__name__,
    NextdotjsIcon.__name__,
    NextbikeIcon.__name__,
    NextbilliondotaiIcon.__name__,
    NextcloudIcon.__name__,
    NextdnsIcon.__name__,
    NextdoorIcon.__name__,
    NextflowIcon.__name__,
    NextraIcon.__name__,
    NexusModsIcon.__name__,
    NfcoreIcon.__name__,
    NfcIcon.__name__,
    NginxIcon.__name__,
    NginxProxyManagerIcon.__name__,
    NgrokIcon.__name__,
    NgrxIcon.__name__,
    NhlIcon.__name__,
    NhostIcon.__name__,
    NicehashIcon.__name__,
    NiconicoIcon.__name__,
    NikeIcon.__name__,
    NikonIcon.__name__,
    NimIcon.__name__,
    NissanIcon.__name__,
    ...
    NomadIcon.__name__,
    NorcoIcon.__name__,
    NordicSemiconductorIcon.__name__,
    ...
    OTwoIcon.__name__,
    ObbIcon.__name__,
    ObsStudioIcon.__name__,
    ObservableIcon.__name__,
    ObsidianIcon.__name__,
    ObtainiumIcon.__name__,
    OcamlIcon.__name__,
    OclcIcon.__name__,
    OclifIcon.__name__,
    OctaneRenderIcon.__name__,
    OctaveIcon.__name__,
    OctoberCmsIcon.__name__,
    ...
    OpenBugBountyIcon.__name__,
    OpenCollectiveIcon.__name__,
    OpenContainersInitiativeIcon.__name__,
    OpenSourceHardwareIcon.__name__,
    OpenSourceInitiativeIcon.__name__,
    ...
    OpenglIcon.__name__,
    OpenhabIcon.__name__,
    OpenidIcon.__name__,
    OpenjdkIcon.__name__,
    OpenjsFoundationIcon.__name__,
    OpenlayersIcon.__name__,
    OpenmediavaultIcon.__name__,
    OpenminedIcon.__name__,
    OpennebulaIcon.__name__,
    OpenprojectIcon.__name__,
    OpenscadIcon.__name__,
    OpenseaIcon.__name__,
    OpensearchIcon.__name__,
    OpensslIcon.__name__,
    OpenstackIcon.__name__,
    OpenstreetmapIcon.__name__,
    OpensuseIcon.__name__,
    ...
    OpenzeppelinIcon.__name__,
    OpenzfsIcon.__name__,
    OperaIcon.__name__,
    OperaGxIcon.__name__,
    OpnsenseIcon.__name__,
    OppoIcon.__name__,
    ...
    OsfIcon.__name__,
    OsgeoIcon.__name__,
    OshkoshIcon.__name__,
    OsmandIcon.__name__,
    OsmcIcon.__name__,
    OsuIcon.__name__,
    OttoIcon.__name__,
    OutlineIcon.__name__,
    OvercastIcon.__name__,
    OverleafIcon.__name__,
    OvhIcon.__name__,
    OwaspIcon.__name__,
    ...
    PackagistIcon.__name__,
    PackerIcon.__name__,
    PacktIcon.__name__,
    PaddleIcon.__name__,
    PaddlepaddleIcon.__name__,
    PaddyPowerIcon.__name__,
    PadletIcon.__name__,
    PagekitIcon.__name__,
    PagerdutyIcon.__name__,
    PagespeedInsightsIcon.__name__,
    PagseguroIcon.__name__,
    PalantirIcon.__name__,
    PaloAltoNetworksIcon.__name__,
    ...
    ParadoxInteractiveIcon.__name__,
    ParamountplusIcon.__name__,
    ParitySubstrateIcon.__name__,
    ParrotSecurityIcon.__name__,
    ParsedotlyIcon.__name__,
    ...
    PayoneerIcon.__name__,
    PaypalIcon.__name__,
    PaysafeIcon.__name__,
    PaytmIcon.__name__,
    PcgamingwikiIcon.__name__,
    PdmIcon.__name__,
    PdqIcon.__name__,
    PeakDesignIcon.__name__,
    PearsonIcon.__name__,
    PeerlistIcon.__name__,
    PeertubeIcon.__name__,
    PegasusAirlinesIcon.__name__,
    PelicanIcon.__name__,
    PelotonIcon.__name__,
    PennyIcon.__name__,
    PenpotIcon.__name__,
    PercyIcon.__name__,
    PerforceIcon.__name__,
    PerlIcon.__name__,
    PerplexityIcon.__name__,
    PersistentIcon.__name__,
    PersonioIcon.__name__,
    PetsAtHomeIcon.__name__,
    PeugeotIcon.__name__,
    PexelsIcon.__name__,
    PfsenseIcon.__name__,
    PhabricatorIcon.__name__,
    PhilipsHueIcon.__name__,
    PhoenixFrameworkIcon.__name__,
    PhonepeIcon.__name__,
    PhosphorIconsIcon.__name__,
    PhotobucketIcon.__name__,
    PhotocrowdIcon.__name__,
    PhotonIcon.__name__,
    PhotopeaIcon.__name__,
    PhpIcon.__name__,
    PhpbbIcon.__name__,
    ...
    PicartodottvIcon.__name__,
    PicnicIcon.__name__,
    PicpayIcon.__name__,
    PicrewIcon.__name__,
    PicsartIcon.__name__,
    PicxyIcon.__name__,
    ...
    PlatformioIcon.__name__,
    PlatziIcon.__name__,
    PlausibleAnalyticsIcon.__name__,
    PlaycanvasIcon.__name__,
    PlayerFmIcon.__name__,
    PlayerdotmeIcon.__name__,
    PlaystationIcon.__name__,
    PlaystationTwoIcon.__name__,
    PlaystationThreeIcon.__name__,
    PlaystationFourIcon.__name__,
    PlaystationFiveIcon.__name__,
    PlaystationPortableIcon.__name__,
    PlaystationVitaIcon.__name__,
    PleromaIcon.__name__,
    PleskIcon.__name__,
    PlexIcon.__name__,
    PlotlyIcon.__name__,
    PlumeIcon.__name__,
    PluralsightIcon.__name__,
    PlurkIcon.__name__,
    PmTwoIcon.__name__,
    PnpmIcon.__name__,
    PocketIcon.__name__,
    PocketCastsIcon.__name__,
    PocketbaseIcon.__name__,
    PodcastAddictIcon.__name__,
    PodcastIndexIcon.__name__,
    PodmanIcon.__name__,
    PoeIcon.__name__,
    PoetryIcon.__name__,
    PolarsIcon.__name__,
    PolestarIcon.__name__,
    PolkadotIcon.__name__,
    PolyIcon.__name__,
    ...
    PortainerIcon.__name__,
    PortswiggerIcon.__name__,
    PositIcon.__name__,
    PostcssIcon.__name__,
    PostgresqlIcon.__name__,
    PosthogIcon.__name__,
    PostmanIcon.__name__,
    PostmatesIcon.__name__,
    PowersIcon.__name__,
    ...
    PrestashopIcon.__name__,
    PrestoIcon.__name__,
    PrettierIcon.__name__,
    PretzelIcon.__name__,
    PreventionIcon.__name__,
    PreziIcon.__name__,
    PrimefacesIcon.__name__,
    PrimengIcon.__name__,
    PrimereactIcon.__name__,
    PrimevueIcon.__name__,
    PrintablesIcon.__name__,
    PrismaIcon.__name__,
    PrismicIcon.__name__,
    PrivateDivisionIcon.__name__,
    PrivateInternetAccessIcon.__name__,
    ...
    ProtocolsdotioIcon.__name__,
    ProtonIcon.__name__,
    ProtonCalendarIcon.__name__,
    ProtonDriveIcon.__name__,
    ProtonMailIcon.__name__,
    ProtonVpnIcon.__name__,
    ProtondbIcon.__name__,
    ProtractorIcon.__name__,
    ProxmoxIcon.__name__,
    PterodactylIcon.__name__,
    PubgIcon.__name__,
    ...
    PumaIcon.__name__,
    PuppetIcon.__name__,
    PuppeteerIcon.__name__,
    PurescriptIcon.__name__,
    PurgecssIcon.__name__,
    PurismIcon.__name__,
    PushbulletIcon.__name__,
    PusherIcon.__name__,
    PwaIcon.__name__,
    PycharmIcon.__name__,
    PycqaIcon.__name__,
    PydanticIcon.__name__,
    PygIcon.__name__,
    PypiIcon.__name__,
    PypyIcon.__name__,
    PyscaffoldIcon.__name__,
    PysyftIcon.__name__,
    PytestIcon.__name__,
    PythonIcon.__name__,
    PythonanywhereIcon.__name__,
    PytorchIcon.__name__,
    PyupIcon.__name__,
    QantasIcon.__name__,
    QaseIcon.__name__,
    ...
    QqIcon.__name__,
    QtIcon.__name__,
    QuadNineIcon.__name__,
    QualcommIcon.__name__,
    QualtricsIcon.__name__,
    QualysIcon.__name__,
    QuantcastIcon.__name__,
    QuantconnectIcon.__name__,
    QuarkusIcon.__name__,
    QuartoIcon.__name__,
    QuasarIcon.__name__,
    QubesOsIcon.__name__,
    QuestIcon.__name__,
    QuickbooksIcon.__name__,
    QuicklookIcon.__name__,
    QuicktimeIcon.__name__,
    QuicktypeIcon.__name__,
    QuipIcon.__name__,
    ...
    RatatuiIcon.__name__,
    RavelryIcon.__name__,
    RayIcon.__name__,
    RaycastIcon.__name__,
    RaylibIcon.__name__,
    RazerIcon.__name__,
    RazorpayIcon.__name__,
    RcloneIcon.__name__,
    ReactIcon.__name__,
    ReactBootstrapIcon.__name__,
    ReactHookFormIcon.__name__,
    ReactQueryIcon.__name__,
    ReactRouterIcon.__name__,
    ReactTableIcon.__name__,
    ReactiveResumeIcon.__name__,
    ReactivexIcon.__name__,
    ReactosIcon.__name__,
    ReadTheDocsIcon.__name__,
    ReaddotcvIcon.__name__,
    ReadmeIcon.__name__,
    ReasonIcon.__name__,
    ReasonStudiosIcon.__name__,
    RecoilIcon.__name__,
    RedIcon.__name__,
    RedBullIcon.__name__,
    RedCandleGamesIcon.__name__,
    RedHatIcon.__name__,
    RedHatOpenShiftIcon.__name__,
    RedashIcon.__name__,
    RedbubbleIcon.__name__,
    RedditIcon.__name__,
    RedisIcon.__name__,
    RedmineIcon.__name__,
    RedoxIcon.__name__,
    RedragonIcon.__name__,
    RedsysIcon.__name__,
    ReduxIcon.__name__,
    ReduxsagaIcon.__name__,
    RedwoodjsIcon.__name__,
    ReebokIcon.__name__,
    RefineIcon.__name__,
    ...
    RemarkIcon.__name__,
    RemedyEntertainmentIcon.__name__,
    RemixIcon.__name__,
    RemovedotbgIcon.__name__,
    RenpyIcon.__name__,
    RenaultIcon.__name__,
    RenderIcon.__name__,
    RenovateIcon.__name__,
    RenrenIcon.__name__,
    ReplicateIcon.__name__,
    ReplitIcon.__name__,
    RepublicOfGamersIcon.__name__,
    RescriptIcon.__name__,
    RescuetimeIcon.__name__,
    ResearchgateIcon.__name__,
    ResendIcon.__name__,
    ResharperIcon.__name__,
    ResurrectionRemixOsIcon.__name__,
    RetoolIcon.__name__,
    RetroarchIcon.__name__,
    RetropieIcon.__name__,
    RevancedIcon.__name__,
    RevealdotjsIcon.__name__,
    RevenuecatIcon.__name__,
    ReverbnationIcon.__name__,
    RevoltdotchatIcon.__name__,
    RevolutIcon.__name__,
    ReweIcon.__name__,
    RezgoIcon.__name__,
    RhinocerosIcon.__name__,
    RichIcon.__name__,
    RiderIcon.__name__,
    RimacAutomobiliIcon.__name__,
    RimeIcon.__name__,
    RingIcon.__name__,
    RiotGamesIcon.__name__,
    RippleIcon.__name__,
    RiscvIcon.__name__,
    RiseupIcon.__name__,
    RitzCarltonIcon.__name__,
    RiveIcon.__name__,
    RoadmapdotshIcon.__name__,
    RoamResearchIcon.__name__,
    RobinhoodIcon.__name__,
    RobloxIcon.__name__,
    RobloxStudioIcon.__name__,
    RoboflowIcon.__name__,
    RobotFrameworkIcon.__name__,
    RocketIcon.__name__,
    RocketdotchatIcon.__name__,
    RocksdbIcon.__name__,
    RockstarGamesIcon.__name__,
    ...
    RootMeIcon.__name__,
    RootsIcon.__name__,
    RootsBedrockIcon.__name__,
    RootsSageIcon.__name__,
    RosIcon.__name__,
    RossmannIcon.__name__,
    RotaryInternationalIcon.__name__,
    RottenTomatoesIcon.__name__,
    RoundcubeIcon.__name__,
    RsocketIcon.__name__,
    RssIcon.__name__,
    RstudioIdeIcon.__name__,
    RteIcon.__name__,
    RtlIcon.__name__,
    RtlzweiIcon.__name__,
    RtmIcon.__name__,
    RubocopIcon.__name__,
    RubyIcon.__name__,
    RubyOnRailsIcon.__name__,
    RubySinatraIcon.__name__,
    RubygemsIcon.__name__,
    RubymineIcon.__name__,
    RuffIcon.__name__,
    RumahwebIcon.__name__,
    RumbleIcon.__name__,
    RundeckIcon.__name__,
    RunkeeperIcon.__name__,
    RunkitIcon.__name__,
    ...
    RyeIcon.__name__,
    SSevenAirlinesIcon.__name__,
    SabanciIcon.__name__,
    SafariIcon.__name__,
    SageIcon.__name__,
    SagemathIcon.__name__,
    SahibindenIcon.__name__,
    SailfishOsIcon.__name__,
    SailsdotjsIcon.__name__,
    SalesforceIcon.__name__,
    SallaIcon.__name__,
    SaltProjectIcon.__name__,
    SamsClubIcon.__name__,
    SamsungIcon.__name__,
    SamsungPayIcon.__name__,
    SanFranciscoMunicipalRailwayIcon.__name__,
    SanicIcon.__name__,
    SanityIcon.__name__,
    SaoPauloMetroIcon.__name__,
    SapIcon.__name__,
    SartoriusIcon.__name__,
    SassIcon.__name__,
    SatdotOneIcon.__name__,
    SatelliteIcon.__name__,
    SaturnIcon.__name__,
    ...
    ScrapboxIcon.__name__,
    ScrapyIcon.__name__,
    ScratchIcon.__name__,
    ScreencastifyIcon.__name__,
    ScribdIcon.__name__,
    ScrimbaIcon.__name__,
    ScrollrevealIcon.__name__,
    ScrumAllianceIcon.__name__,
    ScrutinizerCiIcon.__name__,
    ScylladbIcon.__name__,
    SeafileIcon.__name__,
    SeagateIcon.__name__,
    SearxngIcon.__name__,
    SeatIcon.__name__,
    SeatgeekIcon.__name__,
    SecurityscorecardIcon.__name__,
    SefariaIcon.__name__,
    SegaIcon.__name__,
    SeleniumIcon.__name__,
    SellfyIcon.__name__,
    SemanticScholarIcon.__name__,
    SemanticUiIcon.__name__,
    SemanticUiReactIcon.__name__,
    SemanticWebIcon.__name__,
    SemanticreleaseIcon.__name__,
    SemaphoreCiIcon.__name__,
    SemrushIcon.__name__,
    SemverIcon.__name__,
    SenchaIcon.__name__,
    SendgridIcon.__name__,
    SennheiserIcon.__name__,
    SensuIcon.__name__,
    SentryIcon.__name__,
    SepaIcon.__name__,
    ...
    ShieldsdotioIcon.__name__,
    ShikimoriIcon.__name__,
    ShopeeIcon.__name__,
    ShopifyIcon.__name__,
    ShopwareIcon.__name__,
    ShortcutIcon.__name__,
    ShowpadIcon.__name__,
    ShowtimeIcon.__name__,
    ShowwcaseIcon.__name__,
    ShutterstockIcon.__name__,
    SidekiqIcon.__name__,
    SidequestIcon.__name__,
    SiemensIcon.__name__,
    SifiveIcon.__name__,
    SignalIcon.__name__,
    SilverAirwaysIcon.__name__,
    SimilarwebIcon.__name__,
    SimklIcon.__name__,
    ...
    SimplexIcon.__name__,
    SinaWeiboIcon.__name__,
    SingaporeAirlinesIcon.__name__,
    SinglestoreIcon.__name__,
    SitecoreIcon.__name__,
    ...
    SkillshareIcon.__name__,
    SkodaIcon.__name__,
    SkyIcon.__name__,
    SkypackIcon.__name__,
    SlackIcon.__name__,
    SlackwareIcon.__name__,
    SlashdotIcon.__name__,
    SlickpicIcon.__name__,
    SlidesIcon.__name__,
    SlideshareIcon.__name__,
    SlintIcon.__name__,
    SmartIcon.__name__,
    ...
    SnapcraftIcon.__name__,
    SnapdragonIcon.__name__,
    SncfIcon.__name__,
    SnortIcon.__name__,
    SnowflakeIcon.__name__,
    SnowpackIcon.__name__,
    SnykIcon.__name__,
    SocialBladeIcon.__name__,
    SocietySixIcon.__name__,
    SocketIcon.__name__,
    SocketdotioIcon.__name__,
    SoftcatalaIcon.__name__,
    SoftpediaIcon.__name__,
    SogouIcon.__name__,
    SolanaIcon.__name__,
    SolidIcon.__name__,
    ...
    SonarqubeServerIcon.__name__,
    SonarrIcon.__name__,
    SonatypeIcon.__name__,
    SongkickIcon.__name__,
    SongodaIcon.__name__,
    SonicwallIcon.__name__,
    SonosIcon.__name__,
    SonyIcon.__name__,
    SorianaIcon.__name__,
    SoundchartsIcon.__name__,
    SoundcloudIcon.__name__,
    SourceEngineIcon.__name__,
    SourceforgeIcon.__name__,
    SourcehutIcon.__name__,
    SourcetreeIcon.__name__,
    SouthwestAirlinesIcon.__name__,
    SpacemacsIcon.__name__,
    SpaceshipIcon.__name__,
    SpacexIcon.__name__,
    SpacyIcon.__name__,
    SparkArIcon.__name__,
    SparkasseIcon.__name__,
    SparkfunIcon.__name__,
    SparkpostIcon.__name__,
    SpdxIcon.__name__,
    SpeakerDeckIcon.__name__,
    SpectrumIcon.__name__,
    SpeedtestIcon.__name__,
    ...
    SplunkIcon.__name__,
    SpondIcon.__name__,
    SpotifyIcon.__name__,
    SpotlightIcon.__name__,
    SpreadshirtIcon.__name__,
    SpreakerIcon.__name__,
    SpringIcon.__name__,
    SpringIcon1.__name__,
    SpringCreatorsIcon.__name__,
    SpringBootIcon.__name__,
    SpringSecurityIcon.__name__,
    SpyderIdeIcon.__name__,
    SqlalchemyIcon.__name__,
    SqliteIcon.__name__,
    SquareIcon.__name__,
    SquareEnixIcon.__name__,
    SquarespaceIcon.__name__,
    SrgSsrIcon.__name__,
    SsrnIcon.__name__,
    SstIcon.__name__,
    StackExchangeIcon.__name__,
    StackOverflowIcon.__name__,
    StackbitIcon.__name__,
    StackblitzIcon.__name__,
    StackeditIcon.__name__,
    StackhawkIcon.__name__,
    StackshareIcon.__name__,
    StadiaIcon.__name__,
    StaffbaseIcon.__name__,
    StagetimerIcon.__name__,
    StandardResumeIcon.__name__,
    StandardjsIcon.__name__,
    StarTrekIcon.__name__,
    StarbucksIcon.__name__,
    StardockIcon.__name__,
    StarlingBankIcon.__name__,
    StarshipIcon.__name__,
    StartdotggIcon.__name__,
    StartpageIcon.__name__,
    StarzIcon.__name__,
    StatamicIcon.__name__,
    StatistaIcon.__name__,
    StatuspageIcon.__name__,
    StatuspalIcon.__name__,
    SteamIcon.__name__,
    SteamDeckIcon.__name__,
    SteamdbIcon.__name__,
    SteamworksIcon.__name__,
    SteelseriesIcon.__name__,
    SteemIcon.__name__,
    SteemitIcon.__name__,
    SteinbergIcon.__name__,
    StellarIcon.__name__,
    StencilIcon.__name__,
    StencylIcon.__name__,
    StimulusIcon.__name__,
    StmicroelectronicsIcon.__name__,
    StockxIcon.__name__,
    StopstalkIcon.__name__,
    StoryblokIcon.__name__,
    StorybookIcon.__name__,
    StrapiIcon.__name__,
    StravaIcon.__name__,
    StreamlabsIcon.__name__,
    StreamlitIcon.__name__,
    StreamrunnersIcon.__name__,
    StremioIcon.__name__,
    StripeIcon.__name__,
    StrongswanIcon.__name__,
    StrykerIcon.__name__,
    StubhubIcon.__name__,
    StudioThreeTIcon.__name__,
    StyledcomponentsIcon.__name__,
    StylelintIcon.__name__,
    StyleshareIcon.__name__,
    StylusIcon.__name__,
    SubaruIcon.__name__,
    SublimeTextIcon.__name__,
    SubstackIcon.__name__,
    SubtitleEditIcon.__name__,
    ...
    SuperUserIcon.__name__,
    SupercreaseIcon.__name__,
    SupermicroIcon.__name__,
    SurfsharkIcon.__name__,
    SurrealdbIcon.__name__,
    SurveymonkeyIcon.__name__,
    SuseIcon.__name__,
    SuzukiIcon.__name__,
    SvelteIcon.__name__,
    SvgIcon.__name__,
    SvgdotjsIcon.__name__,
    SvgoIcon.__name__,
    SvgtraceIcon.__name__,
    SwaggerIcon.__name__,
    SwarmIcon.__name__,
    SwayIcon.__name__,
    SwcIcon.__name__,
    SwiftIcon.__name__,
    SwiggyIcon.__name__,
    SwiperIcon.__name__,
    SwisscowsIcon.__name__,
    SwrIcon.__name__,
    SymantecIcon.__name__,
    SymbolabIcon.__name__,
    SymfonyIcon.__name__,
    SymphonyIcon.__name__,
    SympyIcon.__name__,
    SyncthingIcon.__name__,
    SynologyIcon.__name__,
    SystemSeventySixIcon.__name__,
    TabelogIcon.__name__,
    TablecheckIcon.__name__,
    TacoBellIcon.__name__,
    TadoIcon.__name__,
    TaichiGraphicsIcon.__name__,
    TaichiLangIcon.__name__,
    TailsIcon.__name__,
    TailscaleIcon.__name__,
    TailwindCssIcon.__name__,
    TaipyIcon.__name__,
    TaketwoInteractiveSoftwareIcon.__name__,
    TalendIcon.__name__,
    TalenthouseIcon.__name__,
    TalosIcon.__name__,
    TamiyaIcon.__name__,
    ...
    TataIcon.__name__,
    TataConsultancyServicesIcon.__name__,
    TauriIcon.__name__,
    TaxbuzzIcon.__name__,
    TealIcon.__name__,
    TeamcityIcon.__name__,
    TeamspeakIcon.__name__,
    TeamviewerIcon.__name__,
    TechcrunchIcon.__name__,
    TedIcon.__name__,
    TeepublicIcon.__name__,
    TeespringIcon.__name__,
    TektonIcon.__name__,
    TeleFiveIcon.__name__,
    TelequebecIcon.__name__,
    TelefonicaIcon.__name__,
    TelegramIcon.__name__,
    ...
    TermiusIcon.__name__,
    TerraformIcon.__name__,
    TescoIcon.__name__,
    TeslaIcon.__name__,
    TestcafeIcon.__name__,
    TestinIcon.__name__,
    TestingLibraryIcon.__name__,
    TestrailIcon.__name__,
    TetherIcon.__name__,
    TextpatternIcon.__name__,
    TgaIcon.__name__,
    ThangsIcon.__name__,
    ThanosIcon.__name__,
    TheAlgorithmsIcon.__name__,
    TheBoringCompanyIcon.__name__,
    TheConversationIcon.__name__,
    TheFinalsIcon.__name__,
    TheGuardianIcon.__name__,
    TheIrishTimesIcon.__name__,
    TheMightyIcon.__name__,
    TheModelsResourceIcon.__name__,
    TheMovieDatabaseIcon.__name__,
    TheNorthFaceIcon.__name__,
    TheOdinProjectIcon.__name__,
    ThePlanetarySocietyIcon.__name__,
    TheRegisterIcon.__name__,
    TheSoundsResourceIcon.__name__,
    TheSpritersResourceIcon.__name__,
    TheStorygraphIcon.__name__,
    ...
    ThreadsIcon.__name__,
    ThreedotjsIcon.__name__,
    ThreemaIcon.__name__,
    ThumbtackIcon.__name__,
    ThunderbirdIcon.__name__,
    ...
    TietoevryIcon.__name__,
    TiktokIcon.__name__,
    TildaPublishingIcon.__name__,
    TileIcon.__name__,
    TimescaleIcon.__name__,
    TinaIcon.__name__,
    TinderIcon.__name__,
    TindieIcon.__name__,
    TinkercadIcon.__name__,
    TinygradIcon.__name__,
    TinyletterIcon.__name__,
    TistoryIcon.__name__,
    TldrawIcon.__name__,
    TmuxIcon.__name__,
    ...
    TollIcon.__name__,
    TomlIcon.__name__,
    TomorrowlandIcon.__name__,
    TomtomIcon.__name__,
    TonIcon.__name__,
    TopdotggIcon.__name__,
    TopcoderIcon.__name__,
    ToptalIcon.__name__,
    TorBrowserIcon.__name__,
    TorProjectIcon.__name__,
    TorizonIcon.__name__,
    ToshibaIcon.__name__,
    TotvsIcon.__name__,
    TourboxIcon.__name__,
    TowerIcon.__name__,
    ToyotaIcon.__name__,
    TplinkIcon.__name__,
    TqdmIcon.__name__,
    ...
    TraktIcon.__name__,
    TransifexIcon.__name__,
    TransmissionIcon.__name__,
    ...
    TrillertvIcon.__name__,
    TrimbleIcon.__name__,
    TrinoIcon.__name__,
    TripdotcomIcon.__name__,
    ...
    TrueupIcon.__name__,
    TruliaIcon.__name__,
    TrustedShopsIcon.__name__,
    TrustpilotIcon.__name__,
    TryItOnlineIcon.__name__,
    TryhackmeIcon.__name__,
    TsnodeIcon.__name__,
    TubiIcon.__name__,
    TuiIcon.__name__,
    TumblrIcon.__name__,
    ...
    TyperIcon.__name__,
    TypescriptIcon.__name__,
    TypoThreeIcon.__name__,
    TypstIcon.__name__,
    UdotsdotNewsIcon.__name__,
    UberIcon.__name__,
    UberEatsIcon.__name__,
    UbiquitiIcon.__name__,
    UbisoftIcon.__name__,
    UblockOriginIcon.__name__,
    UbuntuIcon.__name__,
    UbuntuMateIcon.__name__,
    UdacityIcon.__name__,
    UdemyIcon.__name__,
    UfcIcon.__name__,
    UikitIcon.__name__,
    UipathIcon.__name__,
    ...
    UluleIcon.__name__,
    UmamiIcon.__name__,
    UmbracoIcon.__name__,
    UmbrelIcon.__name__,
    UmlIcon.__name__,
    UnacademyIcon.__name__,
    UnderArmourIcon.__name__,
    UnderscoredotjsIcon.__name__,
    UndertaleIcon.__name__,
    UnicodeIcon.__name__,
    UnileverIcon.__name__,
    UniqloIcon.__name__,
    UniqloIcon1.__name__,
    UniqloJaIcon.__name__,
    UnitedAirlinesIcon.__name__,
    UnitedNationsIcon.__name__,
    UnityIcon.__name__,
    UnjsIcon.__name__,
    UnlicenseIcon.__name__,
    UnocssIcon.__name__,
    UnpkgIcon.__name__,
    UnraidIcon.__name__,
    ...
    UpholdIcon.__name__,
    UplabsIcon.__name__,
    UpptimeIcon.__name__,
    UpsIcon.__name__,
    UpstashIcon.__name__,
    UptimeKumaIcon.__name__,
    UpworkIcon.__name__,
    UservoiceIcon.__name__,
    UspsIcon.__name__,
    UtorrentIcon.__name__,
    UvIcon.__name__,
    VIcon.__name__,
    VZeroIcon.__name__,
    VTwoExIcon.__name__,
    ...
    VauxhallIcon.__name__,
    VbulletinIcon.__name__,
    VectaryIcon.__name__,
    VectorLogoZoneIcon.__name__,
    VectorworksIcon.__name__,
    VeeamIcon.__name__,
    VeedIcon.__name__,
    VeepeeIcon.__name__,
    VegaIcon.__name__,
    ...
    VelogIcon.__name__,
    VencordIcon.__name__,
    VenmoIcon.__name__,
    VercelIcon.__name__,
    VerdaccioIcon.__name__,
    VeritasIcon.__name__,
    VerizonIcon.__name__,
    VespaIcon.__name__,
    VestelIcon.__name__,
    VexxhostIcon.__name__,
    VfairsIcon.__name__,
    ViadeoIcon.__name__,
    ViaplayIcon.__name__,
    ViberIcon.__name__,
    VibloIcon.__name__,
    ...
    VintedIcon.__name__,
    VirginIcon.__name__,
    VirginAtlanticIcon.__name__,
    VirginMediaIcon.__name__,
    ...
    VoidLinuxIcon.__name__,
    VoipdotmsIcon.__name__,
    VolkswagenIcon.__name__,
    VolvoIcon.__name__,
    VonageIcon.__name__,
    VoronDesignIcon.__name__,
    VowpalWabbitIcon.__name__,
    VoxIcon.__name__,
    VrchatIcon.__name__,
    VscoIcon.__name__,
    VscodiumIcon.__name__,
    VtexIcon.__name__,
    ...
    VultrIcon.__name__,
    VyondIcon.__name__,
    WThreeSchoolsIcon.__name__,
    WacomIcon.__name__,
    WagmiIcon.__name__,
    WagtailIcon.__name__,
    WailsIcon.__name__,
    WakatimeIcon.__name__,
    WalkmanIcon.__name__,
    WallabagIcon.__name__,
    WalletconnectIcon.__name__,
    WalmartIcon.__name__,
    WantedlyIcon.__name__,
    WappalyzerIcon.__name__,
    WarnerBrosdotIcon.__name__,
    WarpIcon.__name__,
    WasabiIcon.__name__,
    WasmcloudIcon.__name__,
    WasmerIcon.__name__,
    WatchtowerIcon.__name__,
    WattpadIcon.__name__,
    ...
    WebauthnIcon.__name__,
    WebcomponentsdotorgIcon.__name__,
    WebdriverioIcon.__name__,
    WebexIcon.__name__,
    WebflowIcon.__name__,
    WebglIcon.__name__,
    WebgpuIcon.__name__,
    WeblateIcon.__name__,
    WebminIcon.__name__,
    WebmoneyIcon.__name__,
    WebpackIcon.__name__,
    WebrtcIcon.__name__,
    WebstormIcon.__name__,
    WebtoonIcon.__name__,
    WebtreesIcon.__name__,
    WechatIcon.__name__,
    WegameIcon.__name__,
    WeightsandBiasesIcon.__name__,
    WelcomeToTheJungleIcon.__name__,
    ...
    WeztermIcon.__name__,
    WgpuIcon.__name__,
    WhatThreeWordsIcon.__name__,
    WhatsappIcon.__name__,
    WhenIWorkIcon.__name__,
    WikidotggIcon.__name__,
    WikidotjsIcon.__name__,
    WikibooksIcon.__name__,
    WikidataIcon.__name__,
    WikimediaCommonsIcon.__name__,
    WikimediaFoundationIcon.__name__,
    WikipediaIcon.__name__,
    WikiquoteIcon.__name__,
    WikisourceIcon.__name__,
    WikiversityIcon.__name__,
    WikivoyageIcon.__name__,
    WinampIcon.__name__,
    WindsurfIcon.__name__,
    WineIcon.__name__,
    WiproIcon.__name__,
    WireIcon.__name__,
    WireguardIcon.__name__,
    WiresharkIcon.__name__,
    WiseIcon.__name__,
    WishIcon.__name__,
    WistiaIcon.__name__,
    WixIcon.__name__,
    WizzAirIcon.__name__,
    WolframIcon.__name__,
    WolframLanguageIcon.__name__,
    WolframMathematicaIcon.__name__,
    WondershareIcon.__name__,
    WondershareFilmoraIcon.__name__,
    WooIcon.__name__,
    WoocommerceIcon.__name__,
    WordpressIcon.__name__,
    WorkplaceIcon.__name__,
    WorldHealthOrganizationIcon.__name__,
    WpEngineIcon.__name__,
    WpRocketIcon.__name__,
    WpexplorerIcon.__name__,
    WritedotasIcon.__name__,
    WweIcon.__name__,
    WwiseIcon.__name__,
    WxtIcon.__name__,
    WykopIcon.__name__,
    WyzeIcon.__name__,
    XIcon.__name__,
    XdotorgIcon.__name__,
    XamppIcon.__name__,
    XcodeIcon.__name__,
    XdaDevelopersIcon.__name__,
    XenditIcon.__name__,
    XeroIcon.__name__,
    XfceIcon.__name__,
    ...
    YamahaMotorCorporationIcon.__name__,
    YamlIcon.__name__,
    YandexCloudIcon.__name__,
    YarnIcon.__name__,
    YelpIcon.__name__,
    YetiIcon.__name__,
    YiiIcon.__name__,
    YoastIcon.__name__,
    YoloIcon.__name__,
    YouhodlerIcon.__name__,
    YoutubeIcon.__name__,
    YoutubeGamingIcon.__name__,
    YoutubeKidsIcon.__name__,
    YoutubeMusicIcon.__name__,
    YoutubeShortsIcon.__name__,
    YoutubeStudioIcon.__name__,
    YoutubeTvIcon.__name__,
    YrIcon.__name__,
    YubicoIcon.__name__,
    ...
    ZendIcon.__name__,
    ZendeskIcon.__name__,
    ZennIcon.__name__,
    ZenodoIcon.__name__,
    ZensarIcon.__name__,
    ZerodhaIcon.__name__,
