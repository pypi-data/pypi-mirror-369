...
pip install mailblock-python

# For async support
pip install mailblock-python[async]

# For development
pip install mailblock-python[dev]
```
...
- **Bug Reports**: [GitHub Issues](https://github.com/5ysc4ll/mailblock-python/issues)
- **Feature Requests**: [GitHub Issues](https://github.com/5ysc4ll/mailblock-python/issues)
- **Documentation**: [MailBlock Docs](https://docs.mailblock.com/python)
- **Support**: [support@mailblock.com](mailto:support@mailblock.com)

## 🔗 Links

- **GitHub**: [https://github.com/5ysc4ll/mailblock-python](https://github.com/5ysc4ll/mailblock-python)
- **PyPI**: [https://pypi.org/project/mailblock-python/](https://pypi.org/project/mailblock-python/)
- **Documentation**: [https://docs.mailblock.com/python](https://docs.mailblock.com/python)
