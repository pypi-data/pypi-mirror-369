...
def handle_draw_action(game, action):
    ...
    print("******************************xyz handle_draw_action0", game.history)
    print("******************************xyz handle_draw_action1", legal_action.player_idx)
    if len(game.history) > 1:
        print("******************************xyz handle_draw_action2")
        last_action = game.history[-1]
        print("******************************xyz handle_draw_action3")
        if last_action.legal_action.player_idx != legal_action.player_idx:
            print("******************************xyz handle_draw_action4")
            ...
            print("******************************xyz handle_draw_action5")
            for spot_idx in range(len(game.decks[0].faceup_spots)):
                print("******************************xyz handle_draw_action6")
                game = append_to_legal_actions(
                    game,
                    LegalAction(
                        player_idx=legal_action.player_idx,
                ...
                print("******************************xyz handle_draw_action7")

    print("******************************xyz handle_draw_action8")
    return game.set(
...
def is_path_open_to_player(game, path_idx, player_idx):
    ...
    print("is_path_open_to_player: ", path_idx, player_idx)
    print("len(board_paths): ", len(game.game_config.fig.board_config.board_paths))
    path = get_path_by_idx(game, path_idx)
    print("path: ", path)
    print("path.segments: ", path.segments)
...
def getpublicaction(s, action):
    return PublicAction(
        player_idx=action.legal_action.player_idx,
        name=action.legal_action.name,
    )
...
def getpublicstate(s):
    return PublicState(
        history=[getpublicaction(s, action) for action in s.history],
...
def is_goal_complete(s, goal, player_idx):
    ...
    if goal.uuid == "dd6a75f6-c60a-4db3-86f0-3399cf3bc62a":
