...
class AuthManager:
    ...
    def is_authenticated(self) -> bool:
        ...
        # For frontend-routed architecture, we only need API key authentication
        # Frontend handles Clerk session validation and proxying
    ...
    def get_auth_headers(self) -> Dict[str, str]:
        ...
        # For frontend-routed architecture, we only use API key authentication
        # Frontend validates API key and adds Clerk context for backend requests
