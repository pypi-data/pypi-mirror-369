...
@click.group()
def workflows():
    """🔄 Workflow (WIP): composable multi‑step pipelines
    
    Chain tools so each step consumes outputs from previous steps—turn ad‑hoc
    analysis into a reproducible pipeline.
    
    • Single step:  ivybloom run esmfold protein_sequence=...
    ...
    Files are YAML/JSON with jobs, dependencies, and data flow.
    Use '--dry-run' to preview plan. See 'ivybloom workflows <cmd> --help'.
    """
    pass
