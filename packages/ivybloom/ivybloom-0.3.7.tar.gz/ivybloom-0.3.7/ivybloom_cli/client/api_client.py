...
class IvyBloomAPIClient:
    ...
    def _get_default_headers(self) -> Dict[str, str]:
        ...
        # Build default headers including auth; prefer JWT/OAuth, fallback to API key
        headers = {
            "Content-Type": "application/json",
            "User-Agent": "ivybloom-cli/0.3.7",
    ...
    def _make_request(self, method: str, endpoint: str, **kwargs) -> httpx.Response:
        ...
        try:
            ...
            if self.config.get('debug'):
                console.print(f"[dim]{method} {endpoint} -> (sending request)[/dim]")
    ...
    def get_tool_schema(self, tool_name: str) -> Dict[str, Any]:
        ...
        Since per-tool schema endpoints are not available, this method loads
        the verbose tools list and extracts the matching tool's schema.
        """
    ...
    def list_projects(self) -> List[Dict[str, Any]]:
        ...
        return self.get("/api/cli/projects")
