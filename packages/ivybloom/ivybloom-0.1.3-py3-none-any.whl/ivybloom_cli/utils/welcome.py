...
def show_welcome_screen(version: str = "0.1.3", force_compact: bool = False) -> None:
    ...
    welcome_text = (
        ...
        "[welcome.text]Computational Biology & Drug Discovery Tools[/welcome.text]\n\n"
...
def show_welcome_panel(version: str = "0.1.3") -> None:
