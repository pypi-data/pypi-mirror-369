...
class Config:
    ...
    def get_api_url(self) -> str:
        ...
        1) Environment variable IVYBLOOM_API_URL
        2) Environment variable IVYBLOOM_ENV mapped via ENVIRONMENT_URLS
        3) Config value 'api_url'
        4) Defaults
        Returns a normalized URL without a trailing slash.
        """
        # 1) Explicit API URL via env var
