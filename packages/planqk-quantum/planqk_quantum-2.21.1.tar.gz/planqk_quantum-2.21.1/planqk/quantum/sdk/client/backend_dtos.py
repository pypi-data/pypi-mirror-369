...
from planqk.quantum.sdk.client.model_enums import Provider, BackendType, HardwareProvider, BackendStatus, JobInputFormat
...
class ConfigurationDto(BaseModel):
    ...
    def __post_init__(self):
        ...
        self.supported_input_formats = [JobInputFormat(input_format) for input_format in self.supported_input_formats]
