...
SYMLINK_DEBUGGING_DIR_TEMPLATE = os.path.expanduser("~/src/.temp_sagemaker_unified_studio_debugging_info/{cell_id}")
SYMLINK_DEBUGGING_DIR_PARENT = os.path.expanduser("~/src/.temp_sagemaker_unified_studio_debugging_info")
