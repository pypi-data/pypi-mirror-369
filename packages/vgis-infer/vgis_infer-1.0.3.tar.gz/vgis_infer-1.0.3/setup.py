...
setup(
    ...
    name="vgis_infer",  # Required 项目名称
    version="1.0.3",  # Required 发布版本号
    description="A libary for ai infer",  # Optional 项目简单描述
    long_description=long_description,  # Optional 详细描述
    long_description_content_type="text/markdown",  # 内容类型
    url="https://github.com/gisfanmachel/vgisInfer",  # Optional github项目地址
    ...
    install_requires=["requests","toollib","Pillow","opencv-python"],
    # Optional 第三方依赖库
