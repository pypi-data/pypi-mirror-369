...
from nfl_data_loader.api.sources.players.adv.ngs.ngs import collect_weekly_ngs_passing_data, collect_weekly_ngs_rushing_data, collect_weekly_ngs_receiving_data
