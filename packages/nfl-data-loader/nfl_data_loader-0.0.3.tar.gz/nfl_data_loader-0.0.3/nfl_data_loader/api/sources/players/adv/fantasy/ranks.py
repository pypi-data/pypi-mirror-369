...
def get_fantasypros_ecr(seasons):
    ...
    fp_join = ids[ids.fantasypros_id.notnull()][['fantasypros_id', 'gsis_id']].rename(columns={'gsis_id': 'player_id'}).copy()
    ...
    player_df = player_df[player_df['player_id'].notnull()].copy()
