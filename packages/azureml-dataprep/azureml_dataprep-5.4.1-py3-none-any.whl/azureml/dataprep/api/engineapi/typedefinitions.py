...
def get_logger():
    ...
    logger = _LoggerFactory.get_logger("typedefinitions")
    return logger
...
def _get_step_property_descriptions(type: str):
    from .._loggerfactory import _log_not_supported_api_usage_and_raise
    _log_not_supported_api_usage_and_raise(get_logger(), '_get_step_property_descriptions', 'Clex deprecated')

def _get_prop_descriptions(type: str):
    from .._loggerfactory import _log_not_supported_api_usage_and_raise
    _log_not_supported_api_usage_and_raise(get_logger(), '_get_prop_descriptions', 'Clex deprecated')

def _get_local_data_descriptions(type: str):
    from .._loggerfactory import _log_not_supported_api_usage_and_raise
    _log_not_supported_api_usage_and_raise(get_logger(), '_get_local_data_descriptions', 'Clex deprecated')

def _get_inspector_descriptions(type: str):
    from .._loggerfactory import _log_not_supported_api_usage_and_raise
    _log_not_supported_api_usage_and_raise(get_logger(), '_get_inspector_descriptions', 'Clex deprecated')
