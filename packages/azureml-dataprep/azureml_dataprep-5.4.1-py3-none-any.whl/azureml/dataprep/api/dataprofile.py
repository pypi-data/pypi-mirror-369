...
from .engineapi.typedefinitions import (DataField, FieldType, ProfileResult, Moments, Quantiles, HistogramBin,
...
def get_logger():
    ...
    logger = _LoggerFactory.get_logger("Dataprofile")
    return logger
...
class DataProfile:
    ...
    @classmethod
    def _from_rslex_execution(cls, script: str):
        inspector_response = _Inspector._from_rslex_execution(script)
        if inspector_response is None:
            return None
    ...
    def compare(self, other_profile, include_columns=None, exclude_columns=None, histogram_compare_method = HistogramCompareMethod.WASSERSTEIN):
        ...
        """
        _log_not_supported_api_usage_and_raise(get_logger(), "Datafprofile.compare()", "Deprecated, downgrade to previous version of azureml-dataprep.")
