...
│   │   │   │   │       ├── __init__.py      # PySide6 dialogs package init (70 lines)
│   │   │   │   │       ├── shortcuts_dialog.py          # Qt shortcuts dialog (290 lines)
│   │   │   │   │       ├── preprocessing_dialog.py      # Qt preprocessing dialog (1518 lines)
│   │   │   │   │       ├── configuration_dialog.py      # Qt configuration dialog (664 lines)
│   │   │   │   │       ├── settings_dialog.py           # Qt settings dialog (662 lines)
│   │   │   │   │       ├── results_dialog.py            # Qt results dialog (696 lines)
│   │   │   │   │       ├── redshift_mode_dialog.py      # Qt redshift mode dialog (441 lines)
│   │   │   │   │       ├── manual_redshift_dialog.py    # Qt manual redshift dialog (1015 lines)
│   │   │   │   │       ├── mask_manager_dialog.py       # Qt mask manager dialog (486 lines)
│   │   │   │   │       ├── enhanced_ai_assistant_dialog.py # Enhanced AI assistant dialog (853 lines)
│   │   │   │   │       ├── cluster_selection_dialog.py  # Cluster selection dialog (836 lines)
│   │   │   │   │       ├── snid_analysis_dialog.py      # SNID analysis dialog (402 lines)
│   │   │   │   │       ├── multi_step_emission_dialog.py # Multi-step emission dialog (934 lines)
│   │   │   │   │       ├── analysis_progress_dialog.py  # Analysis progress dialog (551 lines)
│   │   │   │   │       ├── progress_dialog.py           # Basic progress dialog (211 lines)
│   │   │   │   │       ├── preprocessing_selection_dialog.py # Preprocessing selection (336 lines)
│   │   │   │   │       ├── games_dialog.py              # Games dialog (334 lines)
│   │   │   │   │       ├── gmm_clustering_dialog.py     # GMM clustering dialog (817 lines)
│   │   │   │   │       ├── redshift_age_dialog.py       # Redshift age dialog (614 lines)
│   │   │   │   │       └── subtype_proportions_dialog.py # Subtype proportions dialog (747 lines)
...
│   │   │   │   │   ├── **PYSIDE6 PLOTS:**
│   │   │   │   │   │   ├── pyside6_plot_manager.py      # PySide6 plot manager (676 lines)
│   │   │   │   │   │   └── pyside6_analysis_plotter.py  # PySide6 analysis plotter (441 lines)
│   │   │   │   │   ├── **SHARED PLOTS:**
