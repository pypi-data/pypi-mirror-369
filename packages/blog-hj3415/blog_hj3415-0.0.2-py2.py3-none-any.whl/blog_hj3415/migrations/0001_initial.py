# Generated by Django 5.2.4 on 2025-08-11 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [models.CheckConstraint(condition=models.Q(('status', 'DRAFT'), ('published_at__isnull', False), _connector='OR'), name='post_published_requires_published_at')],
            },
        ),
    ]
