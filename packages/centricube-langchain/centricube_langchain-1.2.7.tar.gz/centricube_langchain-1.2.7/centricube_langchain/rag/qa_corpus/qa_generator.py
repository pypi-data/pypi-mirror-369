...
from centricube_langchain.document_loaders import ElemUnstructuredLoader
from centricube_ragas.trainset import TrainsetGenerator
...
class RagQAGenerator(object):
    ...
    def __init__(self, 
                 corpus_folder,
                 qa_gen_folder,
                 unstructured_api_url="https://centricube.cicit.net/api/v1/etl4llm/predict",
