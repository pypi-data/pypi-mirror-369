...
from centricube_langchain.gpts.tools.api_tools import ALL_API_TOOLS
from centricube_langchain.gpts.tools.bing_search.self_arxiv import ArxivAPIWrapperSelf
from centricube_langchain.gpts.tools.bing_search.tool import BingSearchResults
from centricube_langchain.gpts.tools.calculator.tool import calculator
from centricube_langchain.gpts.tools.code_interpreter.tool import CodeInterpreterTool
# from langchain_community.utilities.dalle_image_generator import DallEAPIWrapper
from centricube_langchain.gpts.tools.dalle_image_generator.tool import (
    DallEAPIWrapper,
    DallEImageGenerator,
)
from centricube_langchain.gpts.tools.get_current_time.tool import get_current_time
from centricube_langchain.gpts.tools.local_file.local_file import LocalFileTool
from centricube_langchain.gpts.tools.sql_agent.tool import SqlAgentTool, SqlAgentAPIWrapper
from centricube_langchain.gpts.tools.web_search.tool import WebSearchTool, SearchTool
from centricube_langchain.rag import CentricubeRAGTool
from centricube_langchain.utils.azure_dalle_image_generator import AzureDallEWrapper
...
_EXTRA_PARAM_TOOLS: Dict[str, Tuple[Callable[[KwArg(Any)], BaseTool], List[Optional[str]], List[Optional[str]]]] = {
    ...
    'centricube_code_interpreter': (_get_native_code_interpreter, ["minio"], ['files']),
    'centricube_rag': (CentricubeRAGTool.get_rag_tool, ['name', 'description'],
