...
import httpx
import yaml
from centricube_langchain.gpts.load_tools import get_all_tool_names, load_tools
from centricube_langchain.gpts.utils import import_by_type, import_class
    ...
    def __init__(
        ...
        **others: Any,
        ...
        agent_executor_object = import_class(
            f'centricube_langchain.gpts.agent_types.{agent_executor_type}')
...
class CentricubeAssistant:
    ...
    def __init__(self, yaml_path) -> None:
        ...
        assistant_message = import_class(f'centricube_langchain.gpts.prompts.{prompt_type}')
...
if __name__ == '__main__':
    ...
    centricube_assistant = CentricubeAssistant('config/base_scene.yaml')
    # centricube_assistant = CentricubeAssistant("config/knowledge_scene.yaml")
    # centricube_assistant = CentricubeAssistant("config/rag_scene.yaml")
    result = centricube_assistant.run(query, chat_history=chat_history)
    print(result)
