    ...
    def transcribe(self, json_path:str, document_ids:list[str]=None):
        ...
        **Example**:
        ...
        for doc in documents:
            ...
            self.add_annotations(doc['id'], [prediction], 'speech transcription', json_path)
    ...
    def analyze_sentiment(self, json_path:str, document_ids:list[str]=None):
        ...
        **Example**:
        ...
        for doc in documents:
            audio_url = Utils.get_value_from_json_path(doc, json_path)
            if audio_url is None:
                print(f"Skipping document with id {doc['id']} because json_path {json_path} not found")
                continue
            prediction = model.predict({"audioUrl": audio_url})
            self.add_annotations(doc['id'], [prediction], 'text classification', json_path)
