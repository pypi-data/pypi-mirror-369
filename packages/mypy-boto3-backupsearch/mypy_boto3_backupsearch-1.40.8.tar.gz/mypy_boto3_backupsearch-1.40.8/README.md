<a id="mypy-boto3-backupsearch"></a>

# mypy-boto3-backupsearch

[![PyPI - mypy-boto3-backupsearch](https://img.shields.io/pypi/v/mypy-boto3-backupsearch.svg?color=blue)](https://pypi.org/project/mypy-boto3-backupsearch/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/mypy-boto3-backupsearch.svg?color=blue)](https://pypi.org/project/mypy-boto3-backupsearch/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/boto3_stubs_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-backupsearch)](https://pypistats.org/packages/mypy-boto3-backupsearch)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 BackupSearch 1.40.8](https://pypi.org/project/boto3/) compatible with
...
[mypy-boto3-backupsearch docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_backupsearch/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [mypy-boto3-backupsearch](#mypy-boto3-backupsearch)
...
- Install `boto3-stubs[backupsearch]` in your environment:
...
- Install `boto3-stubs[backupsearch]` with services you use in your
  environment:
...
`mypy-boto3-backupsearch` dependency in production. However, there is an issue
...
`mypy_boto3_backupsearch.paginator` module contains type annotations for all
paginators.
...
`mypy_boto3_backupsearch.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `BackupSearch` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_backupsearch/literals/).
...
`mypy_boto3_backupsearch.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `BackupSearch` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_backupsearch/type_defs/).
...
`mypy-boto3-backupsearch` version is the same as related `boto3` version and
follows
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_backupsearch/)
