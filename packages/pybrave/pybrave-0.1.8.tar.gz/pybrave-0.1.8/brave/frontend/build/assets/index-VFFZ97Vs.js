import{j as e,B as a,F as n}from"./index-7AvwSwCy.js";import{A as o}from"./index-BB_tI3ZS.js";import{T as r}from"./index-BvukfNTE.js";import{T as s}from"./index-CS88LIE_.js";import"./index-C6RIyMkZ.js";import"./Table-BNMDHWhP.js";import"./addEventListener-DsndksVL.js";import"./index-CsxUT7Dl.js";import"./index-Bb-FBSon.js";import"./index-C8gVfalV.js";import"./index-3BF_qLpI.js";import"./index-CXNer6h3.js";import"./index-QPqVsVq-.js";import"./index-DRXOc65y.js";import"./index-4-7uQlQF.js";import"./index-DQ0qF9w_.js";const l=({record:t,plot:i})=>e.jsx(e.Fragment,{children:t?e.jsxs(e.Fragment,{children:[e.jsx(a,{onClick:()=>{i({name:"基因预测统计",saveAnalysisMethod:"prokka_txt_plot",moduleName:"prokka_txt_plot",params:{file_path:t.content.txt}})},children:"基因预测统计"}),e.jsx(a,{onClick:()=>{i({moduleName:"genome_circos_plot_gbk",params:{file_path:t.content.gbk},tableDesc:`
...
+ gkb文件
    ...
    + /translation="MSNDYRNSEGYPDPTAG...RYFTEECQEV"
                ...
                `})},children:" prokka初步功能注释"})]}):e.jsx(e.Fragment,{children:e.jsx("p",{children:"选择一个样本开始分析"})})}),A=()=>e.jsxs(e.Fragment,{children:[e.jsx(s,{items:[{key:"Prokka",label:"Prokka",children:e.jsx(e.Fragment,{children:e.jsx(o,{inputAnalysisMethod:[{name:"1",label:"基因组组装文件",inputKey:["ngs-individual-assembly","tgs_individual_assembly"],mode:"multiple",type:"GroupSelectSampleButton",groupField:"sample_group",rules:[{required:!0,message:"该字段不能为空!"}]}],analysisMethod:[{name:"1",label:"prokka",inputKey:["prokka"],mode:"multiple"}],analysisType:"sample",children:e.jsx(l,{})})})}]}),e.jsx("p",{})]});export{A as default};
