import{r as m,j as e,B as n,F as _,S as d,a as g}from"./index-7AvwSwCy.js";import{A as h}from"./index-BB_tI3ZS.js";import{f}from"./utils-D2B0dIuM.js";import{T as c}from"./index-CS88LIE_.js";import"./index-C6RIyMkZ.js";import"./Table-BNMDHWhP.js";import"./addEventListener-DsndksVL.js";import"./index-CsxUT7Dl.js";import"./index-BvukfNTE.js";import"./index-Bb-FBSon.js";import"./index-C8gVfalV.js";import"./index-3BF_qLpI.js";import"./index-CXNer6h3.js";import"./index-QPqVsVq-.js";import"./index-DRXOc65y.js";import"./index-4-7uQlQF.js";import"./index-DQ0qF9w_.js";const y=({record:t,plot:a,setHtmlUrl:u,cleanDom:l,resultTableList:o,form:p})=>{const[r,i]=m.useState();return e.jsx(e.Fragment,{children:e.jsx(c,{onChange:l,items:[{key:"1",label:"多样本分析",children:e.jsxs(e.Fragment,{children:[e.jsx(n,{type:"primary",onClick:()=>{a({saveAnalysisMethod:"mutations_gene",moduleName:"circos_plot_mutations",params:{file_path:"/ssd1/wy/workspace2/leipu/leipu_workspace2/output/breseq/OSP-6/data/OSP-6.count"},formDom:e.jsx(e.Fragment,{children:e.jsx(_.Item,{name:"list_files",label:"选择样本",children:e.jsx(d,{mode:"multiple",style:{maxWidth:"20rem"},allowClear:!0,options:o.breseq?o.breseq.map(s=>({label:`${s.sample_name} (${s.content.reference})`,value:`${s.sample_name}#${s.content.annotated_tsv}`})):[]})})}),tableDesc:`
+ 选择样本说明:
...
| "seq_id": "Chr"                            | 突变发生在哪条序列上（例如染色体或质粒）                       |
                ...
                `})},children:"变异统计"})]})}]})})},v=()=>{const[t,a]=m.useState([]),[u,l]=m.useState(!1),o=async()=>{l(!0);const r=await g.get("/api/mutation");console.log(r),l(!1),a(r.data)};m.useEffect(()=>{o()},[]);const p=[{title:"参考基因组",dataIndex:"reference",key:"reference",ellipsis:!0,render:(r,i)=>{var s;return e.jsx(e.Fragment,{children:(s=i==null?void 0:i.content)==null?void 0:s.reference})}}];return e.jsx(e.Fragment,{children:e.jsx(c,{items:[{label:"breseq",key:"breseq",children:e.jsx(h,{appendSampleColumns:p,analysisMethod:[{name:"breseq",label:"breseq",inputKey:["breseq"],mode:"multiple"}],analysisType:"sample",children:e.jsx(y,{})})}]})})};export{v as default};
