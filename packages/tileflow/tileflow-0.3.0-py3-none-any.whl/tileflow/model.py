...
class TileFlow:
    ...
    def __init__(
        ...
        self._chunk_processor: Callable[[list[np.ndarray]], list[np.ndarray]] | None = None
    ...
    def configure(
        ...
        chunk_function: Callable[[list[np.ndarray]], list[np.ndarray]] | None = None,
    ) -> None:
        ...
        chunk_function : Callable[[list[np.ndarray]], list[np.ndarray]], optional
            Function to apply to reconstructed chunks (only used with chunk_size)
        """
    ...
    def _process_chunked(
        ...
        for i, chunk_spec in enumerate(chunk_specs):
            ...
            if self._chunk_processor:
                chunk_output = self._chunk_processor(chunk_output)
