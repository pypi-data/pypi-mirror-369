...
craft --version  # or: claudecraftsman --version
craft --help     # or: claudecraftsman --help
...
### Step 2: Create Your First Feature (In Claude Code)
...
### Step 3: Implement with Progress Tracking (In Claude Code)

**In Claude Code**, execute the plan:
```
...
### Step 4: Add Testing (In Claude Code)
