...
class OrganizationsBrandUpsertRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["background_img_url", "color1", "color2", "color3", "color4", "color5", "logo_img_url", "org_guid", "primary_color", "secondary_color", "tertiary_color"]
