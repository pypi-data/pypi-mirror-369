...
from typing import NoReturn, Optional, Tuple, Type, Dict, Any, Sequence, Callable, Awaitable, List, Protocol
...
class NetworkConnectionProtocol(BaseConnectionProtocol, Protocol):
    ...
    def run_connection_lost_tasks(self) -> None:
        if self.connection_lost_tasks:
            [asyncio.create_task(t()) for t in self.connection_lost_tasks]
