...
if TYPE_CHECKING:
    from aionetworking.networking.protocols import (ProtocolFactoryProtocol, ConnectionProtocol,
                                                    NetworkConnectionProtocol, UDPConnectionProtocol, AdaptorProtocol,
                                                    SenderAdaptorProtocol, SimpleNetworkConnectionProtocol)
