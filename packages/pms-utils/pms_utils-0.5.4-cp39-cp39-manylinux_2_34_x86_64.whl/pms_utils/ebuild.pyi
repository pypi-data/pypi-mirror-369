...
class uri_elem:
    ...
    @property
    def uri(self) -> Union[URI, pathlib.Path]: ...
...
class src_uri:
    ...
    @property
    def conditional(self) -> Optional[Union[pms_utils.depend.UseConditional, pms_utils.depend.GroupHeaderOp]]: ...

    @property
    def nodes(self) -> list[Union[uri_elem, src_uri]]: ...

    def __str__(self) -> str: ...

    def __repr__(self) -> str: ...

    def __iter__(self) -> Iterator[Union[uri_elem, src_uri]]: ...
...
class restrict:
    ...
    @property
    def nodes(self) -> list[Union[restrict_elem, restrict]]: ...

    def __str__(self) -> str: ...

    def __repr__(self) -> str: ...

    def __iter__(self) -> Iterator[Union[restrict_elem, restrict]]: ...
...
class homepage:
    ...
    @property
    def nodes(self) -> list[Union[URI, homepage]]: ...

    def __str__(self) -> str: ...

    def __repr__(self) -> str: ...

    def __iter__(self) -> Iterator[Union[URI, homepage]]: ...
...
class license:
    ...
    @property
    def nodes(self) -> list[Union[license_elem, license]]: ...

    def __str__(self) -> str: ...

    def __repr__(self) -> str: ...

    def __iter__(self) -> Iterator[Union[license_elem, license]]: ...
...
class required_use_elem:
    def __init__(self, expr: str) -> None:
        """
        Constructs a new required_use_elem object from the input expression.
    ...
    def __eq__(self, arg: required_use_elem, /) -> bool: ...

    def __ne__(self, arg: required_use_elem, /) -> bool: ...
...
class required_use:
    ...
    @property
    def nodes(self) -> list[Union[required_use_elem, required_use]]: ...

    def __str__(self) -> str: ...

    def __repr__(self) -> str: ...

    def __iter__(self) -> Iterator[Union[required_use_elem, required_use]]: ...
...
class properties:
    ...
    @property
    def nodes(self) -> list[Union[properties_elem, properties]]: ...

    def __str__(self) -> str: ...

    def __repr__(self) -> str: ...

    def __iter__(self) -> Iterator[Union[properties_elem, properties]]: ...
