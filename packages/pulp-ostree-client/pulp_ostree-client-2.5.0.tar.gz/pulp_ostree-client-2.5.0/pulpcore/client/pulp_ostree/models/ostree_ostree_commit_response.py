...
class OstreeOstreeCommitResponse(BaseModel):
    """
    ...
    parent_commit: Optional[StrictStr] = None
    checksum: StrictStr
    objs: List[StrictStr]
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "pulp_labels", "vuln_report", "artifact", "relative_path", "parent_commit", "checksum", "objs"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if parent_commit (nullable) is None
        # and model_fields_set contains the field
        if self.parent_commit is None and "parent_commit" in self.model_fields_set:
            _dict['parent_commit'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent_commit": obj.get("parent_commit"),
