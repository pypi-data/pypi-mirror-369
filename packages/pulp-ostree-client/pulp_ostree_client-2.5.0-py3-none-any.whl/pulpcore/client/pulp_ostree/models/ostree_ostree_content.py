...
class OstreeOstreeContent(BaseModel):
    """
    ...
    digest: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["repository", "pulp_labels", "artifact", "relative_path", "digest"]
