...
from pulpcore.client.pulp_ostree.api_client import ApiClient, RequestSerialized
from pulpcore.client.pulp_ostree.api_response import ApiResponse
from pulpcore.client.pulp_ostree.rest import RESTResponseType
...
class DistributionsOstreeApi:
    ...
    def add_role(
        self,
        ostree_ostree_distribution_href: StrictStr,
        ...
        :param ostree_ostree_distribution_href: (required)
        :type ostree_ostree_distribution_href: str
        ...
        _param = self._add_role_serialize(
            ostree_ostree_distribution_href=ostree_ostree_distribution_href,
    ...
    def _add_role_serialize(
        ...
        if ostree_ostree_distribution_href is not None:
            _path_params['ostree_ostree_distribution_href'] = ostree_ostree_distribution_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ostree_ostree_distribution_href}add_role/',
    ...
    def create(
        self,
        ostree_ostree_distribution: OstreeOstreeDistribution,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param ostree_ostree_distribution: (required)
        :type ostree_ostree_distribution: OstreeOstreeDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            ostree_ostree_distribution=ostree_ostree_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ostree_ostree_distribution is not None:
            _body_params = ostree_ostree_distribution
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/distributions/ostree/ostree/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{ostree_ostree_distribution_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedostreeOstreeDistributionResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedostreeOstreeDistributionResponseList]:
        """List ostree distributions
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ostree_ostree_distribution_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ostree_ostree_distribution_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        self,
        ostree_ostree_distribution_href: StrictStr,
        patchedostree_ostree_distribution: PatchedostreeOstreeDistribution,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param ostree_ostree_distribution_href: (required)
        :type ostree_ostree_distribution_href: str
        :param patchedostree_ostree_distribution: (required)
        :type patchedostree_ostree_distribution: PatchedostreeOstreeDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            ostree_ostree_distribution_href=ostree_ostree_distribution_href,
            patchedostree_ostree_distribution=patchedostree_ostree_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        self,
        ostree_ostree_distribution_href,
        patchedostree_ostree_distribution,
        x_task_diagnostics,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if patchedostree_ostree_distribution is not None:
            _body_params = patchedostree_ostree_distribution
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OstreeOstreeDistributionResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OstreeOstreeDistributionResponse]:
        """Inspect an ostree distribution
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ostree_ostree_distribution_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ostree_ostree_distribution_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ostree_ostree_distribution_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
