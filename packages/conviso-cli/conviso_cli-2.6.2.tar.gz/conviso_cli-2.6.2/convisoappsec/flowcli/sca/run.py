...
def deploy_results_to_conviso(flow_context, conviso_api, results_filepaths, asset_id, company_id):
...
def perform_command(
    ...
    try:
        ...
        if send_to_flow:
            ...
            deploy_results_to_conviso(flow_context, conviso_beta_api, results_filepaths, asset_id, company_id)
