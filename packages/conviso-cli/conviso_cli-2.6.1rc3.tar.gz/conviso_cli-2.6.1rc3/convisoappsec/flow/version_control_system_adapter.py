...
class GitAdapter(object):
    ...
    def zip_git_folder(self):
        ...
        try:
            # Shallow clone latest commit, no checkout, silent
            ...
            # Remove unnecessary folders to save space
            for folder in ["logs", "hooks", "info"]:
                path = os.path.join(shallow_path, ".git", folder)
