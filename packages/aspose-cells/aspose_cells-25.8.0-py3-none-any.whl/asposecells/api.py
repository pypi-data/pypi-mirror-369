...
class ErrorBarType(IntEnum):
    ...
    ST_DEV = 3,
    ST_ERROR = 4,
class ErrorCellValueType(IntEnum):
    BLOCKED = 10,
    BUSY = 14,
    CALC = 13,
    CONNECT = 9,
...
class ExternalConnectionClassType(IntEnum):
    DATA_MODEL = 3,
    DATABASE = 0,
    TEXT_BASED = 2,
    UNKOWN = 4,
...
class MapChartRegionType(IntEnum):
    ...
    DATA_ONLY = 1,
    WORLD = 3,
class MarkdownTableHeaderType(IntEnum):
    COLUMN_HEADER = 1,
    EMPTY = 2,
    FIRST_ROW = 0,
...
class PivotMissingItemLimitType(IntEnum):
    ...
    MAX = 1,
    NONE = 2,
class PivotRefreshState(IntEnum):
    SUCCESS = 0,
...
class PivotTableSelectionType(IntEnum):
    ...
    DATA_ONLY = 2,
    LABEL_ONLY = 1,
class PivotTableSourceType(IntEnum):
    CONSOLIDATION = 4,
    EXTERNAL = 2,
    SCENARIO = 8,
    SHEET = 1,
...
class SelectionType(IntEnum):
    ...
    MULTI = 1,
    SINGLE = 0,
class SensitivityLabelAssignmentType(IntEnum):
    PRIVILEGED = 1,
    STANDARD = 0,
class SensitivityLabelMarkType(IntEnum):
    ENCRYPTION = 8,
    FOOTER = 2,
    HEADER = 1,
    NONE = 0,
...
class StyleModifyFlag(IntEnum):
    ...
    VERTICAL_BORDER = 64,
    WRAP_TEXT = 524288,
class SvgEmbeddedFontType(IntEnum):
    NONE = 0,
    WOFF = 1,
...
from com.aspose.cells import AbstractLowCodeProtectionProvider
...
from com.aspose.cells import DbfLoadOptions
from com.aspose.cells import DbfSaveOptions
from com.aspose.cells import DeleteBlankOptions
from com.aspose.cells import DeleteOptions
from com.aspose.cells import DifLoadOptions
...
from com.aspose.cells import LowCodeHtmlSaveOptions
from com.aspose.cells import LowCodeImageSaveOptions
from com.aspose.cells import LowCodeLoadOptions
from com.aspose.cells import LowCodeMergeOptions
from com.aspose.cells import LowCodePdfSaveOptions
from com.aspose.cells import LowCodeSaveOptions
...
from com.aspose.cells import SensitivityLabelCollection
...
from com.aspose.cells import SvgImageOptions
...
from com.aspose.cells import HtmlConverter
from com.aspose.cells import ImageConverter
from com.aspose.cells import ImageFormat
from com.aspose.cells import JsonConverter
from com.aspose.cells import PdfConverter
from com.aspose.cells import SpreadsheetConverter
