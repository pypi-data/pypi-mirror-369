...
class CommandTemplate(_message.Message):
    ...
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., metadata: _Optional[_Union[_command_metadata_pb2.CommandMetadata, _Mapping]] = ..., parameters: _Optional[_Iterable[_Union[_parameter_pb2.Parameter, _Mapping]]] = ..., index: _Optional[int] = ..., user_output_key_map: _Optional[_Mapping[str, str]] = ...) -> None: ...
