...
class ExperimentTemplate(_message.Message):
    ...
    name: str
    analyzer_id: _wrappers_pb2.StringValue
    analyzer_maps: _containers.ScalarMap[str, str]
    resolved: bool
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., step_templates: _Optional[_Iterable[_Union[_step_template_pb2.StepTemplate, _Mapping]]] = ..., name: _Optional[str] = ..., analyzer_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., analyzer_maps: _Optional[_Mapping[str, str]] = ..., resolved: bool = ...) -> None: ...
