...
class VariableAllocation(_message.Message):
    ...
    unqiue_id: _wrappers_pb2.StringValue
    variable_type: VariableType
    parameter_name: str
    def __init__(self, unqiue_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., variable_type: _Optional[_Union[VariableType, str]] = ..., parameter_name: _Optional[str] = ...) -> None: ...
