...
class StepTemplate(_message.Message):
    ...
    index: int
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., name: _Optional[str] = ..., is_parallel: bool = ..., command_templates: _Optional[_Iterable[_Union[_command_template_pb2.CommandTemplate, _Mapping]]] = ..., index: _Optional[int] = ...) -> None: ...
