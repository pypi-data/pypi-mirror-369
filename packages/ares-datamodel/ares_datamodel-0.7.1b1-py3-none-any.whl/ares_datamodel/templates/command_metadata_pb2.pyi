...
class CommandMetadata(_message.Message):
    __slots__ = ("unique_id", "name", "description", "device_name", "output_metadata", "parameter_metadatas", "device_type")
    ...
    device_type: str
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., device_name: _Optional[str] = ..., output_metadata: _Optional[_Union[_output_metadata_pb2.OutputMetadata, _Mapping]] = ..., parameter_metadatas: _Optional[_Iterable[_Union[_parameter_metadata_pb2.ParameterMetadata, _Mapping]]] = ..., device_type: _Optional[str] = ...) -> None: ...
