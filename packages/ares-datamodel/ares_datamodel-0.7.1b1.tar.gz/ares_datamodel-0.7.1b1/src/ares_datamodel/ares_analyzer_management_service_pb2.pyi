...
class AddRemoteAnalyzerResponse(_message.Message):
    ...
    def __init__(self, analyzer_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., success: bool = ..., error_message: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class UpdateRemoteAnalyzerRequest(_message.Message):
    ...
    def __init__(self, analyzer_id: _Optional[str] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., url: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class UpdateRemoteAnalyzerResponse(_message.Message):
    ...
    success: bool
    error_message: _wrappers_pb2.StringValue
    def __init__(self, success: bool = ..., error_message: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class AnalyzerStateRequest(_message.Message):
