...
class ExecutionInfo(_message.Message):
    ...
    localtime_offset: _wrappers_pb2.StringValue
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., time_started: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., time_finished: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., timezone: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., localtime_offset: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class ExperimentExecutionSummary(_message.Message):
    ...
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., experiment_id: _Optional[str] = ..., step_summaries: _Optional[_Iterable[_Union[StepExecutionSummary, _Mapping]]] = ..., execution_info: _Optional[_Union[ExecutionInfo, _Mapping]] = ..., experiment_overview: _Optional[_Union[_experiment_overview_pb2.ExperimentOverview, _Mapping]] = ..., result_output_path: _Optional[str] = ...) -> None: ...
...
class StepExecutionSummary(_message.Message):
    ...
    execution_info: ExecutionInfo
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., step_id: _Optional[str] = ..., command_summaries: _Optional[_Iterable[_Union[CommandExecutionSummary, _Mapping]]] = ..., execution_info: _Optional[_Union[ExecutionInfo, _Mapping]] = ...) -> None: ...
...
class CommandExecutionSummary(_message.Message):
    ...
    command_id: str
    execution_info: ExecutionInfo
    result: _device_command_result_pb2.DeviceCommandResult
    command_name: str
    command_description: str
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., command_id: _Optional[str] = ..., execution_info: _Optional[_Union[ExecutionInfo, _Mapping]] = ..., result: _Optional[_Union[_device_command_result_pb2.DeviceCommandResult, _Mapping]] = ..., command_name: _Optional[str] = ..., command_description: _Optional[str] = ...) -> None: ...
