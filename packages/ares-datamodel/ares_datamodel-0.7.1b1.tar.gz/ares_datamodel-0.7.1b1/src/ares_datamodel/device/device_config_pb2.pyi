...
class DeviceConfig(_message.Message):
    ...
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., device_name: _Optional[str] = ..., device_type: _Optional[str] = ..., config_data: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...) -> None: ...
