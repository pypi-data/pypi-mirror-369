...
class AnalysisOverview(_message.Message):
    ...
    experiment_overview_id: _wrappers_pb2.StringValue
    result: float
    analyzer_info: _analyzer_info_pb2.AnalyzerInfo
    def __init__(self, unique_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., experiment_overview_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., result: _Optional[float] = ..., analyzer_info: _Optional[_Union[_analyzer_info_pb2.AnalyzerInfo, _Mapping]] = ...) -> None: ...
