...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_COMMANDTEMPLATE']._serialized_start = 156
    _globals['_COMMANDTEMPLATE']._serialized_end = 506
    _globals['_COMMANDTEMPLATE_USEROUTPUTKEYMAPENTRY']._serialized_start = 451
    _globals['_COMMANDTEMPLATE_USEROUTPUTKEYMAPENTRY']._serialized_end = 506