...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-transcribe)](https://pypistats.org/packages/mypy-boto3-transcribe)
...
`mypy-boto3-transcribe` dependency in production. However, there is an issue in
