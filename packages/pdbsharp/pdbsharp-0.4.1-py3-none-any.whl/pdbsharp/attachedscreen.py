...
class AttachedScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        self.sub_title = f"{get_process_name(self.app._server_pid) if self.app._server_pid else 'process'} (pid {self.app._server_pid if self.app._server_pid else '*unknown*'})"
