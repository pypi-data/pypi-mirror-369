...
class MetadataStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetResource = channel.stream_stream(
                '/featureform.serving.metadata.proto.Metadata/GetResource',
                request_serializer=featureform_dot_proto_dot_metadata__pb2.GetResourceRequest.SerializeToString,
...
class MetadataServicer(object):
    ...
    def GetResource(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MetadataServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetResource': grpc.stream_stream_rpc_method_handler(
                    servicer.GetResource,
                    request_deserializer=featureform_dot_proto_dot_metadata__pb2.GetResourceRequest.FromString,
...
class Metadata(object):
    ...
    @staticmethod
    def GetResource(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/featureform.serving.metadata.proto.Metadata/GetResource',
            featureform_dot_proto_dot_metadata__pb2.GetResourceRequest.SerializeToString,
...
class ApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetResource = channel.stream_stream(
                '/featureform.serving.metadata.proto.Api/GetResource',
                request_serializer=featureform_dot_proto_dot_metadata__pb2.GetResourceRequest.SerializeToString,
                response_deserializer=featureform_dot_proto_dot_metadata__pb2.ResourceVariant.FromString,
                )
        self.GetTaskStatuses = channel.unary_unary(
...
class Api(object):
    ...
    def GetResource(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/featureform.serving.metadata.proto.Api/GetResource',
            featureform_dot_proto_dot_metadata__pb2.GetResourceRequest.SerializeToString,
            featureform_dot_proto_dot_metadata__pb2.ResourceVariant.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
