...
if sys.version_info < (3, 0):
    ...
    from vgrid.dggs.eaggr.exceptions.eaggr_exception import EaggrException
    from vgrid.dggs.eaggr.enums.dggs_return_code import DggsReturnCode
    from vgrid.dggs.eaggr.enums.model import check_model
    from vgrid.dggs.eaggr.enums.shape_string_format import check_shape_string_format
    from vgrid.dggs.eaggr.shapes.native_structures import (
        get_LAT_LONG_SHAPE_array,
        get_LAT_LONG_POINT_array,
        LAT_LONG_POINT,
        LAT_LONG_SHAPE,
