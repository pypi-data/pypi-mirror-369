...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <pyroherd.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <pyroherd.raw.base.StoriesStealthMode>`):
            N/A
