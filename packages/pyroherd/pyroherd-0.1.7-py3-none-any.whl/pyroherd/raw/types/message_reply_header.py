...
class MessageReplyHeader(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        reply_from (:obj:`MessageFwdHeader <pyroherd.raw.base.MessageFwdHeader>`, *optional*):
            N/A

        reply_media (:obj:`MessageMedia <pyroherd.raw.base.MessageMedia>`, *optional*):
            N/A
        ...
        quote_entities (List of :obj:`MessageEntity <pyroherd.raw.base.MessageEntity>`, *optional*):
            N/A
