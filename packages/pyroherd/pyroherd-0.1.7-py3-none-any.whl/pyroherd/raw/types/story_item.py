...
class StoryItem(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        fwd_from (:obj:`StoryFwdHeader <pyroherd.raw.base.StoryFwdHeader>`, *optional*):
            N/A
        ...
        media_areas (List of :obj:`MediaArea <pyroherd.raw.base.MediaArea>`, *optional*):
            N/A

        privacy (List of :obj:`PrivacyRule <pyroherd.raw.base.PrivacyRule>`, *optional*):
            N/A

        views (:obj:`StoryViews <pyroherd.raw.base.StoryViews>`, *optional*):
            N/A

        sent_reaction (:obj:`Reaction <pyroherd.raw.base.Reaction>`, *optional*):
            N/A
