...
class InputBusinessBotRecipients(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroherd.raw.base.InputBusinessBotRecipients`.
    ...
    Parameters:
        ...
        users (List of :obj:`InputUser <pyroherd.raw.base.InputUser>`, *optional*):
            N/A

        exclude_users (List of :obj:`InputUser <pyroherd.raw.base.InputUser>`, *optional*):
            N/A
