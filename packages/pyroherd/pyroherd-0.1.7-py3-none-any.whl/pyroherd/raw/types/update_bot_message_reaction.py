...
class UpdateBotMessageReaction(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        actor (:obj:`Peer <pyroherd.raw.base.Peer>`):
            N/A

        old_reactions (List of :obj:`Reaction <pyroherd.raw.base.Reaction>`):
            N/A

        new_reactions (List of :obj:`Reaction <pyroherd.raw.base.Reaction>`):
            N/A
