...
class DeleteMessages:
    async def delete_messages(
        ...
        .. note::
            ...
            - :obj:`~pyroherd.Client` can delete outgoing messages in private chats, groups, and supergroups.
            - :obj:`~pyroherd.Client` can delete incoming messages in private chats.
            - :obj:`~pyroherd.Client` granted can_post_messages permissions can delete outgoing messages in channels.
            - If the :obj:`~pyroherd.Client` is an administrator of a group, it can delete any message there.
            - If the :obj:`~pyroherd.Client` has can_delete_messages permission in a supergroup or a channel, it can delete any message there.
