...
import pyroherd
from pyroherd import StopTransmission, enums, raw, types, utils
...
class SendVideo:
    async def send_video(
        ...
        .. note::
            ...
            Such messages will have ``scheduled`` property set and beware of using the correct message identifiers when using such :obj:`~pyroherd.types.Message` objects.
