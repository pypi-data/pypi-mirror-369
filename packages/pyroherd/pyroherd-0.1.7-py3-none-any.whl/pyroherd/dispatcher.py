...
class Dispatcher:
    ...
    def __init__(self, client: "pyroherd.Client"):
        ...
        async def message_parser(update, users, chats):
            ...
            return (
                await pyroherd.types.Message._parse(
                    self.client,
                    update.message,
                    users,
                    chats,
        ...
        async def callback_query_parser(update, users, chats):
            return (
                await pyroherd.types.CallbackQuery._parse(self.client, update, users, chats),
        ...
        async def poll_parser(update, users, chats):
            return (
                pyroherd.types.Poll._parse_update(self.client, update, users),
                PollHandler
            )
        ...
        async def story_parser(update, users, chats):
            return (
                await pyroherd.types.Story._parse(self.client, update.story, update.peer, users, chats),
                StoryHandler
            )

        async def pre_checkout_query_parser(update, users, chats):
            return (
                await pyroherd.types.PreCheckoutQuery._parse(self.client, update, users),
                PreCheckoutQueryHandler
            )

        async def shipping_query_parser(update, users, chats):
            return (
                await pyroherd.types.ShippingQuery._parse(self.client, update, users),
                ShippingQueryHandler
            )

        async def message_reaction_parser(update, users, chats):
            return (
                pyroherd.types.MessageReactionUpdated._parse(self.client, update, users, chats),
                MessageReactionHandler
            )

        async def message_reaction_count_parser(update, users, chats):
            return (
                pyroherd.types.MessageReactionCountUpdated._parse(self.client, update, users, chats),
                MessageReactionCountHandler
            )

        async def chat_boost_parser(update, users, chats):
            return (
                pyroherd.types.ChatBoostUpdated._parse(self.client, update, users, chats),
                ChatBoostHandler
            )

        async def purchased_paid_media_parser(update, users, chats):
            return (
                pyroherd.types.PurchasedPaidMedia._parse(self.client, update, users),
