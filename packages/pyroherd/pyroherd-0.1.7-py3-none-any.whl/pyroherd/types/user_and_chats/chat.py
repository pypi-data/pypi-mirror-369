...
class Chat(Object):
    ...
    Parameters:
        ...
        chat_background (:obj:`~pyroherd.types.ChatBackground`, *optional*):
            Chat wallpaper.
        ...
        business_away_message (:obj:`~pyroherd.types.BusinessMessage`, *optional*):
            For private chats with business accounts, the away message of the business.

        business_greeting_message (:obj:`~pyroherd.types.BusinessMessage`, *optional*):
            For private chats with business accounts, the greeting message of the business.

        business_work_hours (:obj:`~pyroherd.types.BusinessWorkingHours`, *optional*):
            For private chats with business accounts, the working hours of the business.

        business_location (:obj:`~pyroherd.types.Location`, *optional*):
        ...
        bot_verification (:obj:`~pyroherd.types.BotVerification`, *optional*):
            Information about bot verification.

        settings (:obj:`~pyroherd.types.ChatSettings`, *optional*):
            Chat settings.
            Returned only in :meth:`~pyroherd.Client.get_chat`.
        ...
        bot_broadcast_admin_rights (:obj:`~pyroherd.types.ChatPrivileges`, *optional*):
            A suggested set of administrator rights for the bot, to be shown when adding the bot as admin to a channel.
            Returned only in :meth:`~pyroherd.Client.get_chat`

        bot_group_admin_rights (:obj:`~pyroherd.types.ChatPrivileges`, *optional*):
        ...
        allowed_gifts (:obj:`~pyroherd.types.AllowedGiftsSettings`, *optional*):
            Information about gifts that can be received by the user.
            Returned only in :meth:`~pyroherd.Client.get_chat`

        raw (:obj:`~pyroherd.raw.types.UserFull` | :obj:`~pyroherd.raw.types.ChatFull` | :obj:`~pyroherd.raw.types.ChannelFull`, *optional*):
    ...
    @staticmethod
    async def _parse_full_user(client: "pyroherd.Client", user: "raw.types.UserFull", users: dict, chats: dict) -> "Chat":
    ...
    @staticmethod
    async def _parse_full_chat(client: "pyroherd.Client", chat: "raw.types.ChatFull", users: dict, chats: dict) -> "Chat":
    ...
    @staticmethod
    async def _parse_full_channel(client: "pyroherd.Client", channel: "raw.types.ChannelFull", users, chats) -> "Chat":
    ...
    @staticmethod
    async def _parse_full(client: "pyroherd.Client", chat_full: Union["raw.types.UserFull", "raw.types.ChatFull", "raw.types.ChannelFull"]) -> Optional["Chat"]:
