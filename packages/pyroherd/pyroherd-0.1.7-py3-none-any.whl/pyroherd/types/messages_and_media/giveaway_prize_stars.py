...
from pyroherd.errors import MessageIdsEmpty, ChannelPrivate
...
class GiveawayPrizeStars(Object):
    ...
    Parameters:
        ...
        sticker (:obj:`~pyroherd.types.Sticker`):
