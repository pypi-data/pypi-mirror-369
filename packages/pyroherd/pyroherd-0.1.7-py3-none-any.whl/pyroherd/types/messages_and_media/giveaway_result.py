...
import pyroherd
from pyroherd import errors, raw, utils
...
class GiveawayResult(Object):
    ...
    Parameters:
        chat (List of :obj:`~pyroherd.types.Chat`):
        ...
        winners (List of :obj:`~pyroherd.types.User`):
        ...
        launch_message (:obj:`~pyroherd.types.Message`, *optional*):
