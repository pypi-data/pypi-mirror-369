...
class MessageOrigin(Object):
    ...
    - :obj:`~pyroherd.types.MessageOriginChannel`
    - :obj:`~pyroherd.types.MessageOriginChat`
    - :obj:`~pyroherd.types.MessageOriginHiddenUser`
    - :obj:`~pyroherd.types.MessageOriginImport`
    - :obj:`~pyroherd.types.MessageOriginUser`
    """
