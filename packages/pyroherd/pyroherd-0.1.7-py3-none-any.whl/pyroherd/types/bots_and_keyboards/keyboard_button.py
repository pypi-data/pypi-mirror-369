...
class KeyboardButton(Object):
    ...
    Parameters:
        ...
        request_poll (:obj:`~pyroherd.types.RequestPollInfo`, *optional*):
            If specified, the poll be sent when the button is pressed.

        request_peer (:obj:`~pyroherd.types.RequestChannelInfo` | :obj:`~pyroherd.types.RequestChatInfo` | :obj:`~pyroherd.types.RequestUserInfo`, *optional*):
