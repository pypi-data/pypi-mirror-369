...
class ShippingQuery(Object, Update):
    ...
    Parameters:
        ...
        shipping_address (:obj:`~pyroherd.types.ShippingAddress`):
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~pyroherd.types.ShippingQuery`.
        ...
        Parameters:
            ...
            shipping_options (:obj:`~pyroherd.types.ShippingOptions`, *optional*):
