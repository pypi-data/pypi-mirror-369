...
class OnPreCheckoutQuery:
    def on_pre_checkout_query(
        ...
        :obj:`~pyroherd.handlers.PreCheckoutQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroherd.Client):
                self.add_handler(pyroherd.handlers.PreCheckoutQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroherd.handlers.PreCheckoutQueryHandler(func, self),
