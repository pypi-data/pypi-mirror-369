...
class OnShippingQuery:
    def on_shipping_query(
        ...
        :obj:`~pyroherd.handlers.ShippingQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroherd.Client):
                self.add_handler(pyroherd.handlers.ShippingQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroherd.handlers.ShippingQueryHandler(func, self),
