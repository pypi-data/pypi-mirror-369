...
class OnPurchasedPaidMedia:
    def on_purchased_paid_media(
        ...
        :obj:`~pyroherd.handlers.PurchasedPaidMediaHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroherd.Client):
                self.add_handler(pyroherd.handlers.MessageReactionHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroherd.handlers.MessageReactionHandler(func, self),
