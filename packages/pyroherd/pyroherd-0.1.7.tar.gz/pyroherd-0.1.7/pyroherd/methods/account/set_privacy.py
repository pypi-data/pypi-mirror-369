...
class SetPrivacy:
    async def set_privacy(
        ...
        Parameters:
            key (:obj:`~pyroherd.enums.PrivacyKey`):
                Privacy key.

            rules (Iterable of :obj:`~pyroherd.types.InputPrivacyRule`):
                List of privacy rules.

        Returns:
            List of :obj:`~pyroherd.types.PrivacyRule`: On success, the list of privacy rules is returned.
