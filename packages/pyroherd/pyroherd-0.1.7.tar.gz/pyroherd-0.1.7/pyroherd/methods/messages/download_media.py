...
import pyroherd
from pyroherd import types, utils
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (``str`` | :obj:`~pyroherd.types.Message` | :obj:`~pyroherd.types.Story` | :obj:`~pyroherd.types.Audio` | :obj:`~pyroherd.types.Document` | :obj:`~pyroherd.types.Photo` | :obj:`~pyroherd.types.Sticker` | :obj:`~pyroherd.types.Animation` | :obj:`~pyroherd.types.Video` | :obj:`~pyroherd.types.Voice` | :obj:`~pyroherd.types.VideoNote` | :obj:`~pyroherd.types.PaidMediaInfo` | :obj:`~pyroherd.types.Thumbnail` | :obj:`~pyroherd.types.StrippedThumbnail` | :obj:`~pyroherd.types.PaidMediaPreview`):
