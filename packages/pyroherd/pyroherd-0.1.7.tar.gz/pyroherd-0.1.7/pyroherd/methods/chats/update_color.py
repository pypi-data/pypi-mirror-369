...
class UpdateColor:
    async def update_color(
        ...
        Parameters:
            ...
            color (:obj:`~pyroherd.enums.ReplyColor` | :obj:`~pyroherd.enums.ProfileColor`):
                Color type.
                Pass :obj:`~pyroherd.enums.ReplyColor` to set reply color or
                :obj:`~pyroherd.enums.ProfileColor` to set profile color.
