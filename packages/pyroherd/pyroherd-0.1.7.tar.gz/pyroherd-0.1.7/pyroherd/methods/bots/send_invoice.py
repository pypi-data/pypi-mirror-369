...
import pyroherd
from pyroherd import enums, raw, utils, types
...
class SendInvoice:
    async def send_invoice(
        ...
        Parameters:
            ...
            prices (List of :obj:`~pyroherd.types.LabeledPrice`):
        ...
        Returns:
            :obj:`~pyroherd.types.Message`: On success, the sent invoice message is returned.
