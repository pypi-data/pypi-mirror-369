...
import pyroherd
from pyroherd import enums, raw, types, utils, StopTransmission
...
class SendStory:
    async def send_story(
        ...
        Parameters:
            ...
            privacy (:obj:`~pyroherd.enums.StoriesPrivacyRules`, *optional*):
                Story privacy.
                Defaults to :obj:`~pyroherd.enums.StoriesPrivacyRules.PUBLIC`

            allowed_users (List of ``int``, *optional*):
                List of user_id or chat_id of chat users who are allowed to view stories.
                Note: chat_id available only with :obj:`~pyroherd.enums.StoriesPrivacyRules.SELECTED_USERS`.
                Works with :obj:`~pyroherd.enums.StoriesPrivacyRules.CLOSE_FRIENDS`
                and :obj:`~pyroherd.enums.StoriesPrivacyRules.SELECTED_USERS` only

            disallowed_users (List of ``int``, *optional*):
                List of user_id whos disallow to view the stories.
                Note: Works with :obj:`~pyroherd.enums.StoriesPrivacyRules.PUBLIC`
                and :obj:`~pyroherd.enums.StoriesPrivacyRules.CONTACTS` only
        ...
        Returns:
            :obj:`~pyroherd.types.Story` a single story is returned.
