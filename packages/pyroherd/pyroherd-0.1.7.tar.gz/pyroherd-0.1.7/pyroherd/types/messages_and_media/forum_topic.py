...
class ForumTopic(Object):
    ...
    Parameters:
        ...
        creator (:obj:`~pyroherd.types.Chat`, *optional*):
            Topic creator.

        top_message (:obj:`~pyroherd.types.Message`, *optional*):
    ...
    @staticmethod
    def _parse(client: "pyroherd.Client", forum_topic: "raw.types.ForumTopic", messages: dict = {},  users: dict = {}, chats: dict = {}) -> "ForumTopic":
        if not forum_topic:
            return None
