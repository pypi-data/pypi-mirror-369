...
import pyroherd
from pyroherd.types.messages_and_media.message import Str
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        question_entities (List of :obj:`~pyroherd.types.MessageEntity`, *optional*):
        ...
        voter (:obj:`~pyroherd.types.User`, *optional*):
