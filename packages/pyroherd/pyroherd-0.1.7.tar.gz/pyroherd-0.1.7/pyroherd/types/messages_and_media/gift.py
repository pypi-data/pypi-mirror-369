...
class Gift(Object):
    ...
    Parameters:
        ...
        attributes (List of :obj:`~pyroherd.types.GiftAttribute`, *optional*):
        ...
        owner (:obj:`~pyroherd.types.Chat`, *optional*):
            Current gift owner.
        ...
        raw (:obj:`~pyroherd.raw.base.StarGift`, *optional*):
    ...
    async def show(self) -> bool:
        """Bound method *show* of :obj:`~pyroherd.types.Gift`.
    ...
    async def hide(self) -> bool:
        """Bound method *hide* of :obj:`~pyroherd.types.Gift`.
    ...
    async def convert(self) -> bool:
        """Bound method *convert* of :obj:`~pyroherd.types.Gift`.
    ...
    async def upgrade(self) -> bool:
        """Bound method *upgrade* of :obj:`~pyroherd.types.Gift`.
    ...
    async def transfer(self, to_chat_id: Union[int, str]) -> bool:
        """Bound method *transfer* of :obj:`~pyroherd.types.Gift`.
    ...
    async def wear(self) -> bool:
        """Bound method *wear* of :obj:`~pyroherd.types.Gift`.
