...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        created_forum_topic (:obj:`~pyroherd.types.ForumTopic`, *optional*):
            New forum topic.
            For :obj:`~pyroherd.enums.ChatEvenAction.CREATED_FORUM_TOPIC` action only.

        old_forum_topic, new_forum_topic (:obj:`~pyroherd.types.ForumTopic`, *optional*):
            Edited forum topic.
            For :obj:`~pyroherd.enums.ChatEvenAction.EDITED_FORUM_TOPIC` action only.

        deleted_forum_topic (:obj:`~pyroherd.types.ForumTopic`, *optional*):
            Deleted forum topic.
            For :obj:`~pyroherd.enums.ChatEvenAction.DELETED_FORUM_TOPIC` action only.
    """
