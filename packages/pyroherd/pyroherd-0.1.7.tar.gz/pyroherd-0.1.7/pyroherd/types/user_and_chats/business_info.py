...
class BusinessInfo(Object):
    ...
    Parameters:
        ...
        greeting_message (:obj:`~pyroherd.types.BusinessMessage`, *optional*):
            Greeting message of the business.

        away_message (:obj:`~pyroherd.types.BusinessMessage`, *optional*):
            Away message of the business.

        working_hours (:obj:`~pyroherd.types.BusinessWorkingHours`, *optional*):
