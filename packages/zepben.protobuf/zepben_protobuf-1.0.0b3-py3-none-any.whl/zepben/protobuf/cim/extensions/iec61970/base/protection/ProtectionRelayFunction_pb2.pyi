...
class ProtectionRelayFunction(_message.Message):
    __slots__ = ("psr", "model", "reclosingNull", "reclosingSet", "timeLimits", "thresholds", "relayDelayTime", "protectionKind", "protectedSwitchMRIDs", "directableNull", "directableSet", "powerDirection", "sensorMRIDs", "schemeMRIDs")
    ...
    def __init__(self, psr: _Optional[_Union[_PowerSystemResource_pb2.PowerSystemResource, _Mapping]] = ..., model: _Optional[str] = ..., reclosingNull: _Optional[_Union[_struct_pb2.NullValue, str]] = ..., reclosingSet: bool = ..., timeLimits: _Optional[_Iterable[float]] = ..., thresholds: _Optional[_Iterable[_Union[_RelaySetting_pb2.RelaySetting, _Mapping]]] = ..., relayDelayTime: _Optional[float] = ..., protectionKind: _Optional[_Union[_ProtectionKind_pb2.ProtectionKind, str]] = ..., protectedSwitchMRIDs: _Optional[_Iterable[str]] = ..., directableNull: _Optional[_Union[_struct_pb2.NullValue, str]] = ..., directableSet: bool = ..., powerDirection: _Optional[_Union[_PowerDirectionKind_pb2.PowerDirectionKind, str]] = ..., sensorMRIDs: _Optional[_Iterable[str]] = ..., schemeMRIDs: _Optional[_Iterable[str]] = ...) -> None: ...
