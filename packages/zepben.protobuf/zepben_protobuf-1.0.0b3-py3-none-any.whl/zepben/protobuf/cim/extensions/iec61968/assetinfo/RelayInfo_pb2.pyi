...
class RelayInfo(_message.Message):
    __slots__ = ("ai", "curveSetting", "recloseDelays", "recloseFastNull", "recloseFastSet")
    ...
    recloseFastSet: bool
    def __init__(self, ai: _Optional[_Union[_AssetInfo_pb2.AssetInfo, _Mapping]] = ..., curveSetting: _Optional[str] = ..., recloseDelays: _Optional[_Iterable[float]] = ..., recloseFastNull: _Optional[_Union[_struct_pb2.NullValue, str]] = ..., recloseFastSet: bool = ...) -> None: ...
