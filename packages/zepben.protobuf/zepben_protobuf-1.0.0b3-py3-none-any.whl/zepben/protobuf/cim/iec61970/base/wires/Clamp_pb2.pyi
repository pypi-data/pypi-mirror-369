...
class Clamp(_message.Message):
    __slots__ = ("ce", "lengthFromTerminal1", "acLineSegmentMRID")
    ...
    def __init__(self, ce: _Optional[_Union[_ConductingEquipment_pb2.ConductingEquipment, _Mapping]] = ..., lengthFromTerminal1: _Optional[float] = ..., acLineSegmentMRID: _Optional[str] = ...) -> None: ...
