...
class PowerTransformer(_message.Message):
    __slots__ = ("ce", "powerTransformerEndMRIDs", "vectorGroup", "transformerUtilisation", "constructionKind", "function")
    CE_FIELD_NUMBER: _ClassVar[int]
    POWERTRANSFORMERENDMRIDS_FIELD_NUMBER: _ClassVar[int]
    VECTORGROUP_FIELD_NUMBER: _ClassVar[int]
    TRANSFORMERUTILISATION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, ce: _Optional[_Union[_ConductingEquipment_pb2.ConductingEquipment, _Mapping]] = ..., powerTransformerEndMRIDs: _Optional[_Iterable[str]] = ..., vectorGroup: _Optional[_Union[_VectorGroup_pb2.VectorGroup, str]] = ..., transformerUtilisation: _Optional[float] = ..., constructionKind: _Optional[_Union[_TransformerConstructionKind_pb2.TransformerConstructionKind, str]] = ..., function: _Optional[_Union[_TransformerFunctionKind_pb2.TransformerFunctionKind, str]] = ...) -> None: ...
