...
class CurrentTransformer(_message.Message):
    __slots__ = ("sn", "coreBurden")
    SN_FIELD_NUMBER: _ClassVar[int]
    COREBURDEN_FIELD_NUMBER: _ClassVar[int]
    sn: _Sensor_pb2.Sensor
    coreBurden: int
    def __init__(self, sn: _Optional[_Union[_Sensor_pb2.Sensor, _Mapping]] = ..., coreBurden: _Optional[int] = ...) -> None: ...
