...
class Breaker(_message.Message):
    __slots__ = ("sw", "inTransitTime")
    SW_FIELD_NUMBER: _ClassVar[int]
    INTRANSITTIME_FIELD_NUMBER: _ClassVar[int]
    sw: _ProtectedSwitch_pb2.ProtectedSwitch
    inTransitTime: float
    def __init__(self, sw: _Optional[_Union[_ProtectedSwitch_pb2.ProtectedSwitch, _Mapping]] = ..., inTransitTime: _Optional[float] = ...) -> None: ...
