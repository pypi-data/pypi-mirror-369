...
class Pole(_message.Message):
    __slots__ = ("st", "streetlightMRIDs", "classification")
    ...
    classification: str
    def __init__(self, st: _Optional[_Union[_Structure_pb2.Structure, _Mapping]] = ..., streetlightMRIDs: _Optional[_Iterable[str]] = ..., classification: _Optional[str] = ...) -> None: ...
