...
class MeterReading(_message.Message):
    __slots__ = ("io", "meterMRID", "readings")
    IO_FIELD_NUMBER: _ClassVar[int]
    METERMRID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, io: _Optional[_Union[_IdentifiedObject_pb2.IdentifiedObject, _Mapping]] = ..., meterMRID: _Optional[str] = ..., readings: _Optional[_Iterable[_Union[_Reading_pb2.Reading, _Mapping]]] = ...) -> None: ...
