...
class Streetlight(_message.Message):
    __slots__ = ("at", "poleMRID", "lampKind", "lightRating")
    AT_FIELD_NUMBER: _ClassVar[int]
    POLEMRID_FIELD_NUMBER: _ClassVar[int]
    LAMPKIND_FIELD_NUMBER: _ClassVar[int]
    LIGHTRATING_FIELD_NUMBER: _ClassVar[int]
    at: _Asset_pb2.Asset
    poleMRID: str
    lampKind: _StreetlightLampKind_pb2.StreetlightLampKind
    lightRating: int
    def __init__(self, at: _Optional[_Union[_Asset_pb2.Asset, _Mapping]] = ..., poleMRID: _Optional[str] = ..., lampKind: _Optional[_Union[_StreetlightLampKind_pb2.StreetlightLampKind, str]] = ..., lightRating: _Optional[int] = ...) -> None: ...
