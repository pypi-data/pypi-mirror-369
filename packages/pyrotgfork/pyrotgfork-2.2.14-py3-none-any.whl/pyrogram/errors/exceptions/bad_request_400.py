...
class MtprotoClusterInvalid(BadRequest):
    """The mtproto 1049295266_343213 cluster is invalid."""
...
class StargiftNotOwner(BadRequest):
    """You cannot control this gift because it does not belong to you."""
...
class StargiftResellCurrencyNotAllowed(BadRequest):
    """The resell currency is not valid."""
...
class StargiftResellNotAllowed(BadRequest):
    """You cannot buy this gift. Someone else may have already bought it."""
...
class StargiftSlugInvalid(BadRequest):
    """The provided star gift slug is invalid."""
