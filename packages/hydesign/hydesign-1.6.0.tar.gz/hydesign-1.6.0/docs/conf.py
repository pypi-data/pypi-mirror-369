...
latex_documents = [
    (master_doc, 'hydesign.tex', 'hydesign Documentation',
...
man_pages = [
    (master_doc, 'hydesign', 'hydesign Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'hydesign', 'hydesign Documentation',
     author, 'hydesign', 'One line description of project.',
     'Miscellaneous'),
]
