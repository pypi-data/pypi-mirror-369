if __name__ == "__main__":
    ...
    inputs = {
        ...
        "variables": {
            ...
            #   'types':'int'
            #   },
            {"var_type": "fixed", "value": 4},
            "Nwt":
            # {'var_type':'design',
            #   'limits':[0, 400],
            #   'types':'int'
            #   },
            {"var_type": "fixed", "value": 90},
            ...
            #   },
            {"var_type": "fixed", "value": 10},
            "ptg_MW [MW]": {"var_type": "design", "limits": [1, 200], "types": "int"},
            # {'var_type':'fixed',
            #   'value': 150
            # },
            "HSS_kg [kg]": {"var_type": "design", "limits": [0, 5000], "types": "int"},
            # {'var_type':'fixed',
            #   'value': 3000
            # },
        },
