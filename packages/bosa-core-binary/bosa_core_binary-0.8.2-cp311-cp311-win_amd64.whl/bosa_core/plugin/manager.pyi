...
class PluginManager:
    ...
    def __init__(self, *, handlers: list[PluginHandler] | None = None, env_file: str | None = None, global_services: list[Any] = (), key_instance: str | None = None) -> None:
        ...
        """
    def register_plugin(self, plugin_class: type[Plugin], custom_initializer: Callable[[Plugin], None] | None = None) -> None:
        ...
        """
    async def aregister_plugin(self, plugin_class: type[Plugin], custom_initializer: Callable[[Plugin], Any] | None = None) -> None:
