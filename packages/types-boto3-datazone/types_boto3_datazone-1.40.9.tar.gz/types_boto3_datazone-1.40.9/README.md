...
Type annotations for [boto3 DataZone 1.40.9](https://pypi.org/project/boto3/)
...
list_accounts_in_account_pool_paginator: ListAccountsInAccountPoolPaginator = client.get_paginator(
