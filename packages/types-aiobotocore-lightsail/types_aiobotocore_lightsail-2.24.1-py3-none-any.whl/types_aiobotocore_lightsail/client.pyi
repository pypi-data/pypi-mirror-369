...
[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_lightsail/client/)
...
class LightsailClient(AioBaseClient):
    ...
    async def attach_disk(
        self, **kwargs: Unpack[AttachDiskRequestTypeDef]
    ) -> AttachDiskResultTypeDef:
        """
    ...
    async def create_disk(
        self, **kwargs: Unpack[CreateDiskRequestTypeDef]
    ) -> CreateDiskResultTypeDef:
        """
    ...
    async def delete_alarm(
        self, **kwargs: Unpack[DeleteAlarmRequestTypeDef]
    ) -> DeleteAlarmResultTypeDef:
        """
        Deletes an alarm.
    ...
    async def delete_disk(
        self, **kwargs: Unpack[DeleteDiskRequestTypeDef]
    ) -> DeleteDiskResultTypeDef:
        """
    ...
    async def detach_disk(
        self, **kwargs: Unpack[DetachDiskRequestTypeDef]
    ) -> DetachDiskResultTypeDef:
        """
    ...
    async def get_alarms(self, **kwargs: Unpack[GetAlarmsRequestTypeDef]) -> GetAlarmsResultTypeDef:
        """
    ...
    async def get_buckets(
        self, **kwargs: Unpack[GetBucketsRequestTypeDef]
    ) -> GetBucketsResultTypeDef:
        """
    ...
    async def get_bundles(
        self, **kwargs: Unpack[GetBundlesRequestTypeDef]
    ) -> GetBundlesResultTypeDef:
        """
    ...
    async def get_disk(self, **kwargs: Unpack[GetDiskRequestTypeDef]) -> GetDiskResultTypeDef:
        """
    ...
    async def get_disks(self, **kwargs: Unpack[GetDisksRequestTypeDef]) -> GetDisksResultTypeDef:
        """
    ...
    async def get_domain(self, **kwargs: Unpack[GetDomainRequestTypeDef]) -> GetDomainResultTypeDef:
        """
    ...
    async def get_domains(
        self, **kwargs: Unpack[GetDomainsRequestTypeDef]
    ) -> GetDomainsResultTypeDef:
        """
    ...
    async def get_key_pair(
        self, **kwargs: Unpack[GetKeyPairRequestTypeDef]
    ) -> GetKeyPairResultTypeDef:
        """
    ...
    async def get_regions(
        self, **kwargs: Unpack[GetRegionsRequestTypeDef]
    ) -> GetRegionsResultTypeDef:
        """
    ...
    async def put_alarm(self, **kwargs: Unpack[PutAlarmRequestTypeDef]) -> PutAlarmResultTypeDef:
        """
    ...
    async def test_alarm(self, **kwargs: Unpack[TestAlarmRequestTypeDef]) -> TestAlarmResultTypeDef:
        """
