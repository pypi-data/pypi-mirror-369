...
version_file = 'agentfactory/version.py'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        keywords='Agent, Reinforcement Learning, Tool Learning, LLM, Multimodal',
        url='https://github.com/wangxingjun778/AgentFactory',
        ...
        entry_points={
            'console_scripts': ['agentfactory=agentfactory.cli.cli:run_cmd']
        },
