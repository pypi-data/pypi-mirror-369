...
class _RankingStatPDF(object):
    ...
    def from_xml(cls, xml, name):
        ...
        self.segments = ligolw.Param.get_param(xml, "segments").value.strip()
        self.segments = \
...
def _get_event_ln_likelihood_ratio_svd_endtime_mass(coinc_bytes):
    coinc_xmldoc = ligolw_utils.load_fileobj(io.BytesIO(coinc_bytes))
