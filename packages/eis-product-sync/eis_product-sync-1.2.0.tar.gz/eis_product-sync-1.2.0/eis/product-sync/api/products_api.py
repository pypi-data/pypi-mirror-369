...
from eis.product-sync.api_client import ApiClient, Endpoint as _Endpoint
...
class ProductsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_environments_endpoint = _Endpoint(
            settings={
                'response_type': (ListEnvironmentsResponseClass,),
                'auth': [
                    'bearer'
                ],
