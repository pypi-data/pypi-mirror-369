...
class ListEnvironmentsResponseClass(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([EnvironmentClass],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, items, *args, **kwargs):  # noqa: E501
        """ListEnvironmentsResponseClass - a model defined in OpenAPI

        Args:
            items ([EnvironmentClass]): Environments.
