...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-directconnect)](https://pypistats.org/packages/mypy-boto3-directconnect)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 DirectConnect 1.40.10](https://pypi.org/project/boto3/) compatible with
...
`mypy-boto3-directconnect` dependency in production. However, there is an issue
