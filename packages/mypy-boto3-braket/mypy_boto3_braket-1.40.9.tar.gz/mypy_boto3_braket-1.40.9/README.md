...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-braket)](https://pypistats.org/packages/mypy-boto3-braket)
...
`mypy-boto3-braket` dependency in production. However, there is an issue in
