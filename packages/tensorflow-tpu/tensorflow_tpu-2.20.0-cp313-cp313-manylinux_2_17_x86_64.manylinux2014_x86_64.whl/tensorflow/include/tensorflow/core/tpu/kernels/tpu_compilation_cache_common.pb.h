...
#ifndef GOOGLE_PROTOBUF_INCLUDED_tensorflow_2fcore_2ftpu_2fkernels_2ftpu_5fcompilation_5fcache_5fcommon_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_tensorflow_2fcore_2ftpu_2fkernels_2ftpu_5fcompilation_5fcache_5fcommon_2eproto_2epb_2eh
...
PROTOBUF_EXPORT extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_tensorflow_2fcore_2ftpu_2fkernels_2ftpu_5fcompilation_5fcache_5fcommon_2eproto;
...
PROTOBUF_EXPORT bool CompilationCacheFetchTarget_IsValid(int value);
PROTOBUF_EXPORT extern const uint32_t CompilationCacheFetchTarget_internal_data_[];
constexpr CompilationCacheFetchTarget CompilationCacheFetchTarget_MIN = static_cast<CompilationCacheFetchTarget>(0);
constexpr CompilationCacheFetchTarget CompilationCacheFetchTarget_MAX = static_cast<CompilationCacheFetchTarget>(3);
constexpr int CompilationCacheFetchTarget_ARRAYSIZE = 3 + 1;
PROTOBUF_EXPORT const ::google::protobuf::EnumDescriptor*
CompilationCacheFetchTarget_descriptor();
template <typename T>
...
inline const std::string& CompilationCacheFetchTarget_Name(CompilationCacheFetchTarget value) {
  return ::google::protobuf::internal::NameOfDenseEnum<CompilationCacheFetchTarget_descriptor,
                                                 0, 3>(
      static_cast<int>(value));
}
inline bool CompilationCacheFetchTarget_Parse(absl::string_view name, CompilationCacheFetchTarget* value) {
...
/* @@protoc_insertion_point(class_definition:tensorflow.tpu.TpuCompilationUidAndIndex) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TpuCompilationUidAndIndex(
  ...
  TpuCompilationUidAndIndex* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 protected:
  explicit TpuCompilationUidAndIndex(::google::protobuf::Arena* arena);
  TpuCompilationUidAndIndex(::google::protobuf::Arena* arena, const TpuCompilationUidAndIndex& from);
  TpuCompilationUidAndIndex(::google::protobuf::Arena* arena, TpuCompilationUidAndIndex&& from) noexcept
...
/* @@protoc_insertion_point(class_definition:tensorflow.tpu.GetTpuProgramRequest) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR GetTpuProgramRequest(
      ::google::protobuf::internal::ConstantInitialized);
  ...
  GetTpuProgramRequest* New(::google::protobuf::Arena* arena = nullptr) const PROTOBUF_FINAL {
 ...
 protected:
  explicit GetTpuProgramRequest(::google::protobuf::Arena* arena);
  GetTpuProgramRequest(::google::protobuf::Arena* arena, const GetTpuProgramRequest& from);
  GetTpuProgramRequest(::google::protobuf::Arena* arena, GetTpuProgramRequest&& from) noexcept
 ...
 public:
  ...
  void set_allocated_uid_and_index(::tensorflow::tpu::TpuCompilationUidAndIndex* value);
  void unsafe_arena_set_allocated_uid_and_index(::tensorflow::tpu::TpuCompilationUidAndIndex* value);
...
inline PROTOBUF_ALWAYS_INLINE void GetTpuProgramRequest::set_key(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (key_oneof_case() != kKey) {
    clear_key_oneof();
...
inline std::string* GetTpuProgramRequest::mutable_key() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void GetTpuProgramRequest::set_allocated_key(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (has_key_oneof()) {
    clear_key_oneof();
  }
...
inline void GetTpuProgramRequest::unsafe_arena_set_allocated_uid_and_index(::tensorflow::tpu::TpuCompilationUidAndIndex* value) {
...
inline ::tensorflow::tpu::TpuCompilationUidAndIndex* GetTpuProgramRequest::mutable_uid_and_index() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_tensorflow_2fcore_2ftpu_2fkernels_2ftpu_5fcompilation_5fcache_5fcommon_2eproto_2epb_2eh
