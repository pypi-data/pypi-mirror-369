...
class PatchedcontainerContainerPullThroughRemote(BaseModel):
    """
    ...
    includes: Optional[List[Annotated[str, Field(min_length=1, strict=True, max_length=255)]]] = Field(default=None, description="             A list of remotes to include during pull-through caching.             Wildcards *, ? are recognized.             'includes' is evaluated before 'excludes'.             ")
    excludes: Optional[List[Annotated[str, Field(min_length=1, strict=True, max_length=255)]]] = Field(default=None, description="             A list of remotes to exclude during pull-through caching.             Wildcards *, ? are recognized.             'excludes' is evaluated after 'includes'.             ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedcontainerContainerPullThroughRemote from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedcontainerContainerPullThroughRemote from a dict"""
        if obj is None:
            return None
