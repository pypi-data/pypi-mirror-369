...
class PatchedcontainerContainerRepository(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "name", "description", "retain_repo_versions", "remote", "manifest_signing_service"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedcontainerContainerRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedcontainerContainerRepository from a dict"""
        if obj is None:
            return None
