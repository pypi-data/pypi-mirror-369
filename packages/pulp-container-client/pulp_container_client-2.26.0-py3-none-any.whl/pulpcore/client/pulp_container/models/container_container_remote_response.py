...
class ContainerContainerRemoteResponse(BaseModel):
    """
    ...
    upstream_name: StrictStr = Field(description="Name of the upstream repository")
    include_tags: Optional[List[Annotated[str, Field(strict=True, max_length=255)]]] = Field(default=None, description="             A list of tags to include during sync.             Wildcards *, ? are recognized.             'include_tags' is evaluated before 'exclude_tags'.             ")
    exclude_tags: Optional[List[Annotated[str, Field(strict=True, max_length=255)]]] = Field(default=None, description="             A list of tags to exclude during sync.             Wildcards *, ? are recognized.             'exclude_tags' is evaluated after 'include_tags'.             ")
    sigstore: Optional[StrictStr] = Field(default=None, description="A URL to a sigstore to download image signatures from")
    __properties: ClassVar[List[str]] = ["pulp_href", "prn", "pulp_created", "pulp_last_updated", "name", "url", "ca_cert", "client_cert", "tls_validation", "proxy_url", "pulp_labels", "download_concurrency", "max_retries", "policy", "total_timeout", "connect_timeout", "sock_connect_timeout", "sock_read_timeout", "headers", "rate_limit", "hidden_fields", "upstream_name", "include_tags", "exclude_tags", "sigstore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContainerContainerRemoteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContainerContainerRemoteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hidden_fields": [ContainerContainerPullThroughRemoteResponseHiddenFieldsInner.from_dict(_item) for _item in obj["hidden_fields"]] if obj.get("hidden_fields") is not None else None,
            "upstream_name": obj.get("upstream_name"),
            "include_tags": obj.get("include_tags"),
            "exclude_tags": obj.get("exclude_tags"),
            "sigstore": obj.get("sigstore")
        })
        return _obj
