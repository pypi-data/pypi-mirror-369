...
class ContainerContainerRemote(BaseModel):
    """
    ...
    upstream_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the upstream repository")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContainerContainerRemote from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContainerContainerRemote from a dict"""
        if obj is None:
            return None
