...
class ContainerContainerPullThroughDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "name", "content_guard", "repository", "pulp_labels", "base_path", "pulp_created", "prn", "pulp_href", "no_content_change_since", "hidden", "remote", "distributions", "namespace", "private", "description"]
