...
class ResGradients:
    """A class dedicated to managing gradient values. A variational quantum circuit ansatz uses a set of parameters to generate a quantum circuit, which yields an expectation value under a given Hamiltonian. These gradient values correspond to this set of parameter values, the ansatz, and the Hamiltonian."""
    def __init__(self, *args, **kwargs) -> None:
        """Initialize self.  See help(type(self)) for accurate signature."""
    @overload
...
class ResGradientsAndExpectation:
    """A class dedicated to managing gradient values and expectation values. A variational quantum circuit ansatz uses a set of parameters to generate a quantum circuit, which yields an expectation value under a Hamiltonian. These gradient values and expectation values correspond to this set of parameter values, the ansatz, and the Hamiltonian."""
    def __init__(self, *args, **kwargs) -> None:
        """Initialize self.  See help(type(self)) for accurate signature."""
    @overload
    def at(self, idx_s: list[int]) -> float:
...
class ResNGradients:
    """A class dedicated to managing gradient values. A variational quantum circuit ansatz uses N groups of parameters to generate N quantum circuits, which yield N expectation values under a single Hamiltonian. These gradient values consist of N groups, corresponding to the N groups of parameter values, the ansatz, and the Hamiltonian."""
    def __init__(self, *args, **kwargs) -> None:
        """Initialize self.  See help(type(self)) for accurate signature."""
    @overload
...
class ResNResGradientsAndExpectation:
    """A class dedicated to managing gradient values and expectation values. A variational quantum circuit ansatz uses N groups of parameters to generate N quantum circuits. These N quantum circuits yield N expectation values under a single Hamiltonian. There are a total of N groups of gradient values and N expectation values, corresponding to these N groups of parameter values, the ansatz, and the Hamiltonian."""
    def __init__(self, *args, **kwargs) -> None:
        """Initialize self.  See help(type(self)) for accurate signature."""
    @overload
