...
from llamphouse.core.workers import ThreadWorker # AsyncWorker is the other option
...
def main():
    ...
    llamphouse = LLAMPHouse(assistants=[my_assistant], worker=ThreadWorker(thread_count=5))
