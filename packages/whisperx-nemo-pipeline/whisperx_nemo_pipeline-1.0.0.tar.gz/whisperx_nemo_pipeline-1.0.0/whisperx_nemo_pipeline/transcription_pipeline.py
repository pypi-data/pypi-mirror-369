...
import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'vendor', 'ctc-forced-aligner'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'vendor', 'deepmultilingualpunctuation'))
