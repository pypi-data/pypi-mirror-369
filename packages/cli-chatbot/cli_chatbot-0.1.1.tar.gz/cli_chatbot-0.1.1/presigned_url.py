...
def generate_presigned_url(
    ...
    Args:
        ...
        expiration (int): Time in seconds before the presigned URL expires. Default is 28800 (8 hours)
        url_type (str): Type of URL to generate - 'put' for upload, 'get' for download
        region_name (str): AWS region name. Default is 'eu-central-1'
    ...
    try:
        ...
        # Remove None values to avoid passing empty credentials
