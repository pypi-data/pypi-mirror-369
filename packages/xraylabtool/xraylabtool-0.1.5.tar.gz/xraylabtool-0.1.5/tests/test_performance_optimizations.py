...
class TestInterpolatorCaching:
    ...
    def test_interpolator_caching_performance(self):
        ...
        try:
            ...
            pytest.skip("Silicon .nff file not available for interpolator performance testing")
    ...
    def test_initialize_element_paths_functionality(self):
        ...
        try:
            ...
            if original_available:
                ...
                common_elements = set(original_available.keys()) & set(_AVAILABLE_ELEMENTS.keys())
...
class TestEnhancedCacheManagement:
    ...
    def test_cache_clearing_comprehensive(self):
        ...
        try:
            ...
            pytest.skip("Required .nff files not available for comprehensive cache testing")
...
class TestPerformanceRegression:
    ...
    def test_optimization_speedup_measurable(self):
        ...
        try:
            ...
            np.testing.assert_allclose(result1.Dispersion, result2.Dispersion, rtol=1e-12)
            np.testing.assert_allclose(result1.Absorption, result2.Absorption, rtol=1e-12)
            ...
            print(f"Cache speedup: {speedup:.1f}x (cold: {cold_time*1000:.2f}ms, warm: {warm_time*1000:.2f}ms)")
