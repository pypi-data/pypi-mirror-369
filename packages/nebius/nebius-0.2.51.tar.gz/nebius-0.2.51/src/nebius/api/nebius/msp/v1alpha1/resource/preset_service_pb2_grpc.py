...
from nebius.api.nebius.msp.v1alpha1.resource import preset_service_pb2 as nebius_dot_msp_dot_v1alpha1_dot_resource_dot_preset__service__pb2
...
def add_PresetServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=nebius_dot_msp_dot_v1alpha1_dot_resource_dot_preset__service__pb2.ListPresetsRequest.FromString,
                    response_serializer=nebius_dot_msp_dot_v1alpha1_dot_resource_dot_preset__service__pb2.ListPresetsResponse.SerializeToString,
            ),
    }
