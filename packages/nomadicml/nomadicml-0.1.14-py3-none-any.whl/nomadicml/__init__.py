...
__version__ = "0.1.14"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "f59428c"      # This will hold the commit hash or full build string, populated by CI
