...
def build_file_list(dataset: str, veto_regions: List[str] = ["BR", "RU", "LB", "US"], veto_tape: bool = True, veto_tier: List[str] = ["T3"], max_workers: int = None, redirector: str = "root://xrootd-cms.infn.it//"):
