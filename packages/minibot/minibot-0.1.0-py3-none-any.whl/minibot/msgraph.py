...
class Outlook:
    ...
    def send_mail(self, from_mail, to, subject, body, attachment=None, cc=None, bcc=None, replayto=None):
        """
    ...
    def send_meeting(self, from_mail, attendee, subject, starts, ends, place, body):
        try:
            attendees = list()
