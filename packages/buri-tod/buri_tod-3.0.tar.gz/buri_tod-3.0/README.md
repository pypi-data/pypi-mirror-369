...
**Command**:
```bash
buri create <file_path> --password <your_password>
```

**Example**:
```bash
buri create shell.php --password mysecretpassword
```
...
**Command**:
```bash
buri run <url> --password <your_password>
```

**Example**:
```bash
buri run https://example.com/uploads/shell.php --password mysecretpassword
```
