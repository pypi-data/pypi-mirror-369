...
def test_variable_injection():
    input_path = os.path.join(TESTS_DIR, 'test_variables/variable_injection', 'sub_config.yaml')
    expected_path = os.path.join(TESTS_DIR, 'test_variables/variable_injection', 'result_config.yaml')
    variable_injection = {
        'var1' : "injected_value",
        'var2' : {
            'subkey1' : "sub_value1",
