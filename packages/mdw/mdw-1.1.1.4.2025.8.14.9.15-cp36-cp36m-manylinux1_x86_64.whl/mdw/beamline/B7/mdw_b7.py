...
detectorWorkerEntity = { "worker_name" : "detectorWorker_autoroi",
                         ...
                         "args": f"--name detectorWorker_autoroi --ip {detectorWorkerIP} --port {detectorWorkerPort}  --outputs {alignWorkerIP}:{alignWorkerPort0}",
...
alignWorkerEntity = { "worker_name" : "alignWorkerStop",
                         ...
                         "args": f"--name alignWorkerStop --log-level=DEBUG --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
...
alignWorkerEntity1 = { "worker_name" : "alignWorkerStopAck",
                      "command": "alignWorkerStopAck",
                      #"args": f"--name alignWorkerStopAck --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','sequence'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
                      #"args": f"--name alignWorkerStopAck --log-level=DEBUG --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','sequence'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
                      #"args": f"--name alignWorkerStopAck --log-level=DEBUG --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','sequence'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
                      #"args": f"--name alignWorkerStopAck --log-level=DEBUG --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','sequence','step'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
                      "args": f"--name alignWorkerStopAck --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','sequence','step'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
                      #"args": f"--name detectorWorker --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort} ",
                      "hostname": mdwIP,
                      "username": mdwUserName,
                      "password": mdwPassword,
                      "function": mdw.core.mdw_network.AlignWorkerStopRunAck
                      }
workers.append(alignWorkerEntity1)
