...
alignWorkerEntity = { "worker_name" : "alignWorkerStop",
                         ...
                         "args": f"--name alignWorkerStop --log-level=DEBUG --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','oneD','twoD'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
...
alignWorkerEntity_xbpm = { "worker_name" : "alignWorkerStop",
                         "command": "alignWorkerStop",
                         #"args": f"--name detectorWorker --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort} {mambaIP}:{mambaPort}",
                         "args": f"--name alignWorkerStop --log-level=DEBUG --input {alignWorkerIP}:{alignWorkerPort_xbpm} --outputs {storageWorkerIP}:{storageWorkerPort}:['Tomography','Count','oneD','twoD'] {mambaIP}:{mambaPort} --process ~/.mdw:average",
                         #"args": f"--name detectorWorker --input {alignWorkerIP}:{alignWorkerPort0} {alignWorkerIP}:{alignWorkerPort1} --outputs {storageWorkerIP}:{storageWorkerPort} ",
                         "hostname": mdwIP,
                         "username": mdwUserName,
                         "password": mdwPassword,
...
#只接收 xbpm数据
workers.append(alignWorkerEntity_xbpm)
