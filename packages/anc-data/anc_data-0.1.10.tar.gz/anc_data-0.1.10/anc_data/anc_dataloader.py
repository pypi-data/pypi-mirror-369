...
from anc_data.anc_dataset import AncDataset
...
class AncDataLoader:
    ...
    def __init__(
        ...
        self.ds_read_counts = [0] * len(paths)
    ...
    def __next__(self):
        ...
        if "_ds_idx" in data:
            for idx in data["_ds_idx"]:
                assert 0 <= idx < len(self.ds_read_counts)
    ...
    def __getstate__(self):
        ...
        state["ds_read_counts"] = self.ds_read_counts[:]  # Create a copy of the array
        return state
