...
#
    ...
    def IsFrame(self)->bool:
        ...
        """
        GetDllLibDoc().Paragraph_get_IsFrame.argtypes=[c_void_p]
        GetDllLibDoc().Paragraph_get_IsFrame.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Paragraph_get_IsFrame,self.Ptr)
        return ret
