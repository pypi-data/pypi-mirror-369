...
class ListLevel (  DocumentSerializable) :
    ...
    def ToString(self)->str:
        ...
        :return: str
        """
        GetDllLibDoc().ListLevel_ToString.argtypes=[c_void_p]
        GetDllLibDoc().ListLevel_ToString.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().ListLevel_ToString,self.Ptr))
        return ret
