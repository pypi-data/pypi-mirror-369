...
class AxisBound (SpireObject) :
    ...
    def __init__(self, dateTime: DateTime):
        ...
        Args:
            dateTime (DateTime): The dateTime to create the AxisBound from.
    ...
    def ToString(self)->str:
        ...
        GetDllLibDoc().AxisBound_ToString.restype=c_wchar_p
        ret = CallCFunction(GetDllLibDoc().AxisBound_ToString,self.Ptr)
        return ret
