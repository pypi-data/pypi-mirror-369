...
class DocumentObjectCollection (  DocumentSerializableCollection, IDocumentObjectCollection) :
    ...
    def FirstItem(self)->'DocumentObject':
        ...
        GetDllLibDoc().DocumentObjectCollection_get_FirstItem.restype=IntPtrWithTypeName
    ...
    def LastItem(self)->'DocumentObject':
        ...
        GetDllLibDoc().DocumentObjectCollection_get_LastItem.restype=IntPtrWithTypeName
