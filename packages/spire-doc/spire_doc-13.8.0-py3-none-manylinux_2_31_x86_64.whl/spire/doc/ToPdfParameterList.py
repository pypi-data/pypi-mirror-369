...
class ToPdfParameterList (SpireObject) :
    ...
    @property
    def PreserveFormFields(self)->bool:
        """

        """
        GetDllLibDoc().ToPdfParameterList_get_PreserveFormFields.argtypes=[c_void_p]
        GetDllLibDoc().ToPdfParameterList_get_PreserveFormFields.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().ToPdfParameterList_get_PreserveFormFields,self.Ptr)
        return ret

    @PreserveFormFields.setter
    def PreserveFormFields(self, value:bool):
        GetDllLibDoc().ToPdfParameterList_set_PreserveFormFields.argtypes=[c_void_p, c_bool]
        CallCFunction(GetDllLibDoc().ToPdfParameterList_set_PreserveFormFields,self.Ptr, value)
