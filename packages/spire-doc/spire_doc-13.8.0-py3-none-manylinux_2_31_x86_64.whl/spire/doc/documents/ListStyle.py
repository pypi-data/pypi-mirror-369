...
class ListStyle (  Style, IStyle) :
    ...
    def ToString(self)->str:
        ...
        :return: str
        """
        GetDllLibDoc().ListStyle_ToString.argtypes=[c_void_p]
        GetDllLibDoc().ListStyle_ToString.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().ListStyle_ToString,self.Ptr))
        return ret
