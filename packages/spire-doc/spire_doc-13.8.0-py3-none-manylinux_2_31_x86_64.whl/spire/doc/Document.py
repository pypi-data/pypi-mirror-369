...
class Document (  DocumentContainer, IDocument, ICompositeObject) :
    ...
    @property
    def DefaultSubstitutionFontName(self)->str:
        """
        Gets the default substitution font Name.
        """
        GetDllLibDoc().Document_get_DefaultSubstitutionFontName.argtypes=[c_void_p]
        GetDllLibDoc().Document_get_DefaultSubstitutionFontName.restype=c_void_p
        ret = PtrToStr(CallCFunction(GetDllLibDoc().Document_get_DefaultSubstitutionFontName,self.Ptr))
        return ret

    @DefaultSubstitutionFontName.setter
    def DefaultSubstitutionFontName(self, value:str):
        """
        Sets the default substitution font Name.
        """
        valuePtr = StrToPtr(value)
        GetDllLibDoc().Document_set_DefaultSubstitutionFontName.argtypes=[c_void_p, c_char_p]
        CallCFunction(GetDllLibDoc().Document_set_DefaultSubstitutionFontName,self.Ptr, valuePtr)
...
#        return ret
    ...
    def UpdateWordCount(self ,splitchar:list):
        """
    <summary>
        Update Paragraphs count, Word count and Character count.
    </summary>
    <param name="splitchar">The word separator. </param>
        ...
        ArrayTypesplitchar = c_char_p * countsplitchar
        arraysplitchar = ArrayTypesplitchar()
        for i in range(0, countsplitchar):
            arraysplitchar[i] = StrToPtr(splitchar[i])
        
        GetDllLibDoc().Document_UpdateWordCountS.argtypes=[c_void_p ,ArrayTypesplitchar, c_int]
        CallCFunction(GetDllLibDoc().Document_UpdateWordCountS,self.Ptr, arraysplitchar, countsplitchar)
...
#        GetDllLibDoc().Document_UpdateWordCountSI(self.Ptr, arraysplitchar,includeTbFnEn)
    ...
    def ReplaceInLine(self ,pattern:Regex, newValue:str)->int:
        ...
        intPtrpattern:c_void_p = pattern.Ptr
        newValuePtr = StrToPtr(newValue)
        GetDllLibDoc().Document_ReplaceInLinePN.argtypes=[c_void_p, c_void_p,c_char_p]
        GetDllLibDoc().Document_ReplaceInLinePN.restype=c_int
        ret =  CallCFunction(GetDllLibDoc().Document_ReplaceInLinePN,self.Ptr, intPtrpattern,newValuePtr)
        return ret
...
#        return ret
    ...
    def IntegrateFontTableTo(self ,destDoc:'Document'):
        """
    <summary>
    ...
    <param name="destDoc">The destination document.</param>
        ...
        GetDllLibDoc().Document_IntegrateFontTableTo.argtypes=[c_void_p ,c_void_p]
        CallCFunction(GetDllLibDoc().Document_IntegrateFontTableTo,self.Ptr, intPtrdestDoc)
    ...
    <summary>
        ...
        """
        GetDllLibDoc().Document_Unprotect.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().Document_Unprotect,self.Ptr)
    ...
    def Unprotect(self ,password:str)->bool:
        ...
        """
        passwordPtr = StrToPtr(password)
        GetDllLibDoc().Document_UnprotectP.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibDoc().Document_UnprotectP.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Document_UnprotectP,self.Ptr, passwordPtr)
        return ret

    @dispatch

    def SetWriteProtection(self ,password:str):
        """
        <summary>
        ...
        """
        passwordPtr = StrToPtr(password)
        GetDllLibDoc().Document_SetWriteProtection.argtypes=[c_void_p ,c_char_p]
        CallCFunction(GetDllLibDoc().Document_SetWriteProtection,self.Ptr, passwordPtr)

    @dispatch

    def SetWriteProtection(self ,password:str,recommended:bool):
        """
        <summary>
        ...
        """
        passwordPtr = StrToPtr(password)
        GetDllLibDoc().Document_SetWriteProtectionPR.argtypes=[c_void_p ,c_char_p,c_bool]
        CallCFunction(GetDllLibDoc().Document_SetWriteProtectionPR,self.Ptr, passwordPtr,recommended)
    @dispatch
    def UnWriteProtection(self):
        """
        <summary>
            Removes the write protection from a document by clearing the password and disabling the read-only recommendation.
        </summary>
        """
        GetDllLibDoc().Document_UnWriteProtection.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().Document_UnWriteProtection,self.Ptr)

    @dispatch

    def UnWriteProtection(self ,password:str)->bool:
        """
        <summary>
        ...
        """
        passwordPtr = StrToPtr(password)
        GetDllLibDoc().Document_UnWriteProtectionP.argtypes=[c_void_p ,c_char_p]
        GetDllLibDoc().Document_UnWriteProtectionP.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Document_UnWriteProtectionP,self.Ptr, passwordPtr)
        return ret

    def HasWriteProtection(self)->bool:
        """
        <summary>
            Checks if the document has write protection.
        </summary>
        """
        GetDllLibDoc().Document_HasWriteProtection.argtypes=[c_void_p]
        GetDllLibDoc().Document_HasWriteProtection.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Document_HasWriteProtection,self.Ptr)
        return ret
    ...
    def IsEncrypted(fileName:str)->bool:
        """
        <summary>
        ...
        """
        fileNamePtr = StrToPtr(fileName)
        GetDllLibDoc().Document_IsEncrypted.argtypes=[ c_char_p]
        GetDllLibDoc().Document_IsEncrypted.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Document_IsEncrypted, fileNamePtr)
        return ret

    @staticmethod
    @dispatch

    def IsEncrypted(stream:Stream)->bool:
        """
        <summary>
            Check that the document is encrypted
        </summary>
        ...
        GetDllLibDoc().Document_IsEncryptedS.argtypes=[ c_void_p]
        GetDllLibDoc().Document_IsEncryptedS.restype=c_bool
        ret = CallCFunction(GetDllLibDoc().Document_IsEncryptedS, intPtrstream)
        return ret
...
#
    ...
    @PrivateFontList.setter
    def PrivateFontList(self, fontPathList:List[PrivateFontPath]):
        """
        Sets the private font list.
        """
        ...
        GetDllLibDoc().Document_set_PrivateFontList.argtypes=[c_void_p, ArrayFontPaths,c_int]
        CallCFunction(GetDllLibDoc().Document_set_PrivateFontList,self.Ptr, arrayFontPaths,countFontPath)
...
#
    ...
    def Watermark(self)->'WatermarkBase':
        ...
        GetDllLibDoc().Document_get_Watermark.restype = IntPtrWithTypeName
        intPtr = CallCFunction(GetDllLibDoc().Document_get_Watermark,self.Ptr)
        ret = None if intPtr==None else self._createWatermarkBase(intPtr)
        return ret

    def _createWatermarkBase(self,intPtrWithTypeName:IntPtrWithTypeName)->'WatermarkBase':
