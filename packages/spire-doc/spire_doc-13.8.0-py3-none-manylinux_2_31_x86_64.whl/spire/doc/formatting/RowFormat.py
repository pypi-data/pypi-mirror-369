...
class RowFormat (  WordAttrCollection) :
    ...
    def BackColor(self)->'Color':
        ...
        """
        warnings.warn("This attribute has been deprecated, please call the 'TableCell.CellFormat.Shading.BackgroundPatternColor' attribute.", DeprecationWarning)
    ...
    def Paddings(self)->'Paddings':
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.Paddings' property.", DeprecationWarning)
    ...
    def CellSpacing(self)->float:
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.CellSpacing' property.", DeprecationWarning)
    ...
    def LeftIndent(self)->float:
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.LeftIndent' property.", DeprecationWarning)
    ...
    def IsAutoResized(self)->bool:
        ...
        """
        warnings.warn("'RowFormat.IsAutoResized' has been deprecated. If you want to set the preferred width of the table, please investigate the use of Table.PreferredWidth instead.", DeprecationWarning)
    ...
    def ClearFormatting(self):
        GetDllLibDoc().RowFormat_ClearFormatting.argtypes=[c_void_p]
        CallCFunction(GetDllLibDoc().RowFormat_ClearFormatting,self.Ptr)
    ...
    def Bidi(self)->bool:
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.Bidi' property.", DeprecationWarning)
    ...
    def HorizontalAlignment(self)->'RowAlignment':
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.HorizontalAlignment' property.", DeprecationWarning)
    ...
    def WrapTextAround(self)->bool:
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.WrapTextAround' property.", DeprecationWarning)
    ...
    def Positioning(self)->'TablePositioning':
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.Positioning' property.", DeprecationWarning)
    ...
    def LayoutType(self)->'LayoutType':
        ...
        """
        warnings.warn("This property is deprecated. Please call the 'Table.Format.LayoutType' property.", DeprecationWarning)
