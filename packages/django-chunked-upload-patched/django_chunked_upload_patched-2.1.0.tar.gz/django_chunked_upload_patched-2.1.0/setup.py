...
download_url = (
    'https://github.com/Forchapeatl/django-chunked-upload-patched/tarball/%s'
)

setup(
    name='django-chunked-upload-patched',
    ...
    url='https://github.com/Forchapeatl/django-chunked-upload-patched',
