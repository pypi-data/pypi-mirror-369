def generate_gnuplot_script(
    ...
    script = (
        ...
        f"set xlabel '{xlabel or 'X'}'{f' offset {xl_off_x},{xl_off_y}' if xl_off_x is not None and xl_off_y is not None else ''}\n"
        f"set ylabel '{ylabel or 'Y'}'{f' offset {yl_off_x},{yl_off_y}' if yl_off_x is not None and yl_off_y is not None else ''}\n"
