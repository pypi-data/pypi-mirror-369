-1/144*(deltaI*(m12 - ma^2 - mpi0^2)*(m12 - meta^2 - mpi0^2)*
   (2*(5*Sqrt[2]*CoefA*thetapi - Sqrt[2]*CoefC*thetapi + Sqrt[2]*CoefD*thetapi + 2*CoefA*thetaprpi - 
      CoefC*thetaprpi + 4*CoefD*thetaprpi)*Cos[thetas] + 
    (8*CoefA*thetapi - 4*CoefC*thetapi - 4*CoefD*thetapi - 2*Sqrt[2]*CoefA*thetaprpi - 
      5*Sqrt[2]*CoefC*thetaprpi - 8*Sqrt[2]*CoefD*thetaprpi)*Sin[thetas])*
   (2*(2*Sqrt[2]*CoefA*deltaI*thetaALP*thetapi + 3*Sqrt[2]*CoefB*deltaI*thetaALP*thetapi - 
     ...
     Cos[thetas] - (-8*CoefA*deltaI*thetaALP*thetapi + 12*CoefB*deltaI*thetaALP*thetapi + 
     ...
     Sin[thetas])*UnitStep[-m12 + 4*mKplus^2])/(m12 + I*(Gammasigma + I*msigma)*msigma) + ((m23 - ma^2 - meta^2)*(m23 - 2*mpi0^2)*(Sqrt[2]*(CoefA - CoefB)*Cos[thetas] + 2*CoefB*Sin[thetas])*
  ...
  UnitStep[-m23 + 4*mKplus^2])/(24*(m23 + I*(Gammasigma + I*msigma)*msigma)) + (deltaI*(m12 + m23 - ma^2 - mpi0^2)*(m12 + m23 - meta^2 - mpi0^2)*
  (2*(5*Sqrt[2]*CoefA*thetapi - Sqrt[2]*CoefC*thetapi + Sqrt[2]*CoefD*thetapi + 2*CoefA*thetaprpi - 
     CoefC*thetaprpi + 4*CoefD*thetaprpi)*Cos[thetas] + 
   (8*CoefA*thetapi - 4*CoefC*thetapi - 4*CoefD*thetapi - 2*Sqrt[2]*CoefA*thetaprpi - 
     5*Sqrt[2]*CoefC*thetaprpi - 8*Sqrt[2]*CoefD*thetaprpi)*Sin[thetas])*
  (2*(2*Sqrt[2]*CoefA*deltaI*thetaALP*thetapi + 3*Sqrt[2]*CoefB*deltaI*thetaALP*thetapi - 
    ...
    Cos[thetas] - (-8*CoefA*deltaI*thetaALP*thetapi + 12*CoefB*deltaI*thetaALP*thetapi + 
     ...
     4*cg*CoefB*(-(Sqrt[6]*deltaI*thetapi) + 2*Sqrt[3]*deltaI*thetaprpi + 
       kappau*(-3 + 2*Sqrt[6]*deltaI*thetapi - Sqrt[3]*deltaI*thetaprpi) + 
       kappad*(3 + 2*Sqrt[6]*deltaI*thetapi - Sqrt[3]*deltaI*thetaprpi)) - 12*CoefB*thpiALP)*
    Sin[thetas]))/(144*(m12 + m23 - ma^2 - meta^2 - 2*mpi0^2 - I*Gammasigma*msigma + msigma^2))*UnitStep[m12 + m23 - ma^2 - meta^2 + 4*mKplus^2 - 2*mpi0^2]