-1/24*((m12 - 2*mpi0^2)*(m12 - ma^2 - mpi0^2)*(Sqrt[2]*(CoefA - CoefB)*Cos[thetas] + 
    2*CoefB*Sin[thetas])*(2*(2*Sqrt[2]*CoefA*deltaI*thetaALP*thetapi + 3*Sqrt[2]*CoefB*deltaI*thetaALP*
       thetapi - Sqrt[2]*CoefC*deltaI*thetaALP*thetapi + Sqrt[2]*CoefD*deltaI*thetaALP*thetapi + 
     ...
     Sin[thetas])*UnitStep[-m12 + 4*mKplus^2])/(m12 + I*(Gammasigma + I*msigma)*msigma)