-1/144*(deltaI*(m12 - ma^2 - mpi0^2)*(m12 - metap^2 - mpi0^2)*
   (-2*(-(CoefC*thetapi) + 4*CoefD*thetapi + 4*Sqrt[2]*CoefC*thetaprpi + 8*Sqrt[2]*CoefD*thetaprpi + 
      2*CoefA*(thetapi + 2*Sqrt[2]*thetaprpi))*Cos[thetas] + 
    (2*Sqrt[2]*CoefA*thetapi + 5*Sqrt[2]*CoefC*thetapi + 8*Sqrt[2]*CoefD*thetapi + 8*CoefA*thetaprpi + 
      8*CoefC*thetaprpi + 32*CoefD*thetaprpi)*Sin[thetas])*
   (-2*(2*Sqrt[2]*CoefA*deltaI*thetaALP*thetapi + 3*Sqrt[2]*CoefB*deltaI*thetaALP*thetapi - 
     ...
     Sin[thetas])*UnitStep[-m12 + 4*mK^2])/(m12 + I*(Gammasigma + I*msigma)*msigma) +  ((m23 - ma^2 - metap^2)*(m23 - 2*mpi0^2)*(Sqrt[2]*(CoefA - CoefB)*Cos[thetas] + 2*CoefB*Sin[thetas])*
  ...
  UnitStep[-m23 + 4*mK^2])/(24*(m23 + I*(Gammasigma + I*msigma)*msigma)) + (deltaI*(m12 + m23 - ma^2 - mpi0^2)*(m12 + m23 - metap^2 - mpi0^2)*
  (-2*(-(CoefC*thetapi) + 4*CoefD*thetapi + 4*Sqrt[2]*CoefC*thetaprpi + 8*Sqrt[2]*CoefD*thetaprpi + 
     2*CoefA*(thetapi + 2*Sqrt[2]*thetaprpi))*Cos[thetas] + 
   (2*Sqrt[2]*CoefA*thetapi + 5*Sqrt[2]*CoefC*thetapi + 8*Sqrt[2]*CoefD*thetapi + 8*CoefA*thetaprpi + 
     8*CoefC*thetaprpi + 32*CoefD*thetaprpi)*Sin[thetas])*
  (-2*(2*Sqrt[2]*CoefA*deltaI*thetaALP*thetapi + 3*Sqrt[2]*CoefB*deltaI*thetaALP*thetapi - 
    ...
    Cos[thetas] + (-8*CoefA*deltaI*thetaALP*thetapi + 12*CoefB*deltaI*thetaALP*thetapi + 
     ...
     4*cg*CoefB*(-(Sqrt[6]*deltaI*thetapi) + 2*Sqrt[3]*deltaI*thetaprpi + 
       kappau*(-3 + 2*Sqrt[6]*deltaI*thetapi - Sqrt[3]*deltaI*thetaprpi) + 
       kappad*(3 + 2*Sqrt[6]*deltaI*thetapi - Sqrt[3]*deltaI*thetaprpi)) - 12*CoefB*thpiALP)*
    Sin[thetas]))/(144*(m12 + m23 - ma^2 - metap^2 - 2*mpi0^2 - I*Gammasigma*msigma + msigma^2)) * UnitStep[m12 + m23 - ma^2 - metap^2 + 4*mK^2 - 2*mpi0^2]