((Sqrt[2]*(CoefA - CoefB)*Cos[thetas] + 2*CoefB*Sin[thetas])*
  (-2*(2*Sqrt[2]*CoefA*deltaI*thetaALP*thetapi + 3*Sqrt[2]*CoefB*deltaI*thetaALP*thetapi - 
    ...
    Sin[thetas])*(((m12 - 2*mpi0^2)*(m12 - ma^2 - mpi0^2)*UnitStep[-m12 + 4*mKplus^2])/
    (m12 + I*(Gammasigma + I*msigma)*msigma) + ((m23 - 2*mpi0^2)*(m23 - ma^2 - mpi0^2)*
     UnitStep[-m23 + 4*mKplus^2])/(m23 + I*(Gammasigma + I*msigma)*msigma) - 
   ((m12 + m23 - 2*mpi0^2)*(m12 + m23 - ma^2 - mpi0^2)*UnitStep[m12 + m23 - ma^2 + 4*mKplus^2 - 
       3*mpi0^2])/(m12 + m23 - ma^2 - 3*mpi0^2 - I*Gammasigma*msigma + msigma^2)))/24