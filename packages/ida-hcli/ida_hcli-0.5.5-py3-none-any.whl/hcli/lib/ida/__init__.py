...
def get_ida_install_default_prefix(ver: IdaVersion = IdaVersion(9, 0, None)) -> str:
    ...
    if get_os() == "windows":
        ...
        return f"/Applications/IDA Professional {ver}"
...
async def _install_ida_unix(installer: str, prefix: str) -> None:
    ...
    share_dir = Path(get_user_home_dir()) / ".local" / "share" / "applications"
