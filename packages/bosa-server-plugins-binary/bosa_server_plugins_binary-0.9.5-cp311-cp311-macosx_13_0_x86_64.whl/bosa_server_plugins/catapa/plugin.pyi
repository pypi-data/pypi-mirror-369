...
class CatapaPlugin(ThirdPartyIntegrationPlugin):
    ...
    def get_integration(self, user_identifier: str, headers: ExposedDefaultHeaders):
        ...
        """
    def refresh_integration(self, user_identifier: str, headers: ExposedDefaultHeaders):
        """Refresh the integration tokens.

        Args:
            user_identifier: The user identifier to refresh.
            headers: The headers.

        Returns:
            The refresh result with new token information.
        """
