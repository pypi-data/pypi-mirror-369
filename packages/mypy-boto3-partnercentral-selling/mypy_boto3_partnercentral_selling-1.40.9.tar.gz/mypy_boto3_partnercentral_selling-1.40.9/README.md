<a id="mypy-boto3-partnercentral-selling"></a>
...
[boto3 PartnerCentralSellingAPI 1.40.9](https://pypi.org/project/boto3/)
...
- Install `boto3-stubs[partnercentral-selling]` in your environment:
...
- Install `boto3-stubs[partnercentral-selling]` with services you use in your
  environment:
...
`mypy-boto3-partnercentral-selling` dependency in production. However, there is
...
from mypy_boto3_partnercentral_selling import PartnerCentralSellingAPIClient
...
`mypy_boto3_partnercentral_selling.paginator` module contains type annotations
for all paginators.
