...
class IdpLogin:
    def __init__(self, redirect_uri: str, id: str, state: str, user: str = None, session: requests.Session = None):
...
class AppSession:
    ...
    def login_to_idp(self, username: str = None, forced = False, use_cached = True, show_endpoints = True) -> IdpLogin:
        if not(idp_uri := self.redirect_uri(show_endpoints=show_endpoints)):
            return None
    ...
    def redirect_uri(self, show_endpoints = True) -> str:
        # stgawsscpsr-c3-c3
