...
class CoreV1DefaultSchedule(BaseModel):
    """
    ...
    compute_group: Optional[StrictStr] = Field(default=None, description="'dedicated' or 'automatic'.", alias="computeGroup")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1DefaultSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1DefaultSchedule from a dict"""
        if obj is None:
            return None
