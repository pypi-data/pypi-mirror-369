...
class DbuiV1TransformRequest(BaseModel):
    ...
    autoloader_input: Optional[DbuiV1TransformRequestAutoloaderInput] = Field(default=None, alias="autoloaderInput")
    ...
    __properties: ClassVar[List[str]] = ["input", "autoloaderInput", "usePreset", "usePresetVersion", "transforms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": DbuiV1TransformRequestInput.from_dict(obj["input"]) if obj.get("input") is not None else None,
            "autoloaderInput": DbuiV1TransformRequestAutoloaderInput.from_dict(obj["autoloaderInput"]) if obj.get("autoloaderInput") is not None else None,
