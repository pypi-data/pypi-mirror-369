...
class DbuiV1ObservableEventsListItemsInnerNotable(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "ruleName", "summary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1ObservableEventsListItemsInnerNotable from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1ObservableEventsListItemsInnerNotable from a dict"""
        if obj is None:
            return None
