...
class WorkspaceV1ServiceAccount(BaseModel):
    """
    A ServiceAccount 
    """ # noqa: E501
    ...
    spec: WorkspaceV1ServiceAccountSpec = Field(description="The desired configuration of this ServiceAccount.")
    status: Optional[WorkspaceV1ServiceAccountStatus] = Field(default=None, description="The current status of this ServiceAccount. This data may be out of date by some window of time. Populated by the system. Read-only.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1ServiceAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1ServiceAccount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": WorkspaceV1ServiceAccountSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": WorkspaceV1ServiceAccountStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
