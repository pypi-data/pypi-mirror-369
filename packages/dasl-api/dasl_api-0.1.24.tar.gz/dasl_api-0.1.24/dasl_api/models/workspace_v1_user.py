...
class WorkspaceV1User(BaseModel):
    """
    A User object representing a person who has access to the system. 
    """ # noqa: E501
    ...
    spec: WorkspaceV1UserSpec = Field(description="The desired configuration of this User.")
    status: Optional[WorkspaceV1UserStatus] = Field(default=None, description="The current status of this User. This data may be out of date by some window of time. Populated by the system. Read-only.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1User from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1User from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": WorkspaceV1UserSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": WorkspaceV1UserStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
