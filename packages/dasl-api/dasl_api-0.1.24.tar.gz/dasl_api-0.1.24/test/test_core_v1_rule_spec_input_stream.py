...
class TestCoreV1RuleSpecInputStream(unittest.TestCase):
    """CoreV1RuleSpecInputStream unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1RuleSpecInputStream:
        """Test CoreV1RuleSpecInputStream
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1RuleSpecInputStream`
        """
        model = CoreV1RuleSpecInputStream()
        if include_optional:
    ...
    def testCoreV1RuleSpecInputStream(self):
        """Test CoreV1RuleSpecInputStream"""
