...
class CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["custom", "name", "filter", "postFilter", "overrideLiquidColumns", "fields", "utils"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner from a dict"""
        if obj is None:
            return None
