...
class WorkspaceV1ServiceAccountList(BaseModel):
    """
    A list of ServiceAccount 
    """ # noqa: E501
    ...
    items: List[WorkspaceV1ServiceAccount] = Field(description="A list of ServiceAccounts.")
    ...
    metadata: Optional[CommonV1ListMeta] = Field(default=None, description="Standard list metadata.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1ServiceAccountList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1ServiceAccountList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [WorkspaceV1ServiceAccount.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
            "metadata": CommonV1ListMeta.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
