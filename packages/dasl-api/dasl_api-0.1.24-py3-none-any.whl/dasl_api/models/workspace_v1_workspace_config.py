...
class WorkspaceV1WorkspaceConfig(BaseModel):
    """
    General configuration for a workspace. 
    """ # noqa: E501
    ...
    spec: WorkspaceV1WorkspaceConfigSpec = Field(description="The workspace config definition.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceV1WorkspaceConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceV1WorkspaceConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": WorkspaceV1WorkspaceConfigSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
