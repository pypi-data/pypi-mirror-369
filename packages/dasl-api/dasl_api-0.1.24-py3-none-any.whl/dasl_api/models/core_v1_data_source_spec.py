...
class CoreV1DataSourceSpec(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["targetMedallion", "source", "sourceType", "schedule", "custom", "usePreset", "usePresetVersion", "primaryKey", "autoloader", "computeMode", "bronze", "silver", "gold"]
