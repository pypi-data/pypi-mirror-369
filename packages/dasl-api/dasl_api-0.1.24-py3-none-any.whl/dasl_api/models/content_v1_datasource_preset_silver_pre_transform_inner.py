...
class ContentV1DatasourcePresetSilverPreTransformInner(BaseModel):
    ...
    fields: Optional[List[Optional[CoreV1DataSourceFieldSpec]]] = Field(default=None, description="A list of FieldSpecs that define the column schema for this pretransformation. Each FieldSpec will  include a name, type, and other properties that define the column schema. ")
