...
class DbuiV1DataSourceSummaryListDataSourcesInnerAlerts(BaseModel):
    """
    DbuiV1DataSourceSummaryListDataSourcesInnerAlerts
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["alertsLast7days", "alertsPreceding7days", "alertsLast24hours", "alertsPreceding24hours", "currentlyOpen"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1DataSourceSummaryListDataSourcesInnerAlerts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1DataSourceSummaryListDataSourcesInnerAlerts from a dict"""
        if obj is None:
            return None
