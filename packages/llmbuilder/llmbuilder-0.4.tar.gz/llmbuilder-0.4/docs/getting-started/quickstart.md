...
If you cloned the repo, we include a tiny cybersecurity dataset in `Model_Test/` and a ready-to-run script in `docs/train_model.py`:

```bash
# Train using the example dataset and small-friendly config
