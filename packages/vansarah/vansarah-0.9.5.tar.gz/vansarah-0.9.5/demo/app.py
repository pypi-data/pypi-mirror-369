...
pipelines['a'].g2p.lexicon.golds['vansarah'] = 'kˈOkəɹO'
pipelines['b'].g2p.lexicon.golds['vansarah'] = 'kˈQkəɹQ'
...
TOKEN_NOTE = '''
💡 Customize pronunciation with Markdown link syntax and /slashes/ like `[vansarah](/kˈOkəɹO/)`
