...
from msl_internal import MslInternal, AsyncMslInternal, APIResponseValidationError
from msl_internal._types import Omit
from msl_internal._models import BaseModel, FinalRequestOptions
from msl_internal._exceptions import APIStatusError, APITimeoutError, MslInternalError, APIResponseValidationError
from msl_internal._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MslInternal | AsyncMslInternal) -> int:
...
class TestMslInternal:
    client = MslInternal(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "msl_internal/_legacy_response.py",
                        "msl_internal/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "msl_internal/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MslInternalError):
            with update_env(**{"LLAMA_API_KEY": Omit()}):
                client2 = MslInternal(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: MslInternal) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MSL_INTERNAL_BASE_URL="http://localhost:5000/from/env"):
            client = MslInternal(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: MslInternal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MslInternal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MslInternal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MslInternal(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = MslInternal(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("msl_internal._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: MslInternal) -> None:
    ...
    @mock.patch("msl_internal._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: MslInternal) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: MslInternal, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMslInternal:
    client = AsyncMslInternal(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MslInternalError):
            with update_env(**{"LLAMA_API_KEY": Omit()}):
                client2 = AsyncMslInternal(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMslInternal) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MSL_INTERNAL_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMslInternal(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMslInternal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMslInternal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMslInternal) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMslInternal(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMslInternal(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        self, respx_mock: MockRouter, async_client: AsyncMslInternal
    ) -> None:
        respx_mock.post("/chat/completions").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMslInternal, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from msl_internal._utils import asyncify
        from msl_internal._base_client import get_platform
