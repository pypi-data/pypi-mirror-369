...
def output_hc_lags(origin_id,fcdate):
    '''
    Given origin_id, outputted the best dates for lagged reforecast
    '''
    ...
    if isinstance(variable_dict.rf_lag_info[origin_id],list): # DOMs. get closest lags
        fc_day = fcdate_obj.day
        rf_freq_info = variable_dict.rf_lag_info[origin_id]
        ...
        return lag
    elif variable_dict.rf_lag_info[origin_id]=='ThMoTh':
    ...
    elif variable_dict.rf_lag_info[origin_id]=='odddates':
    ...
    elif variable_dict.rf_lag_info[origin_id] == 'CNRevery5days':
