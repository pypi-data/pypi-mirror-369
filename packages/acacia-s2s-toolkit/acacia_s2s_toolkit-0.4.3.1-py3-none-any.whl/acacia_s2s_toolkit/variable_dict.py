...
rf_lag_info={
        "ammc":[1,6,11,16,21,26], # DOMs, just choose closest day.
        "babj":'ThMoTh', # Thursday, Monday, Thursday, lag depends on chosen fcdate
        "isac":'CNRevery5days',
        #"lfpw":[0],
        #"sbsj":[0],
        "cwao":'ThMoTh',
        "ecmf":'odddates', # ecmwf has reforecasts every odd day (expect feb 29th). for odd day: -2 and 0, even day: -1 and 1
        #"rums":[0],
        #"anso":[-4,-2,0,2,4],
        #"rjtd":'before_after', # chosen two lags where reforecast is before and after forecast date
        #"rksl":'before_after',
        #"kwbc":[-4,-2,0,2,4],
        #"egrr":'before_after'
        }
