...
class FeatureService(base_tecton_object.BaseTectonObject):
    ...
    def __init__(
        ...
        *,
        ...
        :param realtime_environment: [DEPRECATED] The environment in which all the Realtime Feature Views for this feature service should be executed.
            This parameter is deprecated and will be removed in the next major SDK release. Use 'transform_server_group' instead.
        ...
        # Deprecation warning for realtime_environment
        if realtime_environment is not None:
            logger.warning(errors.REALTIME_ENVIRONMENT_DEPRECATED)
