...
class SortDirection(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    SORT_UNKNOWN: _ClassVar[SortDirection]
...
class AppliedFilter(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    APPLIED_FILTER_UNSPECIFIED: _ClassVar[AppliedFilter]
    APPLIED_FILTER_APPLIED: _ClassVar[AppliedFilter]
    APPLIED_FILTER_UNAPPLIED: _ClassVar[AppliedFilter]

class MaterializationEnabledSearchFilter(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    MATERIALIZATION_ENABLED_SEARCH_FILTER_UNSPECIFIED: _ClassVar[MaterializationEnabledSearchFilter]
    MATERIALIZATION_ENABLED_SEARCH_FILTER_DISABLED: _ClassVar[MaterializationEnabledSearchFilter]
    MATERIALIZATION_ENABLED_SEARCH_FILTER_ENABLED: _ClassVar[MaterializationEnabledSearchFilter]

class WorkspaceCapabilitiesFilter(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    WORKSPACE_CAPABILITIES_FILTER_UNSPECIFIED: _ClassVar[WorkspaceCapabilitiesFilter]
    WORKSPACE_CAPABILITIES_FILTER_DEV: _ClassVar[WorkspaceCapabilitiesFilter]
    WORKSPACE_CAPABILITIES_FILTER_LIVE: _ClassVar[WorkspaceCapabilitiesFilter]

class FcoType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    FCO_TYPE_UNSPECIFIED: _ClassVar[FcoType]
    FCO_TYPE_VIRTUAL_DATA_SOURCE: _ClassVar[FcoType]
    FCO_TYPE_ENTITY: _ClassVar[FcoType]
    FCO_TYPE_TRANSFORMATION: _ClassVar[FcoType]
    FCO_TYPE_FEATURE_VIEW: _ClassVar[FcoType]
    FCO_TYPE_FEATURE_SERVICE: _ClassVar[FcoType]

class FilterField(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    FILTER_FIELD_UNSPECIFIED: _ClassVar[FilterField]
    FILTER_FIELD_FCO_TYPE: _ClassVar[FilterField]
    FILTER_FIELD_WORKSPACE: _ClassVar[FilterField]
    FILTER_FIELD_OWNER: _ClassVar[FilterField]
    FILTER_FIELD_MATERIALIZATION_OFFLINE: _ClassVar[FilterField]
    FILTER_FIELD_MATERIALIZATION_ONLINE: _ClassVar[FilterField]
    FILTER_FIELD_WORKSPACE_STATUS: _ClassVar[FilterField]
    FILTER_FIELD_SEARCH_TYPE: _ClassVar[FilterField]
...
class JobsKeySet(_message.Message):
    __slots__ = ["updated_at", "comparison", "id"]
...
class PaginationRequest(_message.Message):
    __slots__ = ["page", "per_page", "sort_key", "sort_direction", "page_token"]
...
class PaginationResponse(_message.Message):
    __slots__ = ["page", "per_page", "total", "next_page_token", "sort_key", "sort_direction"]
    PAGE_FIELD_NUMBER: _ClassVar[int]
    PER_PAGE_FIELD_NUMBER: _ClassVar[int]
...
class ValidationResultToken(_message.Message):
    __slots__ = ["validation_time", "result_id", "expectation_name"]
...
class GetFeatureServiceRequest(_message.Message):
    __slots__ = ["service_reference", "workspace", "id", "run_object_version_check"]
...
class GetFVServingStatusForFSRequest(_message.Message):
    __slots__ = ["feature_service_id", "workspace", "pagination"]
    FEATURE_SERVICE_ID_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
...
class GetMaterializationStatusRequest(_message.Message):
    __slots__ = ["feature_package_id", "workspace", "include_deleted"]
    FEATURE_PACKAGE_ID_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
...
class GetJobsRequest(_message.Message):
    __slots__ = ["workspaces", "feature_views", "feature_services", "fco_type", "statuses", "last_task_state_change", "task_type", "task_type_for_displays", "num_attempts", "manually_triggered", "duration", "feature_start_time", "feature_end_time", "include_update_materialization_flags", "writes_online", "writes_offline", "pagination"]
    class FCOTypeFilter(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        UNSPECIFIED: _ClassVar[GetJobsRequest.FCOTypeFilter]
        FEATURE_VIEW_ONLY: _ClassVar[GetJobsRequest.FCOTypeFilter]
        FEATURE_SERVICE_ONLY: _ClassVar[GetJobsRequest.FCOTypeFilter]
...
class TaskWithAttempts(_message.Message):
    __slots__ = ["fco_locator", "taskState", "materialization_status", "task_id", "task_type", "task_type_for_display", "manually_triggered", "last_task_state_change", "feature_view_name", "feature_service_name", "feature_start_time", "feature_end_time", "plan_id"]
    FCO_LOCATOR_FIELD_NUMBER: _ClassVar[int]
...
class TaskAttemptDetails(_message.Message):
    __slots__ = ["task_id", "task_type", "task_type_for_display", "task_state", "attempt_status", "run_details", "cluster_config", "environment", "feature_start_time", "feature_end_time", "rift_instance_url"]
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    TASK_TYPE_FIELD_NUMBER: _ClassVar[int]
    TASK_TYPE_FOR_DISPLAY_FIELD_NUMBER: _ClassVar[int]
...
class GetJobsResponse(_message.Message):
    __slots__ = ["tasksWithAttempts", "pagination"]
...
class GetJobDetailsResponse(_message.Message):
    __slots__ = ["fco_locator", "attempt_details"]
    FCO_LOCATOR_FIELD_NUMBER: _ClassVar[int]
...
class ForceRetryMaterializationTaskRequest(_message.Message):
    __slots__ = ["materialization_task_id", "allow_overwrite"]
...
class GetMetricAndExpectationDefinitionResponse(_message.Message):
    __slots__ = ["workspace", "feature_view_name", "metrics", "feature_expectations", "metric_expectations"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    FEATURE_VIEW_NAME_FIELD_NUMBER: _ClassVar[int]
...
class GetFeatureViewRequest(_message.Message):
    __slots__ = ["version_specifier", "workspace", "id", "run_object_version_check"]
...
class GetVirtualDataSourceRequest(_message.Message):
    __slots__ = ["virtual_data_source_id", "name", "workspace", "run_object_version_check"]
...
class GetEntityRequest(_message.Message):
    __slots__ = ["entity_id", "name", "workspace", "run_object_version_check"]
...
class GetTransformationRequest(_message.Message):
    __slots__ = ["transformation_id", "name", "workspace", "run_object_version_check"]
...
class GetResourceProviderRequest(_message.Message):
    __slots__ = ["resource_provider_id", "name", "workspace", "run_object_version_check"]
...
class ListWorkflowsRequest(_message.Message):
    __slots__ = ["partial_workflow_id", "partial_uniqueness_key", "type", "updated_within", "page_size", "page_token"]
...
class ListWorkflowsResponse(_message.Message):
    __slots__ = ["workflows", "workflow_state_names", "next_page_token"]
    class WorkflowStateNamesEntry(_message.Message):
        __slots__ = ["key", "value"]
    ...
    WORKFLOW_STATE_NAMES_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    workflows: _containers.RepeatedCompositeFieldContainer[_workflow__client_pb2.WorkflowStateContainer]
    workflow_state_names: _containers.ScalarMap[str, str]
    next_page_token: str
    def __init__(self, workflows: _Optional[_Iterable[_Union[_workflow__client_pb2.WorkflowStateContainer, _Mapping]]] = ..., workflow_state_names: _Optional[_Mapping[str, str]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
...
class NewStateUpdateRequest(_message.Message):
    __slots__ = ["request", "blocking_dry_run_mode", "enable_eager_response"]
...
class NewStateUpdateRequestV2(_message.Message):
    __slots__ = ["request", "blocking_dry_run_mode", "enable_eager_response", "no_color", "json_output", "suppress_warnings"]
    REQUEST_FIELD_NUMBER: _ClassVar[int]
    BLOCKING_DRY_RUN_MODE_FIELD_NUMBER: _ClassVar[int]
    ENABLE_EAGER_RESPONSE_FIELD_NUMBER: _ClassVar[int]
...
class NewStateUpdateResponse(_message.Message):
    __slots__ = ["state_id", "signed_url_for_repo_upload", "eager_response"]
...
class QueryStateUpdateRequestV2(_message.Message):
    __slots__ = ["state_id", "workspace", "no_color", "json_output", "suppress_warnings"]
    STATE_ID_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    NO_COLOR_FIELD_NUMBER: _ClassVar[int]
    JSON_OUTPUT_FIELD_NUMBER: _ClassVar[int]
...
class QueryStateUpdateResponse(_message.Message):
    __slots__ = ["ready", "success", "error", "recreates_suppressed", "validation_result", "diff_items", "latest_status_message", "plan_integration_validation_result"]
...
class QueryStateUpdateResponseV2(_message.Message):
    __slots__ = ["ready", "success", "error", "latest_status_message", "validation_errors", "successful_plan_output", "applied_by", "applied_by_principal", "applied_at", "workspace", "sdk_version", "created_at", "created_by", "created_by_principal"]
    READY_FIELD_NUMBER: _ClassVar[int]
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    LATEST_STATUS_MESSAGE_FIELD_NUMBER: _ClassVar[int]
...
class ApplyStateUpdateRequest(_message.Message):
    __slots__ = ["state_id", "applied_by", "plan_integration_config"]
    STATE_ID_FIELD_NUMBER: _ClassVar[int]
    APPLIED_BY_FIELD_NUMBER: _ClassVar[int]
...
class GetStateUpdatePlanListRequest(_message.Message):
    __slots__ = ["limit", "workspace", "applied_filter"]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
...
class GetRestoreInfoResponse(_message.Message):
    __slots__ = ["signed_url_for_repo_download", "commit_id", "sdk_version"]
...
class CreateWorkspaceRequest(_message.Message):
    __slots__ = ["workspace_name", "capabilities", "compute_identities"]
...
class UpdateWorkspaceRequest(_message.Message):
    __slots__ = ["workspace", "capabilities", "compute_identities"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    CAPABILITIES_FIELD_NUMBER: _ClassVar[int]
    COMPUTE_IDENTITIES_FIELD_NUMBER: _ClassVar[int]
    workspace: str
...
class IntrospectApiKeyResponse(_message.Message):
    __slots__ = ["id", "description", "created_by", "active", "is_admin", "name"]
    ID_FIELD_NUMBER: _ClassVar[int]
...
class CreateSavedFeatureDataFrameRequest(_message.Message):
    __slots__ = ["name", "workspace", "feature_package_id", "feature_service_id", "join_key_column_names", "timestamp_column_name", "schema"]
    NAME_FIELD_NUMBER: _ClassVar[int]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    FEATURE_PACKAGE_ID_FIELD_NUMBER: _ClassVar[int]
    FEATURE_SERVICE_ID_FIELD_NUMBER: _ClassVar[int]
...
class GetSavedFeatureDataFrameRequest(_message.Message):
    __slots__ = ["saved_feature_dataframe_name", "saved_feature_dataframe_id", "workspace"]
...
class GetClusterAdminInfoResponse(_message.Message):
    __slots__ = ["caller_is_admin", "users", "admins"]
...
class ClusterUserActionRequest(_message.Message):
    __slots__ = ["okta_id", "resend_activation_email", "unlock_user", "grant_admin", "revoke_admin"]
    OKTA_ID_FIELD_NUMBER: _ClassVar[int]
...
class GetAllSavedFeatureDataFramesRequest(_message.Message):
    __slots__ = ["workspace", "pagination", "dataset_name"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    PAGINATION_FIELD_NUMBER: _ClassVar[int]
    ...
    pagination: PaginationRequest
    dataset_name: str
    def __init__(self, workspace: _Optional[str] = ..., pagination: _Optional[_Union[PaginationRequest, _Mapping]] = ..., dataset_name: _Optional[str] = ...) -> None: ...

class GetAllSavedFeatureDataFramesResponse(_message.Message):
    __slots__ = ["saved_feature_dataframes", "pagination"]
    ...
    pagination: PaginationResponse
    def __init__(self, saved_feature_dataframes: _Optional[_Iterable[_Union[_saved_feature_data_frame__client_pb2.SavedFeatureDataFrame, _Mapping]]] = ..., pagination: _Optional[_Union[PaginationResponse, _Mapping]] = ...) -> None: ...

class IngestDataframeRequest(_message.Message):
    __slots__ = ["feature_definition_id", "df_path", "workspace"]
...
class UpdateUserDeploymentSettingsRequest(_message.Message):
    __slots__ = ["user_deployment_settings", "field_mask"]
    USER_DEPLOYMENT_SETTINGS_FIELD_NUMBER: _ClassVar[int]
...
class GetDeleteEntitiesInfoResponse(_message.Message):
    __slots__ = ["df_path", "signed_url_for_df_upload_online", "signed_url_for_df_upload_offline"]
    DF_PATH_FIELD_NUMBER: _ClassVar[int]
...
class DeleteEntitiesRequest(_message.Message):
    __slots__ = ["fco_locator", "online_join_keys_path", "online_join_keys_full_path", "offline_join_keys_path", "online", "offline"]
    FCO_LOCATOR_FIELD_NUMBER: _ClassVar[int]
...
class GetHiveMetadataRequest(_message.Message):
    ...
    class Action(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        ACTION_LIST_DATABASES: _ClassVar[GetHiveMetadataRequest.Action]
...
class GetHiveMetadataResponse(_message.Message):
    __slots__ = ["success", "error_message", "databases", "debug_error_message"]
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    ERROR_MESSAGE_FIELD_NUMBER: _ClassVar[int]
...
class ValidateLocalFcoRequest(_message.Message):
    __slots__ = ["validation_request", "sdk_version"]
...
class ValidateLocalFcoResponse(_message.Message):
    __slots__ = ["success", "validation_result", "error"]
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    VALIDATION_RESULT_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    success: bool
...
class GetOnboardingStatusResponse(_message.Message):
    __slots__ = ["setup_platform", "finish_onboarding"]
...
class GetObservabilityConfigResponse(_message.Message):
    __slots__ = ["workspace", "feature_view_name", "is_dataobs_metric_enabled"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    FEATURE_VIEW_NAME_FIELD_NUMBER: _ClassVar[int]
...
class QueryMetricRequest(_message.Message):
    __slots__ = ["workspace", "feature_view_name", "metric_type", "start_time", "end_time", "limit"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    FEATURE_VIEW_NAME_FIELD_NUMBER: _ClassVar[int]
...
class QueryMetricResponse(_message.Message):
    __slots__ = ["workspace", "feature_view_name", "metric_type", "metric_data_point_interval", "aligned_start_time", "aligned_end_time", "metric_data", "column_names"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    FEATURE_VIEW_NAME_FIELD_NUMBER: _ClassVar[int]
    METRIC_TYPE_FIELD_NUMBER: _ClassVar[int]
...
class GetFeatureValidationResultRequest(_message.Message):
    __slots__ = ["workspace", "validation_start_time", "validation_end_time", "filter_feature_view_names", "filter_expectation_names", "filter_result_types", "pagination"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
...
class GetFeatureValidationSummaryRequest(_message.Message):
    __slots__ = ["workspace", "validation_start_time", "validation_end_time"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    VALIDATION_START_TIME_FIELD_NUMBER: _ClassVar[int]
    VALIDATION_END_TIME_FIELD_NUMBER: _ClassVar[int]
    workspace: str
...
class GetFeatureValidationSummaryResponse(_message.Message):
    __slots__ = ["workspace", "validation_start_time", "validation_end_time", "workspace_summary"]
    WORKSPACE_FIELD_NUMBER: _ClassVar[int]
    VALIDATION_START_TIME_FIELD_NUMBER: _ClassVar[int]
    VALIDATION_END_TIME_FIELD_NUMBER: _ClassVar[int]
...
class FeatureServerAutoScalingConfig(_message.Message):
    __slots__ = ["enabled", "min_node_count", "max_node_count", "target_utilization_percentile", "target_scaling_value"]
    class Utilization(_message.Message):
        __slots__ = []
        class Percentile(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = []
            UNSPECIFIED: _ClassVar[FeatureServerAutoScalingConfig.Utilization.Percentile]
            P50: _ClassVar[FeatureServerAutoScalingConfig.Utilization.Percentile]
            P90: _ClassVar[FeatureServerAutoScalingConfig.Utilization.Percentile]
            P95: _ClassVar[FeatureServerAutoScalingConfig.Utilization.Percentile]
            P99: _ClassVar[FeatureServerAutoScalingConfig.Utilization.Percentile]
            P100: _ClassVar[FeatureServerAutoScalingConfig.Utilization.Percentile]
        UNSPECIFIED: FeatureServerAutoScalingConfig.Utilization.Percentile
        P50: FeatureServerAutoScalingConfig.Utilization.Percentile
        P90: FeatureServerAutoScalingConfig.Utilization.Percentile
        P95: FeatureServerAutoScalingConfig.Utilization.Percentile
        P99: FeatureServerAutoScalingConfig.Utilization.Percentile
        P100: FeatureServerAutoScalingConfig.Utilization.Percentile
        def __init__(self) -> None: ...
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    MIN_NODE_COUNT_FIELD_NUMBER: _ClassVar[int]
    MAX_NODE_COUNT_FIELD_NUMBER: _ClassVar[int]
    TARGET_UTILIZATION_PERCENTILE_FIELD_NUMBER: _ClassVar[int]
    TARGET_SCALING_VALUE_FIELD_NUMBER: _ClassVar[int]
    enabled: bool
    min_node_count: int
    max_node_count: int
    target_utilization_percentile: FeatureServerAutoScalingConfig.Utilization.Percentile
    target_scaling_value: int
    def __init__(self, enabled: bool = ..., min_node_count: _Optional[int] = ..., max_node_count: _Optional[int] = ..., target_utilization_percentile: _Optional[_Union[FeatureServerAutoScalingConfig.Utilization.Percentile, str]] = ..., target_scaling_value: _Optional[int] = ...) -> None: ...
...
class GetFeatureServerConfigResponse(_message.Message):
    __slots__ = ["currentCount", "availableCount", "desiredCount", "autoScalingConfig"]
...
class SetFeatureServerConfigRequest(_message.Message):
    __slots__ = ["count", "autoScalingConfig"]
...
class GetOfflineStoreCredentialsRequest(_message.Message):
    __slots__ = ["feature_view_id", "data_source_id", "saved_feature_data_frame_id"]
    FEATURE_VIEW_ID_FIELD_NUMBER: _ClassVar[int]
...
class GlobalSearchRequest(_message.Message):
    __slots__ = ["text", "current_workspace", "fco_type_filters", "workspace_filters", "owner_filters", "materialization_offline_filter", "materialization_online_filter", "workspace_live_filter"]
...
class GlobalSearchResult(_message.Message):
    __slots__ = ["fco_result", "filter_result", "env_result"]
...
class FcoSearchResult(_message.Message):
    __slots__ = ["fco_id", "workplace_state_id", "fco_type", "name", "description", "owner", "tags", "workspace", "last_updated", "materialization_offline", "materialization_online", "workspace_status", "features", "feature_descriptions", "feature_tags", "job_environment"]
    class TagsEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
...
class EnvironmentSearchResult(_message.Message):
    __slots__ = ["id", "name", "description", "last_updated", "is_custom_environment", "dependencies"]
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    LAST_UPDATED_FIELD_NUMBER: _ClassVar[int]
...
class GetConsumptionRecordsRequest(_message.Message):
    __slots__ = ["consumption_type", "start_time", "end_time"]
