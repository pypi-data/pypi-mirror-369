...
class TestImageResource:
    ...
    def test_from_webcam_error_handling(self):
        ...
        with patch("imgs.image.iio.imread") as mock_imread:
    ...
    def test_stream_webcam(self):
        ...
        with patch("imgs.image.iio.imiter") as mock_imiter:
...
class TestErrorHandling:
    ...
    def test_warnings_suppression(self):
        ...
        with warnings.catch_warnings(record=True) as _:
            ...
            with patch("imgs.image.iio.improps") as mock_improps:
                mock_improps.side_effect = Exception("Test error")

                with patch("imgs.image.iio.immeta") as mock_immeta:
