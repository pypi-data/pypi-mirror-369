...
# Define what gets exported when using "from imgs import *"
__all__ = [
    # Image utilities
    "ImageResource",
    "ImageWriter",
...
display_image = ImageProcessor.display  # Direct access to display functionality


def main():
    """Main entry point for the utilities package."""
    print("🛠️  imgs Package - Image Processing Utilities")
    print("=" * 50)
