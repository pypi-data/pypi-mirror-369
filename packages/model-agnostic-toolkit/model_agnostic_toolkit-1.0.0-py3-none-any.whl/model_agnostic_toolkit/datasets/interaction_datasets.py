...
class InteractionOneDataset(ArtificialDataset):
    """Interaction One Dataset containing random base features and artificial interactions for a regression task, generated synthetically.
    Consists of five observed random base features with one hidden interaction.
    """

    def __init__(self, name: str = 'Interaction One', file: str = './data/interaction_one_dataset.hdf5', n: int = 1000,
                 test_size: float = 0.2, weights: list[float] = None, alpha: float = None,
...
class InteractionTwoDataset(ArtificialDataset):
    """Interaction Two Dataset containing random base features and artificial interactions for a regression task, generated synthetically.
    Consists of five observed random base features with two hidden interactions.
    """

    def __init__(self, name: str = 'Interaction Two', file: str = './data/interaction_two_dataset.hdf5', n: int = 1000,
                 test_size: float = 0.2, weights: list[float] = None,
                 alpha: float = None, noise_variance: float = 0.1, include_hidden: bool = False,
...
class InteractionThreeDataset(ArtificialDataset):
    """Interaction Three Dataset containing random base features and artificial interactions for a regression task, generated synthetically.
    Consists of five observed random base features with two hidden interactions.
    """

    def __init__(self, name: str = 'Interaction Three', file: str = './data/interaction_three_dataset.hdf5',
...
class InteractionFourDataset(ArtificialDataset):
    """Interaction Four Dataset containing random base features and artificial interactions for a regression task, generated synthetically.
    Consists of five observed random base features with three hidden interactions.
    """

    def __init__(self, name: str = 'Interaction Four', file: str = './data/interaction_four_dataset.hdf5',
                 n: int = 1000, test_size: float = 0.2, weights: list[float] = None,
                 alpha: float = None, noise_variance: float = 0.1,
                 include_hidden: bool = False, force: bool = False) -> None:
