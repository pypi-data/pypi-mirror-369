...
class ClassificationOneDataset(ArtificialDataset):
...
class ClassificationTwoDataset(ArtificialDataset):
    ...
    def __init__(
            ...
            file: str = "./data/classification_two_dataset.hdf5",
            n: int = 1000,
            test_size: float = 0.2,
            weights: list[float] = None,
            noise_variance: float = 0.1,
...
class ClassificationThreeDataset(ArtificialDataset):
...
class ClassificationFourDataset(ArtificialDataset):
