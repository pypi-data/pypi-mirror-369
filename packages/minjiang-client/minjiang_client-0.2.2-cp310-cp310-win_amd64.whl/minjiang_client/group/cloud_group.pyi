...
class CloudGroup(Group):
    ...
    @staticmethod
    def list_groups(page: int = 1, per_page: int = 10, show_hidden: bool = True) -> dict: ...
    @staticmethod
    def create_group(device_group_name: str, description: str) -> dict: ...
    @property
    ...
    def create_result_cache_dir(self, exp_id: int = None): ...
    def create_exp_cache_dir(self): ...
