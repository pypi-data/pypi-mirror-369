...
class SESV2Client(AioBaseClient):
    ...
    async def create_multi_region_endpoint(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/client/#create_multi_region_endpoint)
        """
    ...
    async def delete_multi_region_endpoint(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/client/#delete_multi_region_endpoint)
        """
    ...
    async def get_multi_region_endpoint(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/client/#get_multi_region_endpoint)
        """
    ...
    async def list_multi_region_endpoints(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/client/#list_multi_region_endpoints)
        """
    ...
    async def put_configuration_set_archiving_options(
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/client/#put_configuration_set_archiving_options)
        """
    ...
    def get_paginator(  # type: ignore[override]
        ...
        [Show types-aiobotocore documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_sesv2/client/#get_paginator)
        """
