...
class IncidentPostmortem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["body_updated_at", "preview_key", "published_at", "id", "incident_id", "created_at", "notify_subscribers", "body_draft", "body_draft_updated_at", "updated_at", "body"]
