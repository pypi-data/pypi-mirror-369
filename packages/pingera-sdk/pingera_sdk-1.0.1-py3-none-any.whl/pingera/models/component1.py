...
class Component1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["updated_at", "description", "page_id", "group", "id", "name", "only_show_if_degraded", "start_date", "created_at", "position", "status", "showcase", "group_id"]
