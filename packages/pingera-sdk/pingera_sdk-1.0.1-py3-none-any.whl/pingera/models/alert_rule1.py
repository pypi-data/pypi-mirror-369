...
class AlertRule1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enabled", "channels", "auto_resolve", "check_name", "id", "check_id", "name", "condition_parameters", "created_at", "severity", "cooldown_period", "condition", "updated_at", "channel_ids"]
