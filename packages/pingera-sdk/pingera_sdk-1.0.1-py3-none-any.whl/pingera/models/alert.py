...
class Alert(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["resolved_at", "description", "notification_count", "alert_metadata", "last_notification_at", "id", "check_id", "fired_at", "duration", "title", "rule_name", "acknowledged_by_id", "status", "severity", "rule_id", "is_active", "check_name", "acknowledged_at"]
