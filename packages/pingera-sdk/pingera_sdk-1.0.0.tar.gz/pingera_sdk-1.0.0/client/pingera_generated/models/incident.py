...
class Incident(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["monitoring_at", "postmortem_published_at", "deliver_notifications", "scheduled_auto_completed", "components", "postmortem_body_last_updated_at", "scheduled_reminded_at", "created_at", "scheduled_until", "auto_transition_to_maintenance_state", "incident_updates", "page_id", "postmortem_body", "auto_transition_deliver_notifications_at_end", "resolved_at", "scheduled_for", "auto_transition_deliver_notifications_at_start", "scheduled_remind_prior", "impact", "status", "reminder_intervals", "scheduled_auto_in_progress", "id", "name", "metadata", "updated_at", "auto_transition_to_operational_state", "body"]
