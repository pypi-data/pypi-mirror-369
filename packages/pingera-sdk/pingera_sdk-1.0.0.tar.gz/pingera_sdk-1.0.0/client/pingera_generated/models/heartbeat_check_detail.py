...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "recent_pings", "next_expected_ping", "id", "name", "last_ping_at", "created_at", "grace_seconds", "period_seconds", "status", "ping_url", "updated_at"]
