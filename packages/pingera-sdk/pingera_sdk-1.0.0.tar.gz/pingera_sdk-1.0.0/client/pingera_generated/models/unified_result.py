...
class UnifiedResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["check_metadata", "check_server", "id", "check_id", "response_time", "check_type", "error_message", "created_at", "status", "result_type", "check_name", "check_server_id", "region"]
