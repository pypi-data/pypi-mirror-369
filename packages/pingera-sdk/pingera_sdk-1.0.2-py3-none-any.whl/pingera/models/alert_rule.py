...
class AlertRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["condition", "check_id", "severity", "enabled", "id", "channels", "name", "check_name", "created_at", "updated_at", "channel_ids", "auto_resolve", "condition_parameters", "cooldown_period"]
