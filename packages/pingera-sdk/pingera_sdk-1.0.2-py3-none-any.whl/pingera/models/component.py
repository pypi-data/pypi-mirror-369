...
class Component(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["position", "showcase", "start_date", "id", "page_id", "group", "name", "status", "created_at", "updated_at", "group_id", "description", "only_show_if_degraded"]
