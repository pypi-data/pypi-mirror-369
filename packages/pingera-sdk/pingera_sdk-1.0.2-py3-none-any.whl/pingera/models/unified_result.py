...
class UnifiedResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["result_type", "check_id", "response_time", "error_message", "check_server_id", "check_server", "region", "id", "check_name", "status", "created_at", "check_metadata", "check_type"]
