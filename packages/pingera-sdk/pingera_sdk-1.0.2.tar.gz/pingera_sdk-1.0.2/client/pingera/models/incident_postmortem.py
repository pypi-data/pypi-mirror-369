...
class IncidentPostmortem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["published_at", "id", "preview_key", "body_updated_at", "incident_id", "body_draft_updated_at", "notify_subscribers", "created_at", "updated_at", "body", "body_draft"]
