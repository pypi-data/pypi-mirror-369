...
class Incident(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scheduled_for", "scheduled_until", "status", "monitoring_at", "resolved_at", "deliver_notifications", "auto_transition_deliver_notifications_at_end", "page_id", "scheduled_auto_in_progress", "created_at", "postmortem_body_last_updated_at", "auto_transition_deliver_notifications_at_start", "reminder_intervals", "postmortem_body", "auto_transition_to_maintenance_state", "incident_updates", "metadata", "name", "auto_transition_to_operational_state", "updated_at", "postmortem_published_at", "components", "scheduled_reminded_at", "body", "impact", "id", "scheduled_auto_completed", "scheduled_remind_prior"]
