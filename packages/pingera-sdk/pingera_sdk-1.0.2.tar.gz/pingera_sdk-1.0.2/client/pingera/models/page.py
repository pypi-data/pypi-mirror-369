...
class Page(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["city", "css_button_color", "allow_incident_subscribers", "subdomain", "css_greens", "css_button_border_color", "support_url", "favicon_logo", "css_link_color", "css_button_text_color", "activity_score", "css_button_hover_color", "domain", "hidden_from_search", "css_border_color", "css_yellows", "css_spinner_color", "notifications_from_email", "created_at", "viewers_must_be_team_members", "transactional_logo", "hero_cover", "css_no_data", "css_body_background_color", "page_description", "css_light_font_color", "css_oranges", "css_font_color", "name", "css_reds", "updated_at", "ip_restrictions", "template", "time_zone", "language", "organization_id", "allow_webhook_subscribers", "notifications_email_footer", "company_logo", "template_id", "email_logo", "id", "allow_sms_subscribers", "allow_email_subscribers", "allow_page_subscribers", "allow_rss_atom_feeds", "headline", "state", "css_blues", "url", "css_graph_color", "country"]
