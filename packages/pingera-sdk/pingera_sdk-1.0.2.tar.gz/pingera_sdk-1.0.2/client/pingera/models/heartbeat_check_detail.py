...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "ping_url", "period_seconds", "id", "last_ping_at", "name", "recent_pings", "grace_seconds", "status", "created_at", "updated_at", "next_expected_ping"]
