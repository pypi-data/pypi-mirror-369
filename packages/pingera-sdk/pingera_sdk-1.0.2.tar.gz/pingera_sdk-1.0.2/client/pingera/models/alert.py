...
class Alert(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acknowledged_at", "title", "is_active", "check_id", "duration", "severity", "notification_count", "id", "rule_name", "fired_at", "alert_metadata", "check_name", "status", "acknowledged_by_id", "resolved_at", "rule_id", "description", "last_notification_at"]
