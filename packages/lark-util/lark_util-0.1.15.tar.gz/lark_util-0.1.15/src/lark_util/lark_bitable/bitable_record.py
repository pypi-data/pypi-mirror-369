...
class BitableBaseRecord(ABC):
    ...
    last_modified_time: datetime = field(default="")
...
def parse_bitable_record(cls: Type[T], input: AppTableRecord) -> T:
    ...
    if hasattr(input, "last_modified_time") and input.last_modified_time:
        obj.last_modified_time = input.last_modified_time
