...
> generate_grafana_service_key(admin_username, admin_password, service_account_role, service_account_name=service_account_name)
...
with ObservabilityAPI.ApiClient(configuration) as api_client:
    ...
    try:
        # Generate Grafana Service Account Key
        api_instance.generate_grafana_service_key(admin_username, admin_password, service_account_role, service_account_name=service_account_name)
    except Exception as e:
