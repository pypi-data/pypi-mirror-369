...
CONTENT_DATAS = {
    ...
    ContentDatas.LEAGUES: {
        LeagueNames.MLB: League(
            ...
            competitors={
                ...
                CompetitorNames.TORONTO: UMCContent(
                    id='umc.cst.759rfvi2tf95aivbpxoj34l5n',
                    name='Toronto Blue Jays',
                    type=ContentTypes.TEAM
                ),
                CompetitorNames.NEW_YORK: UMCContent(
                    id='umc.cst.76tr6jayxrot6gqbs07rxua9q',
        ...
        LeagueNames.MLS: League(
            ...
            name='Major League Soccer',  # in itms11 league was renamed
            competitors={
                CompetitorNames.SEATTLE: UMCContent(
    ...
    ContentDatas.PERSONS: {
        ...
        PersonNames.MICHELLE_YEOH: Person(
            id='umc.cpc.52wdrdw9y20get7qymj3lurzf',
            name='Michelle Yeoh'
        ),
        PersonNames.ZAZIE_BEETZ: Person(
            id='umc.cpc.1j70u0xcv92xuynbz9qlnu22d',
            name='Zazie Beets'
        ),
        ...
        PersonNames.JUNO_TEMPLE: Person(
            id='umc.cpc.4i1p5gdc0q2f24h9xxob732y5',
            name='Juno Temple'
        ),
        ...
        PersonNames.LUCY_LIU: Person(
            id='umc.cpc.442ht5lgui1wwggjpkvbrnjb',
            name='Lucy Liu'
        ),
        PersonNames.AVA_KOLKER: Person(
            id='umc.cpc.1rvjigzmc4oef2ovg9nsrxhzt',
            name='Ava Kolker'
        ),
        PersonNames.RAPHAEL_PERSONNAZ: Person(
            id='umc.cpc.1gup28ckpg0vreg03aut4wtq5',
            name='Raphael Personnaz'
        ),
        PersonNames.DENNIS_HAYSBERT: Person(
            id='umc.cpc.2im9q7lvdw2ttuku41y2fx96l',
            name='Dennis Haysbert'
        ),
        PersonNames.MARINA_PERSON: Person(
            id='umc.cpc.6clznie906vufdllhuq8o8l3e',
            name='Marina Person'
        ),
        PersonNames.ANSEL_ELGORT: Person(
            id='umc.cpc.3l6q6nlvxwykrtx6sq9xn8wcv',
            name='Ansel Elgort'
        ),
        ...
        PersonNames.JASON_MOMOA: Person(
            id='umc.cpc.ss19it04h2ib95rcx2nxch8x',
            name='Jason Momoa',
        )
    },
    ContentDatas.AB_TESTING: {
        # Collections with different setup A/B Testing
    ...
    ContentDatas.CAMPAIGNS: {
        CampaignNames.SPORTING_EVENT_BASKETBALL: Campaign(
            id='uts.cmpn.3085abe6-655f-4d35-802e-d95095373820',
            user_id='c7c9a193987c44eda8ea71e92a9ae40c002',
        )
    }
}
