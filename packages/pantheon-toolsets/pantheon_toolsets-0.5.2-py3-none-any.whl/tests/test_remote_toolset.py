...
async def test_python_interpreter_toolset():
    ...
    with Engine() as engine:
        ...
        resp = await s.invoke("run_python_code", {"code": "res = 1 + 1", "result_var_name": "res"})
...
async def test_julia_toolset():
    ...
    async with run_toolsets([toolset]):
        ...
        resp = await s.invoke("run_julia_code", {"code": "x = 10; y = 20; x + y", "context_variables": context})
...
async def test_julia_interpreter_management():
    ...
    async with run_toolsets([toolset]):
        ...
        output = await s.invoke("run_code_in_interpreter", {
            "code": "a = 100; b = 200; a + b",
