...
def run_once(config_key: Optional[str] = None, runtime_variables: Optional[Dict[str, Any]] = None) -> None:
    load_envs()
    validate_envs()
    ...
    with get_db_connection() as conn:
        ...
        insert_log(cur, cfg_key, status, duration_ms, resp_json, error, log_body)
