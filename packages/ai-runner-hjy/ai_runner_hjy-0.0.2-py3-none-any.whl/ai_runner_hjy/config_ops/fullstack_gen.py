...
from backend.ai_runner_hjy.cfg_tool import (
    upsert_connection,
    upsert_model,
...
def generate_fullstack_from_yaml_dict(data: Dict[str, Any]) -> List[str]:
    ...
    with get_db_connection() as conn:
        with conn.cursor() as cur:
            ...
            for c in connections:
                ...
                cid = upsert_connection(cur, name, provider, base_url, api_key_plain)
