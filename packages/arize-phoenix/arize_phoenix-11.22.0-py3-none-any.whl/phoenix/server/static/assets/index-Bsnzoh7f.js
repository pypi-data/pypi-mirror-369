import{U as g,j as o,cY as h,eB as v,eC as y,eD as x,l as r,cl as z,eE as a,r as w,o as P,eF as k}from"./vendor-D9AxkwFX.js";import{r as S,s as L}from"./vendor-arizeai-BSWqLnk0.js";import{L as C,g as R,r as j,h as I,i as E,F as D,j as A,P as F,k as G,M as t,l as T,D as M,n as _,E as O,o as N,p as V,q,s as B,t as d,v as W,w as U,x as $,y as H,z as K,B as X,C as Y,G as J,H as Q,I as Z,J as oo,K as ao,N as lo,O as ro,Q as co,U as go,V as eo,W as m,X as p,Y as u,Z as bo,_ as no,$ as io,a0 as so,a1 as to,a2 as mo,a3 as po,a4 as uo,a5 as fo,a6 as ho,a7 as vo,a8 as yo,a9 as xo,aa as zo,ab as wo,ac as Po,ad as ko,ae as So,af as Lo,ag as Co,ah as Ro,ai as jo,aj as Io,ak as Eo,al as Do,am as Ao,an as Fo,ao as Go,ap as To,aq as Mo,ar as _o,as as Oo,at as No,au as Vo,av as qo,aw as Bo,ax as Wo,ay as Uo,az as n,aA as $o,aB as Ho,aC as Ko,aD as Xo,aE as Yo,aF as Jo,aG as Qo}from"./pages-BLzMd6Fl.js";import{fG as Zo,cX as oa,U as aa,fH as la,fI as ra}from"./components-BpxtWe3X.js";import"./vendor-three-BLWp5bic.js";import"./vendor-codemirror-DQOFTPza.js";import"./vendor-shiki-DTHqzvBl.js";import"./vendor-recharts-BcJHP7DH.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))s(c);new MutationObserver(c=>{for(const e of c)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function f(c){const e={};return c.integrity&&(e.integrity=c.integrity),c.referrerPolicy&&(e.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?e.credentials="include":c.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function s(c){if(c.ep)return;c.ep=!0;const e=f(c);fetch(c.href,e)}})();const ca=g`
  :root,
  .ac-theme {
...
`;function fa(){const{theme:l="dark"}=S();return o(h,{styles:g(ea,ga,l==="dark"?ba:na,ia(l),ca,sa,ta,da,ma,pa,ua)})}const ha=v(y(r(a,{path:"/",errorElement:o(n,{}),children:[o(a,{path:"/v1/*",element:o(z,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(C,{})}),o(a,{path:"/logout",element:o(R,{})}),o(a,{path:"/reset-password",element:o(I,{}),loader:j}),o(a,{path:"/reset-password-with-token",element:o(E,{})}),o(a,{path:"/forgot-password",element:o(D,{})}),o(a,{element:o(Xo,{}),loader:A,children:r(a,{element:o(Ko,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(F,{})}),o(a,{index:!0,loader:G}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(N,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(M,{}),loader:T})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(O,{}),loader:_,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(Z,{}),children:[o(a,{index:!0,element:o(V,{})}),r(a,{path:":projectId",loader:q,handle:{crumb:l=>l.project.name},element:o(Q,{}),children:[o(a,{index:!0,element:o(B,{})}),r(a,{element:o(J,{}),children:[o(a,{path:"traces",element:o(W,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(U,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(K,{}),children:o(a,{path:":sessionId",element:o(H,{}),loader:$})}),o(a,{path:"config",element:o(X,{})}),o(a,{path:"metrics",element:o(Y,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"Dashboards"},element:o(go,{}),children:[o(a,{index:!0,element:o(ao,{}),loader:oo}),o(a,{path:"projects/:projectId",element:o(ro,{}),loader:lo,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(co,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(a,{index:!0,element:o(eo,{})}),r(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(mo,{}),loader:m,children:[o(a,{index:!0,element:o(u,{}),loader:p}),o(a,{path:"experiments",element:o(u,{}),loader:p}),o(a,{path:"examples",element:o(io,{}),loader:bo,children:o(a,{path:":exampleId",element:o(no,{})})}),o(a,{path:"versions",element:o(to,{}),loader:so})]}),o(a,{path:"compare",element:o(uo,{}),loader:po,handle:{crumb:()=>"compare"}})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(fo,{})}),o(a,{path:"spans/:spanId",element:o(vo,{}),loader:ho,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(a,{index:!0,element:o(xo,{}),loader:yo}),r(a,{path:":promptId",loader:zo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(jo,{}),children:[o(a,{index:!0,element:o(wo,{})}),o(a,{path:"versions",loader:Po,element:o(Lo,{}),children:o(a,{path:":versionId",loader:ko,element:o(So,{})})}),o(a,{path:"config",element:o(Ro,{}),loader:Co})]}),o(a,{path:"playground",element:o(Eo,{}),loader:Io,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Do,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Ao,{}),handle:{crumb:()=>"Support"}}),r(a,{path:"/settings",element:o(Wo,{}),handle:{crumb:()=>"Settings"},children:[o(a,{path:"general",loader:Fo,element:o(Go,{}),handle:{crumb:()=>"General"}}),o(a,{path:"providers",loader:To,element:o(Mo,{}),handle:{crumb:()=>"AI Providers"}}),o(a,{path:"models",loader:_o,element:o(Oo,{}),handle:{crumb:()=>"Models"}}),o(a,{path:"annotations",loader:No,element:o(Vo,{}),handle:{crumb:()=>"Annotations"}}),o(a,{path:"data",element:o(Bo,{}),handle:{crumb:()=>"Data Retention"},loader:qo})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Uo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:$o,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_id",loader:Ho,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function va(){return o(x,{router:ha})}function ya(){return o(Yo,{children:o(Zo,{children:o(xa,{})})})}function xa(){const{theme:l}=oa();return o(L,{theme:l,mountGlobalStyles:!1,children:r(P.RelayEnvironmentProvider,{environment:aa,children:[o(fa,{}),o(Jo,{children:o(la,{children:o(Qo,{children:o(w.Suspense,{children:o(ra,{children:o(va,{})})})})})})]})})}const za=document.getElementById("root"),wa=k.createRoot(za);wa.render(o(ya,{}));
