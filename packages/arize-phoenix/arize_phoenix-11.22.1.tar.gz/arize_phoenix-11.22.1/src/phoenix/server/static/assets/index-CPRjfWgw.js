import{U as g,j as o,cY as f,eB as h,eC as v,eD as y,l as r,cl as x,eE as a,r as z,o as w,eF as P}from"./vendor-OZY7E_So.js";import{r as k,s as S}from"./vendor-arizeai-gVnaUuEN.js";import{L,g as C,r as R,h as j,i as I,F as E,j as D,P as A,k as F,M as t,l as T,D as G,n as M,E as _,o as O,p as N,q as V,s as q,t as d,v as B,w as W,x as U,y as $,z as H,B as J,C as K,G as X,H as Y,I as Q,J as Z,K as oo,N as ao,O as lo,Q as ro,U as co,V as go,W as m,X as p,Y as eo,Z as bo,_ as no,$ as io,a0 as so,a1 as to,a2 as mo,a3 as po,a4 as uo,a5 as fo,a6 as ho,a7 as vo,a8 as yo,a9 as xo,aa as zo,ab as wo,ac as Po,ad as ko,ae as So,af as Lo,ag as Co,ah as Ro,ai as jo,aj as Io,ak as Eo,al as Do,am as Ao,an as Fo,ao as To,ap as Go,aq as Mo,ar as _o,as as Oo,at as No,au as Vo,av as qo,aw as Bo,ax as Wo,ay as n,az as Uo,aA as $o,aB as Ho,aC as Jo,aD as Ko,aE as Xo,aF as Yo}from"./pages-BJo09m3C.js";import{fH as Qo,cX as Zo,U as oa,fI as aa,fJ as la}from"./components-DQCiuSGl.js";import"./vendor-three-BLWp5bic.js";import"./vendor-codemirror-B7tfxPRK.js";import"./vendor-shiki-C9RjEdM9.js";import"./vendor-recharts-BYEfkUTh.js";(function(){const b=document.createElement("link").relList;if(b&&b.supports&&b.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))s(c);new MutationObserver(c=>{for(const e of c)if(e.type==="childList")for(const i of e.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function u(c){const e={};return c.integrity&&(e.integrity=c.integrity),c.referrerPolicy&&(e.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?e.credentials="include":c.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function s(c){if(c.ep)return;c.ep=!0;const e=u(c);fetch(c.href,e)}})();const ra=g`
  :root,
  .ac-theme {
...
`;function ua(){const{theme:l="dark"}=k();return o(f,{styles:g(ga,ca,l==="dark"?ea:ba,na(l),ra,ia,sa,ta,da,ma,pa)})}const fa=h(v(r(a,{path:"/",errorElement:o(n,{}),children:[o(a,{path:"/v1/*",element:o(x,{to:"/",replace:!0})}),o(a,{path:"/login",element:o(L,{})}),o(a,{path:"/logout",element:o(C,{})}),o(a,{path:"/reset-password",element:o(j,{}),loader:R}),o(a,{path:"/reset-password-with-token",element:o(I,{})}),o(a,{path:"/forgot-password",element:o(E,{})}),o(a,{element:o(Jo,{}),loader:D,children:r(a,{element:o(Ho,{}),children:[o(a,{path:"/profile",handle:{crumb:()=>"profile"},element:o(A,{})}),o(a,{index:!0,loader:F}),r(a,{path:"/model",handle:{crumb:()=>"model"},element:o(O,{}),children:[o(a,{index:!0,element:o(t,{})}),o(a,{element:o(t,{}),children:o(a,{path:"dimensions",children:o(a,{path:":dimensionId",element:o(G,{}),loader:T})})}),o(a,{path:"embeddings",children:o(a,{path:":embeddingDimensionId",element:o(_,{}),loader:M,handle:{crumb:l=>l.embedding.name}})})]}),r(a,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(Q,{}),children:[o(a,{index:!0,element:o(N,{})}),r(a,{path:":projectId",loader:V,handle:{crumb:l=>l.project.name},element:o(Y,{}),children:[o(a,{index:!0,element:o(q,{})}),r(a,{element:o(X,{}),children:[o(a,{path:"traces",element:o(B,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"spans",element:o(W,{}),children:o(a,{path:":traceId",element:o(d,{})})}),o(a,{path:"sessions",element:o(H,{}),children:o(a,{path:":sessionId",element:o($,{}),loader:U})}),o(a,{path:"config",element:o(J,{})}),o(a,{path:"metrics",element:o(K,{})})]})]})]}),r(a,{path:"/dashboards",handle:{crumb:()=>"Dashboards"},element:o(co,{}),children:[o(a,{index:!0,element:o(oo,{}),loader:Z}),o(a,{path:"projects/:projectId",element:o(lo,{}),loader:ao,handle:{crumb:l=>l.project.name}}),o(a,{path:":dashboardId",handle:{crumb:()=>"dashboard"},element:o(ro,{})})]}),r(a,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(a,{index:!0,element:o(go,{})}),r(a,{path:":datasetId",loader:m,handle:{crumb:l=>l.dataset.name},children:[r(a,{element:o(to,{}),loader:m,children:[o(a,{index:!0,element:o(p,{})}),o(a,{path:"experiments",element:o(p,{})}),o(a,{path:"examples",element:o(no,{}),loader:eo,children:o(a,{path:":exampleId",element:o(bo,{})})}),o(a,{path:"versions",element:o(so,{}),loader:io})]}),o(a,{path:"compare",element:o(po,{}),loader:mo,handle:{crumb:()=>"compare"}})]})]}),r(a,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(a,{index:!0,element:o(uo,{})}),o(a,{path:"spans/:spanId",element:o(ho,{}),loader:fo,handle:{crumb:l=>l.span.__typename==="Span"?`span ${l.span.spanId}`:"span unknown"}})]}),r(a,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(a,{index:!0,element:o(yo,{}),loader:vo}),r(a,{path:":promptId",loader:xo,shouldRevalidate:()=>!0,handle:{crumb:l=>l.prompt.__typename==="Prompt"?l.prompt.name:"unknown"},children:[r(a,{element:o(Ro,{}),children:[o(a,{index:!0,element:o(zo,{})}),o(a,{path:"versions",loader:wo,element:o(So,{}),children:o(a,{path:":versionId",loader:Po,element:o(ko,{})})}),o(a,{path:"config",element:o(Co,{}),loader:Lo})]}),o(a,{path:"playground",element:o(Io,{}),loader:jo,handle:{crumb:()=>"playground"}})]})]}),o(a,{path:"/apis",element:o(Eo,{}),handle:{crumb:()=>"APIs"}}),o(a,{path:"/support",element:o(Do,{}),handle:{crumb:()=>"Support"}}),r(a,{path:"/settings",element:o(Bo,{}),handle:{crumb:()=>"Settings"},children:[o(a,{path:"general",loader:Ao,element:o(Fo,{}),handle:{crumb:()=>"General"}}),o(a,{path:"providers",loader:To,element:o(Go,{}),handle:{crumb:()=>"AI Providers"}}),o(a,{path:"models",loader:Mo,element:o(_o,{}),handle:{crumb:()=>"Models"}}),o(a,{path:"annotations",loader:Oo,element:o(No,{}),handle:{crumb:()=>"Annotations"}}),o(a,{path:"data",element:o(qo,{}),handle:{crumb:()=>"Data Retention"},loader:Vo})]}),o(a,{path:"/redirects/spans/:span_otel_id",loader:Wo,errorElement:o(n,{})}),o(a,{path:"/redirects/traces/:trace_otel_id",loader:Uo,errorElement:o(n,{})}),o(a,{path:"/redirects/sessions/:session_id",loader:$o,errorElement:o(n,{})})]})})]})),{basename:window.Config.basename});function ha(){return o(y,{router:fa})}function va(){return o(Ko,{children:o(Qo,{children:o(ya,{})})})}function ya(){const{theme:l}=Zo();return o(S,{theme:l,mountGlobalStyles:!1,children:r(w.RelayEnvironmentProvider,{environment:oa,children:[o(ua,{}),o(Xo,{children:o(aa,{children:o(Yo,{children:o(z.Suspense,{children:o(la,{children:o(ha,{})})})})})})]})})}const xa=document.getElementById("root"),za=P.createRoot(xa);za.render(o(va,{}));
