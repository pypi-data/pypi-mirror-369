...
class PredictionTableJob(KumoFuture[PredictionTable]):
    ...
    def get_tags(self) -> dict[str, str]:
        ...
        return _get_prediction_table_job(self.job_id).tags
...
def _get_prediction_table_job(
        job_id: str) -> GeneratePredictionTableJobResource:
    return global_state.client.generate_prediction_table_job_api.get(job_id)
