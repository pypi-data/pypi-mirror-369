...
class TrainingTableJob(KumoProgressFuture[TrainingTable]):
    ...
    def get_tags(self) -> dict[str, str]:
        ...
        return _get_training_table_job(self.job_id).tags
...
def _get_training_table_job(job_id: str) -> GenerateTrainTableJobResource:
    return global_state.client.generate_train_table_job_api.get(job_id)
