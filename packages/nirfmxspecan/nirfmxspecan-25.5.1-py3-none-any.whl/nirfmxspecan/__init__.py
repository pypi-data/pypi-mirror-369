"""nirfmxspecan package."""

__version__ = "25.5.1"

from nirfmxspecan.attributes import *  # noqa: F403
from nirfmxspecan.enums import *  # noqa: F403
from nirfmxspecan.specan import SpecAn, _SpecAnSignalConfiguration
...
def get_diagnostic_information():
    ...
    if platform.system() == "Windows":
        ...
        os_name = "Windows"
        try:
            driver_version_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, r"SOFTWARE\National Instruments\RFmx\SpecAn\C Runtime Support")  # type: ignore
    ...
    info["driver"]["name"] = "NI-RFmxSpecAn"
    info["driver"]["version"] = driver_version
    info["module"]["name"] = "nirfmxspecan"
    info["module"]["version"] = "25.5.1"
