...
class ConversationHandler:
    ...
    def _setup_environment(self, provider: ProviderType) -> None:
        ...
        self.config_manager.load_global_environment()

        # Then load provider-specific credentials
    ...
    def _get_provider_and_model(
        ...
        if not provider or not default_model:
            raise ValueError(
                "No default provider configured. Run 'cmdlm --configure' first."
            )
    ...
    def handle_prompt(
        ...
        if not prompt or not prompt.strip():
            self.console.print("Cannot process empty prompt.", style="yellow")
            return
            ...
            if provider_type == ProviderType.OTHER and custom_provider:
                ...
                if model_name.startswith(provider_prefix):
                    ...
                    if provider_type in [
                        ...
                        # For most providers like Groq, etc. don't add prefix
                        actual_model = model_name
