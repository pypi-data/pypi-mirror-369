...
class ModelPostDataRelationships(BaseModel):
    """
    ModelPostDataRelationships
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelPostDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelPostDataRelationships from a dict"""
        if obj is None:
            return None
