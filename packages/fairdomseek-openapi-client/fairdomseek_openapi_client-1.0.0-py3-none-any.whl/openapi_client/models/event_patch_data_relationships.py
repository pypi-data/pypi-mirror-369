...
class EventPatchDataRelationships(BaseModel):
    """
    EventPatchDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["projects", "data_files", "publications", "presentations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventPatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventPatchDataRelationships from a dict"""
        if obj is None:
            return None
