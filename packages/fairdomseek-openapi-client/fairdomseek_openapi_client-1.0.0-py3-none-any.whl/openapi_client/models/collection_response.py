...
class CollectionResponse(BaseModel):
    ...
    included: Optional[Annotated[List[CollectionItem], Field(min_length=0)]] = None
    jsonapi: JsonApiVersion
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["data", "included", "jsonapi"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CollectionResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "included": [CollectionItem.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
