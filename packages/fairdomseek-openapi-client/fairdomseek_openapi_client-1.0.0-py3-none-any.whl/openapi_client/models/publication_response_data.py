...
class PublicationResponseData(BaseModel):
    """
    PublicationResponseData
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: PublicationType
    attributes: PublicationResponseDataAttributes
    relationships: PublicationResponseDataRelationships
    links: Links
    meta: Meta
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicationResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicationResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": PublicationResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": PublicationResponseDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
