...
class StudyPatchDataAttributes(BaseModel):
    """
    StudyPatchDataAttributes
    """ # noqa: E501
    ...
    experimentalists: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "experimentalists", "other_creators", "creators", "policy", "extended_attributes", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyPatchDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "experimentalists": obj.get("experimentalists"),
