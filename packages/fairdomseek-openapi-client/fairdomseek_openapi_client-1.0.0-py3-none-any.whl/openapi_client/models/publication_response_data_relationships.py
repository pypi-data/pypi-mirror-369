...
class PublicationResponseDataRelationships(BaseModel):
    """
    PublicationResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["people", "projects", "investigations", "studies", "assays", "data_files", "models", "presentations", "events", "workflows", "creators", "submitter"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PublicationResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PublicationResponseDataRelationships from a dict"""
        if obj is None:
            return None
