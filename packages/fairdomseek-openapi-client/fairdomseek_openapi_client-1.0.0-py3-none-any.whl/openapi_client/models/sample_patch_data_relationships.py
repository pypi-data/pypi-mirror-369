...
class SamplePatchDataRelationships(BaseModel):
    """
    SamplePatchDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "people", "projects", "data_files", "assays", "sample_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SamplePatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SamplePatchDataRelationships from a dict"""
        if obj is None:
            return None
