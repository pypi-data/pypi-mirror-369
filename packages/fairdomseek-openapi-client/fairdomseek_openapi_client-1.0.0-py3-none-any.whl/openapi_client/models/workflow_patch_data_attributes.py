...
class WorkflowPatchDataAttributes(BaseModel):
    """
    WorkflowPatchDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tags", "topic_annotations", "operation_annotations", "tools", "title", "description", "workflow_class", "license", "policy", "other_creators", "creators", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowPatchDataAttributes from a dict"""
        if obj is None:
            return None
