...
class ModelPatchDataRelationships(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creators", "projects", "assays", "publications", "organisms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelPatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelPatchDataRelationships from a dict"""
        if obj is None:
            return None
