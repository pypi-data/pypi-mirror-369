...
class ProjectResponseDataAttributes(BaseModel):
    """
    ProjectResponseDataAttributes
    """ # noqa: E501
    ...
    wiki_page: Annotated[str, Field(min_length=1, strict=True)]
    default_policy: Optional[Policy] = None
    default_license: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    members: Optional[List[ProjectMembersListInner]] = None
    use_default_policy: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["avatar", "title", "description", "web_page", "wiki_page", "default_policy", "default_license", "discussion_links", "extended_attributes", "topic_annotations", "start_date", "end_date", "members", "use_default_policy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectResponseDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "wiki_page": obj.get("wiki_page"),
            "default_policy": Policy.from_dict(obj["default_policy"]) if obj.get("default_policy") is not None else None,
            ...
            "members": [ProjectMembersListInner.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
            "use_default_policy": obj.get("use_default_policy")
        })
        return _obj
