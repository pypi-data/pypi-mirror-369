...
class SampleResponseDataRelationships(BaseModel):
    """
    SampleResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "submitter", "people", "projects", "data_files", "assays", "studies", "investigations", "sample_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleResponseDataRelationships from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.sample_type:
            _dict['sample_type'] = self.sample_type.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleResponseDataRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sample_type": SingleReference.from_dict(obj["sample_type"]) if obj.get("sample_type") is not None else None
        })
        return _obj
