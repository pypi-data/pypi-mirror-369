...
class WorkflowPatchDataRelationships(BaseModel):
    """
    WorkflowPatchDataRelationships
    """ # noqa: E501
    ...
    presentations: Optional[MultipleReferences] = None
    data_files: Optional[MultipleReferences] = None
    documents: Optional[MultipleReferences] = None
    __properties: ClassVar[List[str]] = ["creators", "projects", "assays", "publications", "sops", "presentations", "data_files", "documents"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowPatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowPatchDataRelationships from a dict"""
        if obj is None:
            return None
