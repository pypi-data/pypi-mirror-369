...
class SampleResponseData(BaseModel):
    ...
    type: SampleType
    attributes: SampleResponseDataAttributes
    relationships: SampleResponseDataRelationships
    links: Links
    meta: Meta
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": SampleResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": SampleResponseDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
