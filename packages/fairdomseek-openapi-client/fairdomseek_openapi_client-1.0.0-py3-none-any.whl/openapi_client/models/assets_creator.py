...
class AssetsCreator(BaseModel):
    """
    AssetsCreator
    """ # noqa: E501
    pos: Optional[StrictInt] = None
    profile: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    given_name: Annotated[str, Field(min_length=1, strict=True)]
    family_name: Annotated[str, Field(min_length=1, strict=True)]
    orcid: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    affiliation: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["pos", "profile", "given_name", "family_name", "orcid", "affiliation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetsCreator from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetsCreator from a dict"""
        if obj is None:
            return None
