...
class RemoteContentBlob(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "original_filename", "content_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RemoteContentBlob from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RemoteContentBlob from a dict"""
        if obj is None:
            return None
