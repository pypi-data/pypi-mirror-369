...
class PersonResponseDataAttributes(BaseModel):
    """
    PersonResponseDataAttributes
    """ # noqa: E501
    avatar: Annotated[str| None, Field(min_length=0, strict=True)] = None
    title: Annotated[str, Field(min_length=1, strict=True)]
    description: Annotated[str | None, Field(min_length=0, strict=True)] = None
    first_name: Annotated[str, Field(min_length=0, strict=True)]
    last_name: Annotated[str, Field(min_length=0, strict=True)]
    web_page: Optional[Annotated[str, Field(min_length=0, strict=True)]] = None
    orcid: Annotated[str | None, Field(min_length=0, strict=True)] = None
    mbox_sha1sum: Annotated[str, Field(min_length=5, strict=True, max_length=40)]
    expertise: List[Annotated[str, Field(min_length=1, strict=True)]]
    tools: List[Annotated[str, Field(min_length=1, strict=True)]]
    phone: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    skype_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    login: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["avatar", "title", "description", "first_name", "last_name", "web_page", "orcid", "mbox_sha1sum", "expertise", "tools", "phone", "skype_name", "login"]

    @field_validator('mbox_sha1sum')
    def mbox_sha1sum_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"[0-9a-f]{5,40}", value):
            raise ValueError(r"must validate the regular expression /[0-9a-f]{5,40}/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonResponseDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "web_page": obj.get("web_page"),
            "orcid": obj.get("orcid"),
            "mbox_sha1sum": obj.get("mbox_sha1sum"),
            "expertise": obj.get("expertise"),
            "tools": obj.get("tools"),
            "phone": obj.get("phone"),
            "skype_name": obj.get("skype_name"),
            "login": obj.get("login")
        })
        return _obj
