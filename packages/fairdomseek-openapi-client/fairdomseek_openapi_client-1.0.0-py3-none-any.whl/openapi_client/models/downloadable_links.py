...
class DownloadableLinks(BaseModel):
    """
    DownloadableLinks
    """ # noqa: E501
    var_self: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="self")
    download: Annotated[str, Field(min_length=1, strict=True)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DownloadableLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DownloadableLinks from a dict"""
        if obj is None:
            return None
