...
class OrganismResponse(BaseModel):
    ...
    OrganismResponse
    """ # noqa: E501
    data: OrganismResponseData
    jsonapi: JsonApiVersion
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["data", "jsonapi"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganismResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganismResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": OrganismResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
