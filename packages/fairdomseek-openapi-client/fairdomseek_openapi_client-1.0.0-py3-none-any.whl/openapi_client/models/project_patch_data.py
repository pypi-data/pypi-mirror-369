...
class ProjectPatchData(BaseModel):
    ...
    type: ProjectType
    attributes: Optional[ProjectPatchDataAttributes] = None
    relationships: Optional[ProjectPostDataRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectPatchData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectPatchData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ProjectPatchDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": ProjectPostDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
