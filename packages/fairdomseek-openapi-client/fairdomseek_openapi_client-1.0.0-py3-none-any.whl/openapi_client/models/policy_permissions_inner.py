...
class PolicyPermissionsInner(BaseModel):
    """
    PolicyPermissionsInner
    """ # noqa: E501
    resource: PermissionResource
    access: AccessTypes
    __properties: ClassVar[List[str]] = ["resource", "access"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PolicyPermissionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PolicyPermissionsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resource": PermissionResource.from_dict(obj["resource"]) if obj.get("resource") is not None else None,
