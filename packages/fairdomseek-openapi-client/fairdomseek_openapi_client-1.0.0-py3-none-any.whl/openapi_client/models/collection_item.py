...
class CollectionItem(BaseModel):
    ...
    relationships: CollectionItemRelationships
    links: Links
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CollectionItemAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CollectionItemRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "links": Links.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "meta": CollectionItemMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
