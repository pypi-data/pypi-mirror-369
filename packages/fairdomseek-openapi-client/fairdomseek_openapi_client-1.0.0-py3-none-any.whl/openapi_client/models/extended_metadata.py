...
class ExtendedMetadata(BaseModel):
    ...
    ExtendedMetadata
    """ # noqa: E501
    extended_metadata_type_id: StrictStr
    attribute_map: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["extended_metadata_type_id", "attribute_map"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "extended_metadata_type_id": obj.get("extended_metadata_type_id"),
