...
class PersonPatchData(BaseModel):
    ...
    type: PeopleType
    attributes: Optional[PersonPatchDataAttributes] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonPatchData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonPatchData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": PersonPatchDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
