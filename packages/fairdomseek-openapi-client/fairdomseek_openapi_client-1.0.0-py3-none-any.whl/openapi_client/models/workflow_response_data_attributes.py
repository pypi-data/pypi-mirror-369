...
class WorkflowResponseDataAttributes(BaseModel):
    """
    WorkflowResponseDataAttributes
    """ # noqa: E501
    ...
    workflow_class: WorkflowResponseDataAttributesWorkflowClass
    license: Annotated[str, Field(min_length=1, strict=True)]
    latest_version: Union[StrictFloat, StrictInt]
    versions: Annotated[List[WorkflowResponseDataAttributesVersionsInner], Field(min_length=1)]
    ...
    internals: Optional[WorkflowResponseDataAttributesInternals] = None
    ...
    __properties: ClassVar[List[str]] = ["tags", "topic_annotations", "operation_annotations", "title", "description", "workflow_class", "license", "latest_version", "versions", "version", "revision_comments", "doi", "created_at", "updated_at", "content_blobs", "policy", "other_creators", "creators", "internals", "discussion_links", "tools"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataAttributes from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of internals
        if self.internals:
            _dict['internals'] = self.internals.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "workflow_class": WorkflowResponseDataAttributesWorkflowClass.from_dict(obj["workflow_class"]) if obj.get("workflow_class") is not None else None,
            "license": obj.get("license"),
            "latest_version": obj.get("latest_version"),
            "versions": [WorkflowResponseDataAttributesVersionsInner.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None,
            ...
            "internals": WorkflowResponseDataAttributesInternals.from_dict(obj["internals"]) if obj.get("internals") is not None else None,
