...
class InstitutionPatchDataAttributes(BaseModel):
    """
    InstitutionPatchDataAttributes
    """ # noqa: E501
    avatar: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["avatar", "title", "country", "city", "address", "web_page", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstitutionPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstitutionPatchDataAttributes from a dict"""
        if obj is None:
            return None
