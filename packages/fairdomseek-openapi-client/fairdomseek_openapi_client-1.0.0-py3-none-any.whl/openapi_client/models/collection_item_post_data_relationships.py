...
class CollectionItemPostDataRelationships(BaseModel):
    """
    CollectionItemPostDataRelationships
    """ # noqa: E501
    asset: SingleReference
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionItemPostDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionItemPostDataRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "asset": SingleReference.from_dict(obj["asset"]) if obj.get("asset") is not None else None
        })
        return _obj
