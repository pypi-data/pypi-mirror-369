...
class AssayAttributes(BaseModel):
    """
    AssayAttributes
    """ # noqa: E501
    ...
    assay_class: AssayAttributesAssayClass
    assay_type: AssayAttributesAssayType
    technology_type: AssayAttributesTechnologyType
    discussion_links: Optional[Annotated[List[AssetLink], Field(min_length=0)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "assay_class", "assay_type", "technology_type", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "assay_class": AssayAttributesAssayClass.from_dict(obj["assay_class"]) if obj.get("assay_class") is not None else None,
            "assay_type": AssayAttributesAssayType.from_dict(obj["assay_type"]) if obj.get("assay_type") is not None else None,
            "technology_type": AssayAttributesTechnologyType.from_dict(obj["technology_type"]) if obj.get("technology_type") is not None else None,
