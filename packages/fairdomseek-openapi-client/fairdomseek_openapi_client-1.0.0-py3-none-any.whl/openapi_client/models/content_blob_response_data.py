...
class ContentBlobResponseData(BaseModel):
    """
    ContentBlobResponseData
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: ContentBlobType
    attributes: ContentBlobResponseDataAttributes
    relationships: CollectionItemPostDataRelationships
    links: DownloadableLinks
    meta: Meta
    __properties: ClassVar[List[str]] = ["id", "type", "attributes", "relationships", "links", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentBlobResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ContentBlobResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CollectionItemPostDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "links": DownloadableLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
