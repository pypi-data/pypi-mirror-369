...
class InvestigationPatchData(BaseModel):
    """
    InvestigationPatchData
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: InvestigationType
    attributes: Optional[InvestigationPatchDataAttributes] = None
    relationships: Optional[InvestigationPatchDataRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvestigationPatchData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvestigationPatchData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": InvestigationPatchDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": InvestigationPatchDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
