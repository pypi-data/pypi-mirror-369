...
class InvestigationPatchDataRelationships(BaseModel):
    """
    InvestigationPatchDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "projects", "publications"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvestigationPatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvestigationPatchDataRelationships from a dict"""
        if obj is None:
            return None
