...
class CollectionPostDataRelationships(BaseModel):
    """
    CollectionPostDataRelationships
    """ # noqa: E501
    creators: Optional[MultipleReferences] = None
    projects: MultipleReferences
    __properties: ClassVar[List[str]] = ["creators", "projects"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionPostDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionPostDataRelationships from a dict"""
        if obj is None:
            return None
