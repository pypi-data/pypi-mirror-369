...
class ProgrammeDataType(BaseModel):
    """
    ProgrammeDataType
    """ # noqa: E501
    avatar: Annotated[str, Field(min_length=1, strict=True)]
    title: Annotated[str, Field(min_length=1, strict=True)]
    description: Annotated[str, Field(min_length=1, strict=True)]
    web_page: Annotated[str, Field(min_length=1, strict=True)]
    funding_details: Annotated[str, Field(min_length=1, strict=True)]
    funding_codes: List[Annotated[str, Field(min_length=1, strict=True)]]
    discussion_links: Optional[Annotated[List[AssetLink], Field(min_length=0)]] = None
    __properties: ClassVar[List[str]] = ["avatar", "title", "description", "web_page", "funding_details", "funding_codes", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammeDataType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammeDataType from a dict"""
        if obj is None:
            return None
