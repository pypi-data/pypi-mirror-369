...
class ProjectPatchDataAttributes(BaseModel):
    """
    ProjectPatchDataAttributes
    """ # noqa: E501
    ...
    wiki_page: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["avatar", "title", "description", "web_page", "wiki_page", "default_policy", "default_license", "discussion_links", "extended_attributes", "topic_annotations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectPatchDataAttributes from a dict"""
        if obj is None:
            return None
