...
class PersonPatchDataAttributes(BaseModel):
    """
    PersonPatchDataAttributes
    """ # noqa: E501
    ...
    orcid: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    expertise: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    tools: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    ...
    __properties: ClassVar[List[str]] = ["description", "first_name", "last_name", "email", "web_page", "orcid", "expertise", "tools", "phone", "skype_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonPatchDataAttributes from a dict"""
        if obj is None:
            return None
