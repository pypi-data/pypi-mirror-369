...
class SamplePatchDataAttributes(BaseModel):
    """
    SamplePatchDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tags", "other_creators", "attribute_map", "policy", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SamplePatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SamplePatchDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "attribute_map": obj.get("attribute_map"),
