...
class ProgrammePostDataRelationships(BaseModel):
    """
    ProgrammePostDataRelationships
    """ # noqa: E501
    administrators: Optional[MultipleReferences] = None
    projects: Optional[MultipleReferences] = None
    __properties: ClassVar[List[str]] = ["administrators", "projects"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammePostDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammePostDataRelationships from a dict"""
        if obj is None:
            return None
