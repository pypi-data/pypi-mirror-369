...
class PersonResponseDataRelationships(BaseModel):
    """
    PersonResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["projects", "institutions", "investigations", "studies", "assays", "data_files", "documents", "models", "sops", "publications", "presentations", "events", "collections", "workflows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonResponseDataRelationships from a dict"""
        if obj is None:
            return None
