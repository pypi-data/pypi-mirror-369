...
class DocumentPatchDataRelationships(BaseModel):
    """
    DocumentPatchDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "projects", "assays", "workflows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentPatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentPatchDataRelationships from a dict"""
        if obj is None:
            return None
