...
class SampleTypeResponseDataAttributes(BaseModel):
    """
    SampleTypeResponseDataAttributes
    """ # noqa: E501
    ...
    sample_attributes: Optional[Annotated[List[SampleTypeSampleAttributeResponse], Field(min_length=1)]] = None
    tags: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    __properties: ClassVar[List[str]] = ["title", "description", "policy", "discussion_links", "sample_attributes", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypeResponseDataAttributes from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sample_attributes (list)
        _items = []
        if self.sample_attributes:
            for _item_sample_attributes in self.sample_attributes:
                if _item_sample_attributes:
                    _items.append(_item_sample_attributes.to_dict())
            _dict['sample_attributes'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypeResponseDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sample_attributes": [SampleTypeSampleAttributeResponse.from_dict(_item) for _item in obj["sample_attributes"]] if obj.get("sample_attributes") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
