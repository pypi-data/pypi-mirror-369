...
class CollectionItemRelationships(BaseModel):
    """
    CollectionItemRelationships
    """ # noqa: E501
    asset: Optional[SingleReferenceWithTitle] = None
    collection: SingleReference
    __properties: ClassVar[List[str]] = ["asset", "collection"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionItemRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionItemRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "asset": SingleReferenceWithTitle.from_dict(obj["asset"]) if obj.get("asset") is not None else None,
            "collection": SingleReference.from_dict(obj["collection"]) if obj.get("collection") is not None else None
        })
        return _obj
