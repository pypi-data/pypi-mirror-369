...
class SampleResponseDataAttributes(BaseModel):
    """
    SampleResponseDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tags", "title", "created_at", "updated_at", "other_creators", "attribute_map", "policy", "creators", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleResponseDataAttributes from a dict"""
        if obj is None:
            return None
