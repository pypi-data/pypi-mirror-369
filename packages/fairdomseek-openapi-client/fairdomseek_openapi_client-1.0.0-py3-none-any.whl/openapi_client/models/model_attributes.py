...
class ModelAttributes(BaseModel):
    ...
    model_type: Annotated[str, Field(min_length=1, strict=True)]
    model_format: Annotated[str, Field(min_length=1, strict=True)]
    environment: Annotated[str, Field(min_length=1, strict=True)]
    ...
    model_image_link: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "license", "latest_version", "versions", "version", "revision_comments", "doi", "created_at", "updated_at", "content_blobs", "model_type", "model_format", "environment", "policy", "extended_attributes", "other_creators", "creators", "discussion_links", "model_image_link"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "model_image_link": obj.get("model_image_link")
        })
        return _obj
