...
class ProgrammePatchData(BaseModel):
    """
    ProgrammePatchData
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: ProgrammeType
    attributes: Optional[ProgrammePatchDataAttributes] = None
    relationships: Optional[ProgrammePatchDataRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammePatchData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammePatchData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ProgrammePatchDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": ProgrammePatchDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
