...
class ModelPatchDataAttributes(BaseModel):
    """
    ModelPatchDataAttributes
    """ # noqa: E501
    ...
    model_type: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    model_format: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "license", "policy", "other_creators", "creators", "model_type", "model_format", "environment", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelPatchDataAttributes from a dict"""
        if obj is None:
            return None
