...
class WorkflowResponseData(BaseModel):
    ...
    type: WorkflowType
    attributes: WorkflowResponseDataAttributes
    relationships: WorkflowResponseDataRelationships
    links: WorkflowResponseDataLinks
    meta: Meta
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": WorkflowResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": WorkflowResponseDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "links": WorkflowResponseDataLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
