...
class ExtendedMetadataTypeResponseDataMeta(BaseModel):
    """
    ExtendedMetadataTypeResponseDataMeta
    """ # noqa: E501
    base_url: Annotated[str, Field(min_length=1, strict=True)]
    api_version: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["base_url", "api_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponseDataMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponseDataMeta from a dict"""
        if obj is None:
            return None
