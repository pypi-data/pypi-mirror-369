...
class SampleTypeSampleAttributePost(BaseModel):
    ...
    unit_symbol: Optional[Annotated[str, Field(min_length=0, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "pid", "sample_attribute_type", "required", "pos", "unit_symbol", "is_title", "sample_controlled_vocab_id", "linked_sample_type_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributePost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributePost from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pos": obj.get("pos"),
            "unit_symbol": obj.get("unit_symbol"),
