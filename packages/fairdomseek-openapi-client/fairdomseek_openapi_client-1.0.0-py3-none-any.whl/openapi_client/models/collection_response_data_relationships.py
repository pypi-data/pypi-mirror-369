...
class CollectionResponseDataRelationships(BaseModel):
    """
    CollectionResponseDataRelationships
    """ # noqa: E501
    ...
    items: MultipleReferences
    __properties: ClassVar[List[str]] = ["creators", "submitter", "people", "projects", "publications", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionResponseDataRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": MultipleReferences.from_dict(obj["items"]) if obj.get("items") is not None else None
        })
        return _obj
