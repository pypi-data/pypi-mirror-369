...
class StudyResponseDataRelationships(BaseModel):
    """
    StudyResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "submitter", "people", "projects", "investigation", "assays", "data_files", "documents", "models", "sops", "publications"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StudyResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StudyResponseDataRelationships from a dict"""
        if obj is None:
            return None
