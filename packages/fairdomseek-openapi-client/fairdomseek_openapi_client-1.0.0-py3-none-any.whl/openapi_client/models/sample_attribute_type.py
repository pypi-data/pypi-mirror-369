...
class SampleAttributeType(BaseModel):
    ...
    type: SampleAttributeTypeType
    attributes: SampleAttributeTypeAttributes
    links: IndexLinks
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": SampleAttributeTypeAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
