...
class PersonPostDataAttributes(BaseModel):
    """
    PersonPostDataAttributes
    """ # noqa: E501
    ...
    last_name: Annotated[str, Field(min_length=1, strict=True)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonPostDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonPostDataAttributes from a dict"""
        if obj is None:
            return None
