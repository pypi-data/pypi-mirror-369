...
class ContentBlobPlaceholder(BaseModel):
    ...
    """ # noqa: E501
    original_filename: Annotated[str, Field(min_length=1, strict=True)]
    content_type: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["original_filename", "content_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentBlobPlaceholder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentBlobPlaceholder from a dict"""
        if obj is None:
            return None
