...
class WorkflowResponseDataAttributesInternals(BaseModel):
    """
    WorkflowResponseDataAttributesInternals
    """ # noqa: E501
    inputs: Optional[List[WorkflowInput]] = None
    steps: Optional[List[WorkflowStep]] = None
    outputs: Optional[List[WorkflowOutput]] = None
    __properties: ClassVar[List[str]] = ["inputs", "steps", "outputs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataAttributesInternals from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataAttributesInternals from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "inputs": [WorkflowInput.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None,
            "steps": [WorkflowStep.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
            "outputs": [WorkflowOutput.from_dict(_item) for _item in obj["outputs"]] if obj.get("outputs") is not None else None
        })
        return _obj
