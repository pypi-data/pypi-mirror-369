...
class SampleTypeSampleAttributePatch(BaseModel):
    ...
    pid: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    sample_attribute_type: Optional[SampleTypeSampleAttributePostSampleAttributeType] = None
    required: Optional[StrictBool] = None
    pos: Optional[StrictInt] = None
    unit_symbol: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    is_title: Optional[StrictBool] = None
    sample_controlled_vocab_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    linked_sample_type_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    destroy: Optional[StrictBool] = Field(default=None, alias="_destroy")
    __properties: ClassVar[List[str]] = ["id", "title", "description", "pid", "sample_attribute_type", "required", "pos", "unit", "is_title", "sample_controlled_vocab_id", "linked_sample_type_id", "_destroy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributePatch from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sample_attribute_type
        if self.sample_attribute_type:
            _dict['sample_attribute_type'] = self.sample_attribute_type.to_dict()
        # set to None if sample_attribute_type (nullable) is None
        # and model_fields_set contains the field
        if self.sample_attribute_type is None and "sample_attribute_type" in self.model_fields_set:
            _dict['sample_attribute_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributePatch from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pid": obj.get("pid"),
            "sample_attribute_type": SampleTypeSampleAttributePostSampleAttributeType.from_dict(obj["sample_attribute_type"]) if obj.get("sample_attribute_type") is not None else None,
            "required": obj.get("required"),
            "pos": obj.get("pos"),
            "unit_symbol": obj.get("unit"),
            "is_title": obj.get("is_title"),
            "sample_controlled_vocab_id": obj.get("sample_controlled_vocab_id"),
            "linked_sample_type_id": obj.get("linked_sample_type_id"),
