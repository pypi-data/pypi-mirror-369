...
class AssayPostDataAttributes(BaseModel):
    """
    AssayPostDataAttributes
    """ # noqa: E501
    ...
    assay_class: AssayPostDataAttributesAssayClass
    assay_type: AssayPostDataAttributesAssayType
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayPostDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayPostDataAttributes from a dict"""
        if obj is None:
            return None
