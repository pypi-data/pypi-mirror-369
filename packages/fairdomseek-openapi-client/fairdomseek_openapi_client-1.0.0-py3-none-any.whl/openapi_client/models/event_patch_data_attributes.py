...
class EventPatchDataAttributes(BaseModel):
    """
    EventPatchDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "url", "address", "city", "country", "start_date", "end_date", "policy", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventPatchDataAttributes from a dict"""
        if obj is None:
            return None
