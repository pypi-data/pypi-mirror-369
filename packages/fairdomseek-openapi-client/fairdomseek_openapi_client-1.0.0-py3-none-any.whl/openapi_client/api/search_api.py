...
class SearchApi:
    ...
    def search(
        self,
        q: Annotated[StrictStr, Field(description="The text to search for ")],
        search_type: Annotated[Optional[StrictStr], Field(description="The type of resource to return")] = None,
        ...
        """Search SEEK for a given query

        <a name=\"searchOperation\"></a>**search** returns a list of references to resources    * of the specified type  * that are visible to the authenticated user, and  * contain the specified test  

        :param q: The text to search for  (required)
        :type q: str
        :param search_type: The type of resource to return
