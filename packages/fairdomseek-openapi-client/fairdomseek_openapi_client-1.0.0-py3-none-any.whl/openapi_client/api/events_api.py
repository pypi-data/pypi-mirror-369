...
class EventsApi:
    ...
    def create_event(
        self,
        event_post: Annotated[Optional[EventPost], Field(description="The event to create.")] = None,
        ...
        <a name=\"createEvent\"></a>A **createEvent** operation creates a new instance of a <a href=\"#events\">**Event**</a>. The instance is populated with the content of the body of the API call.  The **createEvent** operation returns a JSON object representing the newly created <a href=\"#events\">**Event**</a> and redirects to its URL. 

        :param event_post: The event to create.
        :type event_post: EventPost
    ...
    def delete_event(
        ...
        <a name=\"deleteEvent\"></a>A **deleteEvent** operation will delete the specified <a href=\"#events\">**Event**</a>, if the authenticated user has sufficient access to it.  
    ...
    def list_events(
        ...
        <a name=\"listEvents\"></a>The **listEvents** operation returns a JSON object containing a list of all the <a href=\"#events\">**Events**</a> to which the authenticated user has access. 
    ...
    def read_event(
        ...
        <a name=\"readEvent\"></a>A **readEvent** operation will return information about the <a href=\"#events\">Event</a> identified, provided the authenticated user has access to it.  The **readEvent** operation returns a JSON object representing the <a href=\"#events\">**Event**</a>. 
