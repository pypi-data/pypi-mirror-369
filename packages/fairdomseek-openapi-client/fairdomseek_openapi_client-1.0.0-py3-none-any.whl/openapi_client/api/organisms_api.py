...
class OrganismsApi:
    ...
    def list_organisms(
        ...
        <a name=\"listOrganisms\"></a>The **listOrganisms** operation returns a JSON object containing a list of all the <a href=\"#organisms\">**Organisms**</a> to which the authenticated user has access. 
        ...
        _param = self._list_organisms_serialize(
    ...
    @validate_call
    def list_organisms_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_organisms_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def read_organism(
        self,
        id: Annotated[StrictInt, Field(description="The organism to fetch, patch or delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        <a name=\"readOrganism\"></a>A **readOrganism** operation will return information about the <a href=\"#organisms\">Organism</a> identified, provided the authenticated user has access to it.  The **readOrganism** operation returns a JSON object representing the <a href=\"#organisms\">**Organism**</a>. 

        :param id: The organism to fetch, patch or delete (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._read_organism_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_organism_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The organism to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_organism_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The organism to fetch, patch or delete")],
        _request_timeout: Union[
            None,
