...
class ProgrammesApi:
    ...
    def create_programme(
        self,
        programme_post: Annotated[Optional[ProgrammePost], Field(description="The programme to create.")] = None,
        ...
        <a name=\"createProgramme\"></a>A **createProgramme** operation creates a new instance of a <a href=\"#programmes\">**Programme**</a>. The instance is populated with the content of the body of the API call.  The **createProgramme** operation returns a JSON object representing the newly created <a href=\"#programmes\">**Programme**</a> and redirects to its URL. 

        :param programme_post: The programme to create.
        :type programme_post: ProgrammePost
        ...
        _param = self._create_programme_serialize(
            programme_post=programme_post,
    ...
    @validate_call
    def create_programme_with_http_info(
        self,
        programme_post: Annotated[Optional[ProgrammePost], Field(description="The programme to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_programme_without_preload_content(
        self,
        programme_post: Annotated[Optional[ProgrammePost], Field(description="The programme to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_programme_serialize(
        self,
        programme_post,
        _request_auth,
        _content_type,
        ...
        if programme_post is not None:
            _body_params = programme_post
    ...
    def delete_programme(
        ...
        <a name=\"deleteProgramme\"></a>A **deleteProgramme** operation will delete the specified <a href=\"#programmes\">**Programme**</a>, if the authenticated user has sufficient access to it.  
        ...
        _param = self._delete_programme_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_programme_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The programme to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_programme_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The programme to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_programme_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_programmes(
        ...
        <a name=\"listProgrammes\"></a>The **listProgrammes** operation returns a JSON object containing a list of all the <a href=\"#programmes\">**Programmes**</a> to which the authenticated user has access. 
        ...
        _param = self._list_programmes_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_programmes_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_programmes_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_programmes_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def read_programme(
        ...
        <a name=\"readProgramme\"></a>A **readProgramme** operation will return information about the <a href=\"#programmes\">Programme</a> identified, provided the authenticated user has access to it.  The **readProgramme** operation returns a JSON object representing the <a href=\"#programmes\">**Programme**</a>. 
        ...
        _param = self._read_programme_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_programme_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The programme to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_programme_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The programme to fetch, patch or delete")],
        _request_timeout: Union[
            None,
