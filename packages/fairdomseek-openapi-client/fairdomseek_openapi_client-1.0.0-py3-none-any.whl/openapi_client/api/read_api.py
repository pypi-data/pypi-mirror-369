...
class ReadApi:
    ...
    def current_person(
        ...
        <a name=\"currentPerson\"></a>A **currentPerson** operation will return information about the current authenticated user.  The **currentPerson** operation returns a JSON object representing the <a href=\"#people\">**Person**</a>.  If there is no current user, The **currentPerson** operation will return a 404 error. 
        ...
        _param = self._current_person_serialize(
    ...
    @validate_call
    def current_person_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def current_person_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def read_collection(
        ...
        <a name=\"readCollection\"></a>A **readCollection** operation will return information about the <a href=\"#collections\">Collection</a> identified, provided the authenticated user has access to it.  The **readCollection** operation returns a JSON object representing the <a href=\"#collections\">**Collection**</a>. 
        ...
        _param = self._read_collection_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_collection_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The collection to fetch")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_collection_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The collection to fetch")],
        _request_timeout: Union[
            None,
    ...
    def _read_collection_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def read_collection_item(
        ...
        <a name=\"readCollectionItem\"></a>A **readCollectionItem** operation will return information about the <a href=\"#collection_items\">CollectionItem</a> identified, provided the authenticated user has access to it.  The **readCollectionItem** operation returns a JSON object representing the <a href=\"#collection_items\">**Collection Item**</a>. 
        ...
        _param = self._read_collection_item_serialize(
    ...
    @validate_call
    def read_collection_item_with_http_info(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection")],
        id: Annotated[StrictInt, Field(description="The ID of the item in the collection")],
        _request_timeout: Union[
    ...
    @validate_call
    def read_collection_item_without_preload_content(
        self,
        collection_id: Annotated[StrictInt, Field(description="The ID of the collection")],
        id: Annotated[StrictInt, Field(description="The ID of the item in the collection")],
        _request_timeout: Union[
    ...
    def _read_collection_item_serialize(
        self,
        collection_id,
        id,
        _request_auth,
    ...
    def read_content_blob(
        ...
        """Fetch information on a content blob

        <a name=\"readContentBlob\"></a>A **readContentBlob** operation will return information about the <a href=\"#contentBlobs\">ContentBlob</a> identified, provided the authenticated user has access to it.  The **readContentBlob** operation may return * a JSON object representing the <a href=\"#contentBlobs\">**ContentBlob**</a>. * a csv file, if **text/csv** is specified in the **Accept** header and if the content blob can be converted into a csv or is already a csv 
        ...
        _param = self._read_content_blob_serialize(
    ...
    @validate_call
    def read_content_blob_with_http_info(
        self,
        asset_types: Annotated[StrictStr, Field(description="The types of asset being fetched, uploaded or downloaded")],
        id: Annotated[StrictInt, Field(description="The asset content to fetch, upload or download")],
        blob_id: Annotated[StrictInt, Field(description="The asset identifier to fetch, upload or download")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContentBlobResponse]:
        """Fetch information on a content blob
    ...
    @validate_call
    def read_content_blob_without_preload_content(
        self,
        asset_types: Annotated[StrictStr, Field(description="The types of asset being fetched, uploaded or downloaded")],
        id: Annotated[StrictInt, Field(description="The asset content to fetch, upload or download")],
        blob_id: Annotated[StrictInt, Field(description="The asset identifier to fetch, upload or download")],
    ...
    def _read_content_blob_serialize(
        self,
        asset_types,
        id,
        blob_id,
    ...
    def read_document(
        ...
        <a name=\"readDocument\"></a>A **readDocument** operation will return information about the <a href=\"#documents\">Document</a> identified, provided the authenticated user has access to it.  The **readDocument** operation returns a JSON object representing the <a href=\"#documents\">**Document**</a>. 
        ...
        _param = self._read_document_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_document_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The document to fetch")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_document_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The document to fetch")],
        _request_timeout: Union[
            None,
    ...
    def read_institution(
        ...
        <a name=\"readInstitution\"></a>A **readInstitution** operation will return information about the <a href=\"#institutions\">Institution</a> identified, provided the authenticated user has access to it.  The **readInstitution** operation returns a JSON object representing the <a href=\"#institutions\">**Institution**</a>. 
        ...
        _param = self._read_institution_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_institution_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The institution to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_institution_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The institution to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def _read_institution_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def read_person(
        ...
        <a name=\"readPerson\"></a>A **readPerson** operation will return information about the <a href=\"#people\">Person</a> identified, provided the authenticated user has access to it.  The **readPerson** operation returns a JSON object representing the <a href=\"#people\">**Person**</a>. 
        ...
        _param = self._read_person_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_person_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The person to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_person_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The person to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def read_presentation(
        self,
        version: Annotated[StrictInt, Field(description="The version of the presentation to get")],
        ...
        <a name=\"readPresentation\"></a>A **readPresentation** operation will return information about the <a href=\"#presentations\">Presentation</a> identified, provided the authenticated user has access to it.  The **readPresentation** operation returns a JSON object representing the <a href=\"#presentations\">**Presentation**</a>. 

        :param version: The version of the presentation to get (required)
        :type version: int
        ...
        _param = self._read_presentation_serialize(
            version=version,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def read_presentation_with_http_info(
        self,
        version: Annotated[StrictInt, Field(description="The version of the presentation to get")],
        id: Annotated[StrictInt, Field(description="The presentation to fetch, patch or delete")],
        _request_timeout: Union[
    ...
    @validate_call
    def read_presentation_without_preload_content(
        self,
        version: Annotated[StrictInt, Field(description="The version of the presentation to get")],
        id: Annotated[StrictInt, Field(description="The presentation to fetch, patch or delete")],
        _request_timeout: Union[
    ...
    def _read_presentation_serialize(
        self,
        version,
        id,
        _request_auth,
    ...
    def read_project(
        ...
        <a name=\"readProject\"></a>A **readProject** operation will return information about the <a href=\"#projects\">Project</a> identified, provided the authenticated user has access to it.  The **readProject** operation returns a JSON object representing the <a href=\"#projects\">**Project**</a>. 
    ...
    def read_publication(
        self,
        id: Annotated[StrictInt, Field(description="The publication to fetch, patch or delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        <a name=\"readPublication\"></a>A **readPublication** operation will return information about the <a href=\"#publications\">Publication</a> identified, provided the authenticated user has access to it.  The **readPublication** operation returns a JSON object representing the <a href=\"#publications\">**Publication**</a>. 

        :param id: The publication to fetch, patch or delete (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._read_publication_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_publication_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The publication to fetch, patch or delete")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PublicationResponse]:
        """Fetch a publication
    ...
    @validate_call
    def read_publication_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The publication to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def _read_publication_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def read_sample(
        ...
        <a name=\"readSampleType\"></a>A **readSample** operation will return information about the <a href=\"#samples\">Sample</a> identified, provided the authenticated user has access to it.  The **readSample** operation returns a JSON object representing the <a href=\"#samples\">**Sample**</a>.
        ...
        _param = self._read_sample_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_sample_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The sample to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_sample_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The sample to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def read_study(
        ...
        <a name=\"readStudy\"></a>A **readStudy** operation will return information about the <a href=\"#studies\">Study</a> identified, provided the authenticated user has access to it.  The **readStudy** operation returns a JSON object representing the <a href=\"#studies\">**Study**</a>. 
        ...
        _param = self._read_study_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_study_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The study to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def read_workflow(
        ...
        <a name=\"readWorkflow\"></a>A **readWorkflow** operation will return information about the <a href=\"#workflows\">Workflow</a> identified, provided the authenticated user has access to it.  Please note that currently the type of relationship between a linked workflow and data file (e.g. test or example data) isn't described through the api.  The **readWorkflow** operation returns a JSON object representing the <a href=\"#workflows\">**Workflow**</a>. 
        ...
        _param = self._read_workflow_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_workflow_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The workflow to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_workflow_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The workflow to fetch, patch or delete")],
        _request_timeout: Union[
            None,
