...
class ModelsApi:
    ...
    def create_model(
        self,
        model_post: Annotated[Optional[ModelPost], Field(description="The model to create.")] = None,
        ...
        <a name=\"createModel\"></a>A **createModel** operation creates a new instance of a <a href=\"#models\">**Model**</a>. The instance is populated with the content of the body of the API call.  The **createModel** operation returns a JSON object representing the newly created <a href=\"#models\">**Model**</a> and redirects to its URL. 

        :param model_post: The model to create.
        :type model_post: ModelPost
    ...
    def delete_model(
        ...
        <a name=\"deleteModel\"></a>A **deleteModel** operation will delete the specified <a href=\"#models\">**Model**</a>, if the authenticated user has sufficient access to it.  
    ...
    def list_models(
        ...
        <a name=\"listModels\"></a>The **listModels** operation returns a JSON object containing a list of all the <a href=\"#models\">**Models**</a> to which the authenticated user has access. 
    ...
    def read_model(
        self,
        version: Annotated[StrictInt, Field(description="The version of the model to get")],
        id: Annotated[StrictInt, Field(description="The model to fetch, patch or delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        <a name=\"readModel\"></a>A **readModel** operation will return information about the <a href=\"#models\">Model</a> identified, provided the authenticated user has access to it.  The **readModel** operation returns a JSON object representing the <a href=\"#models\">**Model**</a>. 

        :param version: The version of the model to get (required)
        :type version: int
        :param id: The model to fetch, patch or delete (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._read_model_serialize(
            version=version,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def read_model_without_preload_content(
        self,
        version: Annotated[StrictInt, Field(description="The version of the model to get")],
        id: Annotated[StrictInt, Field(description="The model to fetch, patch or delete")],
        _request_timeout: Union[
