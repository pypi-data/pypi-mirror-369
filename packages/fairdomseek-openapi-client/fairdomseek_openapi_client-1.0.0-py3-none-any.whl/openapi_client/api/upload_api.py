...
class UploadApi:
    ...
    def upload_asset_content(
        self,
        asset_types: Annotated[StrictStr, Field(description="The types of asset being fetched, uploaded or downloaded")],
        id: Annotated[StrictInt, Field(description="The asset content to fetch, upload or download")],
        blob_id: Annotated[StrictInt, Field(description="The asset identifier to fetch, upload or download")],
        body: Annotated[Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]], Field(description="The blob content to fetch, upload or download")] = None,
        ...
        """Upload content to an existing content blob placeholder

        <a name=\"uploadAssetContent\"></a>Upload the message body into the blob of the identified asset

        :param asset_types: The types of asset being fetched, uploaded or downloaded (required)
        :type asset_types: str
        :param id: The asset content to fetch, upload or download (required)
        :type id: int
        :param blob_id: The asset identifier to fetch, upload or download (required)
        :type blob_id: int
        :param body: The blob content to fetch, upload or download
        :type body: bytearray
        ...
        _param = self._upload_asset_content_serialize(
    ...
    @validate_call
    def upload_asset_content_with_http_info(
        self,
        asset_types: Annotated[StrictStr, Field(description="The types of asset being fetched, uploaded or downloaded")],
        id: Annotated[StrictInt, Field(description="The asset content to fetch, upload or download")],
        blob_id: Annotated[StrictInt, Field(description="The asset identifier to fetch, upload or download")],
    ...
    @validate_call
    def upload_asset_content_without_preload_content(
        self,
        asset_types: Annotated[StrictStr, Field(description="The types of asset being fetched, uploaded or downloaded")],
        id: Annotated[StrictInt, Field(description="The asset content to fetch, upload or download")],
        blob_id: Annotated[StrictInt, Field(description="The asset identifier to fetch, upload or download")],
    ...
    def _upload_asset_content_serialize(
        self,
        asset_types,
        id,
        blob_id,
        ...
        if asset_types is not None:
            _path_params['asset_types'] = asset_types
        if id is not None:
            _path_params['id'] = id
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/{asset_types}/{id}/content_blobs/{blob_id}',
