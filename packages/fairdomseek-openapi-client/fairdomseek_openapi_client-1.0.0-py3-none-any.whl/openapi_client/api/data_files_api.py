...
class DataFilesApi:
    ...
    def create_data_file(
        self,
        data_file_post: Annotated[Optional[DataFilePost], Field(description="The dataFile to create.")] = None,
        ...
        <a name=\"createDataFile\"></a>A **createDataFile** operation creates a new instance of a <a href=\"#dataFiles\">**DataFile**</a>. The instance is populated with the content of the body of the API call.  Please note that when linking a data file to a workflow it currently isn't possible to define the relationship type (e.g test data, example data) through the api.  The **createDataFile** operation returns a JSON object representing the newly created <a href=\"#dataFiles\">**DataFile**</a> and redirects to its URL. 

        :param data_file_post: The dataFile to create.
        :type data_file_post: DataFilePost
        ...
        _param = self._create_data_file_serialize(
            data_file_post=data_file_post,
    ...
    @validate_call
    def create_data_file_with_http_info(
        self,
        data_file_post: Annotated[Optional[DataFilePost], Field(description="The dataFile to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_data_file_without_preload_content(
        self,
        data_file_post: Annotated[Optional[DataFilePost], Field(description="The dataFile to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_data_file_serialize(
        self,
        data_file_post,
        _request_auth,
        _content_type,
        ...
        if data_file_post is not None:
            _body_params = data_file_post
    ...
    def delete_data_file(
        ...
        <a name=\"deleteDataFile\"></a>A **deleteDataFile** operation will delete the specified <a href=\"#dataFiles\">**DataFile**</a>, if the authenticated user has sufficient access to it.  
        ...
        _param = self._delete_data_file_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_data_file_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The data file to fetch")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_data_file_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The data file to fetch")],
        _request_timeout: Union[
            None,
    ...
    def _delete_data_file_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_data_files(
        ...
        <a name=\"listDataFiles\"></a>The **listDataFiles** operation returns a JSON object containing a list of all the <a href=\"#dataFiles\">**DataFiles**</a> to which the authenticated user has access. 
        ...
        _param = self._list_data_files_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_data_files_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_data_files_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_data_files_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def read_data_file(
        self,
        version: Annotated[StrictInt, Field(description="The version of the data file to get")],
        id: Annotated[StrictInt, Field(description="The data file to fetch")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        <a name=\"readDataFile\"></a>A **readDataFile** operation will return information about the <a href=\"#dataFiles\">DataFile</a> identified, provided the authenticated user has access to it.  Please note that currently the type of relationship between a linked workflow and data file (e.g. test or example data) isn't described through the api.  The **readDataFile** operation returns a JSON object representing the <a href=\"#dataFiles\">**DataFile**</a>. 

        :param version: The version of the data file to get (required)
        :type version: int
        :param id: The data file to fetch (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._read_data_file_serialize(
            version=version,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def read_data_file_with_http_info(
        self,
        version: Annotated[StrictInt, Field(description="The version of the data file to get")],
        id: Annotated[StrictInt, Field(description="The data file to fetch")],
        _request_timeout: Union[
    ...
    @validate_call
    def read_data_file_without_preload_content(
        self,
        version: Annotated[StrictInt, Field(description="The version of the data file to get")],
        id: Annotated[StrictInt, Field(description="The data file to fetch")],
        _request_timeout: Union[
