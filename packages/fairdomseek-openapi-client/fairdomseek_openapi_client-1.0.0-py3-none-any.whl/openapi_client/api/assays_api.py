...
class AssaysApi:
    ...
    def create_assay(
        self,
        assay_post: Annotated[Optional[AssayPost], Field(description="The assay to create.")] = None,
        ...
        <a name=\"createAssay\"></a>A **createAssay** operation creates a new instance of a <a href=\"#assays\">**Assay**</a>. The instance is populated with the content of the body of the API call.  The **createAssay** operation returns a JSON object representing the newly created <a href=\"#assays\">**Assay**</a> and redirects to its URL. 

        :param assay_post: The assay to create.
        :type assay_post: AssayPost
        ...
        _param = self._create_assay_serialize(
            assay_post=assay_post,
    ...
    @validate_call
    def create_assay_with_http_info(
        self,
        assay_post: Annotated[Optional[AssayPost], Field(description="The assay to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_assay_without_preload_content(
        self,
        assay_post: Annotated[Optional[AssayPost], Field(description="The assay to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_assay_serialize(
        ...
        if assay_post is not None:
            _body_params = assay_post
    ...
    def delete_assay(
        ...
        <a name=\"deleteAssay\"></a>A **deleteAssay** operation will delete the specified <a href=\"#assays\">**Assay**</a>, if the authenticated user has sufficient access to it.  
        ...
        _param = self._delete_assay_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_assay_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The assay to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_assay_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The assay to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
    ...
    def list_assays(
        ...
        <a name=\"listAssays\"></a>The **listAssays** operation returns a JSON object containing a list of all the <a href=\"#assays\">**Assays**</a> to which the authenticated user has access. 
        ...
        _param = self._list_assays_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_assays_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_assays_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def read_assay(
        ...
        <a name=\"readAssay\"></a>A **readAssay** operation will return information about the <a href=\"#assays\">Assay</a> identified, provided the authenticated user has access to it.  The **readAssay** operation returns a JSON object representing the <a href=\"#assays\">**Assay**</a>. 
        ...
        _param = self._read_assay_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_assay_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The assay to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
