...
class SampleAttributeTypesApi:
    ...
    @validate_call
    def list_sample_attribute_types(
        self,
        ...
        """List possible sample attribute types
        ...
        _param = self._list_sample_attribute_types_serialize(
    ...
    @validate_call
    def list_sample_attribute_types_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_sample_attribute_types_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_sample_attribute_types_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/sample_attribute_types',
