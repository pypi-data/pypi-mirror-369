...
class DownloadApi:
    ...
    def download_asset_content(
        self,
        asset_types: Annotated[StrictStr, Field(description="The typs of asset being downloaded")],
        id: Annotated[StrictInt, Field(description="The asset to fetch")],
        blob_id: Annotated[StrictInt, Field(description="The blob to download")],
        ...
        :param asset_types: The typs of asset being downloaded (required)
        :type asset_types: str
        :param id: The asset to fetch (required)
        :type id: int
        :param blob_id: The blob to download (required)
        :type blob_id: int
        ...
        _param = self._download_asset_content_serialize(
    ...
    @validate_call
    def download_asset_content_with_http_info(
        self,
        asset_types: Annotated[StrictStr, Field(description="The typs of asset being downloaded")],
        id: Annotated[StrictInt, Field(description="The asset to fetch")],
        blob_id: Annotated[StrictInt, Field(description="The blob to download")],
    ...
    @validate_call
    def download_asset_content_without_preload_content(
        self,
        asset_types: Annotated[StrictStr, Field(description="The typs of asset being downloaded")],
        id: Annotated[StrictInt, Field(description="The asset to fetch")],
        blob_id: Annotated[StrictInt, Field(description="The blob to download")],
    ...
    def _download_asset_content_serialize(
        self,
        asset_types,
        id,
        blob_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{asset_types}/{id}/content_blobs/{blob_id}/download',
