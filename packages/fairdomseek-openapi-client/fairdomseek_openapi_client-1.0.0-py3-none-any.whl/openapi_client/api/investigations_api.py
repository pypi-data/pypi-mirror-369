...
class InvestigationsApi:
    ...
    def create_investigation(
        self,
        investigation_post: Annotated[Optional[InvestigationPost], Field(description="The investigation to create.")] = None,
        ...
        <a name=\"createInvestigation\"></a>A **createInvestigation** operation creates a new instance of a <a href=\"#investigations\">**Investigation**</a>. The instance is populated with the content of the body of the API call.  The **createInvestigation** operation returns a JSON object representing the newly created <a href=\"#investigations\">**Investigation**</a> and redirects to its URL. 

        :param investigation_post: The investigation to create.
        :type investigation_post: InvestigationPost
        ...
        _param = self._create_investigation_serialize(
    ...
    @validate_call
    def create_investigation_with_http_info(
        self,
        investigation_post: Annotated[Optional[InvestigationPost], Field(description="The investigation to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_investigation_without_preload_content(
        self,
        investigation_post: Annotated[Optional[InvestigationPost], Field(description="The investigation to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_investigation_serialize(
        self,
        investigation_post,
        _request_auth,
        _content_type,
        ...
        if investigation_post is not None:
            _body_params = investigation_post
    ...
    def delete_investigation(
        ...
        <a name=\"deleteInvestigation\"></a>A **deleteInvestigation** operation will delete the specified <a href=\"#investigations\">**Investigation**</a>, if the authenticated user has sufficient access to it.  
        ...
        _param = self._delete_investigation_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_investigation_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The investigation to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_investigation_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def read_investigation(
        ...
        <a name=\"readInvestigation\"></a>A **readInvestigation** operation will return information about the <a href=\"#investigations\">Investigation</a> identified, provided the authenticated user has access to it.  The **readInvestigation** operation returns a JSON object representing the <a href=\"#investigations\">**Investigation**</a>. 
        ...
        _param = self._read_investigation_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_investigation_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The investigation to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_investigation_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The investigation to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def _read_investigation_serialize(
        self,
        id,
        _request_auth,
        _content_type,
