...
class SopsApi:
    ...
    def create_sop(
        self,
        sop_post: Annotated[Optional[SopPost], Field(description="The sop to create.")] = None,
        ...
        <a name=\"createSop\"></a>A **createSop** operation creates a new instance of a <a href=\"#sops\">**Sop**</a>. The instance is populated with the content of the body of the API call.  The **createSop** operation returns a JSON object representing the newly created <a href=\"#sops\">**Sop**</a> and redirects to its URL. 

        :param sop_post: The sop to create.
        :type sop_post: SopPost
        ...
        _param = self._create_sop_serialize(
            sop_post=sop_post,
    ...
    @validate_call
    def create_sop_without_preload_content(
        self,
        sop_post: Annotated[Optional[SopPost], Field(description="The sop to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_sop_serialize(
        ...
        if sop_post is not None:
            _body_params = sop_post
    ...
    def delete_sop(
        ...
        <a name=\"deleteSop\"></a>A **deleteSop** operation will delete the specified <a href=\"#sops\">**Sop**</a>, if the authenticated user has sufficient access to it.  
        ...
        _param = self._delete_sop_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_sop_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The SOP to fetch, patch or delete")],
        _request_timeout: Union[
            None,
    ...
    def list_sops(
        ...
        <a name=\"listSops\"></a>The **listSops** operation returns a JSON object containing a list of all the <a href=\"#sops\">**Sops**</a> to which the authenticated user has access. 
        ...
        _param = self._list_sops_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_sops_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def read_sop(
        self,
        version: Annotated[StrictInt, Field(description="The version of the sop to get")],
        id: Annotated[StrictInt, Field(description="The SOP to fetch, patch or delete")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        <a name=\"readSop\"></a>A **readSop** operation will return information about the <a href=\"#sops\">Sop</a> identified, provided the authenticated user has access to it.  The **readSop** operation returns a JSON object representing the <a href=\"#sops\">**Sop**</a>. 

        :param version: The version of the sop to get (required)
        :type version: int
        :param id: The SOP to fetch, patch or delete (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._read_sop_serialize(
            version=version,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def read_sop_without_preload_content(
        self,
        version: Annotated[StrictInt, Field(description="The version of the sop to get")],
        id: Annotated[StrictInt, Field(description="The SOP to fetch, patch or delete")],
        _request_timeout: Union[
