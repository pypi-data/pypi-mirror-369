...
class SampleTypesApi:
    ...
    def create_sample_type(
        self,
        sample_type_post: Annotated[Optional[SampleTypePost], Field(description="The sampleType to create.")] = None,
        ...
        <a name=\"createSampleType\"></a>A **createSampleType** operation creates a new instance of a <a href=\"#sampleTypes\">**SampleType**</a>. The instance is populated with the content of the body of the API call.  The **createSampleType** operation returns a JSON object representing the newly created <a href=\"#sampleTypes\">**SampleType**</a> and redirects to its URL. 

        :param sample_type_post: The sampleType to create.
        :type sample_type_post: SampleTypePost
        ...
        _param = self._create_sample_type_serialize(
            sample_type_post=sample_type_post,
    ...
    @validate_call
    def create_sample_type_with_http_info(
        self,
        sample_type_post: Annotated[Optional[SampleTypePost], Field(description="The sampleType to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_sample_type_without_preload_content(
        self,
        sample_type_post: Annotated[Optional[SampleTypePost], Field(description="The sampleType to create.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_sample_type_serialize(
        self,
        sample_type_post,
        _request_auth,
        _content_type,
        ...
        if sample_type_post is not None:
            _body_params = sample_type_post
    ...
    def delete_sample_type(
        ...
        <a name=\"deleteSampleType\"></a>A **deleteSampleType** operation will delete the specified <a href=\"#sampleTypes\">**SampleType**</a>, if the authenticated user has sufficient access to it.  
        ...
        _param = self._delete_sample_type_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_sample_type_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The sample type to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_sample_type_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The sample type to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
    ...
    def _delete_sample_type_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_sample_types(
        ...
        _param = self._list_sample_types_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_sample_types_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_sample_types_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_sample_types_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def read_sample_type(
        ...
        <a name=\"readSampleType\"></a>A **readSampleType** operation will return information about the <a href=\"#sampleTypes\">SampleType</a> identified, provided the authenticated user has access to it.  The **readSampleType** operation returns a JSON object representing the <a href=\"#sampleTypes\">**SampleType**</a>. 
        ...
        _param = self._read_sample_type_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_sample_type_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The sample type to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def read_sample_type_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The sample type to be fetched, updated or deleted")],
        _request_timeout: Union[
            None,
    ...
    def _read_sample_type_serialize(
        self,
        id,
        _request_auth,
        _content_type,
