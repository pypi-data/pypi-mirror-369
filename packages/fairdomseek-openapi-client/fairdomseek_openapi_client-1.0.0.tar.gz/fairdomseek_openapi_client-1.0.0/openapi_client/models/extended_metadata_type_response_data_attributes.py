...
class ExtendedMetadataTypeResponseDataAttributes(BaseModel):
    """
    ExtendedMetadataTypeResponseDataAttributes
    """ # noqa: E501
    title: Annotated[str, Field(min_length=1, strict=True)]
    supported_type: Annotated[str, Field(min_length=1, strict=True)]
    enabled: StrictBool
    extended_metadata_attributes: Annotated[List[ExtendedMetadataTypeExtendedMetadataAttributeResponse], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["title", "supported_type", "enabled", "extended_metadata_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponseDataAttributes from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in extended_metadata_attributes (list)
        _items = []
        if self.extended_metadata_attributes:
            for _item_extended_metadata_attributes in self.extended_metadata_attributes:
                if _item_extended_metadata_attributes:
                    _items.append(_item_extended_metadata_attributes.to_dict())
            _dict['extended_metadata_attributes'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponseDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "supported_type": obj.get("supported_type"),
            "enabled": obj.get("enabled"),
            "extended_metadata_attributes": [ExtendedMetadataTypeExtendedMetadataAttributeResponse.from_dict(_item) for _item in obj["extended_metadata_attributes"]] if obj.get("extended_metadata_attributes") is not None else None
        })
        return _obj
