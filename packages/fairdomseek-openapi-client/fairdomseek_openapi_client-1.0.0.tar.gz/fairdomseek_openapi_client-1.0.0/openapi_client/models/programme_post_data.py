...
class ProgrammePostData(BaseModel):
    """
    ProgrammePostData
    """ # noqa: E501
    type: ProgrammeType
    attributes: ProgrammePostDataAttributes
    relationships: Optional[ProgrammePostDataRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammePostData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammePostData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": ProgrammePostDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": ProgrammePostDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
