...
class InstitutionResponseDataAttributes(BaseModel):
    """
    InstitutionResponseDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["avatar", "title", "country", "country_code", "city", "address", "web_page", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstitutionResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstitutionResponseDataAttributes from a dict"""
        if obj is None:
            return None
