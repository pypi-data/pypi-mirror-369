...
class AssayAttributesAssayClass(BaseModel):
    """
    AssayAttributesAssayClass
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayAttributesAssayClass from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayAttributesAssayClass from a dict"""
        if obj is None:
            return None
