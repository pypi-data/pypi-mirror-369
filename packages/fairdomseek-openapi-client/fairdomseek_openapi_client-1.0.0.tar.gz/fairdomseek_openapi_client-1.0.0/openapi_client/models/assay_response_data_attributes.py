...
class AssayResponseDataAttributes(BaseModel):
    """
    AssayResponseDataAttributes
    """ # noqa: E501
    snapshots: Optional[List[SnapshotSkeleton]] = None
    ...
    other_creators: Optional[Annotated[str, Field(min_length=0, strict=True)]] = None
    creators: Optional[Annotated[List[AssetsCreator], Field(min_length=0)]] = None
    assay_class: AssayResponseDataAttributesAssayClass
    assay_type: AssayResponseDataAttributesAssayType
    technology_type: AssayResponseDataAttributesTechnologyType
    ...
    __properties: ClassVar[List[str]] = ["snapshots", "tags", "title", "description", "other_creators", "creators", "assay_class", "assay_type", "technology_type", "policy", "discussion_links", "position", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayResponseDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "snapshots": [SnapshotSkeleton.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None,
            "tags": obj.get("tags"),
            "title": obj.get("title"),
            ...
            "assay_class": AssayResponseDataAttributesAssayClass.from_dict(obj["assay_class"]) if obj.get("assay_class") is not None else None,
            "assay_type": AssayResponseDataAttributesAssayType.from_dict(obj["assay_type"]) if obj.get("assay_type") is not None else None,
            "technology_type": AssayResponseDataAttributesTechnologyType.from_dict(obj["technology_type"]) if obj.get("technology_type") is not None else None,
