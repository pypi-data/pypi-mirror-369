...
class SingleReferenceWithTitle(BaseModel):
    """
    SingleReferenceWithTitle
    """ # noqa: E501
    data: ItemReference
    meta: SingleReferenceWithTitleMeta
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleReferenceWithTitle from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleReferenceWithTitle from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": ItemReference.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "meta": SingleReferenceWithTitleMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
