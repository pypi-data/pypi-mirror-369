...
class ProjectPostDataRelationships(BaseModel):
    """
    ProjectPostDataRelationships
    """ # noqa: E501
    programmes: Optional[MultipleReferences] = None
    organisms: Optional[MultipleReferences] = None
    __properties: ClassVar[List[str]] = ["programmes", "organisms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectPostDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectPostDataRelationships from a dict"""
        if obj is None:
            return None
