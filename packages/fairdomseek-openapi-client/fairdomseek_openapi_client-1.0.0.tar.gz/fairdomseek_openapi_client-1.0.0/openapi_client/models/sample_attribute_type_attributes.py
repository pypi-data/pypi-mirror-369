...
class SampleAttributeTypeAttributes(BaseModel):
    """
    SampleAttributeTypeAttributes
    """ # noqa: E501
    title: Annotated[str, Field(min_length=1, strict=True)]
    base_type: SampleAttributeBaseType
    regexp: Annotated[str, Field(min_length=1, strict=True)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["title", "base_type", "regexp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleAttributeTypeAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleAttributeTypeAttributes from a dict"""
        if obj is None:
            return None
