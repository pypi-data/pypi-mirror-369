...
class DataFilePatchDataAttributes(BaseModel):
    """
    DataFilePatchDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tags", "data_type_annotations", "data_format_annotations", "title", "description", "license", "policy", "other_creators", "creators", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataFilePatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataFilePatchDataAttributes from a dict"""
        if obj is None:
            return None
