...
class ProgrammePostDataAttributes(BaseModel):
    """
    ProgrammePostDataAttributes
    """ # noqa: E501
    title: Annotated[str, Field(min_length=1, strict=True)]
    description: Optional[Annotated[str, Field(min_length=0, strict=True)]] = None
    web_page: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    funding_details: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    funding_codes: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    discussion_links: Optional[Annotated[List[AssetLinkCreate], Field(min_length=0)]] = None
    __properties: ClassVar[List[str]] = ["title", "description", "web_page", "funding_details", "funding_codes", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammePostDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammePostDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "funding_details": obj.get("funding_details"),
            "funding_codes": obj.get("funding_codes"),
