...
class ContentBlobResponseDataAttributes(BaseModel):
    """
    ContentBlobResponseDataAttributes
    """ # noqa: E501
    original_filename: Annotated[str, Field(min_length=1, strict=True)]
    url: Annotated[str, Field(min_length=1, strict=True)]
    md5sum: Annotated[str, Field(min_length=32, strict=True, max_length=32)]
    sha1sum: Annotated[str, Field(min_length=5, strict=True, max_length=40)]
    content_type: Annotated[str, Field(min_length=1, strict=True)]
    size: Optional[StrictInt]
    __properties: ClassVar[List[str]] = ["original_filename", "url", "md5sum", "sha1sum", "content_type", "size"]
    ...
    @field_validator('sha1sum')
    def sha1sum_validate_regular_expression(cls, value):
        """Validates the regular expression"""
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentBlobResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentBlobResponseDataAttributes from a dict"""
        if obj is None:
            return None
