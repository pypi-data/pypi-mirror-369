...
class DocumentPostDataAttributes(BaseModel):
    """
    DocumentPostDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "license", "policy", "content_blobs", "other_creators", "creators", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentPostDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentPostDataAttributes from a dict"""
        if obj is None:
            return None
