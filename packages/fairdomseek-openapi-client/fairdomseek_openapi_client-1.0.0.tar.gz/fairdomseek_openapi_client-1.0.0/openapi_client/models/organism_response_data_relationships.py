...
class OrganismResponseDataRelationships(BaseModel):
    """
    OrganismResponseDataRelationships
    """ # noqa: E501
    projects: MultipleReferences
    assays: MultipleReferences
    models: MultipleReferences
    __properties: ClassVar[List[str]] = ["projects", "assays", "models"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganismResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganismResponseDataRelationships from a dict"""
        if obj is None:
            return None
