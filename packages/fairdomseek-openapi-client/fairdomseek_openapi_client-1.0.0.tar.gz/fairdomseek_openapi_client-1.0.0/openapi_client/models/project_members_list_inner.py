...
class ProjectMembersListInner(BaseModel):
    """
    ProjectMembersListInner
    """ # noqa: E501
    person_id: Annotated[str, Field(min_length=1, strict=True)]
    institution_id: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["person_id", "institution_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProjectMembersListInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProjectMembersListInner from a dict"""
        if obj is None:
            return None
