...
class ExtendedMetadataTypeResponseData(BaseModel):
    """
    ExtendedMetadataTypeResponseData
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: Annotated[str, Field(min_length=1, strict=True)]
    attributes: ExtendedMetadataTypeResponseDataAttributes
    links: Links
    meta: ExtendedMetadataTypeResponseDataMeta
    __properties: ClassVar[List[str]] = ["id", "type", "attributes", "links", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ExtendedMetadataTypeResponseDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "links": Links.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "meta": ExtendedMetadataTypeResponseDataMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
