...
class ModelPostDataAttributes(BaseModel):
    """
    ModelPostDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "license", "policy", "content_blobs", "other_creators", "creators", "model_type", "model_format", "environment", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ModelPostDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ModelPostDataAttributes from a dict"""
        if obj is None:
            return None
