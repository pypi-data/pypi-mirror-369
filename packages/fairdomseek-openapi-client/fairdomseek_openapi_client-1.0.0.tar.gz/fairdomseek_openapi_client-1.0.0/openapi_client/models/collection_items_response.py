...
class CollectionItemsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Annotated[List[CollectionItem], Field(min_length=0)]
    jsonapi: JsonApiVersion
    meta: BaseMeta
    links: Optional[IndexLinks] = None
    __properties: ClassVar[List[str]] = ["data", "jsonapi", "meta", "links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionItemsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionItemsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "jsonapi": JsonApiVersion.from_dict(obj["jsonapi"]) if obj.get("jsonapi") is not None else None,
            "meta": BaseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "links": IndexLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
