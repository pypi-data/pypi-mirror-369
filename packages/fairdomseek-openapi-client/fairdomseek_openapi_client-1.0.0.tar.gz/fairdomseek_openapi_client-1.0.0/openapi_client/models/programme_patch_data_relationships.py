...
class ProgrammePatchDataRelationships(BaseModel):
    """
    ProgrammePatchDataRelationships
    """ # noqa: E501
    administrators: Optional[MultipleReferences] = None
    people: Optional[MultipleReferences] = None
    projects: Optional[MultipleReferences] = None
    __properties: ClassVar[List[str]] = ["administrators", "people", "projects"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammePatchDataRelationships from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of administrators
        if self.administrators:
            _dict['administrators'] = self.administrators.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammePatchDataRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "administrators": MultipleReferences.from_dict(obj["administrators"]) if obj.get("administrators") is not None else None,
