...
class SnapshotSkeleton(BaseModel):
    """
    SnapshotSkeleton
    """ # noqa: E501
    snapshot: Annotated[int, Field(strict=True, ge=1)]
    url: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["snapshot", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SnapshotSkeleton from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SnapshotSkeleton from a dict"""
        if obj is None:
            return None
