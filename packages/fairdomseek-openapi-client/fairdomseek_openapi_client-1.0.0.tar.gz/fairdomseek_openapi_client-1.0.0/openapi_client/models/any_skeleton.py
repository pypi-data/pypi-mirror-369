...
class AnySkeleton(BaseModel):
    """
    AnySkeleton
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: object
    attributes: AnySkeletonAttributes
    links: Links
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnySkeleton from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnySkeleton from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": AnySkeletonAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
