...
class SampleTypeResponseDataRelationships(BaseModel):
    """
    SampleTypeResponseDataRelationships
    """ # noqa: E501
    submitter: MultipleReferences
    projects: MultipleReferences
    assays: MultipleReferences
    samples: MultipleReferences
    __properties: ClassVar[List[str]] = ["submitter", "projects", "assays", "samples"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypeResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypeResponseDataRelationships from a dict"""
        if obj is None:
            return None
