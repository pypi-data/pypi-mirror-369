...
class SampleTypeSampleAttributeResponseSampleAttributeType(BaseModel):
    """
    SampleTypeSampleAttributeResponseSampleAttributeType
    """ # noqa: E501
    ...
    base_type: Optional[SampleAttributeBaseType] = None
    regexp: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "base_type", "regexp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributeResponseSampleAttributeType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributeResponseSampleAttributeType from a dict"""
        if obj is None:
            return None
