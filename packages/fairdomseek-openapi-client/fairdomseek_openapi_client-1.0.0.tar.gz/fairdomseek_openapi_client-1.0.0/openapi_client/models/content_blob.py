...
class ContentBlob(BaseModel):
    ...
    url: Optional[Annotated[str, Field(min_length=1, strict=True)]]
    ...
    __properties: ClassVar[List[str]] = ["original_filename", "url", "md5sum", "sha1sum", "content_type", "link", "size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContentBlob from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContentBlob from a dict"""
        if obj is None:
            return None
