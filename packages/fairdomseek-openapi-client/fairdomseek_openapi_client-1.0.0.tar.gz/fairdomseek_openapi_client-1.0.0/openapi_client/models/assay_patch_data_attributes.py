...
class AssayPatchDataAttributes(BaseModel):
    """
    AssayPatchDataAttributes
    """ # noqa: E501
    ...
    assay_class: Optional[AssayPostDataAttributesAssayClass] = None
    assay_type: Optional[AssayPostDataAttributesAssayType] = None
    technology_type: Optional[AssayPostDataAttributesAssayType] = None
    policy: Optional[Policy] = None
    discussion_links: Optional[Annotated[List[AssetLinkPatchListInner], Field(min_length=0)]] = None
    extended_attributes: Optional[ExtendedMetadata] = None
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "other_creators", "creators", "assay_class", "assay_type", "technology_type", "policy", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayPatchDataAttributes from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of assay_class
        if self.assay_class:
            _dict['assay_class'] = self.assay_class.to_dict()
        # override the default output from pydantic by calling `to_dict()` of assay_type
        if self.assay_type:
            _dict['assay_type'] = self.assay_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of technology_type
        if self.technology_type:
            _dict['technology_type'] = self.technology_type.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of extended_attributes
        if self.extended_attributes:
            _dict['extended_attributes'] = self.extended_attributes.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayPatchDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "assay_class": AssayPostDataAttributesAssayClass.from_dict(obj["assay_class"]) if obj.get("assay_class") is not None else None,
            "assay_type": AssayPostDataAttributesAssayType.from_dict(obj["assay_type"]) if obj.get("assay_type") is not None else None,
            "technology_type": AssayPostDataAttributesAssayType.from_dict(obj["technology_type"]) if obj.get("technology_type") is not None else None,
            "policy": Policy.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "discussion_links": [AssetLinkPatchListInner.from_dict(_item) for _item in obj["discussion_links"]] if obj.get("discussion_links") is not None else None,
            "extended_attributes": ExtendedMetadata.from_dict(obj["extended_attributes"]) if obj.get("extended_attributes") is not None else None
        })
        return _obj
