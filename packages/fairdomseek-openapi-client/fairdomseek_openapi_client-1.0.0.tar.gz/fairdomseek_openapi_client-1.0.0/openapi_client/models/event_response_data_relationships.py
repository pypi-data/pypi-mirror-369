...
class EventResponseDataRelationships(BaseModel):
    """
    EventResponseDataRelationships
    """ # noqa: E501
    submitter: Optional[MultipleReferences] = None
    projects: MultipleReferences
    data_files: MultipleReferences
    publications: MultipleReferences
    presentations: MultipleReferences
    __properties: ClassVar[List[str]] = ["submitter", "projects", "data_files", "publications", "presentations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventResponseDataRelationships from a dict"""
        if obj is None:
            return None
