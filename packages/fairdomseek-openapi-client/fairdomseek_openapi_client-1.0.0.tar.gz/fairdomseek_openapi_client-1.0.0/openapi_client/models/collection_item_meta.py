...
class CollectionItemMeta(BaseModel):
    """
    CollectionItemMeta
    """ # noqa: E501
    ...
    created: datetime
    modified: datetime
    __properties: ClassVar[List[str]] = ["base_url", "api_version", "created", "modified"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionItemMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionItemMeta from a dict"""
        if obj is None:
            return None
