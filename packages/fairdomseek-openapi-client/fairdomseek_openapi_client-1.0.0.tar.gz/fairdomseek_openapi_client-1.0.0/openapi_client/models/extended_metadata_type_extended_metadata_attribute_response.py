...
class ExtendedMetadataTypeExtendedMetadataAttributeResponse(BaseModel):
    """
    ExtendedMetadataTypeExtendedMetadataAttributeResponse
    """ # noqa: E501
    ...
    sample_attribute_type: SampleTypeSampleAttributeResponseSampleAttributeType
    required: StrictBool
    pos: Optional[StrictInt] = None
    sample_controlled_vocab_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    linked_extended_metadata_type_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "label", "description", "pid", "sample_attribute_type", "required", "pos", "sample_controlled_vocab_id", "linked_extended_metadata_type_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeExtendedMetadataAttributeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeExtendedMetadataAttributeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pid": obj.get("pid"),
            "sample_attribute_type": SampleTypeSampleAttributeResponseSampleAttributeType.from_dict(obj["sample_attribute_type"]) if obj.get("sample_attribute_type") is not None else None,
            "required": obj.get("required"),
            "pos": obj.get("pos"),
            "sample_controlled_vocab_id": obj.get("sample_controlled_vocab_id"),
            "linked_extended_metadata_type_id": obj.get("linked_extended_metadata_type_id")
        })
        return _obj
