...
class WorkflowResponseDataAttributesWorkflowClass(BaseModel):
    """
    WorkflowResponseDataAttributesWorkflowClass
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["title", "key", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataAttributesWorkflowClass from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataAttributesWorkflowClass from a dict"""
        if obj is None:
            return None
