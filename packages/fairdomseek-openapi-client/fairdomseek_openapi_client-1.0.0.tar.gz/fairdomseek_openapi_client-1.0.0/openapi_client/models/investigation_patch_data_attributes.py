...
class InvestigationPatchDataAttributes(BaseModel):
    """
    InvestigationPatchDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "other_creators", "creators", "policy", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvestigationPatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvestigationPatchDataAttributes from a dict"""
        if obj is None:
            return None
