...
class SampleTypeSampleAttributeResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "pid", "sample_attribute_type", "required", "pos", "unit", "is_title", "sample_controlled_vocab_id", "linked_sample_type_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypeSampleAttributeResponse from a dict"""
        if obj is None:
            return None
