...
class SampleTypePatchDataAttributes(BaseModel):
    """
    SampleTypePatchDataAttributes
    """ # noqa: E501
    ...
    sample_attributes: Optional[Annotated[List[SampleTypeSampleAttributePatch], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "policy", "discussion_links", "sample_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypePatchDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypePatchDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sample_attributes": [SampleTypeSampleAttributePatch.from_dict(_item) for _item in obj["sample_attributes"]] if obj.get("sample_attributes") is not None else None
        })
        return _obj
