...
class DataFileResponseDataRelationships(BaseModel):
    """
    DataFileResponseDataRelationships
    """ # noqa: E501
    ...
    file_template: SingleReference
    placeholder: SingleReference
    workflows: MultipleReferences
    __properties: ClassVar[List[str]] = ["creators", "submitter", "people", "projects", "investigations", "studies", "assays", "publications", "events", "file_template", "placeholder", "workflows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataFileResponseDataRelationships from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of file_template
        if self.file_template:
            _dict['file_template'] = self.file_template.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataFileResponseDataRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "file_template": SingleReference.from_dict(obj["file_template"]) if obj.get("file_template") is not None else None,
            "placeholder": SingleReference.from_dict(obj["placeholder"]) if obj.get("placeholder") is not None else None,
