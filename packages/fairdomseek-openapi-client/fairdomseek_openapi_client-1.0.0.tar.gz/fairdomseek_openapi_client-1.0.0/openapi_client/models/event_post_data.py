...
class EventPostData(BaseModel):
    """
    EventPostData
    """ # noqa: E501
    type: EventType
    attributes: EventPostDataAttributes
    relationships: EventPostDataRelationships
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventPostData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventPostData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": EventPostDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": EventPostDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
