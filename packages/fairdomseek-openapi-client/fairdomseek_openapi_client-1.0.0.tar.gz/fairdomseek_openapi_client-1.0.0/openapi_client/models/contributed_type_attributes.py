...
class ContributedTypeAttributes(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tags", "title", "description", "license", "latest_version", "versions", "version", "revision_comments", "doi", "created_at", "updated_at", "content_blobs", "policy", "other_creators", "creators", "discussion_links", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContributedTypeAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContributedTypeAttributes from a dict"""
        if obj is None:
            return None
