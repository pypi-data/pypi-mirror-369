...
class InstitutionResponseDataRelationships(BaseModel):
    """
    InstitutionResponseDataRelationships
    """ # noqa: E501
    people: MultipleReferences
    projects: MultipleReferences
    __properties: ClassVar[List[str]] = ["people", "projects"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstitutionResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstitutionResponseDataRelationships from a dict"""
        if obj is None:
            return None
