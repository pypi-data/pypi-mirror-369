...
class CollectionPostData(BaseModel):
    """
    CollectionPostData
    """ # noqa: E501
    type: CollectionType
    attributes: CollectionPostDataAttributes
    relationships: CollectionPostDataRelationships
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionPostData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionPostData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attributes": CollectionPostDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CollectionPostDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None
        })
        return _obj
