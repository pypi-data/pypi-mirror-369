...
class PresentationPostDataRelationships(BaseModel):
    """
    PresentationPostDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "projects", "publications", "events", "workflows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PresentationPostDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PresentationPostDataRelationships from a dict"""
        if obj is None:
            return None
