...
class AssayPatchDataRelationships(BaseModel):
    """
    AssayPatchDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "study", "publications", "data_files", "samples", "documents", "models", "sops", "organisms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayPatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayPatchDataRelationships from a dict"""
        if obj is None:
            return None
