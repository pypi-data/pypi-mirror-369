...
class AssayResponseDataAttributesTechnologyType(BaseModel):
    """
    AssayResponseDataAttributesTechnologyType
    """ # noqa: E501
    label: Optional[Annotated[str, Field(min_length=0, strict=True)]] = None
    uri:  Annotated[Optional[str], Field(min_length=0, strict=True, nullable=True)]
    __properties: ClassVar[List[str]] = ["label", "uri"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayResponseDataAttributesTechnologyType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayResponseDataAttributesTechnologyType from a dict"""
        if obj is None:
            return None
