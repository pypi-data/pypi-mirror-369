...
class IndexLinks(BaseModel):
    ...
    IndexLinks
    """ # noqa: E501
    var_self: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="self")
    first: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    prev: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    next: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    last: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IndexLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IndexLinks from a dict"""
        if obj is None:
            return None
