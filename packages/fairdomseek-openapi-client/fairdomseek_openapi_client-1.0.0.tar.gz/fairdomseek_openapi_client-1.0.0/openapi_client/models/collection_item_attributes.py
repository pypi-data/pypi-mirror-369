...
class CollectionItemAttributes(BaseModel):
    """
    CollectionItemAttributes
    """ # noqa: E501
    comment: Annotated[str, Field(min_length=1, strict=True)]
    order: Optional[StrictInt]
    __properties: ClassVar[List[str]] = ["comment", "order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionItemAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionItemAttributes from a dict"""
        if obj is None:
            return None
