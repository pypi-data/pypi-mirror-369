...
class ExtendedMetadataTypeResponse(BaseModel):
    """
    ExtendedMetadataTypeResponse
    """ # noqa: E501
    data: ExtendedMetadataTypeResponseData
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtendedMetadataTypeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": ExtendedMetadataTypeResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
