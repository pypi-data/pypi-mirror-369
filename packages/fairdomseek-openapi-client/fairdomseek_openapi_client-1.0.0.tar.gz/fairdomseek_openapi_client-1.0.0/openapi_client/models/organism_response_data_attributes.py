...
class OrganismResponseDataAttributes(BaseModel):
    """
    OrganismResponseDataAttributes
    """ # noqa: E501
    title: Annotated[str, Field(min_length=1, strict=True)]
    concept_uri: Annotated[str, Field(min_length=1, strict=True)]
    ontology_id: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["title", "concept_uri", "ontology_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganismResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganismResponseDataAttributes from a dict"""
        if obj is None:
            return None
