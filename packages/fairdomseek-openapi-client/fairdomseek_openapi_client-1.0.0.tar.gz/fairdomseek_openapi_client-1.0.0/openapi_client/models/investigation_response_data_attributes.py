...
class InvestigationResponseDataAttributes(BaseModel):
    """
    InvestigationResponseDataAttributes
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["snapshots", "title", "description", "other_creators", "creators", "policy", "discussion_links", "position", "extended_attributes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvestigationResponseDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvestigationResponseDataAttributes from a dict"""
        if obj is None:
            return None
