...
class AssayResponseDataRelationships(BaseModel):
    """
    AssayResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "submitter", "organisms", "people", "projects", "investigation", "study", "data_files", "samples", "documents", "models", "sops", "publications", "placeholders", "human_diseases"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayResponseDataRelationships from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of creators
        if self.creators:
            _dict['creators'] = self.creators.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayResponseDataRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "creators": MultipleReferences.from_dict(obj["creators"]) if obj.get("creators") is not None else None,
            "submitter": MultipleReferences.from_dict(obj["submitter"]) if obj.get("submitter") is not None else None,
            ...
            "projects": MultipleReferences.from_dict(obj["projects"]) if obj.get("projects") is not None else None,
            "investigation": SingleReference.from_dict(obj["investigation"]) if obj.get("investigation") is not None else None,
            "study": SingleReference.from_dict(obj["study"]) if obj.get("study") is not None else None,
            "data_files": MultipleReferences.from_dict(obj["data_files"]) if obj.get("data_files") is not None else None,
            "samples": MultipleReferences.from_dict(obj["samples"]) if obj.get("samples") is not None else None,
