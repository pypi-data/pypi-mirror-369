...
class CollectionItemPatchData(BaseModel):
    """
    CollectionItemPatchData
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: CollectionItemType
    attributes: Optional[CollectionItemPostDataAttributes] = None
    relationships: Optional[CollectionItemPostDataRelationships] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionItemPatchData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionItemPatchData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": CollectionItemPostDataAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
