...
class PresentationResponseDataRelationships(BaseModel):
    """
    PresentationResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creators", "submitter", "people", "projects", "investigations", "studies", "assays", "publications", "events", "workflows"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PresentationResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PresentationResponseDataRelationships from a dict"""
        if obj is None:
            return None
