...
class AssayPostDataAttributesAssayType(BaseModel):
    """
    AssayPostDataAttributesAssayType
    """ # noqa: E501
    uri: Annotated[str, Field(min_length=0, strict=True)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssayPostDataAttributesAssayType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssayPostDataAttributesAssayType from a dict"""
        if obj is None:
            return None
