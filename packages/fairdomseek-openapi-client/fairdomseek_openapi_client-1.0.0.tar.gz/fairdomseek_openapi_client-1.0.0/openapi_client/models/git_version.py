...
class GitVersion(BaseModel):
    ...
    revision_comments: Annotated[str, Field(min_length=1, strict=True)]
    url: Annotated[str, Field(min_length=1, strict=True)]
    commit: Annotated[str, Field(min_length=1, strict=True)]
    ref: Annotated[str, Field(min_length=1, strict=True)]
    tree: Annotated[str, Field(min_length=1, strict=True)]
    remote: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    doi: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["version", "revision_comments", "url", "commit", "ref", "tree", "remote", "doi"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitVersion from a dict"""
        if obj is None:
            return None
