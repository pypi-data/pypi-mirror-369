...
class WorkflowPostDataAttributes(BaseModel):
    """
    WorkflowPostDataAttributes
    """ # noqa: E501
    tags: Optional[List[Annotated[str, Field(min_length=1, strict=True)]]] = None
    topic_annotations: Optional[Annotated[List[OntologyTerm], Field(min_length=0)]] = None
    operation_annotations: Optional[Annotated[List[OntologyTerm], Field(min_length=0)]] = None
    tools: Optional[Annotated[List[Workflowtool], Field(min_length=0)]] = None
    title: Annotated[str, Field(min_length=1, strict=True)]
    description: Optional[Annotated[str, Field(min_length=0, strict=True)]] = None
    workflow_class: Optional[WorkflowPostDataAttributesWorkflowClass] = None
    license: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    policy: Optional[Policy] = None
    content_blobs: Annotated[List[ContentBlobSlot], Field(min_length=1)]
    ...
    discussion_links: Optional[Annotated[List[AssetLinkCreate], Field(min_length=0)]] = None
    __properties: ClassVar[List[str]] = ["tags", "topic_annotations", "operation_annotations", "tools", "title", "description", "workflow_class", "license", "policy", "content_blobs", "other_creators", "creators", "discussion_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowPostDataAttributes from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in topic_annotations (list)
        _items = []
        if self.topic_annotations:
            for _item_topic_annotations in self.topic_annotations:
                if _item_topic_annotations:
                    _items.append(_item_topic_annotations.to_dict())
            _dict['topic_annotations'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in operation_annotations (list)
        _items = []
        if self.operation_annotations:
            for _item_operation_annotations in self.operation_annotations:
                if _item_operation_annotations:
                    _items.append(_item_operation_annotations.to_dict())
            _dict['operation_annotations'] = _items
        ...
        if self.tools:
            ...
            _dict['tools'] = _items
        # override the default output from pydantic by calling `to_dict()` of workflow_class
        if self.workflow_class:
            _dict['workflow_class'] = self.workflow_class.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowPostDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tags": obj.get("tags"),
            "topic_annotations": [OntologyTerm.from_dict(_item) for _item in obj["topic_annotations"]] if obj.get("topic_annotations") is not None else None,
            "operation_annotations": [OntologyTerm.from_dict(_item) for _item in obj["operation_annotations"]] if obj.get("operation_annotations") is not None else None,
            "tools": [Workflowtool.from_dict(_item) for _item in obj["tools"]] if obj.get("tools") is not None else None,
            "title": obj.get("title"),
            "description": obj.get("description"),
            "workflow_class": WorkflowPostDataAttributesWorkflowClass.from_dict(obj["workflow_class"]) if obj.get("workflow_class") is not None else None,
            "license": obj.get("license"),
            "policy": Policy.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
            "content_blobs": [ContentBlobSlot.from_dict(_item) for _item in obj["content_blobs"]] if obj.get("content_blobs") is not None else None,
            ...
            "discussion_links": [AssetLinkCreate.from_dict(_item) for _item in obj["discussion_links"]] if obj.get("discussion_links") is not None else None
        })
        return _obj
