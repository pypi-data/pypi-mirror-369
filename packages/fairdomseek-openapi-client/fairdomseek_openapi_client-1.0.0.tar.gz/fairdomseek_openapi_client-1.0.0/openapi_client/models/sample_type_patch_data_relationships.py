...
class SampleTypePatchDataRelationships(BaseModel):
    """
    SampleTypePatchDataRelationships
    """ # noqa: E501
    projects: Optional[MultipleReferences] = None
    assays: Optional[MultipleReferences] = None
    __properties: ClassVar[List[str]] = ["projects", "assays"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypePatchDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypePatchDataRelationships from a dict"""
        if obj is None:
            return None
