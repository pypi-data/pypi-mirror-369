...
class ProgrammeResponseDataRelationships(BaseModel):
    """
    ProgrammeResponseDataRelationships
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["administrators", "people", "projects", "institutions", "investigations", "studies", "assays", "data_files", "documents", "models", "sops", "publications", "presentations", "events", "workflows", "collections"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProgrammeResponseDataRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProgrammeResponseDataRelationships from a dict"""
        if obj is None:
            return None
