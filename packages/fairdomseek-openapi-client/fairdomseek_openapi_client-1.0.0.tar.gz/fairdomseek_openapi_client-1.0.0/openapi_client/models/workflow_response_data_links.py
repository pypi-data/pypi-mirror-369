...
class WorkflowResponseDataLinks(BaseModel):
    """
    WorkflowResponseDataLinks
    """ # noqa: E501
    var_self: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="self")
    diagram: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["self", "diagram"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowResponseDataLinks from a dict"""
        if obj is None:
            return None
