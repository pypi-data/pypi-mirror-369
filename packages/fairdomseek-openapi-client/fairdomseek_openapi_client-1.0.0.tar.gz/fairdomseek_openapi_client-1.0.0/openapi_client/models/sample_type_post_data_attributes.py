...
class SampleTypePostDataAttributes(BaseModel):
    """
    SampleTypePostDataAttributes
    """ # noqa: E501
    ...
    sample_attributes: Annotated[List[SampleTypeSampleAttributePost], Field(min_length=1)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleTypePostDataAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleTypePostDataAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sample_attributes": [SampleTypeSampleAttributePost.from_dict(_item) for _item in obj["sample_attributes"]] if obj.get("sample_attributes") is not None else None
        })
        return _obj
