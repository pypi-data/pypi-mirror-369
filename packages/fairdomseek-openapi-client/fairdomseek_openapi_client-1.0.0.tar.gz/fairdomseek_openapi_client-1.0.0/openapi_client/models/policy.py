...
class Policy(BaseModel):
    ...
    """ # noqa: E501
    access: AccessTypes
    permissions: Annotated[List[PolicyPermissionsInner], Field(min_length=0)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["access", "permissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": [PolicyPermissionsInner.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
