...
class SearchResponse(BaseModel):
    ...
    SearchResponse
    """ # noqa: E501
    data: Annotated[List[AnySkeleton], Field(min_length=0)]
    jsonapi: JsonApiVersion
    meta: BaseMeta
    __properties: ClassVar[List[str]] = ["data", "jsonapi", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AnySkeleton.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
