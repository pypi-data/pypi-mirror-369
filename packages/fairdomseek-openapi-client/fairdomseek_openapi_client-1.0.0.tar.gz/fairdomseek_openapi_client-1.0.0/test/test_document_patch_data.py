...
class TestDocumentPatchData(unittest.TestCase):
    """DocumentPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPatchData:
        """Test DocumentPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPatchData`
        """
        model = DocumentPatchData()
        if include_optional:
            return DocumentPatchData(
                id = '0',
                type = 'documents',
                ...
                relationships = openapi_client.models.document_patch_data_relationships.documentPatch_data_relationships(
    ...
    def testDocumentPatchData(self):
        """Test DocumentPatchData"""
