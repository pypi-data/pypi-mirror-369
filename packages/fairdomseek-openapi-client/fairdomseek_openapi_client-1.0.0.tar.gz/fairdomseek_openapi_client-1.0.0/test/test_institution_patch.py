...
class TestInstitutionPatch(unittest.TestCase):
    """InstitutionPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionPatch:
        """Test InstitutionPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionPatch`
        """
        model = InstitutionPatch()
        if include_optional:
            return InstitutionPatch(
                data = openapi_client.models.institution_patch_data.institutionPatch_data(
                    id = '0', 
                    type = 'institutions', 
