...
class TestStudyResponseData(unittest.TestCase):
    """StudyResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyResponseData:
        """Test StudyResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyResponseData`
        """
        model = StudyResponseData()
        if include_optional:
            return StudyResponseData(
                id = '0',
                type = 'studies',
                attributes = openapi_client.models.study_response_data_attributes.studyResponse_data_attributes(
                    snapshots = [
                    ...
                    position = 56, ),
                relationships = openapi_client.models.study_response_data_relationships.studyResponse_data_relationships(
    ...
    def testStudyResponseData(self):
        """Test StudyResponseData"""
