...
class TestOrganismResponseDataRelationships(unittest.TestCase):
    """OrganismResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganismResponseDataRelationships:
        """Test OrganismResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganismResponseDataRelationships`
        """
        model = OrganismResponseDataRelationships()
        if include_optional:
            return OrganismResponseDataRelationships(
    ...
    def testOrganismResponseDataRelationships(self):
        """Test OrganismResponseDataRelationships"""
