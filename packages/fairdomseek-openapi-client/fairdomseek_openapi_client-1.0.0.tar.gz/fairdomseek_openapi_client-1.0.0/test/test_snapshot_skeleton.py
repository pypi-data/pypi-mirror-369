...
class TestSnapshotSkeleton(unittest.TestCase):
    """SnapshotSkeleton unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnapshotSkeleton:
        """Test SnapshotSkeleton
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnapshotSkeleton`
        """
        model = SnapshotSkeleton()
        if include_optional:
