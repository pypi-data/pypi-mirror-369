...
class TestPersonPost(unittest.TestCase):
    """PersonPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPost:
        """Test PersonPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPost`
        """
        model = PersonPost()
        if include_optional:
            return PersonPost(
                data = openapi_client.models.person_post_data.personPost_data(
                    type = 'people', 
                    attributes = openapi_client.models.person_post_data_attributes.personPost_data_attributes(
                        description = '0', 
                        first_name = '0', 
                        last_name = , 
                        email = , 
