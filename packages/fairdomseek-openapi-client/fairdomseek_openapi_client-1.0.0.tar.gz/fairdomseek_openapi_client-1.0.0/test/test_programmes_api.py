...
class TestProgrammesApi(unittest.TestCase):
    """ProgrammesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ProgrammesApi()

    def tearDown(self) -> None:
        pass

    def test_create_programme(self) -> None:
        """Test case for create_programme
    ...
    def test_update_programme(self) -> None:
        """Test case for update_programme
