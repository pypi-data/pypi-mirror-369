...
class TestEventPost(unittest.TestCase):
    """EventPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPost:
        """Test EventPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPost`
        """
        model = EventPost()
        if include_optional:
            return EventPost(
                data = openapi_client.models.event_post_data.eventPost_data(
                    type = 'events', 
                    attributes = openapi_client.models.event_post_data_attributes.eventPost_data_attributes(
                        title = '0', 
                        description = '0', 
                        url = '0', 
                        address = '0', 
                    ...
                    relationships = openapi_client.models.event_post_data_relationships.eventPost_data_relationships(
