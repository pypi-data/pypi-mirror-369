...
class TestAssayPostData(unittest.TestCase):
    """AssayPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPostData:
        """Test AssayPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPostData`
        """
        model = AssayPostData()
        if include_optional:
            return AssayPostData(
                type = 'assays',
