...
class TestSampleTypesApi(unittest.TestCase):
    """SampleTypesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SampleTypesApi()

    def tearDown(self) -> None:
        pass

    def test_create_sample_type(self) -> None:
        """Test case for create_sample_type
    ...
    def test_update_sample_type(self) -> None:
        """Test case for update_sample_type
