...
class TestSampleTypePostData(unittest.TestCase):
    """SampleTypePostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePostData:
        """Test SampleTypePostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePostData`
        """
        model = SampleTypePostData()
        if include_optional:
            return SampleTypePostData(
                type = 'sample_types',
                attributes = openapi_client.models.sample_type_post_data_attributes.sampleTypePost_data_attributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                    ...
                    sample_attributes = [
                        openapi_client.models.sample_type_sample_attribute_post.sampleTypeSampleAttributePost(
                            id = '0', 
                            title = '0', 
                            description = '0', 
                            pid = '0', 
                ...
                relationships = openapi_client.models.sample_type_post_data_relationships.sampleTypePost_data_relationships(
    ...
    def testSampleTypePostData(self):
        """Test SampleTypePostData"""
