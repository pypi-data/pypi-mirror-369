...
class TestInvestigationPost(unittest.TestCase):
    """InvestigationPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPost:
        """Test InvestigationPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPost`
        """
        model = InvestigationPost()
        if include_optional:
            return InvestigationPost(
                data = openapi_client.models.investigation_post_data.investigationPost_data(
                    type = 'investigations', 
                    attributes = openapi_client.models.investigation_post_data_attributes.investigationPost_data_attributes(
                        title = '0', 
                        description = '0', 
                        other_creators = '0', 
                        creators = [
                    ...
                    relationships = openapi_client.models.investigation_post_data_relationships.investigationPost_data_relationships(
    ...
    def testInvestigationPost(self):
        """Test InvestigationPost"""
