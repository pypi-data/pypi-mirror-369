...
class TestContentBlobResponseDataAttributes(unittest.TestCase):
    """ContentBlobResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentBlobResponseDataAttributes:
        """Test ContentBlobResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentBlobResponseDataAttributes`
        """
        model = ContentBlobResponseDataAttributes()
        if include_optional:
            return ContentBlobResponseDataAttributes(
                original_filename = '0',
                url = '0',
    ...
    def testContentBlobResponseDataAttributes(self):
        """Test ContentBlobResponseDataAttributes"""
