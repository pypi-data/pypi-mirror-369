...
class TestContentBlobsApi(unittest.TestCase):
    ...
    def test_download_asset_content(self) -> None:
        """Test case for download_asset_content
    ...
    def test_upload_asset_content(self) -> None:
        """Test case for upload_asset_content
