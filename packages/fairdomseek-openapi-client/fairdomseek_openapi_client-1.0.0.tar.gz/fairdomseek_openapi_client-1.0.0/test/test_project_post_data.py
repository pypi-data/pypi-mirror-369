...
class TestProjectPostData(unittest.TestCase):
    """ProjectPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPostData:
        """Test ProjectPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPostData`
        """
        model = ProjectPostData()
        if include_optional:
            return ProjectPostData(
                type = 'projects',
                attributes = openapi_client.models.project_post_data_attributes.projectPost_data_attributes(
                    avatar = '0', 
                    title = '0', 
                    description = '0', 
                    web_page = '0', 
