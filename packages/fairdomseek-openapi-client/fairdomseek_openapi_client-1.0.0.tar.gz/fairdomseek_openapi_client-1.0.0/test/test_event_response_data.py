...
class TestEventResponseData(unittest.TestCase):
    """EventResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventResponseData:
        """Test EventResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventResponseData`
        """
        model = EventResponseData()
        if include_optional:
            return EventResponseData(
                id = '0',
                type = 'events',
                attributes = openapi_client.models.event_response_data_attributes.eventResponse_data_attributes(
                    title = '0', 
                    description = '0', 
                    url = '0', 
                    address = '0', 
                ...
                relationships = openapi_client.models.event_response_data_relationships.eventResponse_data_relationships(
    ...
    def testEventResponseData(self):
        """Test EventResponseData"""
