...
class TestModelPostDataAttributes(unittest.TestCase):
    """ModelPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelPostDataAttributes:
        """Test ModelPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPostDataAttributes`
        """
        model = ModelPostDataAttributes()
        if include_optional:
            return ModelPostDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testModelPostDataAttributes(self):
        """Test ModelPostDataAttributes"""
