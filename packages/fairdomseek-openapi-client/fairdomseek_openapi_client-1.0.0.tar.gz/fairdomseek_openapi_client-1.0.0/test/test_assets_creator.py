...
class TestAssetsCreator(unittest.TestCase):
    """AssetsCreator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetsCreator:
        """Test AssetsCreator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetsCreator`
        """
        model = AssetsCreator()
        if include_optional:
            return AssetsCreator(
                pos = 56,
                profile = '0',
                given_name = '0',
                family_name = '0',
