...
class TestDocumentPostDataRelationships(unittest.TestCase):
    """DocumentPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPostDataRelationships:
        """Test DocumentPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPostDataRelationships`
        """
        model = DocumentPostDataRelationships()
        if include_optional:
            return DocumentPostDataRelationships(
    ...
    def testDocumentPostDataRelationships(self):
        """Test DocumentPostDataRelationships"""
