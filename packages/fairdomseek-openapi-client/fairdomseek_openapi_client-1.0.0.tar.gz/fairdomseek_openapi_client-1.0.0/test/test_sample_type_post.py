...
class TestSampleTypePost(unittest.TestCase):
    """SampleTypePost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePost:
        """Test SampleTypePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePost`
        """
        model = SampleTypePost()
        if include_optional:
            return SampleTypePost(
                data = openapi_client.models.sample_type_post_data.sampleTypePost_data(
                    type = 'sample_types', 
