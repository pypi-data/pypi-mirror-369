    ...
    def make_instance(self, include_optional) -> ModelResponse:
        ...
        if include_optional:
            return ModelResponse(
                data = openapi_client.models.model_response_data.modelResponse_data(
                    id = '0', 
                    type = 'models', 
                    attributes = openapi_client.models.model_attributes.modelAttributes(
                        tags = [
                            '0'
                            ], 
                        title = '0', 
                        ...
                        model_image_link = '0', ), 
                    relationships = openapi_client.models.model_response_data_relationships.modelResponse_data_relationships(
