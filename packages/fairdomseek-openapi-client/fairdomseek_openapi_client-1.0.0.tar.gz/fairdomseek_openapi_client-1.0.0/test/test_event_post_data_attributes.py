...
class TestEventPostDataAttributes(unittest.TestCase):
    """EventPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPostDataAttributes:
        """Test EventPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPostDataAttributes`
        """
        model = EventPostDataAttributes()
        if include_optional:
            return EventPostDataAttributes(
                title = '0',
                description = '0',
                url = '0',
                address = '0',
    ...
    def testEventPostDataAttributes(self):
        """Test EventPostDataAttributes"""
