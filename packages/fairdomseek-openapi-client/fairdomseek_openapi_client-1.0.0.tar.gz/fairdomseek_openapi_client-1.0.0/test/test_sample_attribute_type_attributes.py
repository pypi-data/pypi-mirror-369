...
class TestSampleAttributeTypeAttributes(unittest.TestCase):
    """SampleAttributeTypeAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleAttributeTypeAttributes:
        """Test SampleAttributeTypeAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleAttributeTypeAttributes`
        """
        model = SampleAttributeTypeAttributes()
        if include_optional:
            return SampleAttributeTypeAttributes(
                title = '0',
                base_type = 'Integer',
                regexp = '0'
            )
    ...
    def testSampleAttributeTypeAttributes(self):
        """Test SampleAttributeTypeAttributes"""
