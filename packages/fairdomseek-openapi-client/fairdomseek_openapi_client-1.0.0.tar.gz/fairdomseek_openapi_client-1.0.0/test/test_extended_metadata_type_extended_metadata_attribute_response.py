...
class TestExtendedMetadataTypeExtendedMetadataAttributeResponse(unittest.TestCase):
    """ExtendedMetadataTypeExtendedMetadataAttributeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedMetadataTypeExtendedMetadataAttributeResponse:
        """Test ExtendedMetadataTypeExtendedMetadataAttributeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedMetadataTypeExtendedMetadataAttributeResponse`
        """
        model = ExtendedMetadataTypeExtendedMetadataAttributeResponse()
        if include_optional:
            return ExtendedMetadataTypeExtendedMetadataAttributeResponse(
                id = '0',
                title = '0',
                label = '0',
                description = '0',
    ...
    def testExtendedMetadataTypeExtendedMetadataAttributeResponse(self):
        """Test ExtendedMetadataTypeExtendedMetadataAttributeResponse"""
