...
class TestDataFilePatchDataAttributes(unittest.TestCase):
    """DataFilePatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePatchDataAttributes:
        """Test DataFilePatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePatchDataAttributes`
        """
        model = DataFilePatchDataAttributes()
        if include_optional:
            return DataFilePatchDataAttributes(
                tags = [
                    '0'
                    ],
    ...
    def testDataFilePatchDataAttributes(self):
        """Test DataFilePatchDataAttributes"""
