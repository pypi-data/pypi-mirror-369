...
class TestStudyPatch(unittest.TestCase):
    """StudyPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPatch:
        """Test StudyPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPatch`
        """
        model = StudyPatch()
        if include_optional:
            return StudyPatch(
                data = openapi_client.models.study_patch_data.studyPatch_data(
                    id = '0', 
                    type = 'studies', 
