...
class TestRemoteContentBlob(unittest.TestCase):
    """RemoteContentBlob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoteContentBlob:
        """Test RemoteContentBlob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteContentBlob`
        """
        model = RemoteContentBlob()
        if include_optional:
            return RemoteContentBlob(
                url = '0',
                original_filename = '0',
                content_type = '0'
            )
    ...
    def testRemoteContentBlob(self):
        """Test RemoteContentBlob"""
