...
class TestWorkflowtool(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Workflowtool:
        """Test Workflowtool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Workflowtool`
        """
        model = Workflowtool()
        if include_optional:
            return Workflowtool(
