...
class TestProgrammeResponse(unittest.TestCase):
    """ProgrammeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammeResponse:
        """Test ProgrammeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammeResponse`
        """
        model = ProgrammeResponse()
        if include_optional:
            return ProgrammeResponse(
                data = openapi_client.models.programme_response_data.programmeResponse_data(
                    id = '0', 
                    type = 'programmes', 
    ...
    def testProgrammeResponse(self):
        """Test ProgrammeResponse"""
