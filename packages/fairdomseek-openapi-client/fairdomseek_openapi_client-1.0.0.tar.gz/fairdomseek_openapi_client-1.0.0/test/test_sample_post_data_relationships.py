...
class TestSamplePostDataRelationships(unittest.TestCase):
    """SamplePostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePostDataRelationships:
        """Test SamplePostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePostDataRelationships`
        """
        model = SamplePostDataRelationships()
        if include_optional:
            return SamplePostDataRelationships(
    ...
    def testSamplePostDataRelationships(self):
        """Test SamplePostDataRelationships"""
