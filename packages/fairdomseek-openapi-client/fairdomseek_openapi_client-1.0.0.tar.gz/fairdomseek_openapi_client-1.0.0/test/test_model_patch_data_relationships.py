...
class TestModelPatchDataRelationships(unittest.TestCase):
    """ModelPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelPatchDataRelationships:
        """Test ModelPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPatchDataRelationships`
        """
        model = ModelPatchDataRelationships()
        if include_optional:
            return ModelPatchDataRelationships(
    ...
    def testModelPatchDataRelationships(self):
        """Test ModelPatchDataRelationships"""
