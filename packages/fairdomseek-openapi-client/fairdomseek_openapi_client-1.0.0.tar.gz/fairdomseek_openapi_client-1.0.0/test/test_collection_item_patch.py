...
class TestCollectionItemPatch(unittest.TestCase):
    """CollectionItemPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemPatch:
        """Test CollectionItemPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemPatch`
        """
        model = CollectionItemPatch()
        if include_optional:
            return CollectionItemPatch(
                data = openapi_client.models.collection_item_patch_data.collectionItemPatch_data(
                    id = '0', 
    ...
    def testCollectionItemPatch(self):
        """Test CollectionItemPatch"""
