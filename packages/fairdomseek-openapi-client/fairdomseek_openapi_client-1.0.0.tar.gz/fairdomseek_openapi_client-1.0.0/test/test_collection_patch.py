...
class TestCollectionPatch(unittest.TestCase):
    """CollectionPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPatch:
        """Test CollectionPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPatch`
        """
        model = CollectionPatch()
        if include_optional:
            return CollectionPatch(
                data = openapi_client.models.collection_patch_data.collectionPatch_data(
                    id = '0', 
                    type = 'collections', 
                    ...
                    relationships = openapi_client.models.collection_patch_data_relationships.collectionPatch_data_relationships(
