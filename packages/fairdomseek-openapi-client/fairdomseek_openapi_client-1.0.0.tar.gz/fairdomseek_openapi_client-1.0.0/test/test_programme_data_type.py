...
class TestProgrammeDataType(unittest.TestCase):
    """ProgrammeDataType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammeDataType:
        """Test ProgrammeDataType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammeDataType`
        """
        model = ProgrammeDataType()
        if include_optional:
    ...
    def testProgrammeDataType(self):
        """Test ProgrammeDataType"""
