...
class TestSampleTypeSampleAttributePostSampleAttributeType(unittest.TestCase):
    """SampleTypeSampleAttributePostSampleAttributeType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeSampleAttributePostSampleAttributeType:
        """Test SampleTypeSampleAttributePostSampleAttributeType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeSampleAttributePostSampleAttributeType`
        """
        model = SampleTypeSampleAttributePostSampleAttributeType()
        if include_optional:
            return SampleTypeSampleAttributePostSampleAttributeType(
                id = '0',
                title = '0'
            )
        else:
    ...
    def testSampleTypeSampleAttributePostSampleAttributeType(self):
        """Test SampleTypeSampleAttributePostSampleAttributeType"""
