...
class TestDataFilePatchDataRelationships(unittest.TestCase):
    """DataFilePatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePatchDataRelationships:
        """Test DataFilePatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePatchDataRelationships`
        """
        model = DataFilePatchDataRelationships()
        if include_optional:
            return DataFilePatchDataRelationships(
    ...
    def testDataFilePatchDataRelationships(self):
        """Test DataFilePatchDataRelationships"""
