...
class TestWorkflowPostDataAttributes(unittest.TestCase):
    """WorkflowPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPostDataAttributes:
        """Test WorkflowPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPostDataAttributes`
        """
        model = WorkflowPostDataAttributes()
        if include_optional:
            return WorkflowPostDataAttributes(
                tags = [
                    '0'
                    ],
                topic_annotations = [
    ...
    def testWorkflowPostDataAttributes(self):
        """Test WorkflowPostDataAttributes"""
