...
class TestModelPostDataRelationships(unittest.TestCase):
    """ModelPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelPostDataRelationships:
        """Test ModelPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPostDataRelationships`
        """
        model = ModelPostDataRelationships()
        if include_optional:
            return ModelPostDataRelationships(
    ...
    def testModelPostDataRelationships(self):
        """Test ModelPostDataRelationships"""
