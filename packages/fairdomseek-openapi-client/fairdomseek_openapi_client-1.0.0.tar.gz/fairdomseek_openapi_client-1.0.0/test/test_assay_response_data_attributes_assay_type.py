...
class TestAssayResponseDataAttributesAssayType(unittest.TestCase):
    """AssayResponseDataAttributesAssayType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayResponseDataAttributesAssayType:
        """Test AssayResponseDataAttributesAssayType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayResponseDataAttributesAssayType`
        """
        model = AssayResponseDataAttributesAssayType()
        if include_optional:
            return AssayResponseDataAttributesAssayType(
                label = '0',
                uri = '0'
            )
        else:
    ...
    def testAssayResponseDataAttributesAssayType(self):
        """Test AssayResponseDataAttributesAssayType"""
