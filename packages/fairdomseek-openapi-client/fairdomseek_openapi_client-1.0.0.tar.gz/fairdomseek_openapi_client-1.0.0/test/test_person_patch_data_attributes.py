...
class TestPersonPatchDataAttributes(unittest.TestCase):
    """PersonPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPatchDataAttributes:
        """Test PersonPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPatchDataAttributes`
        """
        model = PersonPatchDataAttributes()
        if include_optional:
            return PersonPatchDataAttributes(
                description = '0',
                first_name = '0',
                last_name = '0',
                email = '0',
    ...
    def testPersonPatchDataAttributes(self):
        """Test PersonPatchDataAttributes"""
