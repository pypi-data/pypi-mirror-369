...
class TestAssayPostDataAttributes(unittest.TestCase):
    """AssayPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPostDataAttributes:
        """Test AssayPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPostDataAttributes`
        """
        model = AssayPostDataAttributes()
        if include_optional:
            return AssayPostDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testAssayPostDataAttributes(self):
        """Test AssayPostDataAttributes"""
