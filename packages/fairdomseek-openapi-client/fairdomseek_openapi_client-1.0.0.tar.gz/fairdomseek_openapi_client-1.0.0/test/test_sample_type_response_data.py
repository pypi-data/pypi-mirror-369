...
class TestSampleTypeResponseData(unittest.TestCase):
    """SampleTypeResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeResponseData:
        """Test SampleTypeResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeResponseData`
        """
        model = SampleTypeResponseData()
        if include_optional:
            return SampleTypeResponseData(
                id = '0',
                type = 'sample_types',
                attributes = openapi_client.models.sample_type_response_data_attributes.sampleTypeResponse_data_attributes(
                    title = '0', 
                    description = '0', 
                    policy = {
                        'key' : null
                    ...
                    sample_attributes = [
                        openapi_client.models.sample_type_sample_attribute_response.sampleTypeSampleAttributeResponse(
                            id = '0', 
                            title = '0', 
                            description = '0', 
                            pid = '0', 
                            sample_attribute_type = openapi_client.models.sample_type_sample_attribute_response_sample_attribute_type.sampleTypeSampleAttributeResponse_sample_attribute_type(
                                id = '0', 
                                title = '0', 
                                base_type = 'Integer', 
                                regexp = '0', ), 
                ...
                relationships = openapi_client.models.sample_type_response_data_relationships.sampleTypeResponse_data_relationships(
    ...
    def testSampleTypeResponseData(self):
        """Test SampleTypeResponseData"""
