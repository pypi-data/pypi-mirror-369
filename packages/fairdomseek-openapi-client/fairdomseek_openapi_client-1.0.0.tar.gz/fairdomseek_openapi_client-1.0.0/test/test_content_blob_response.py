...
class TestContentBlobResponse(unittest.TestCase):
    """ContentBlobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentBlobResponse:
        """Test ContentBlobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentBlobResponse`
        """
        model = ContentBlobResponse()
        if include_optional:
            return ContentBlobResponse(
                data = openapi_client.models.content_blob_response_data.contentBlobResponse_data(
                    id = '0', 
                    type = 'content_blobs', 
                    attributes = openapi_client.models.content_blob_response_data_attributes.contentBlobResponse_data_attributes(
                        original_filename = '0', 
                        url = '0', 
                        md5sum = 'bf325375e030fccba00917317c574773012345678910111213141516171819202122232425262728293031', 
                        sha1sum = 'f325375e030fccba00917317c574773100bf001234', 
                        content_type = '0', 
                        size = 56, ), 
                    relationships = openapi_client.models.collection_item_post_data_relationships.collectionItemPost_data_relationships(
                        asset = openapi_client.models.single_reference.singleReference(
                            data = openapi_client.models.item_reference.itemReference(
                                id = '0', 
                                type = 'assays', ), ), ), 
                    links = openapi_client.models.downloadable_links.downloadableLinks(
                        self = '0', 
                        download = '0', ), 
                    meta = openapi_client.models.meta.meta(
                        ...
                        uuid = '0', ), ),
                jsonapi = openapi_client.models.json_api_version.JsonApiVersion(
                    version = '1.0', )
            )
        else:
            return ContentBlobResponse(
    ...
    def testContentBlobResponse(self):
        """Test ContentBlobResponse"""
