...
class TestWorkflowPatchDataRelationships(unittest.TestCase):
    """WorkflowPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPatchDataRelationships:
        """Test WorkflowPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPatchDataRelationships`
        """
        model = WorkflowPatchDataRelationships()
        if include_optional:
            return WorkflowPatchDataRelationships(
    ...
    def testWorkflowPatchDataRelationships(self):
        """Test WorkflowPatchDataRelationships"""
