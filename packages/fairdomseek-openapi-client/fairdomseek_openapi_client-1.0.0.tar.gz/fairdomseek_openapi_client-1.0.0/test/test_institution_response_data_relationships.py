...
class TestInstitutionResponseDataRelationships(unittest.TestCase):
    """InstitutionResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionResponseDataRelationships:
        """Test InstitutionResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionResponseDataRelationships`
        """
        model = InstitutionResponseDataRelationships()
        if include_optional:
            return InstitutionResponseDataRelationships(
    ...
    def testInstitutionResponseDataRelationships(self):
        """Test InstitutionResponseDataRelationships"""
