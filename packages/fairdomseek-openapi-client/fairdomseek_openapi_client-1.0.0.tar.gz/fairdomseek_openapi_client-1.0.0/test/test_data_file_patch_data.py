...
class TestDataFilePatchData(unittest.TestCase):
    """DataFilePatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePatchData:
        """Test DataFilePatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePatchData`
        """
        model = DataFilePatchData()
        if include_optional:
            return DataFilePatchData(
                id = '0',
                type = 'data_files',
    ...
    def testDataFilePatchData(self):
        """Test DataFilePatchData"""
