...
class TestModelPatchData(unittest.TestCase):
    """ModelPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelPatchData:
        """Test ModelPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPatchData`
        """
        model = ModelPatchData()
        if include_optional:
            return ModelPatchData(
                id = '0',
                type = 'models',
                attributes = openapi_client.models.model_patch_data_attributes.modelPatch_data_attributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                ...
                relationships = openapi_client.models.model_patch_data_relationships.modelPatch_data_relationships(
