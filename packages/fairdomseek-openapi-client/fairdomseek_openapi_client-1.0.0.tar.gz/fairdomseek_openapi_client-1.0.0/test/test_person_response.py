    ...
    def make_instance(self, include_optional) -> PersonResponse:
        ...
        if include_optional:
            return PersonResponse(
                data = openapi_client.models.person_response_data.personResponse_data(
                    id = '0', 
                    type = 'people', 
                    attributes = openapi_client.models.person_response_data_attributes.personResponse_data_attributes(
                        avatar = '0', 
                        title = '0', 
                        description = '0', 
                        first_name = '0', 
                        ...
                        skype_name = , 
                        login = , ), 
                    relationships = openapi_client.models.person_response_data_relationships.personResponse_data_relationships(
                        ...
                        institutions = openapi_client.models.multiple_references.multipleReferences(
                            data = [
                                openapi_client.models.item_reference.itemReference(
                                    id = '0', 
                                    type = 'assays', )
