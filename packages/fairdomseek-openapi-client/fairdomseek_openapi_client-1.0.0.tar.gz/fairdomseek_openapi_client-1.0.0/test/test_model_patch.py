...
class TestModelPatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModelPatch:
        """Test ModelPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPatch`
        """
        model = ModelPatch()
        if include_optional:
            return ModelPatch(
                data = openapi_client.models.model_patch_data.modelPatch_data(
                    id = '0', 
                    type = 'models', 
