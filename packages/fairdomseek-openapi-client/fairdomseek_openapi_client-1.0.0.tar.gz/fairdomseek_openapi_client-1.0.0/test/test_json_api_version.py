...
class TestJsonApiVersion(unittest.TestCase):
    """JsonApiVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonApiVersion:
        """Test JsonApiVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonApiVersion`
        """
        model = JsonApiVersion()
        if include_optional:
