...
class TestOrganismResponse(unittest.TestCase):
    """OrganismResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganismResponse:
        """Test OrganismResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganismResponse`
        """
        model = OrganismResponse()
        if include_optional:
            return OrganismResponse(
                data = openapi_client.models.organism_response_data.organismResponse_data(
                    id = '0', 
                    type = 'organisms', 
                    attributes = openapi_client.models.organism_response_data_attributes.organismResponse_data_attributes(
                        title = '0', 
                        concept_uri = '0', 
                        ontology_id = '0', ), 
                    relationships = openapi_client.models.organism_response_data_relationships.organismResponse_data_relationships(
