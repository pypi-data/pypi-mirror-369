...
class TestCollectionItemPost(unittest.TestCase):
    """CollectionItemPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemPost:
        """Test CollectionItemPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemPost`
        """
        model = CollectionItemPost()
        if include_optional:
            return CollectionItemPost(
                data = openapi_client.models.collection_item_post_data.collectionItemPost_data(
    ...
    def testCollectionItemPost(self):
        """Test CollectionItemPost"""
