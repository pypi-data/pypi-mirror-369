    ...
    def make_instance(self, include_optional) -> CollectionResponse:
        ...
        if include_optional:
            return CollectionResponse(
                data = openapi_client.models.collection_response_data.collectionResponse_data(
                    id = '0', 
                    type = 'collections', 
                    attributes = openapi_client.models.collection_attributes.collectionAttributes(
                        tags = [
                            '0'
                            ], 
                        title = '0', 
                    ...
                    relationships = openapi_client.models.collection_response_data_relationships.collectionResponse_data_relationships(
