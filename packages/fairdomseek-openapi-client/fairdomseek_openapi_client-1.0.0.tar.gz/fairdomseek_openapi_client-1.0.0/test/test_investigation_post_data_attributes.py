...
class TestInvestigationPostDataAttributes(unittest.TestCase):
    """InvestigationPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPostDataAttributes:
        """Test InvestigationPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPostDataAttributes`
        """
        model = InvestigationPostDataAttributes()
        if include_optional:
            return InvestigationPostDataAttributes(
                title = '0',
                description = '0',
                other_creators = '0',
                creators = [
    ...
    def testInvestigationPostDataAttributes(self):
        """Test InvestigationPostDataAttributes"""
