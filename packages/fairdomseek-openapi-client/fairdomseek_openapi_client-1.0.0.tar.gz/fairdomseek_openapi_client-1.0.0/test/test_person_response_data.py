...
class TestPersonResponseData(unittest.TestCase):
    """PersonResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonResponseData:
        """Test PersonResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonResponseData`
        """
        model = PersonResponseData()
        if include_optional:
    ...
    def testPersonResponseData(self):
        """Test PersonResponseData"""
