...
class TestPersonResponseDataAttributes(unittest.TestCase):
    """PersonResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonResponseDataAttributes:
        """Test PersonResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonResponseDataAttributes`
        """
        model = PersonResponseDataAttributes()
        if include_optional:
            return PersonResponseDataAttributes(
                avatar = '0',
                title = '0',
                description = '0',
                first_name = '0',
                ...
                web_page = '0',
                orcid = '0',
                mbox_sha1sum = 'f325375e030fccba00917317c574773100bf001234',
                expertise = [
                    '0'
                    ],
                tools = [
    ...
    def testPersonResponseDataAttributes(self):
        """Test PersonResponseDataAttributes"""
