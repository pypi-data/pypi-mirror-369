...
class TestEventPatchDataRelationships(unittest.TestCase):
    """EventPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPatchDataRelationships:
        """Test EventPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPatchDataRelationships`
        """
        model = EventPatchDataRelationships()
        if include_optional:
            return EventPatchDataRelationships(
    ...
    def testEventPatchDataRelationships(self):
        """Test EventPatchDataRelationships"""
