...
class TestPolicyPermissionsInner(unittest.TestCase):
    """PolicyPermissionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyPermissionsInner:
        """Test PolicyPermissionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyPermissionsInner`
        """
        model = PolicyPermissionsInner()
        if include_optional:
            return PolicyPermissionsInner(
                resource = openapi_client.models.permission_resource.permissionResource(
                    type = 'people', 
                    id = '0', ),
                access = 'manage'
            )
    ...
    def testPolicyPermissionsInner(self):
        """Test PolicyPermissionsInner"""
