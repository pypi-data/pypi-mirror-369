...
class TestInstitutionPostDataAttributes(unittest.TestCase):
    """InstitutionPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionPostDataAttributes:
        """Test InstitutionPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionPostDataAttributes`
        """
        model = InstitutionPostDataAttributes()
        if include_optional:
            return InstitutionPostDataAttributes(
                avatar = '0',
                title = '0',
                country = '',
                city = '0',
    ...
    def testInstitutionPostDataAttributes(self):
        """Test InstitutionPostDataAttributes"""
