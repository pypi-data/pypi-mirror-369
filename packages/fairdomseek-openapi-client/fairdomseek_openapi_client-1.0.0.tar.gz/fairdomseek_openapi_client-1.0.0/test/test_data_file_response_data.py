...
class TestDataFileResponseData(unittest.TestCase):
    """DataFileResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFileResponseData:
        """Test DataFileResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFileResponseData`
        """
        model = DataFileResponseData()
        if include_optional:
            return DataFileResponseData(
                id = '0',
                type = 'data_files',
                attributes = openapi_client.models.data_file_response_data_attributes.dataFileResponse_data_attributes(
                    tags = [
                        '0'
                        ], 
                    data_type_annotations = [
                        openapi_client.models.ontology_term.ontologyTerm(
                            label = '0', 
                            identifier = '0', )
                        ], 
                    data_format_annotations = [
                        openapi_client.models.ontology_term.ontologyTerm(
                            label = '0', 
                            identifier = '0', )
                        ], 
                    ...
                    content_blobs = [
                        openapi_client.models.content_blob.contentBlob(
                            original_filename = '0', 
                            url = '0', 
                ...
                relationships = openapi_client.models.data_file_response_data_relationships.dataFileResponse_data_relationships(
    ...
    def testDataFileResponseData(self):
        """Test DataFileResponseData"""
