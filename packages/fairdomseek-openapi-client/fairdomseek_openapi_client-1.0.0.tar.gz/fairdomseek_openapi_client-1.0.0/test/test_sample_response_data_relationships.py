...
class TestSampleResponseDataRelationships(unittest.TestCase):
    """SampleResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleResponseDataRelationships:
        """Test SampleResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleResponseDataRelationships`
        """
        model = SampleResponseDataRelationships()
        if include_optional:
            return SampleResponseDataRelationships(
                ...
                sample_type = openapi_client.models.single_reference.singleReference(
    ...
    def testSampleResponseDataRelationships(self):
        """Test SampleResponseDataRelationships"""
