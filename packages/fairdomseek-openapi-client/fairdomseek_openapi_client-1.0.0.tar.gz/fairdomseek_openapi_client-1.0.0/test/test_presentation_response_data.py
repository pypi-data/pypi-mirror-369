...
class TestPresentationResponseData(unittest.TestCase):
    """PresentationResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationResponseData:
        """Test PresentationResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationResponseData`
        """
        model = PresentationResponseData()
        if include_optional:
            return PresentationResponseData(
                id = '0',
                type = 'presentations',
                attributes = openapi_client.models.contributed_type_attributes.contributedTypeAttributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                ...
                relationships = openapi_client.models.presentation_response_data_relationships.presentationResponse_data_relationships(
    ...
    def testPresentationResponseData(self):
        """Test PresentationResponseData"""
