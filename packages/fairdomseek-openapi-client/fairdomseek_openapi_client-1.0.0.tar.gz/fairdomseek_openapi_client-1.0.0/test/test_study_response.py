...
class TestStudyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StudyResponse:
        """Test StudyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyResponse`
        """
        model = StudyResponse()
        if include_optional:
            return StudyResponse(
                data = openapi_client.models.study_response_data.studyResponse_data(
                    id = '0', 
                    type = 'studies', 
