...
class TestSopPost(unittest.TestCase):
    """SopPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SopPost:
        """Test SopPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SopPost`
        """
        model = SopPost()
        if include_optional:
            return SopPost(
                data = openapi_client.models.sop_post_data.sopPost_data(
                    type = 'sops', 
                    ...
                    relationships = openapi_client.models.document_post_data_relationships.documentPost_data_relationships(
