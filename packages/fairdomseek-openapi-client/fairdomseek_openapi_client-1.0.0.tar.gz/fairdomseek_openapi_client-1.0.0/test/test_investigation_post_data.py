...
class TestInvestigationPostData(unittest.TestCase):
    """InvestigationPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPostData:
        """Test InvestigationPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPostData`
        """
        model = InvestigationPostData()
        if include_optional:
            return InvestigationPostData(
                type = 'investigations',
    ...
    def testInvestigationPostData(self):
        """Test InvestigationPostData"""
