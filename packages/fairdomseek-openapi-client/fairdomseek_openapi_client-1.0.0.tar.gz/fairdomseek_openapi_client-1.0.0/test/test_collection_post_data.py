...
class TestCollectionPostData(unittest.TestCase):
    """CollectionPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPostData:
        """Test CollectionPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPostData`
        """
        model = CollectionPostData()
        if include_optional:
    ...
    def testCollectionPostData(self):
        """Test CollectionPostData"""
