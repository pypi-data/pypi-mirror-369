...
class TestStudyPostDataRelationships(unittest.TestCase):
    """StudyPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPostDataRelationships:
        """Test StudyPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPostDataRelationships`
        """
        model = StudyPostDataRelationships()
        if include_optional:
            return StudyPostDataRelationships(
    ...
    def testStudyPostDataRelationships(self):
        """Test StudyPostDataRelationships"""
