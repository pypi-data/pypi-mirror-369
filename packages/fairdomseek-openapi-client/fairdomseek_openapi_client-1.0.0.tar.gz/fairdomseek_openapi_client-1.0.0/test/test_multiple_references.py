...
class TestMultipleReferences(unittest.TestCase):
    """MultipleReferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultipleReferences:
        """Test MultipleReferences
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipleReferences`
        """
        model = MultipleReferences()
        if include_optional:
