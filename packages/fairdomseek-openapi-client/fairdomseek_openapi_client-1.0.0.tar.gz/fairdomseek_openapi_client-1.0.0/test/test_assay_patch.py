...
class TestAssayPatch(unittest.TestCase):
    """AssayPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPatch:
        """Test AssayPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPatch`
        """
        model = AssayPatch()
        if include_optional:
            return AssayPatch(
                data = openapi_client.models.assay_patch_data.assayPatch_data(
                    id = '0', 
                    type = 'assays', 
