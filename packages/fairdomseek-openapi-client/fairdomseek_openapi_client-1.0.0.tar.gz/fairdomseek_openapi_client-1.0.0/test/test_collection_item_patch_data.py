...
class TestCollectionItemPatchData(unittest.TestCase):
    """CollectionItemPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemPatchData:
        """Test CollectionItemPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemPatchData`
        """
        model = CollectionItemPatchData()
        if include_optional:
            return CollectionItemPatchData(
                id = '0',
                type = 'collection_items',
                attributes = openapi_client.models.collection_item_post_data_attributes.collectionItemPost_data_attributes(
                    comment = '0', 
                    order = 56, ),
    ...
    def testCollectionItemPatchData(self):
        """Test CollectionItemPatchData"""
