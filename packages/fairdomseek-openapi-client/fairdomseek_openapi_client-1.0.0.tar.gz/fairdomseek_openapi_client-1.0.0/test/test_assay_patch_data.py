...
class TestAssayPatchData(unittest.TestCase):
    """AssayPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPatchData:
        """Test AssayPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPatchData`
        """
        model = AssayPatchData()
        if include_optional:
            return AssayPatchData(
                id = '0',
                type = 'assays',
                attributes = openapi_client.models.assay_patch_data_attributes.assayPatch_data_attributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                ...
                relationships = openapi_client.models.assay_patch_data_relationships.assayPatch_data_relationships(
