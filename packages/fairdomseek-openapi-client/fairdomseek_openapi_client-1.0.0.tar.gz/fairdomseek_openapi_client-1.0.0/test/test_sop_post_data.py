...
class TestSopPostData(unittest.TestCase):
    """SopPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SopPostData:
        """Test SopPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SopPostData`
        """
        model = SopPostData()
        if include_optional:
            return SopPostData(
