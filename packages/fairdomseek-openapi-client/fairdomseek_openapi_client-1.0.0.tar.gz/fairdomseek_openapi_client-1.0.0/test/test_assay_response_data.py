...
class TestAssayResponseData(unittest.TestCase):
    """AssayResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayResponseData:
        """Test AssayResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayResponseData`
        """
        model = AssayResponseData()
        if include_optional:
            return AssayResponseData(
                id = '0',
                type = 'assays',
                attributes = openapi_client.models.assay_response_data_attributes.assayResponse_data_attributes(
                    snapshots = [
                    ...
                    assay_class = openapi_client.models.assay_response_data_attributes_assay_class.assayResponse_data_attributes_assay_class(
                        title = '0', 
                        key = '0', 
                        description = '0', ), 
                    assay_type = openapi_client.models.assay_response_data_attributes_assay_type.assayResponse_data_attributes_assay_type(
                        label = '0', 
                        uri = '0', ), 
                    technology_type = openapi_client.models.assay_response_data_attributes_technology_type.assayResponse_data_attributes_technology_type(
                        label = '0', 
                        uri = '0', ), 
                    policy = {
                        'key' : null
                ...
                relationships = openapi_client.models.assay_response_data_relationships.assayResponse_data_relationships(
    ...
    def testAssayResponseData(self):
        """Test AssayResponseData"""
