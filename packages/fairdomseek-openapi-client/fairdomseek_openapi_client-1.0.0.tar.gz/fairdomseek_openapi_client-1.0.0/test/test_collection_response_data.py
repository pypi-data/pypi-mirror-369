...
class TestCollectionResponseData(unittest.TestCase):
    """CollectionResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionResponseData:
        """Test CollectionResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionResponseData`
        """
        model = CollectionResponseData()
        if include_optional:
    ...
    def testCollectionResponseData(self):
        """Test CollectionResponseData"""
