...
class TestPersonPostData(unittest.TestCase):
    """PersonPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPostData:
        """Test PersonPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPostData`
        """
        model = PersonPostData()
        if include_optional:
