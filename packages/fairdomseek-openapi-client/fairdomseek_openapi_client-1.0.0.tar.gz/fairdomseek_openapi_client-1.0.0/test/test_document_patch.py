...
class TestDocumentPatch(unittest.TestCase):
    """DocumentPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPatch:
        """Test DocumentPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPatch`
        """
        model = DocumentPatch()
        if include_optional:
            return DocumentPatch(
                data = openapi_client.models.document_patch_data.documentPatch_data(
                    id = '0', 
                    type = 'documents', 
