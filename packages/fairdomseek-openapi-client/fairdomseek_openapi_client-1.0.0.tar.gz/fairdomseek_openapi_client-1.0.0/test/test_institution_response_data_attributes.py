...
class TestInstitutionResponseDataAttributes(unittest.TestCase):
    """InstitutionResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionResponseDataAttributes:
        """Test InstitutionResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionResponseDataAttributes`
        """
        model = InstitutionResponseDataAttributes()
        if include_optional:
            return InstitutionResponseDataAttributes(
                avatar = '0',
                title = '0',
                country = '',
                country_code = '01',
    ...
    def testInstitutionResponseDataAttributes(self):
        """Test InstitutionResponseDataAttributes"""
