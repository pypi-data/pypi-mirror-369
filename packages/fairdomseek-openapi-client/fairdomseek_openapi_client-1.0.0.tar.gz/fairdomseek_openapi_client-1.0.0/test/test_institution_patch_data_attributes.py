...
class TestInstitutionPatchDataAttributes(unittest.TestCase):
    """InstitutionPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionPatchDataAttributes:
        """Test InstitutionPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionPatchDataAttributes`
        """
        model = InstitutionPatchDataAttributes()
        if include_optional:
            return InstitutionPatchDataAttributes(
                avatar = '0',
                title = '0',
                country = '',
                city = '0',
    ...
    def testInstitutionPatchDataAttributes(self):
        """Test InstitutionPatchDataAttributes"""
