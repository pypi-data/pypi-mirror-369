...
class TestSampleTypeSampleAttributeResponse(unittest.TestCase):
    """SampleTypeSampleAttributeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeSampleAttributeResponse:
        """Test SampleTypeSampleAttributeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeSampleAttributeResponse`
        """
        model = SampleTypeSampleAttributeResponse()
        if include_optional:
            return SampleTypeSampleAttributeResponse(
                id = '0',
                title = '0',
                description = '0',
                pid = '0',
    ...
    def testSampleTypeSampleAttributeResponse(self):
        """Test SampleTypeSampleAttributeResponse"""
