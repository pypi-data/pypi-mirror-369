...
class TestSamplePatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SamplePatch:
        """Test SamplePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePatch`
        """
        model = SamplePatch()
        if include_optional:
            return SamplePatch(
                data = openapi_client.models.sample_patch_data.samplePatch_data(
                    id = '0', 
                    type = 'samples', 
