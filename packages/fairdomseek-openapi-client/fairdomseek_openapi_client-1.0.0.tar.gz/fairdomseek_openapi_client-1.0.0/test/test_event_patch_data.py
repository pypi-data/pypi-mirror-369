...
class TestEventPatchData(unittest.TestCase):
    """EventPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPatchData:
        """Test EventPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPatchData`
        """
        model = EventPatchData()
        if include_optional:
            return EventPatchData(
                id = '0',
                type = 'events',
