...
class TestDownloadableLinks(unittest.TestCase):
    """DownloadableLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownloadableLinks:
        """Test DownloadableLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownloadableLinks`
        """
        model = DownloadableLinks()
        if include_optional:
    ...
    def testDownloadableLinks(self):
        """Test DownloadableLinks"""
