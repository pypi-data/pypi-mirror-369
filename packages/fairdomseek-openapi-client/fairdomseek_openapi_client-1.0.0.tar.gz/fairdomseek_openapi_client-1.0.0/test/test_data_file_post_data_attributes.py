...
class TestDataFilePostDataAttributes(unittest.TestCase):
    """DataFilePostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePostDataAttributes:
        """Test DataFilePostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePostDataAttributes`
        """
        model = DataFilePostDataAttributes()
        if include_optional:
            return DataFilePostDataAttributes(
                tags = [
                    '0'
                    ],
    ...
    def testDataFilePostDataAttributes(self):
        """Test DataFilePostDataAttributes"""
