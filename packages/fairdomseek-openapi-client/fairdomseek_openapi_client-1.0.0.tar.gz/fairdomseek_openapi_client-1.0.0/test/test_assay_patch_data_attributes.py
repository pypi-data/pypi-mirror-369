...
class TestAssayPatchDataAttributes(unittest.TestCase):
    """AssayPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPatchDataAttributes:
        """Test AssayPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPatchDataAttributes`
        """
        model = AssayPatchDataAttributes()
        if include_optional:
            return AssayPatchDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testAssayPatchDataAttributes(self):
        """Test AssayPatchDataAttributes"""
