...
class TestContentBlob(unittest.TestCase):
    """ContentBlob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentBlob:
        """Test ContentBlob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentBlob`
        """
        model = ContentBlob()
        if include_optional:
            return ContentBlob(
