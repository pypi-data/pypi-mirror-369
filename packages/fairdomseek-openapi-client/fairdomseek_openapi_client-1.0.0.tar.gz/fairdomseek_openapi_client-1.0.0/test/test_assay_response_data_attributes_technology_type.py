...
class TestAssayResponseDataAttributesTechnologyType(unittest.TestCase):
    """AssayResponseDataAttributesTechnologyType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayResponseDataAttributesTechnologyType:
        """Test AssayResponseDataAttributesTechnologyType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayResponseDataAttributesTechnologyType`
        """
        model = AssayResponseDataAttributesTechnologyType()
        if include_optional:
            return AssayResponseDataAttributesTechnologyType(
                label = '0',
                uri = '0'
            )
        else:
    ...
    def testAssayResponseDataAttributesTechnologyType(self):
        """Test AssayResponseDataAttributesTechnologyType"""
