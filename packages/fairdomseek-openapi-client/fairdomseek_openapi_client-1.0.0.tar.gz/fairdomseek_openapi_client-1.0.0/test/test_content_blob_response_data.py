...
class TestContentBlobResponseData(unittest.TestCase):
    """ContentBlobResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentBlobResponseData:
        """Test ContentBlobResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentBlobResponseData`
        """
        model = ContentBlobResponseData()
        if include_optional:
            return ContentBlobResponseData(
                id = '0',
                type = 'content_blobs',
    ...
    def testContentBlobResponseData(self):
        """Test ContentBlobResponseData"""
