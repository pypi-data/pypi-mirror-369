...
class TestSopResponse(unittest.TestCase):
    """SopResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SopResponse:
        """Test SopResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SopResponse`
        """
        model = SopResponse()
        if include_optional:
            return SopResponse(
                data = openapi_client.models.sop_response_data.sopResponse_data(
                    id = '0', 
                    type = 'sops', 
