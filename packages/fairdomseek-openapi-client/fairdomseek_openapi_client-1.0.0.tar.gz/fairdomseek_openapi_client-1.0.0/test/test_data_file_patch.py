...
class TestDataFilePatch(unittest.TestCase):
    """DataFilePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePatch:
        """Test DataFilePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePatch`
        """
        model = DataFilePatch()
        if include_optional:
            return DataFilePatch(
                data = openapi_client.models.data_file_patch_data.dataFilePatch_data(
                    id = '0', 
                    type = 'data_files', 
                    attributes = openapi_client.models.data_file_patch_data_attributes.dataFilePatch_data_attributes(
                        tags = [
                            '0'
                            ], 
                    ...
                    relationships = openapi_client.models.data_file_patch_data_relationships.dataFilePatch_data_relationships(
