...
class TestCollectionItemResponse(unittest.TestCase):
    """CollectionItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemResponse:
        """Test CollectionItemResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemResponse`
        """
        model = CollectionItemResponse()
        if include_optional:
    ...
    def testCollectionItemResponse(self):
        """Test CollectionItemResponse"""
