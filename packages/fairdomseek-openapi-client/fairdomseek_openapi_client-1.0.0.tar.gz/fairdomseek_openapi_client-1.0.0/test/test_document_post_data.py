...
class TestDocumentPostData(unittest.TestCase):
    """DocumentPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPostData:
        """Test DocumentPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPostData`
        """
        model = DocumentPostData()
        if include_optional:
            return DocumentPostData(
                type = 'documents',
