...
class TestInvestigationResponseDataRelationships(unittest.TestCase):
    """InvestigationResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationResponseDataRelationships:
        """Test InvestigationResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationResponseDataRelationships`
        """
        model = InvestigationResponseDataRelationships()
        if include_optional:
            return InvestigationResponseDataRelationships(
    ...
    def testInvestigationResponseDataRelationships(self):
        """Test InvestigationResponseDataRelationships"""
