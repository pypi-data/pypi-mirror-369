...
class TestUnprocessableEntityResponse(unittest.TestCase):
    """UnprocessableEntityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnprocessableEntityResponse:
        """Test UnprocessableEntityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnprocessableEntityResponse`
        """
            ...
            return UnprocessableEntityResponse(
                errors = [
                    openapi_client.models.error.error(
                        ...
                        title = '', 
                        detail = '', 
                        source = openapi_client.models.error_source.error_source(
                            pointer = '', ), )
                    ]
            )
        else:
    ...
    def testUnprocessableEntityResponse(self):
        """Test UnprocessableEntityResponse"""
