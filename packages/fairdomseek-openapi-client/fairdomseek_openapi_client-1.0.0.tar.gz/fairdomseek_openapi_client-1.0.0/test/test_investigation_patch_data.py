...
class TestInvestigationPatchData(unittest.TestCase):
    """InvestigationPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPatchData:
        """Test InvestigationPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPatchData`
        """
        model = InvestigationPatchData()
        if include_optional:
            return InvestigationPatchData(
                id = '0',
                type = 'investigations',
    ...
    def testInvestigationPatchData(self):
        """Test InvestigationPatchData"""
