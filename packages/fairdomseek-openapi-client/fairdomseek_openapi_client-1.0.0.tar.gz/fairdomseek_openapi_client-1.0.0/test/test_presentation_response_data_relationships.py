...
class TestPresentationResponseDataRelationships(unittest.TestCase):
    """PresentationResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationResponseDataRelationships:
        """Test PresentationResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationResponseDataRelationships`
        """
        model = PresentationResponseDataRelationships()
        if include_optional:
            return PresentationResponseDataRelationships(
    ...
    def testPresentationResponseDataRelationships(self):
        """Test PresentationResponseDataRelationships"""
