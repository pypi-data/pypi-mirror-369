...
class TestStudyResponseDataRelationships(unittest.TestCase):
    """StudyResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyResponseDataRelationships:
        """Test StudyResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyResponseDataRelationships`
        """
        model = StudyResponseDataRelationships()
        if include_optional:
            return StudyResponseDataRelationships(
    ...
    def testStudyResponseDataRelationships(self):
        """Test StudyResponseDataRelationships"""
