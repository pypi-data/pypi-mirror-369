...
class TestAssayPost(unittest.TestCase):
    """AssayPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPost:
        """Test AssayPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPost`
        """
        model = AssayPost()
        if include_optional:
            return AssayPost(
                data = openapi_client.models.assay_post_data.assayPost_data(
                    type = 'assays', 
                    attributes = openapi_client.models.assay_post_data_attributes.assayPost_data_attributes(
                        tags = [
                            '0'
                            ], 
                        title = '0', 
                        ...
                        assay_class = openapi_client.models.assay_post_data_attributes_assay_class.assayPost_data_attributes_assay_class(
                            key = '0', ), 
                        assay_type = openapi_client.models.assay_post_data_attributes_assay_type.assayPost_data_attributes_assay_type(
                            uri = '0', ), 
                        technology_type = openapi_client.models.assay_post_data_attributes_assay_type.assayPost_data_attributes_assay_type(
                            uri = '0', ), 
                        policy = {
                            'key' : null
                            }, 
                        discussion_links = [
                            openapi_client.models.asset_link_create.assetLinkCreate(
                                label = '0', 
                                url = '0', )
                            ], 
                    ...
                    relationships = openapi_client.models.assay_post_data_relationships.assayPost_data_relationships(
