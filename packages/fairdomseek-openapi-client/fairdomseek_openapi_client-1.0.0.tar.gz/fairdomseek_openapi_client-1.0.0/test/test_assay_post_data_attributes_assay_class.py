...
class TestAssayPostDataAttributesAssayClass(unittest.TestCase):
    """AssayPostDataAttributesAssayClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPostDataAttributesAssayClass:
        """Test AssayPostDataAttributesAssayClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPostDataAttributesAssayClass`
        """
        model = AssayPostDataAttributesAssayClass()
        if include_optional:
            return AssayPostDataAttributesAssayClass(
                key = '0'
            )
        else:
            return AssayPostDataAttributesAssayClass(
    ...
    def testAssayPostDataAttributesAssayClass(self):
        """Test AssayPostDataAttributesAssayClass"""
