...
class TestCollectionItemAttributes(unittest.TestCase):
    """CollectionItemAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemAttributes:
        """Test CollectionItemAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemAttributes`
        """
        model = CollectionItemAttributes()
        if include_optional:
            return CollectionItemAttributes(
                comment = '0',
                order = 56
            )
        else:
    ...
    def testCollectionItemAttributes(self):
        """Test CollectionItemAttributes"""
