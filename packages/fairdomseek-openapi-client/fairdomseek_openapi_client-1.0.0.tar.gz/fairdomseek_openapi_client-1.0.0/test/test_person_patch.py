...
class TestPersonPatch(unittest.TestCase):
    """PersonPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPatch:
        """Test PersonPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPatch`
        """
        model = PersonPatch()
        if include_optional:
            return PersonPatch(
                data = openapi_client.models.person_patch_data.personPatch_data(
                    id = '0', 
                    type = 'people', 
