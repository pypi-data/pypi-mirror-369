...
class TestSampleTypePatchDataRelationships(unittest.TestCase):
    """SampleTypePatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePatchDataRelationships:
        """Test SampleTypePatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePatchDataRelationships`
        """
        model = SampleTypePatchDataRelationships()
        if include_optional:
            return SampleTypePatchDataRelationships(
    ...
    def testSampleTypePatchDataRelationships(self):
        """Test SampleTypePatchDataRelationships"""
