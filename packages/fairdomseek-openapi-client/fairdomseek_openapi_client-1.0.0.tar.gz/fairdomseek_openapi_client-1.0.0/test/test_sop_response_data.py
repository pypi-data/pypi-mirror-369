...
class TestSopResponseData(unittest.TestCase):
    """SopResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SopResponseData:
        """Test SopResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SopResponseData`
        """
        model = SopResponseData()
        if include_optional:
            return SopResponseData(
                id = '0',
                type = 'sops',
                ...
                relationships = openapi_client.models.document_response_data_relationships.documentResponse_data_relationships(
