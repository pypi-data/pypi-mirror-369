...
class TestModelPostData(unittest.TestCase):
    """ModelPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelPostData:
        """Test ModelPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPostData`
        """
        model = ModelPostData()
        if include_optional:
