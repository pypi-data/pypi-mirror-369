...
class TestWorkflowPost(unittest.TestCase):
    """WorkflowPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPost:
        """Test WorkflowPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPost`
        """
        model = WorkflowPost()
        if include_optional:
            return WorkflowPost(
                data = openapi_client.models.workflow_post_data.workflowPost_data(
                    type = 'workflows', 
                    attributes = openapi_client.models.workflow_post_data_attributes.workflowPost_data_attributes(
                        tags = [
                            '0'
                            ], 
                        topic_annotations = [
                        ...
                        tools = [
                            openapi_client.models.workflowtool.workflowtool(
                                id = '0', 
                                name = '0', )
                            ], 
                        title = '0', 
                        description = '0', 
                        workflow_class = openapi_client.models.workflow_post_data_attributes_workflow_class.workflowPost_data_attributes_workflow_class(
                            key = '0', ), 
                        license = '0', 
                        policy = {
                            'key' : null
                    ...
                    relationships = openapi_client.models.workflow_post_data_relationships.workflowPost_data_relationships(
