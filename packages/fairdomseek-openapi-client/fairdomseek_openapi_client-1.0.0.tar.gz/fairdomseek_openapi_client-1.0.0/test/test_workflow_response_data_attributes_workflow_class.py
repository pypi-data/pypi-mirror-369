...
class TestWorkflowResponseDataAttributesWorkflowClass(unittest.TestCase):
    """WorkflowResponseDataAttributesWorkflowClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseDataAttributesWorkflowClass:
        """Test WorkflowResponseDataAttributesWorkflowClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseDataAttributesWorkflowClass`
        """
        model = WorkflowResponseDataAttributesWorkflowClass()
        if include_optional:
            return WorkflowResponseDataAttributesWorkflowClass(
                title = '0',
                key = '0',
                description = '0'
            )
    ...
    def testWorkflowResponseDataAttributesWorkflowClass(self):
        """Test WorkflowResponseDataAttributesWorkflowClass"""
