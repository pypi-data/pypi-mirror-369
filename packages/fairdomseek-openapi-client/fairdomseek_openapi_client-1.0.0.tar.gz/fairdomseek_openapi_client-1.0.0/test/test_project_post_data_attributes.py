...
class TestProjectPostDataAttributes(unittest.TestCase):
    """ProjectPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPostDataAttributes:
        """Test ProjectPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPostDataAttributes`
        """
        model = ProjectPostDataAttributes()
        if include_optional:
            return ProjectPostDataAttributes(
                avatar = '0',
                title = '0',
                description = '0',
                web_page = '0',
    ...
    def testProjectPostDataAttributes(self):
        """Test ProjectPostDataAttributes"""
