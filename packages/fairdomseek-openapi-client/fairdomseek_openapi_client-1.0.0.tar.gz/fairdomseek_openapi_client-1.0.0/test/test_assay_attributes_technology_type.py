...
class TestAssayAttributesTechnologyType(unittest.TestCase):
    """AssayAttributesTechnologyType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayAttributesTechnologyType:
        """Test AssayAttributesTechnologyType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayAttributesTechnologyType`
        """
        model = AssayAttributesTechnologyType()
        if include_optional:
            return AssayAttributesTechnologyType(
                label = '0',
                uri = '0'
            )
        else:
    ...
    def testAssayAttributesTechnologyType(self):
        """Test AssayAttributesTechnologyType"""
