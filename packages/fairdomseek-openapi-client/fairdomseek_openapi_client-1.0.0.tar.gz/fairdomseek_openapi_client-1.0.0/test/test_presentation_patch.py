...
class TestPresentationPatch(unittest.TestCase):
    """PresentationPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationPatch:
        """Test PresentationPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationPatch`
        """
        model = PresentationPatch()
        if include_optional:
            return PresentationPatch(
                data = openapi_client.models.presentation_patch_data.presentationPatch_data(
                    id = '0', 
                    type = 'presentations', 
    ...
    def testPresentationPatch(self):
        """Test PresentationPatch"""
