...
class TestSampleResponseData(unittest.TestCase):
    """SampleResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleResponseData:
        """Test SampleResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleResponseData`
        """
        model = SampleResponseData()
        if include_optional:
            return SampleResponseData(
                id = '0',
                type = 'samples',
                attributes = openapi_client.models.sample_response_data_attributes.sampleResponse_data_attributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                ...
                relationships = openapi_client.models.sample_response_data_relationships.sampleResponse_data_relationships(
    ...
    def testSampleResponseData(self):
        """Test SampleResponseData"""
