...
class TestSampleTypeSampleAttributeResponseSampleAttributeType(unittest.TestCase):
    """SampleTypeSampleAttributeResponseSampleAttributeType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeSampleAttributeResponseSampleAttributeType:
        """Test SampleTypeSampleAttributeResponseSampleAttributeType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeSampleAttributeResponseSampleAttributeType`
        """
        model = SampleTypeSampleAttributeResponseSampleAttributeType()
        if include_optional:
            return SampleTypeSampleAttributeResponseSampleAttributeType(
                id = '0',
                title = '0',
                base_type = 'Integer',
                regexp = '0'
    ...
    def testSampleTypeSampleAttributeResponseSampleAttributeType(self):
        """Test SampleTypeSampleAttributeResponseSampleAttributeType"""
