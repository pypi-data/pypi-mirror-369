...
class TestCollectionPatchData(unittest.TestCase):
    """CollectionPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPatchData:
        """Test CollectionPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPatchData`
        """
        model = CollectionPatchData()
        if include_optional:
    ...
    def testCollectionPatchData(self):
        """Test CollectionPatchData"""
