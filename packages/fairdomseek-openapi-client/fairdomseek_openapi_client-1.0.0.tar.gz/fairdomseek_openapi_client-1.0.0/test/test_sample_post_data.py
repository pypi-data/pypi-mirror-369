...
class TestSamplePostData(unittest.TestCase):
    """SamplePostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePostData:
        """Test SamplePostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePostData`
        """
        model = SamplePostData()
        if include_optional:
            return SamplePostData(
                type = 'samples',
                attributes = openapi_client.models.sample_post_data_attributes.samplePost_data_attributes(
                    tags = [
                        '0'
                        ], 
                    other_creators = '0', 
                ...
                relationships = openapi_client.models.sample_post_data_relationships.samplePost_data_relationships(
