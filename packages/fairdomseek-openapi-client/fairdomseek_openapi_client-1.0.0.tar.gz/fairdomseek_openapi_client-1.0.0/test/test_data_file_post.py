...
class TestDataFilePost(unittest.TestCase):
    """DataFilePost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePost:
        """Test DataFilePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePost`
        """
        model = DataFilePost()
        if include_optional:
            return DataFilePost(
                data = openapi_client.models.data_file_post_data.dataFilePost_data(
                    type = 'data_files', 
                    attributes = openapi_client.models.data_file_post_data_attributes.dataFilePost_data_attributes(
                        tags = [
                            '0'
                            ], 
                    ...
                    relationships = openapi_client.models.data_file_post_data_relationships.dataFilePost_data_relationships(
