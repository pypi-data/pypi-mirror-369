...
class TestSamplePatchDataAttributes(unittest.TestCase):
    """SamplePatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePatchDataAttributes:
        """Test SamplePatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePatchDataAttributes`
        """
        model = SamplePatchDataAttributes()
        if include_optional:
            return SamplePatchDataAttributes(
                tags = [
                    '0'
                    ],
                other_creators = '0',
    ...
    def testSamplePatchDataAttributes(self):
        """Test SamplePatchDataAttributes"""
