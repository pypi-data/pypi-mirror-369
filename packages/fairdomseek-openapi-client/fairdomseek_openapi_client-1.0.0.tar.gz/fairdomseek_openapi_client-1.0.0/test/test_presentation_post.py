...
class TestPresentationPost(unittest.TestCase):
    """PresentationPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationPost:
        """Test PresentationPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationPost`
        """
        model = PresentationPost()
        if include_optional:
            return PresentationPost(
                data = openapi_client.models.presentation_post_data.presentationPost_data(
                    type = 'presentations', 
                    attributes = openapi_client.models.document_post_data_attributes.documentPost_data_attributes(
                        tags = [
                            '0'
                            ], 
                        title = '0', 
                    ...
                    relationships = openapi_client.models.presentation_post_data_relationships.presentationPost_data_relationships(
