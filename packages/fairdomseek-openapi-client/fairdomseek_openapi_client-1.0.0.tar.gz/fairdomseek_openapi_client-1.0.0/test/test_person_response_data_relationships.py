...
class TestPersonResponseDataRelationships(unittest.TestCase):
    """PersonResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonResponseDataRelationships:
        """Test PersonResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonResponseDataRelationships`
        """
        model = PersonResponseDataRelationships()
        if include_optional:
            return PersonResponseDataRelationships(
    ...
    def testPersonResponseDataRelationships(self):
        """Test PersonResponseDataRelationships"""
