...
class TestSampleTypeSampleAttributePost(unittest.TestCase):
    """SampleTypeSampleAttributePost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeSampleAttributePost:
        """Test SampleTypeSampleAttributePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeSampleAttributePost`
        """
        model = SampleTypeSampleAttributePost()
        if include_optional:
            return SampleTypeSampleAttributePost(
                id = '0',
                title = '0',
                description = '0',
                pid = '0',
    ...
    def testSampleTypeSampleAttributePost(self):
        """Test SampleTypeSampleAttributePost"""
