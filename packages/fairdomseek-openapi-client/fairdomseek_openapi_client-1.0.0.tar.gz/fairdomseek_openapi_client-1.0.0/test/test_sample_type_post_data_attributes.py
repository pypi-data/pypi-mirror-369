...
class TestSampleTypePostDataAttributes(unittest.TestCase):
    """SampleTypePostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePostDataAttributes:
        """Test SampleTypePostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePostDataAttributes`
        """
        model = SampleTypePostDataAttributes()
        if include_optional:
            return SampleTypePostDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testSampleTypePostDataAttributes(self):
        """Test SampleTypePostDataAttributes"""
