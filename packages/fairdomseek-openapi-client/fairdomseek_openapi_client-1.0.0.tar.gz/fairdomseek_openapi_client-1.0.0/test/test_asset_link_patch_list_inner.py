...
class TestAssetLinkPatchListInner(unittest.TestCase):
    """AssetLinkPatchListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetLinkPatchListInner:
        """Test AssetLinkPatchListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetLinkPatchListInner`
        """
        model = AssetLinkPatchListInner()
        if include_optional:
            return AssetLinkPatchListInner(
                id = '0',
                label = '0',
                url = '0'
            )
    ...
    def testAssetLinkPatchListInner(self):
        """Test AssetLinkPatchListInner"""
