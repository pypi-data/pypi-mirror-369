...
class TestWorkflowResponseDataAttributesInternals(unittest.TestCase):
    """WorkflowResponseDataAttributesInternals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseDataAttributesInternals:
        """Test WorkflowResponseDataAttributesInternals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseDataAttributesInternals`
        """
        model = WorkflowResponseDataAttributesInternals()
        if include_optional:
            return WorkflowResponseDataAttributesInternals(
                inputs = [
                    openapi_client.models.workflow_input.workflowInput(
                        id = '0', 
                        name = '0', 
                        description = '0', 
                        type = '0', 
                ...
                outputs = [
                    openapi_client.models.workflow_output.workflowOutput(
                        id = '0', 
                        name = '0', 
                        description = '0', 
                        type = '0', )
    ...
    def testWorkflowResponseDataAttributesInternals(self):
        """Test WorkflowResponseDataAttributesInternals"""
