...
class TestAssayResponseDataAttributesAssayClass(unittest.TestCase):
    """AssayResponseDataAttributesAssayClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayResponseDataAttributesAssayClass:
        """Test AssayResponseDataAttributesAssayClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayResponseDataAttributesAssayClass`
        """
        model = AssayResponseDataAttributesAssayClass()
        if include_optional:
            return AssayResponseDataAttributesAssayClass(
                title = '0',
                key = '0',
                description = '0'
            )
    ...
    def testAssayResponseDataAttributesAssayClass(self):
        """Test AssayResponseDataAttributesAssayClass"""
