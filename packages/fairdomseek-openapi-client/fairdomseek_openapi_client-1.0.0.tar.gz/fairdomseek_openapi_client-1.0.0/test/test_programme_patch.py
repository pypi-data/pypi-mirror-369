...
class TestProgrammePatch(unittest.TestCase):
    """ProgrammePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePatch:
        """Test ProgrammePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePatch`
        """
        model = ProgrammePatch()
        if include_optional:
            return ProgrammePatch(
                data = openapi_client.models.programme_patch_data.programmePatch_data(
                    id = '0', 
                    type = 'programmes', 
