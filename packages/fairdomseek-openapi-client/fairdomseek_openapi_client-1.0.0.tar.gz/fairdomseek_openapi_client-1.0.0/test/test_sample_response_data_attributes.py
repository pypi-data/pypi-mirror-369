...
class TestSampleResponseDataAttributes(unittest.TestCase):
    """SampleResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleResponseDataAttributes:
        """Test SampleResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleResponseDataAttributes`
        """
        model = SampleResponseDataAttributes()
        if include_optional:
            return SampleResponseDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testSampleResponseDataAttributes(self):
        """Test SampleResponseDataAttributes"""
