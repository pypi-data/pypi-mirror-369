...
class TestCollectionsApi(unittest.TestCase):
    ...
    def test_create_collection_item(self) -> None:
    ...
    def test_list_collection_items(self) -> None:
        ...
        List translation items in a collection
        """
        pass
    ...
    def test_read_collection(self) -> None:
    ...
    def test_read_collection_item(self) -> None:
        """Test case for read_collection_item
