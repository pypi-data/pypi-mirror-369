...
class TestEventPatchDataAttributes(unittest.TestCase):
    """EventPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPatchDataAttributes:
        """Test EventPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPatchDataAttributes`
        """
        model = EventPatchDataAttributes()
        if include_optional:
            return EventPatchDataAttributes(
                title = '0',
                description = '0',
                url = '0',
                address = '0',
    ...
    def testEventPatchDataAttributes(self):
        """Test EventPatchDataAttributes"""
