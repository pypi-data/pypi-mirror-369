...
class TestStudyPostData(unittest.TestCase):
    """StudyPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPostData:
        """Test StudyPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPostData`
        """
        model = StudyPostData()
        if include_optional:
            return StudyPostData(
                type = 'studies',
