...
class TestCollectionPatchDataRelationships(unittest.TestCase):
    """CollectionPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPatchDataRelationships:
        """Test CollectionPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPatchDataRelationships`
        """
        model = CollectionPatchDataRelationships()
        if include_optional:
            return CollectionPatchDataRelationships(
    ...
    def testCollectionPatchDataRelationships(self):
        """Test CollectionPatchDataRelationships"""
