...
class TestSampleResponse(unittest.TestCase):
    """SampleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleResponse:
        """Test SampleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleResponse`
        """
        model = SampleResponse()
        if include_optional:
            return SampleResponse(
                data = openapi_client.models.sample_response_data.sampleResponse_data(
                    id = '0', 
                    type = 'samples', 
