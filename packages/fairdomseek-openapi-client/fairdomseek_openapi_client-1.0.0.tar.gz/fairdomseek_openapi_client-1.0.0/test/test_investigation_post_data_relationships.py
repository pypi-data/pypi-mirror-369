...
class TestInvestigationPostDataRelationships(unittest.TestCase):
    """InvestigationPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPostDataRelationships:
        """Test InvestigationPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPostDataRelationships`
        """
        model = InvestigationPostDataRelationships()
        if include_optional:
            return InvestigationPostDataRelationships(
    ...
    def testInvestigationPostDataRelationships(self):
        """Test InvestigationPostDataRelationships"""
