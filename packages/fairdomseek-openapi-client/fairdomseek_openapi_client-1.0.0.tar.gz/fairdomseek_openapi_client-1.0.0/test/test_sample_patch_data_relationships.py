...
class TestSamplePatchDataRelationships(unittest.TestCase):
    """SamplePatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePatchDataRelationships:
        """Test SamplePatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePatchDataRelationships`
        """
        model = SamplePatchDataRelationships()
        if include_optional:
            return SamplePatchDataRelationships(
    ...
    def testSamplePatchDataRelationships(self):
        """Test SamplePatchDataRelationships"""
