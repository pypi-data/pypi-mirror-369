...
class TestSampleTypePatchData(unittest.TestCase):
    """SampleTypePatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePatchData:
        """Test SampleTypePatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePatchData`
        """
        model = SampleTypePatchData()
        if include_optional:
            return SampleTypePatchData(
                id = '0',
                type = 'sample_types',
                attributes = openapi_client.models.sample_type_patch_data_attributes.sampleTypePatch_data_attributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                    ...
                    sample_attributes = [
                        openapi_client.models.sample_type_sample_attribute_patch.sampleTypeSampleAttributePatch(
                            id = '0', 
                            title = '0', 
                            description = '0', 
                            pid = '0', 
                            sample_attribute_type = openapi_client.models.sample_type_sample_attribute_post_sample_attribute_type.sampleTypeSampleAttributePost_sample_attribute_type(
                                id = '0', 
                                title = '0', ), 
                            required = True, 
                            pos = 56, 
                            unit = '0', 
                            is_title = True, 
                            sample_controlled_vocab_id = '0', 
                            linked_sample_type_id = '0', 
                            _destroy = True, )
                        ], ),
                relationships = openapi_client.models.sample_type_patch_data_relationships.sampleTypePatch_data_relationships(
    ...
    def testSampleTypePatchData(self):
        """Test SampleTypePatchData"""
