...
class TestInstitutionResponseData(unittest.TestCase):
    """InstitutionResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionResponseData:
        """Test InstitutionResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionResponseData`
        """
        model = InstitutionResponseData()
        if include_optional:
            return InstitutionResponseData(
                id = '0',
                type = 'institutions',
                attributes = openapi_client.models.institution_response_data_attributes.institutionResponse_data_attributes(
                    avatar = '0', 
                    title = '0', 
                    country = '', 
                    country_code = '01', 
                ...
                relationships = openapi_client.models.institution_response_data_relationships.institutionResponse_data_relationships(
    ...
    def testInstitutionResponseData(self):
        """Test InstitutionResponseData"""
