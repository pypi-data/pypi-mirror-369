...
class TestStudyResponseDataAttributes(unittest.TestCase):
    """StudyResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyResponseDataAttributes:
        """Test StudyResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyResponseDataAttributes`
        """
        model = StudyResponseDataAttributes()
        if include_optional:
            return StudyResponseDataAttributes(
                snapshots = [
    ...
    def testStudyResponseDataAttributes(self):
        """Test StudyResponseDataAttributes"""
