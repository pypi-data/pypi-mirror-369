...
class TestStudyPatchData(unittest.TestCase):
    """StudyPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPatchData:
        """Test StudyPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPatchData`
        """
        model = StudyPatchData()
        if include_optional:
            return StudyPatchData(
                id = '0',
                type = 'studies',
                attributes = openapi_client.models.study_patch_data_attributes.studyPatch_data_attributes(
                    title = '0', 
                    description = '0', 
                    experimentalists = '0', 
                    other_creators = '0', 
                ...
                relationships = openapi_client.models.study_patch_data_relationships.studyPatch_data_relationships(
