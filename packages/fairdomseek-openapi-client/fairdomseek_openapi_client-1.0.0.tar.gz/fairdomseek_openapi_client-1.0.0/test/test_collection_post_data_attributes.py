...
class TestCollectionPostDataAttributes(unittest.TestCase):
    """CollectionPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPostDataAttributes:
        """Test CollectionPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPostDataAttributes`
        """
        model = CollectionPostDataAttributes()
        if include_optional:
            return CollectionPostDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testCollectionPostDataAttributes(self):
        """Test CollectionPostDataAttributes"""
