...
class TestPublicationResponseDataRelationships(unittest.TestCase):
    """PublicationResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationResponseDataRelationships:
        """Test PublicationResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationResponseDataRelationships`
        """
        model = PublicationResponseDataRelationships()
        if include_optional:
            return PublicationResponseDataRelationships(
                ...
                presentations = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
    ...
    def testPublicationResponseDataRelationships(self):
        """Test PublicationResponseDataRelationships"""
