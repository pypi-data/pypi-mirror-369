...
class TestSopPatch(unittest.TestCase):
    """SopPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SopPatch:
        """Test SopPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SopPatch`
        """
        model = SopPatch()
        if include_optional:
            return SopPatch(
                data = openapi_client.models.sop_patch_data.sopPatch_data(
                    id = '0', 
                    type = 'sops', 
