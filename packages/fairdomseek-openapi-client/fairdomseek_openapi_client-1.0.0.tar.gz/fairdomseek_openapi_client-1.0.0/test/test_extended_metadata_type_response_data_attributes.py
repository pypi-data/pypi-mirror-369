...
class TestExtendedMetadataTypeResponseDataAttributes(unittest.TestCase):
    """ExtendedMetadataTypeResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedMetadataTypeResponseDataAttributes:
        """Test ExtendedMetadataTypeResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedMetadataTypeResponseDataAttributes`
        """
        model = ExtendedMetadataTypeResponseDataAttributes()
        if include_optional:
            return ExtendedMetadataTypeResponseDataAttributes(
                title = '0',
                supported_type = '0',
                enabled = True,
                extended_metadata_attributes = [
                    openapi_client.models.extended_metadata_type_extended_metadata_attribute_response.extendedMetadataTypeExtendedMetadataAttributeResponse(
                        id = '0', 
                        title = '0', 
                        label = '0', 
                        description = '0', 
                        ...
                        linked_extended_metadata_type_id = '0', )
                    ]
            )
        else:
            return ExtendedMetadataTypeResponseDataAttributes(
    ...
    def testExtendedMetadataTypeResponseDataAttributes(self):
        """Test ExtendedMetadataTypeResponseDataAttributes"""
