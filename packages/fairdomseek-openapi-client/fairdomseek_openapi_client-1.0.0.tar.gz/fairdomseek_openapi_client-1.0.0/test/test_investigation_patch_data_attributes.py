...
class TestInvestigationPatchDataAttributes(unittest.TestCase):
    """InvestigationPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPatchDataAttributes:
        """Test InvestigationPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPatchDataAttributes`
        """
        model = InvestigationPatchDataAttributes()
        if include_optional:
            return InvestigationPatchDataAttributes(
                title = '0',
                description = '0',
                other_creators = '0',
                creators = [
    ...
    def testInvestigationPatchDataAttributes(self):
        """Test InvestigationPatchDataAttributes"""
