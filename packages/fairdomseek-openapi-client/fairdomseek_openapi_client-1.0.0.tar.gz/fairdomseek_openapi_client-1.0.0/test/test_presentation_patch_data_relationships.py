...
class TestPresentationPatchDataRelationships(unittest.TestCase):
    """PresentationPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationPatchDataRelationships:
        """Test PresentationPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationPatchDataRelationships`
        """
        model = PresentationPatchDataRelationships()
        if include_optional:
            return PresentationPatchDataRelationships(
    ...
    def testPresentationPatchDataRelationships(self):
        """Test PresentationPatchDataRelationships"""
