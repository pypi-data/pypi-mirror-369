...
class TestDeleteApi(unittest.TestCase):
    ...
    def test_delete_assay(self) -> None:
        """Test case for delete_assay
    ...
    def test_delete_collection_item(self) -> None:
        """Test case for delete_collection_item

        Remove an item from a collection
        """
        pass

    def test_delete_data_file(self) -> None:
    ...
    def test_delete_investigation(self) -> None:
        """Test case for delete_investigation
    ...
    def test_delete_programme(self) -> None:
        """Test case for delete_programme
    ...
    def test_delete_sample_type(self) -> None:
        """Test case for delete_sample_type

        Delete a sample type
        """
        pass

    def test_delete_sop(self) -> None:
        """Test case for delete_sop
