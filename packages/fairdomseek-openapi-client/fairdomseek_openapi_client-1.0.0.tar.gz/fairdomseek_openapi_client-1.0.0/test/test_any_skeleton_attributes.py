...
class TestAnySkeletonAttributes(unittest.TestCase):
    """AnySkeletonAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnySkeletonAttributes:
        """Test AnySkeletonAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnySkeletonAttributes`
        """
        model = AnySkeletonAttributes()
        if include_optional:
            return AnySkeletonAttributes(
                title = '0'
            )
        else:
            return AnySkeletonAttributes(
    ...
    def testAnySkeletonAttributes(self):
        """Test AnySkeletonAttributes"""
