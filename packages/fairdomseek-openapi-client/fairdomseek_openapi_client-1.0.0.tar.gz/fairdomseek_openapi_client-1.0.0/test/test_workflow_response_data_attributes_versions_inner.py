...
class TestWorkflowResponseDataAttributesVersionsInner(unittest.TestCase):
    """WorkflowResponseDataAttributesVersionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseDataAttributesVersionsInner:
        """Test WorkflowResponseDataAttributesVersionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseDataAttributesVersionsInner`
        """
        model = WorkflowResponseDataAttributesVersionsInner()
        if include_optional:
            return WorkflowResponseDataAttributesVersionsInner(
                version = 1.337,
                revision_comments = '0',
                url = '0',
                doi = '0',
    ...
    def testWorkflowResponseDataAttributesVersionsInner(self):
        """Test WorkflowResponseDataAttributesVersionsInner"""
