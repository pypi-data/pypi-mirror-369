...
class TestStudyPatchDataAttributes(unittest.TestCase):
    """StudyPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPatchDataAttributes:
        """Test StudyPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPatchDataAttributes`
        """
        model = StudyPatchDataAttributes()
        if include_optional:
            return StudyPatchDataAttributes(
                title = '0',
                description = '0',
                experimentalists = '0',
                other_creators = '0',
    ...
    def testStudyPatchDataAttributes(self):
        """Test StudyPatchDataAttributes"""
