...
class TestProjectResponseData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectResponseData:
        """Test ProjectResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectResponseData`
        """
        model = ProjectResponseData()
        if include_optional:
            return ProjectResponseData(
                id = '0',
                type = 'projects',
                attributes = openapi_client.models.project_response_data_attributes.projectResponse_data_attributes(
                    avatar = '0', 
                    title = '0', 
                    description = '0', 
                    web_page = '0', 
                    ...
                    members = [
                        openapi_client.models.project_members_list_inner.projectMembersList_inner(
                            person_id = '0', 
                            institution_id = '0', )
                        ], 
                    use_default_policy = True, ),
                relationships = openapi_client.models.project_response_data_relationships.projectResponse_data_relationships(
