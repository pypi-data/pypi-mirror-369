...
class TestAssayPatchDataRelationships(unittest.TestCase):
    """AssayPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPatchDataRelationships:
        """Test AssayPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPatchDataRelationships`
        """
        model = AssayPatchDataRelationships()
        if include_optional:
            return AssayPatchDataRelationships(
    ...
    def testAssayPatchDataRelationships(self):
        """Test AssayPatchDataRelationships"""
