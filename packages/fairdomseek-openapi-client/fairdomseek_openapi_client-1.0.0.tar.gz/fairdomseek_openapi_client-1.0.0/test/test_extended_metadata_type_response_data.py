...
class TestExtendedMetadataTypeResponseData(unittest.TestCase):
    """ExtendedMetadataTypeResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedMetadataTypeResponseData:
        """Test ExtendedMetadataTypeResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedMetadataTypeResponseData`
        """
        model = ExtendedMetadataTypeResponseData()
        if include_optional:
            return ExtendedMetadataTypeResponseData(
                id = '0',
                type = '0',
    ...
    def testExtendedMetadataTypeResponseData(self):
        """Test ExtendedMetadataTypeResponseData"""
