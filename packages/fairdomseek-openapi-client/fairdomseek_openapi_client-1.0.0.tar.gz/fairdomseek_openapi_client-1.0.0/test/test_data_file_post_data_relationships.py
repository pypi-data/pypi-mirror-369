...
class TestDataFilePostDataRelationships(unittest.TestCase):
    """DataFilePostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePostDataRelationships:
        """Test DataFilePostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePostDataRelationships`
        """
        model = DataFilePostDataRelationships()
        if include_optional:
            return DataFilePostDataRelationships(
    ...
    def testDataFilePostDataRelationships(self):
        """Test DataFilePostDataRelationships"""
