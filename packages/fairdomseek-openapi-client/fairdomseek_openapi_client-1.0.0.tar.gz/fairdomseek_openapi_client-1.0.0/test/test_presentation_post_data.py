...
class TestPresentationPostData(unittest.TestCase):
    """PresentationPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationPostData:
        """Test PresentationPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationPostData`
        """
        model = PresentationPostData()
        if include_optional:
            return PresentationPostData(
                type = 'presentations',
    ...
    def testPresentationPostData(self):
        """Test PresentationPostData"""
