...
class TestCollectionItemRelationships(unittest.TestCase):
    """CollectionItemRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemRelationships:
        """Test CollectionItemRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemRelationships`
        """
        model = CollectionItemRelationships()
        if include_optional:
            return CollectionItemRelationships(
                asset = openapi_client.models.single_reference_with_title.singleReferenceWithTitle(
                    ...
                    meta = openapi_client.models.single_reference_with_title_meta.singleReferenceWithTitle_meta(
                        title = '0', ), ),
                collection = openapi_client.models.single_reference.singleReference(
                    data = openapi_client.models.item_reference.itemReference(
                        id = '0', 
                        type = 'assays', ), )
            )
    ...
    def testCollectionItemRelationships(self):
        """Test CollectionItemRelationships"""
