...
class TestSamplePost(unittest.TestCase):
    """SamplePost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePost:
        """Test SamplePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePost`
        """
        model = SamplePost()
        if include_optional:
            return SamplePost(
                data = openapi_client.models.sample_post_data.samplePost_data(
                    type = 'samples', 
