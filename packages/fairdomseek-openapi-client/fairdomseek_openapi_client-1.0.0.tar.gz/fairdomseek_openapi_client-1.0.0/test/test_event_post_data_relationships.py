...
class TestEventPostDataRelationships(unittest.TestCase):
    """EventPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPostDataRelationships:
        """Test EventPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPostDataRelationships`
        """
        model = EventPostDataRelationships()
        if include_optional:
            return EventPostDataRelationships(
    ...
    def testEventPostDataRelationships(self):
        """Test EventPostDataRelationships"""
