...
class TestCollectionItemMeta(unittest.TestCase):
    """CollectionItemMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemMeta:
        """Test CollectionItemMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemMeta`
        """
        model = CollectionItemMeta()
        if include_optional:
            return CollectionItemMeta(
                base_url = '0',
                api_version = '0',
    ...
    def testCollectionItemMeta(self):
        """Test CollectionItemMeta"""
