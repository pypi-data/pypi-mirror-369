...
class TestStudyPatchDataRelationships(unittest.TestCase):
    """StudyPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPatchDataRelationships:
        """Test StudyPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPatchDataRelationships`
        """
        model = StudyPatchDataRelationships()
        if include_optional:
            return StudyPatchDataRelationships(
    ...
    def testStudyPatchDataRelationships(self):
        """Test StudyPatchDataRelationships"""
