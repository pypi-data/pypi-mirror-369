...
class TestCollectionItemPostDataAttributes(unittest.TestCase):
    """CollectionItemPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemPostDataAttributes:
        """Test CollectionItemPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemPostDataAttributes`
        """
        model = CollectionItemPostDataAttributes()
        if include_optional:
            return CollectionItemPostDataAttributes(
                comment = '0',
                order = 56
            )
        else:
    ...
    def testCollectionItemPostDataAttributes(self):
        """Test CollectionItemPostDataAttributes"""
