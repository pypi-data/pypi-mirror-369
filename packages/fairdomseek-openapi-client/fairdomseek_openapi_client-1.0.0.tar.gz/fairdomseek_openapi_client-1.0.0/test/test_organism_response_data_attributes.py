...
class TestOrganismResponseDataAttributes(unittest.TestCase):
    """OrganismResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganismResponseDataAttributes:
        """Test OrganismResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganismResponseDataAttributes`
        """
        model = OrganismResponseDataAttributes()
        if include_optional:
            return OrganismResponseDataAttributes(
                title = '0',
                concept_uri = '0',
                ontology_id = '0'
            )
    ...
    def testOrganismResponseDataAttributes(self):
        """Test OrganismResponseDataAttributes"""
