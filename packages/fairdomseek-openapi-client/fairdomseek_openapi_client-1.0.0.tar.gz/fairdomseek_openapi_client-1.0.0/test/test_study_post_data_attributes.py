...
class TestStudyPostDataAttributes(unittest.TestCase):
    """StudyPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPostDataAttributes:
        """Test StudyPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPostDataAttributes`
        """
        model = StudyPostDataAttributes()
        if include_optional:
            return StudyPostDataAttributes(
                title = '0',
                description = '0',
                experimentalists = '0',
                other_creators = '0',
    ...
    def testStudyPostDataAttributes(self):
        """Test StudyPostDataAttributes"""
