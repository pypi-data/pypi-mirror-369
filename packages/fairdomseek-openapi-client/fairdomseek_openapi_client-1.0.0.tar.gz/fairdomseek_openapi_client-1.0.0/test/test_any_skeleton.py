...
class TestAnySkeleton(unittest.TestCase):
    """AnySkeleton unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnySkeleton:
        """Test AnySkeleton
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnySkeleton`
        """
        model = AnySkeleton()
        if include_optional:
            return AnySkeleton(
                id = '0',
                type = 'assays',
                attributes = openapi_client.models.any_skeleton_attributes.anySkeleton_attributes(
                    title = '0', ),
