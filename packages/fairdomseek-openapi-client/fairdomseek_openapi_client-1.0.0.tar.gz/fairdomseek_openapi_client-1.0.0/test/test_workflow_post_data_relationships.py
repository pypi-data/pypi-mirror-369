...
class TestWorkflowPostDataRelationships(unittest.TestCase):
    """WorkflowPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPostDataRelationships:
        """Test WorkflowPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPostDataRelationships`
        """
        model = WorkflowPostDataRelationships()
        if include_optional:
            return WorkflowPostDataRelationships(
    ...
    def testWorkflowPostDataRelationships(self):
        """Test WorkflowPostDataRelationships"""
