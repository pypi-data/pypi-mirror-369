...
class TestProgrammePatchDataRelationships(unittest.TestCase):
    """ProgrammePatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePatchDataRelationships:
        """Test ProgrammePatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePatchDataRelationships`
        """
        model = ProgrammePatchDataRelationships()
        if include_optional:
            return ProgrammePatchDataRelationships(
    ...
    def testProgrammePatchDataRelationships(self):
        """Test ProgrammePatchDataRelationships"""
