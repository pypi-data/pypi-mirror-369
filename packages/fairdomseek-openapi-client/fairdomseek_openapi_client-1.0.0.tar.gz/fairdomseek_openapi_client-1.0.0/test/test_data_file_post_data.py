...
class TestDataFilePostData(unittest.TestCase):
    """DataFilePostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFilePostData:
        """Test DataFilePostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFilePostData`
        """
        model = DataFilePostData()
        if include_optional:
            return DataFilePostData(
                type = 'data_files',
