...
class TestStudyPost(unittest.TestCase):
    """StudyPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StudyPost:
        """Test StudyPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StudyPost`
        """
        model = StudyPost()
        if include_optional:
            return StudyPost(
                data = openapi_client.models.study_post_data.studyPost_data(
                    type = 'studies', 
                    attributes = openapi_client.models.study_post_data_attributes.studyPost_data_attributes(
                        title = '0', 
                        description = '0', 
                        experimentalists = '0', 
                        other_creators = '0', 
                    ...
                    relationships = openapi_client.models.study_post_data_relationships.studyPost_data_relationships(
