...
class TestProjectMembersListInner(unittest.TestCase):
    """ProjectMembersListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectMembersListInner:
        """Test ProjectMembersListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectMembersListInner`
        """
        model = ProjectMembersListInner()
        if include_optional:
            return ProjectMembersListInner(
                person_id = '0',
                institution_id = '0'
            )
        else:
    ...
    def testProjectMembersListInner(self):
        """Test ProjectMembersListInner"""
