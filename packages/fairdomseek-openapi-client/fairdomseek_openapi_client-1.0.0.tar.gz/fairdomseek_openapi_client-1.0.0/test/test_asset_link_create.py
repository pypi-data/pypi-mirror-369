...
class TestAssetLinkCreate(unittest.TestCase):
    """AssetLinkCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetLinkCreate:
        """Test AssetLinkCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetLinkCreate`
        """
        model = AssetLinkCreate()
        if include_optional:
            return AssetLinkCreate(
                label = '0',
                url = '0'
            )
        else:
