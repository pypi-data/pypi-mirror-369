...
class TestInstitutionPost(unittest.TestCase):
    """InstitutionPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionPost:
        """Test InstitutionPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionPost`
        """
        model = InstitutionPost()
        if include_optional:
            return InstitutionPost(
                data = openapi_client.models.institution_post_data.institutionPost_data(
                    type = 'institutions', 
                    attributes = openapi_client.models.institution_post_data_attributes.institutionPost_data_attributes(
                        avatar = '0', 
                        title = '0', 
                        country = '', 
                        city = '0', 
