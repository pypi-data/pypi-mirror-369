...
class TestIndexLinks(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndexLinks:
        """Test IndexLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexLinks`
        """
        model = IndexLinks()
        if include_optional:
            return IndexLinks(
