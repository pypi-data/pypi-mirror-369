...
class TestSamplePatchData(unittest.TestCase):
    """SamplePatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePatchData:
        """Test SamplePatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePatchData`
        """
        model = SamplePatchData()
        if include_optional:
            return SamplePatchData(
                id = '0',
                type = 'samples',
                attributes = openapi_client.models.sample_patch_data_attributes.samplePatch_data_attributes(
                    tags = [
                        '0'
                        ], 
                    other_creators = '0', 
                ...
                relationships = openapi_client.models.sample_patch_data_relationships.samplePatch_data_relationships(
