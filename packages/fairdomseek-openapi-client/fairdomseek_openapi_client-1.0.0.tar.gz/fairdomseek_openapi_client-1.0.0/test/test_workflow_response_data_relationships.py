...
class TestWorkflowResponseDataRelationships(unittest.TestCase):
    """WorkflowResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseDataRelationships:
        """Test WorkflowResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseDataRelationships`
        """
        model = WorkflowResponseDataRelationships()
        if include_optional:
            return WorkflowResponseDataRelationships(
    ...
    def testWorkflowResponseDataRelationships(self):
        """Test WorkflowResponseDataRelationships"""
