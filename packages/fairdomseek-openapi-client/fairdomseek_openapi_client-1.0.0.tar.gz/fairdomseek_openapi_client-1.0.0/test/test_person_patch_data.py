...
class TestPersonPatchData(unittest.TestCase):
    """PersonPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPatchData:
        """Test PersonPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPatchData`
        """
        model = PersonPatchData()
        if include_optional:
            return PersonPatchData(
                id = '0',
                type = 'people',
                attributes = openapi_client.models.person_patch_data_attributes.personPatch_data_attributes(
                    description = '0', 
                    first_name = '0', 
                    last_name = '0', 
                    email = '0', 
