...
class TestSampleTypeSampleAttributePatch(unittest.TestCase):
    """SampleTypeSampleAttributePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeSampleAttributePatch:
        """Test SampleTypeSampleAttributePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeSampleAttributePatch`
        """
        model = SampleTypeSampleAttributePatch()
        if include_optional:
            return SampleTypeSampleAttributePatch(
                id = '0',
                title = '0',
                description = '0',
                pid = '0',
    ...
    def testSampleTypeSampleAttributePatch(self):
        """Test SampleTypeSampleAttributePatch"""
