...
class TestUpdateApi(unittest.TestCase):
    ...
    def test_update_data_file(self) -> None:
        """Test case for update_data_file
    ...
    def test_update_investigation(self) -> None:
        """Test case for update_investigation
    ...
    def test_update_sop(self) -> None:
        """Test case for update_sop
