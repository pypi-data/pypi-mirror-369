...
class TestProgrammePostData(unittest.TestCase):
    """ProgrammePostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePostData:
        """Test ProgrammePostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePostData`
        """
        model = ProgrammePostData()
        if include_optional:
            return ProgrammePostData(
                type = 'programmes',
                attributes = openapi_client.models.programme_post_data_attributes.programmePost_data_attributes(
                    title = '0', 
                    description = '0', 
                    web_page = '0', 
                    funding_details = '0', 
                ...
                relationships = openapi_client.models.programme_post_data_relationships.programmePost_data_relationships(
                    administrators = openapi_client.models.multiple_references.multipleReferences(
                        data = [
    ...
    def testProgrammePostData(self):
        """Test ProgrammePostData"""
