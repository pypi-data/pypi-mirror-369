...
class TestContentBlobPlaceholder(unittest.TestCase):
    """ContentBlobPlaceholder unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentBlobPlaceholder:
        """Test ContentBlobPlaceholder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentBlobPlaceholder`
        """
        model = ContentBlobPlaceholder()
        if include_optional:
            return ContentBlobPlaceholder(
                original_filename = '0',
                content_type = '0'
            )
        else:
    ...
    def testContentBlobPlaceholder(self):
        """Test ContentBlobPlaceholder"""
