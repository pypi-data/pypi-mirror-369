...
class TestDocumentResponseDataRelationships(unittest.TestCase):
    """DocumentResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentResponseDataRelationships:
        """Test DocumentResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentResponseDataRelationships`
        """
        model = DocumentResponseDataRelationships()
        if include_optional:
            return DocumentResponseDataRelationships(
    ...
    def testDocumentResponseDataRelationships(self):
        """Test DocumentResponseDataRelationships"""
