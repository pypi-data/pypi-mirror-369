...
class TestSampleTypePostDataRelationships(unittest.TestCase):
    """SampleTypePostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePostDataRelationships:
        """Test SampleTypePostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePostDataRelationships`
        """
        model = SampleTypePostDataRelationships()
        if include_optional:
            return SampleTypePostDataRelationships(
    ...
    def testSampleTypePostDataRelationships(self):
        """Test SampleTypePostDataRelationships"""
