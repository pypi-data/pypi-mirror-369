...
class TestWorkflowPatchDataAttributes(unittest.TestCase):
    """WorkflowPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPatchDataAttributes:
        """Test WorkflowPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPatchDataAttributes`
        """
        model = WorkflowPatchDataAttributes()
        if include_optional:
            return WorkflowPatchDataAttributes(
                tags = [
                    '0'
                    ],
                topic_annotations = [
    ...
    def testWorkflowPatchDataAttributes(self):
        """Test WorkflowPatchDataAttributes"""
