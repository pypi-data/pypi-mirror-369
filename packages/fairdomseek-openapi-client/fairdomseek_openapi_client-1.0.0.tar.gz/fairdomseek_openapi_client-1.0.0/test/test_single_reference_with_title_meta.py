...
class TestSingleReferenceWithTitleMeta(unittest.TestCase):
    """SingleReferenceWithTitleMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleReferenceWithTitleMeta:
        """Test SingleReferenceWithTitleMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleReferenceWithTitleMeta`
        """
        model = SingleReferenceWithTitleMeta()
        if include_optional:
            return SingleReferenceWithTitleMeta(
                title = '0'
            )
        else:
            return SingleReferenceWithTitleMeta(
    ...
    def testSingleReferenceWithTitleMeta(self):
        """Test SingleReferenceWithTitleMeta"""
