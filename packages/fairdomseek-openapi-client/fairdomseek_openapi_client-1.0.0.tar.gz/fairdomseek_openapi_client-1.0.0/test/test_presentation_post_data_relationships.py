...
class TestPresentationPostDataRelationships(unittest.TestCase):
    """PresentationPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationPostDataRelationships:
        """Test PresentationPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationPostDataRelationships`
        """
        model = PresentationPostDataRelationships()
        if include_optional:
            return PresentationPostDataRelationships(
    ...
    def testPresentationPostDataRelationships(self):
        """Test PresentationPostDataRelationships"""
