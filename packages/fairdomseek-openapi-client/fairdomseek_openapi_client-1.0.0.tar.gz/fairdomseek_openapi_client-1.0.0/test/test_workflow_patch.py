...
class TestWorkflowPatch(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WorkflowPatch:
        """Test WorkflowPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPatch`
        """
        model = WorkflowPatch()
        if include_optional:
            return WorkflowPatch(
                data = openapi_client.models.workflow_patch_data.workflowPatch_data(
                    id = '0', 
                    type = 'workflows', 
