...
class TestExtendedMetadataTypeResponseDataMeta(unittest.TestCase):
    """ExtendedMetadataTypeResponseDataMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedMetadataTypeResponseDataMeta:
        """Test ExtendedMetadataTypeResponseDataMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedMetadataTypeResponseDataMeta`
        """
        model = ExtendedMetadataTypeResponseDataMeta()
        if include_optional:
            return ExtendedMetadataTypeResponseDataMeta(
                base_url = '0',
                api_version = '0'
            )
        else:
    ...
    def testExtendedMetadataTypeResponseDataMeta(self):
        """Test ExtendedMetadataTypeResponseDataMeta"""
