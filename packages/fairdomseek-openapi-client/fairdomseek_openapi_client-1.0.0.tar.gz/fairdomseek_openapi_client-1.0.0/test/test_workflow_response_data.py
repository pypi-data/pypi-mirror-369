...
class TestWorkflowResponseData(unittest.TestCase):
    """WorkflowResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseData:
        """Test WorkflowResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseData`
        """
        model = WorkflowResponseData()
        if include_optional:
            return WorkflowResponseData(
                id = '0',
                type = 'workflows',
                attributes = openapi_client.models.workflow_response_data_attributes.workflowResponse_data_attributes(
                    tags = [
                        '0'
                        ], 
                    topic_annotations = [
                    ...
                    title = '0', 
                    description = '0', 
                    workflow_class = openapi_client.models.workflow_response_data_attributes_workflow_class.workflowResponse_data_attributes_workflow_class(
                        title = '0', 
                        key = '0', 
                        description = '0', ), 
                    license = '0', 
                    ...
                    internals = openapi_client.models.workflow_response_data_attributes_internals.workflowResponse_data_attributes_internals(
                        inputs = [
                ...
                relationships = openapi_client.models.workflow_response_data_relationships.workflowResponse_data_relationships(
                    ...
                    data_files = , 
                    documents = , ),
                links = openapi_client.models.workflow_response_data_links.workflowResponse_data_links(
                    self = '0', 
                    diagram = '0', ),
    ...
    def testWorkflowResponseData(self):
        """Test WorkflowResponseData"""
