...
class TestModelPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModelPost:
        """Test ModelPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPost`
        """
        model = ModelPost()
        if include_optional:
            return ModelPost(
                data = openapi_client.models.model_post_data.modelPost_data(
                    type = 'models', 
                    attributes = openapi_client.models.model_post_data_attributes.modelPost_data_attributes(
                        tags = [
                            '0'
                            ], 
                        title = '0', 
                    ...
                    relationships = openapi_client.models.model_post_data_relationships.modelPost_data_relationships(
