...
class TestProgrammePatchData(unittest.TestCase):
    """ProgrammePatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePatchData:
        """Test ProgrammePatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePatchData`
        """
        model = ProgrammePatchData()
        if include_optional:
            return ProgrammePatchData(
                id = '0',
                type = 'programmes',
                attributes = openapi_client.models.programme_patch_data_attributes.programmePatch_data_attributes(
                    title = '0', 
                    description = '0', 
                    web_page = '0', 
                    funding_details = '0', 
                ...
                relationships = openapi_client.models.programme_patch_data_relationships.programmePatch_data_relationships(
    ...
    def testProgrammePatchData(self):
        """Test ProgrammePatchData"""
