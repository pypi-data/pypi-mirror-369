...
class TestCollectionPostDataRelationships(unittest.TestCase):
    """CollectionPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPostDataRelationships:
        """Test CollectionPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPostDataRelationships`
        """
        model = CollectionPostDataRelationships()
        if include_optional:
            return CollectionPostDataRelationships(
    ...
    def testCollectionPostDataRelationships(self):
        """Test CollectionPostDataRelationships"""
