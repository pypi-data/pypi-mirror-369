...
class TestInvestigationPatchDataRelationships(unittest.TestCase):
    """InvestigationPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPatchDataRelationships:
        """Test InvestigationPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPatchDataRelationships`
        """
        model = InvestigationPatchDataRelationships()
        if include_optional:
            return InvestigationPatchDataRelationships(
    ...
    def testInvestigationPatchDataRelationships(self):
        """Test InvestigationPatchDataRelationships"""
