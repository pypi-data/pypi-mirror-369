...
class TestInvestigationPatch(unittest.TestCase):
    """InvestigationPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationPatch:
        """Test InvestigationPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationPatch`
        """
        model = InvestigationPatch()
        if include_optional:
            return InvestigationPatch(
                data = openapi_client.models.investigation_patch_data.investigationPatch_data(
                    id = '0', 
                    type = 'investigations', 
                    attributes = openapi_client.models.investigation_patch_data_attributes.investigationPatch_data_attributes(
                        title = '0', 
                        description = '0', 
                        other_creators = '0', 
                        creators = [
                    ...
                    relationships = openapi_client.models.investigation_patch_data_relationships.investigationPatch_data_relationships(
    ...
    def testInvestigationPatch(self):
        """Test InvestigationPatch"""
