...
class TestProgrammePost(unittest.TestCase):
    """ProgrammePost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePost:
        """Test ProgrammePost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePost`
        """
        model = ProgrammePost()
        if include_optional:
            return ProgrammePost(
                data = openapi_client.models.programme_post_data.programmePost_data(
                    type = 'programmes', 
