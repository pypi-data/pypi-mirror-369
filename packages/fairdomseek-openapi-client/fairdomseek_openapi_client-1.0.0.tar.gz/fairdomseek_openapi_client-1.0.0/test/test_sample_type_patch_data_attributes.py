...
class TestSampleTypePatchDataAttributes(unittest.TestCase):
    """SampleTypePatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePatchDataAttributes:
        """Test SampleTypePatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePatchDataAttributes`
        """
        model = SampleTypePatchDataAttributes()
        if include_optional:
            return SampleTypePatchDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testSampleTypePatchDataAttributes(self):
        """Test SampleTypePatchDataAttributes"""
