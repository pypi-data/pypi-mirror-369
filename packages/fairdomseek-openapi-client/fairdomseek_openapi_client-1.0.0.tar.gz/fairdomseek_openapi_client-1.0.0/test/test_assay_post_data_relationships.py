...
class TestAssayPostDataRelationships(unittest.TestCase):
    """AssayPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPostDataRelationships:
        """Test AssayPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPostDataRelationships`
        """
        model = AssayPostDataRelationships()
        if include_optional:
            return AssayPostDataRelationships(
    ...
    def testAssayPostDataRelationships(self):
        """Test AssayPostDataRelationships"""
