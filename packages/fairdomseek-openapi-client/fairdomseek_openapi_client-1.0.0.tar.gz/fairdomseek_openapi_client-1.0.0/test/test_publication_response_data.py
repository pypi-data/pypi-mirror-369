...
class TestPublicationResponseData(unittest.TestCase):
    """PublicationResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationResponseData:
        """Test PublicationResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationResponseData`
        """
        model = PublicationResponseData()
        if include_optional:
            return PublicationResponseData(
                id = '0',
                type = 'publications',
                attributes = openapi_client.models.publication_response_data_attributes.publicationResponse_data_attributes(
                    title = '0', 
                    journal = '0', 
                    published_date = '0', 
                    doi = '0', 
                ...
                relationships = openapi_client.models.publication_response_data_relationships.publicationResponse_data_relationships(
    ...
    def testPublicationResponseData(self):
        """Test PublicationResponseData"""
