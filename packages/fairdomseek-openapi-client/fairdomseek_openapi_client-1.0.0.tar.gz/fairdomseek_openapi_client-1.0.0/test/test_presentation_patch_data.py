...
class TestPresentationPatchData(unittest.TestCase):
    """PresentationPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationPatchData:
        """Test PresentationPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationPatchData`
        """
        model = PresentationPatchData()
        if include_optional:
            return PresentationPatchData(
                id = '0',
                type = 'presentations',
                attributes = openapi_client.models.collection_patch_data_attributes.collectionPatch_data_attributes(
                    tags = [
                        '0'
                        ], 
                    title = '0', 
                ...
                relationships = openapi_client.models.presentation_patch_data_relationships.presentationPatch_data_relationships(
    ...
    def testPresentationPatchData(self):
        """Test PresentationPatchData"""
