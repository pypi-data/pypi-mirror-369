...
class TestSamplePostDataAttributes(unittest.TestCase):
    """SamplePostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplePostDataAttributes:
        """Test SamplePostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplePostDataAttributes`
        """
        model = SamplePostDataAttributes()
        if include_optional:
            return SamplePostDataAttributes(
                tags = [
                    '0'
                    ],
                other_creators = '0',
    ...
    def testSamplePostDataAttributes(self):
        """Test SamplePostDataAttributes"""
