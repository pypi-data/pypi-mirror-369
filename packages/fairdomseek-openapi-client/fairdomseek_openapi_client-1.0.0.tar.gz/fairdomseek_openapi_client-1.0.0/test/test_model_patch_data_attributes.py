...
class TestModelPatchDataAttributes(unittest.TestCase):
    """ModelPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelPatchDataAttributes:
        """Test ModelPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelPatchDataAttributes`
        """
        model = ModelPatchDataAttributes()
        if include_optional:
            return ModelPatchDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testModelPatchDataAttributes(self):
        """Test ModelPatchDataAttributes"""
