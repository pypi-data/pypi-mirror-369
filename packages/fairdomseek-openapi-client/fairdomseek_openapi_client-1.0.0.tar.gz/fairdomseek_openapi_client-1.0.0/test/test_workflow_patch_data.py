...
class TestWorkflowPatchData(unittest.TestCase):
    """WorkflowPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPatchData:
        """Test WorkflowPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPatchData`
        """
        model = WorkflowPatchData()
        if include_optional:
            return WorkflowPatchData(
                id = '0',
                type = 'workflows',
                attributes = openapi_client.models.workflow_patch_data_attributes.workflowPatch_data_attributes(
                    tags = [
                        '0'
                        ], 
                    topic_annotations = [
                ...
                relationships = openapi_client.models.workflow_patch_data_relationships.workflowPatch_data_relationships(
    ...
    def testWorkflowPatchData(self):
        """Test WorkflowPatchData"""
