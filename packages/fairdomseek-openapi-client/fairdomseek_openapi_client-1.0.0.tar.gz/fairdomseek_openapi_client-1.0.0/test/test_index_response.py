...
class TestIndexResponse(unittest.TestCase):
    """IndexResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndexResponse:
        """Test IndexResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexResponse`
        """
        model = IndexResponse()
        if include_optional:
            return IndexResponse(
                ...
                jsonapi = openapi_client.models.json_api_version.JsonApiVersion(
                    version = '1.0', ),
                meta = openapi_client.models.base_meta.baseMeta(
                    base_url = '0', 
                    api_version = '0', ),
                links = openapi_client.models.index_links.indexLinks(
                    self = '0', 
                    first = '0', 
                    prev = '0', 
                    next = '0', 
