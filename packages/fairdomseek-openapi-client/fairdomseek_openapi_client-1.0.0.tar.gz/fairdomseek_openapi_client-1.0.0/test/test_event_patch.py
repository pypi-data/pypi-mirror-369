...
class TestEventPatch(unittest.TestCase):
    """EventPatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPatch:
        """Test EventPatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPatch`
        """
        model = EventPatch()
        if include_optional:
            return EventPatch(
                data = openapi_client.models.event_patch_data.eventPatch_data(
                    id = '0', 
                    type = 'events', 
                    attributes = openapi_client.models.event_patch_data_attributes.eventPatch_data_attributes(
                        title = '0', 
                        description = '0', 
                        url = '0', 
                        address = '0', 
                    ...
                    relationships = openapi_client.models.event_patch_data_relationships.eventPatch_data_relationships(
