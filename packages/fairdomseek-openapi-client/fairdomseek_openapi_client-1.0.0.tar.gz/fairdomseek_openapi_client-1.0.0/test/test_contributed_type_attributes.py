...
class TestContributedTypeAttributes(unittest.TestCase):
    """ContributedTypeAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContributedTypeAttributes:
        """Test ContributedTypeAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContributedTypeAttributes`
        """
        model = ContributedTypeAttributes()
        if include_optional:
            return ContributedTypeAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testContributedTypeAttributes(self):
        """Test ContributedTypeAttributes"""
