...
class TestWorkflowPostDataAttributesWorkflowClass(unittest.TestCase):
    """WorkflowPostDataAttributesWorkflowClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPostDataAttributesWorkflowClass:
        """Test WorkflowPostDataAttributesWorkflowClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPostDataAttributesWorkflowClass`
        """
        model = WorkflowPostDataAttributesWorkflowClass()
        if include_optional:
            return WorkflowPostDataAttributesWorkflowClass(
                key = '0'
            )
        else:
            return WorkflowPostDataAttributesWorkflowClass(
    ...
    def testWorkflowPostDataAttributesWorkflowClass(self):
        """Test WorkflowPostDataAttributesWorkflowClass"""
