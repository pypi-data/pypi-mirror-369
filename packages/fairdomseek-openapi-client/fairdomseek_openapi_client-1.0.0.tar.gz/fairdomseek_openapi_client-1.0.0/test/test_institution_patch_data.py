...
class TestInstitutionPatchData(unittest.TestCase):
    """InstitutionPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionPatchData:
        """Test InstitutionPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionPatchData`
        """
        model = InstitutionPatchData()
        if include_optional:
            return InstitutionPatchData(
                id = '0',
                type = 'institutions',
                attributes = openapi_client.models.institution_patch_data_attributes.institutionPatch_data_attributes(
                    avatar = '0', 
                    title = '0', 
                    country = '', 
                    city = '0', 
    ...
    def testInstitutionPatchData(self):
        """Test InstitutionPatchData"""
