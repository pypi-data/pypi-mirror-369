...
class TestWorkflowPostData(unittest.TestCase):
    """WorkflowPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowPostData:
        """Test WorkflowPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowPostData`
        """
        model = WorkflowPostData()
        if include_optional:
            return WorkflowPostData(
                type = 'workflows',
