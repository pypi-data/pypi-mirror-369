...
class TestDocumentPostDataAttributes(unittest.TestCase):
    """DocumentPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPostDataAttributes:
        """Test DocumentPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPostDataAttributes`
        """
        model = DocumentPostDataAttributes()
        if include_optional:
            return DocumentPostDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testDocumentPostDataAttributes(self):
        """Test DocumentPostDataAttributes"""
