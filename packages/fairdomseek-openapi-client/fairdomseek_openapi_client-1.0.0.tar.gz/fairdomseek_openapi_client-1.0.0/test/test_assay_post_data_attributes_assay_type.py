...
class TestAssayPostDataAttributesAssayType(unittest.TestCase):
    """AssayPostDataAttributesAssayType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayPostDataAttributesAssayType:
        """Test AssayPostDataAttributesAssayType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayPostDataAttributesAssayType`
        """
        model = AssayPostDataAttributesAssayType()
        if include_optional:
            return AssayPostDataAttributesAssayType(
                uri = '0'
            )
        else:
            return AssayPostDataAttributesAssayType(
    ...
    def testAssayPostDataAttributesAssayType(self):
        """Test AssayPostDataAttributesAssayType"""
