...
class TestDataFileResponseDataAttributes(unittest.TestCase):
    """DataFileResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFileResponseDataAttributes:
        """Test DataFileResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFileResponseDataAttributes`
        """
        model = DataFileResponseDataAttributes()
        if include_optional:
            return DataFileResponseDataAttributes(
                tags = [
                    '0'
                    ],
    ...
    def testDataFileResponseDataAttributes(self):
        """Test DataFileResponseDataAttributes"""
