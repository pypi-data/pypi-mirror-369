...
class TestOrganismResponseData(unittest.TestCase):
    """OrganismResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganismResponseData:
        """Test OrganismResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganismResponseData`
        """
        model = OrganismResponseData()
        if include_optional:
            return OrganismResponseData(
                id = '0',
                type = 'organisms',
    ...
    def testOrganismResponseData(self):
        """Test OrganismResponseData"""
