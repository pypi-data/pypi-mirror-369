...
class TestCollectionItemPostDataRelationships(unittest.TestCase):
    """CollectionItemPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemPostDataRelationships:
        """Test CollectionItemPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemPostDataRelationships`
        """
        model = CollectionItemPostDataRelationships()
        if include_optional:
            return CollectionItemPostDataRelationships(
    ...
    def testCollectionItemPostDataRelationships(self):
        """Test CollectionItemPostDataRelationships"""
