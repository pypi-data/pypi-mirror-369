...
class TestCollectionPatchDataAttributes(unittest.TestCase):
    """CollectionPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPatchDataAttributes:
        """Test CollectionPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPatchDataAttributes`
        """
        model = CollectionPatchDataAttributes()
        if include_optional:
            return CollectionPatchDataAttributes(
                tags = [
                    '0'
                    ],
                title = '0',
    ...
    def testCollectionPatchDataAttributes(self):
        """Test CollectionPatchDataAttributes"""
