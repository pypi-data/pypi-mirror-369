...
class TestProjectPatchData(unittest.TestCase):
    """ProjectPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPatchData:
        """Test ProjectPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPatchData`
        """
        model = ProjectPatchData()
        if include_optional:
            return ProjectPatchData(
                id = '0',
                type = 'projects',
                attributes = openapi_client.models.project_patch_data_attributes.projectPatch_data_attributes(
                    avatar = '0', 
                    title = '0', 
                    description = '0', 
                    web_page = '0', 
                ...
                relationships = openapi_client.models.project_post_data_relationships.projectPost_data_relationships(
