...
class TestPresentationResponse(unittest.TestCase):
    """PresentationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PresentationResponse:
        """Test PresentationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PresentationResponse`
        """
        model = PresentationResponse()
        if include_optional:
            return PresentationResponse(
                data = openapi_client.models.presentation_response_data.presentationResponse_data(
                    id = '0', 
                    type = 'presentations', 
    ...
    def testPresentationResponse(self):
        """Test PresentationResponse"""
