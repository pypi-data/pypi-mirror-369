...
class TestExtendedMetadataTypeResponse(unittest.TestCase):
    """ExtendedMetadataTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedMetadataTypeResponse:
        """Test ExtendedMetadataTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedMetadataTypeResponse`
        """
        model = ExtendedMetadataTypeResponse()
        if include_optional:
            return ExtendedMetadataTypeResponse(
                data = openapi_client.models.extended_metadata_type_response_data.extendedMetadataTypeResponse_data(
                    id = '0', 
                    type = '0', 
                    attributes = openapi_client.models.extended_metadata_type_response_data_attributes.extendedMetadataTypeResponse_data_attributes(
                        title = '0', 
                        supported_type = '0', 
                        enabled = True, 
                    ...
                    links = openapi_client.models.links.links(
                        self = '0', ), 
                    meta = openapi_client.models.extended_metadata_type_response_data_meta.extendedMetadataTypeResponse_data_meta(
                        base_url = '0', 
                        api_version = , ), ),
    ...
    def testExtendedMetadataTypeResponse(self):
        """Test ExtendedMetadataTypeResponse"""
