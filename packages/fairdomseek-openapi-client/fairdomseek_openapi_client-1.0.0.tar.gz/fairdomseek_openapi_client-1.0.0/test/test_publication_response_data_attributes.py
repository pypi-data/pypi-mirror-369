...
class TestPublicationResponseDataAttributes(unittest.TestCase):
    """PublicationResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationResponseDataAttributes:
        """Test PublicationResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationResponseDataAttributes`
        """
        model = PublicationResponseDataAttributes()
        if include_optional:
            return PublicationResponseDataAttributes(
                title = '0',
                journal = '0',
                published_date = '0',
                doi = '0',
    ...
    def testPublicationResponseDataAttributes(self):
        """Test PublicationResponseDataAttributes"""
