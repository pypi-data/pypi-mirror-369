...
class TestAssayResponseDataAttributes(unittest.TestCase):
    """AssayResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayResponseDataAttributes:
        """Test AssayResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayResponseDataAttributes`
        """
        model = AssayResponseDataAttributes()
        if include_optional:
            return AssayResponseDataAttributes(
                snapshots = [
    ...
    def testAssayResponseDataAttributes(self):
        """Test AssayResponseDataAttributes"""
