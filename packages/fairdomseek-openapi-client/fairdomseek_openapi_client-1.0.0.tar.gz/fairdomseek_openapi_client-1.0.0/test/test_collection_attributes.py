...
class TestCollectionAttributes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CollectionAttributes:
        """Test CollectionAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionAttributes`
        """
    ...
    def testCollectionAttributes(self):
        """Test CollectionAttributes"""
