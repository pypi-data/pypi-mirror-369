...
class TestSampleTypeResponseDataAttributes(unittest.TestCase):
    """SampleTypeResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeResponseDataAttributes:
        """Test SampleTypeResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeResponseDataAttributes`
        """
        model = SampleTypeResponseDataAttributes()
        if include_optional:
            return SampleTypeResponseDataAttributes(
                title = '0',
                description = '0',
                policy = {
                    'key' : null
    ...
    def testSampleTypeResponseDataAttributes(self):
        """Test SampleTypeResponseDataAttributes"""
