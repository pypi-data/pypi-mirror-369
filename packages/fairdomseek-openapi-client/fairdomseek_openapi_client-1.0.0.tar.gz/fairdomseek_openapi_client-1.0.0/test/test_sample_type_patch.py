...
class TestSampleTypePatch(unittest.TestCase):
    """SampleTypePatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypePatch:
        """Test SampleTypePatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypePatch`
        """
        model = SampleTypePatch()
        if include_optional:
            return SampleTypePatch(
                data = openapi_client.models.sample_type_patch_data.sampleTypePatch_data(
                    id = '0', 
                    type = 'sample_types', 
