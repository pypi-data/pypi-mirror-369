...
class TestCollectionItemPostData(unittest.TestCase):
    """CollectionItemPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionItemPostData:
        """Test CollectionItemPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionItemPostData`
        """
        model = CollectionItemPostData()
        if include_optional:
            return CollectionItemPostData(
    ...
    def testCollectionItemPostData(self):
        """Test CollectionItemPostData"""
