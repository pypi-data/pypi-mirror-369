...
class TestDocumentPost(unittest.TestCase):
    """DocumentPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPost:
        """Test DocumentPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPost`
        """
        model = DocumentPost()
        if include_optional:
            return DocumentPost(
                data = openapi_client.models.document_post_data.documentPost_data(
                    type = 'documents', 
