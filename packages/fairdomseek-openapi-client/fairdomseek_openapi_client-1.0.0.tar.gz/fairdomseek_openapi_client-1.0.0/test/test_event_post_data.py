...
class TestEventPostData(unittest.TestCase):
    """EventPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventPostData:
        """Test EventPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventPostData`
        """
        model = EventPostData()
        if include_optional:
