...
class TestAssayAttributes(unittest.TestCase):
    """AssayAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayAttributes:
        """Test AssayAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayAttributes`
        """
        model = AssayAttributes()
        if include_optional:
            return AssayAttributes(
                ...
                technology_type = openapi_client.models.assay_attributes_technology_type.assayAttributes_technology_type(
                    label = '0', 
                    uri = '0', ),
                discussion_links = [
