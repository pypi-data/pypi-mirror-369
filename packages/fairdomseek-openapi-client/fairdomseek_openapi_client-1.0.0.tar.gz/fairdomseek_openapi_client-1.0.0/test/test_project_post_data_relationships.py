...
class TestProjectPostDataRelationships(unittest.TestCase):
    """ProjectPostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPostDataRelationships:
        """Test ProjectPostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPostDataRelationships`
        """
        model = ProjectPostDataRelationships()
        if include_optional:
            return ProjectPostDataRelationships(
                programmes = openapi_client.models.multiple_references.multipleReferences(
                    data = [
    ...
    def testProjectPostDataRelationships(self):
        """Test ProjectPostDataRelationships"""
