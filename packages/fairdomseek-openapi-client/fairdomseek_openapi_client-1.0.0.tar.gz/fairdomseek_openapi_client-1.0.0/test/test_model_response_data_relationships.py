...
class TestModelResponseDataRelationships(unittest.TestCase):
    """ModelResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelResponseDataRelationships:
        """Test ModelResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelResponseDataRelationships`
        """
        model = ModelResponseDataRelationships()
        if include_optional:
            return ModelResponseDataRelationships(
    ...
    def testModelResponseDataRelationships(self):
        """Test ModelResponseDataRelationships"""
