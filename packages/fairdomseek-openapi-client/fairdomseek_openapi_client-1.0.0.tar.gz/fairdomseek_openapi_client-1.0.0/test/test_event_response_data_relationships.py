...
class TestEventResponseDataRelationships(unittest.TestCase):
    """EventResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventResponseDataRelationships:
        """Test EventResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventResponseDataRelationships`
        """
        model = EventResponseDataRelationships()
        if include_optional:
            return EventResponseDataRelationships(
    ...
    def testEventResponseDataRelationships(self):
        """Test EventResponseDataRelationships"""
