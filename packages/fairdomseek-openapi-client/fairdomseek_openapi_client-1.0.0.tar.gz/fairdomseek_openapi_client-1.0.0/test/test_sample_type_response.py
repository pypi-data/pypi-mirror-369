...
class TestSampleTypeResponse(unittest.TestCase):
    """SampleTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeResponse:
        """Test SampleTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeResponse`
        """
        model = SampleTypeResponse()
        if include_optional:
            return SampleTypeResponse(
                data = openapi_client.models.sample_type_response_data.sampleTypeResponse_data(
                    id = '0', 
                    type = 'sample_types', 
    ...
    def testSampleTypeResponse(self):
        """Test SampleTypeResponse"""
