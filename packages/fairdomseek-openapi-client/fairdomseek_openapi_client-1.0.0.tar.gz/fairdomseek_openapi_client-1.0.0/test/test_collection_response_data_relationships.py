...
class TestCollectionResponseDataRelationships(unittest.TestCase):
    """CollectionResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionResponseDataRelationships:
        """Test CollectionResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionResponseDataRelationships`
        """
        model = CollectionResponseDataRelationships()
        if include_optional:
            return CollectionResponseDataRelationships(
                ...
                items = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
    ...
    def testCollectionResponseDataRelationships(self):
        """Test CollectionResponseDataRelationships"""
