...
class TestSopPatchData(unittest.TestCase):
    """SopPatchData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SopPatchData:
        """Test SopPatchData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SopPatchData`
        """
        model = SopPatchData()
        if include_optional:
            return SopPatchData(
