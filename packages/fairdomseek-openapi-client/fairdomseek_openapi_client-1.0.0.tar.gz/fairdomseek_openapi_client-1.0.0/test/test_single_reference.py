...
class TestSingleReference(unittest.TestCase):
    """SingleReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleReference:
        """Test SingleReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleReference`
        """
        model = SingleReference()
        if include_optional:
