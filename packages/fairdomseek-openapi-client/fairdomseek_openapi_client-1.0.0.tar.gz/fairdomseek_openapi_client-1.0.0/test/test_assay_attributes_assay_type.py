...
class TestAssayAttributesAssayType(unittest.TestCase):
    """AssayAttributesAssayType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayAttributesAssayType:
        """Test AssayAttributesAssayType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayAttributesAssayType`
        """
        model = AssayAttributesAssayType()
        if include_optional:
            return AssayAttributesAssayType(
                label = '0',
                uri = '0'
            )
        else:
    ...
    def testAssayAttributesAssayType(self):
        """Test AssayAttributesAssayType"""
