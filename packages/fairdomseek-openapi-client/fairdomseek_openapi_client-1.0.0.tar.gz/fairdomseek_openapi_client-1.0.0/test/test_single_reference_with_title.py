...
class TestSingleReferenceWithTitle(unittest.TestCase):
    """SingleReferenceWithTitle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleReferenceWithTitle:
        """Test SingleReferenceWithTitle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleReferenceWithTitle`
        """
        model = SingleReferenceWithTitle()
        if include_optional:
            return SingleReferenceWithTitle(
                data = openapi_client.models.item_reference.itemReference(
                    id = '0', 
                    type = 'assays', ),
                meta = openapi_client.models.single_reference_with_title_meta.singleReferenceWithTitle_meta(
                    title = '0', )
            )
        else:
            return SingleReferenceWithTitle(
    ...
    def testSingleReferenceWithTitle(self):
        """Test SingleReferenceWithTitle"""
