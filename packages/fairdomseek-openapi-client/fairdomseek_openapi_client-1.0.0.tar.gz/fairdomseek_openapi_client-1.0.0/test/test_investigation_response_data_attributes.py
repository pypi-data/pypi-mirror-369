...
class TestInvestigationResponseDataAttributes(unittest.TestCase):
    """InvestigationResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationResponseDataAttributes:
        """Test InvestigationResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationResponseDataAttributes`
        """
        model = InvestigationResponseDataAttributes()
        if include_optional:
            return InvestigationResponseDataAttributes(
                snapshots = [
    ...
    def testInvestigationResponseDataAttributes(self):
        """Test InvestigationResponseDataAttributes"""
