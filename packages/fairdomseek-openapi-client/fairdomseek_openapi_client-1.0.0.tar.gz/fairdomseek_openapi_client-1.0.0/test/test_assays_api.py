...
class TestAssaysApi(unittest.TestCase):
    ...
    def test_create_assay(self) -> None:
        """Test case for create_assay
    ...
    def test_list_assays(self) -> None:
        """Test case for list_assays

        List assays
        """
        pass

    def test_read_assay(self) -> None:
        """Test case for read_assay

        Fetch an assay
        """
        pass

    def test_update_assay(self) -> None:
        """Test case for update_assay
