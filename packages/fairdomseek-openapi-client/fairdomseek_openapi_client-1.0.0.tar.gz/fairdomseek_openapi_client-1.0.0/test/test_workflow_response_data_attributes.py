...
class TestWorkflowResponseDataAttributes(unittest.TestCase):
    """WorkflowResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseDataAttributes:
        """Test WorkflowResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseDataAttributes`
        """
        model = WorkflowResponseDataAttributes()
        if include_optional:
            return WorkflowResponseDataAttributes(
                tags = [
                    '0'
                    ],
                topic_annotations = [
    ...
    def testWorkflowResponseDataAttributes(self):
        """Test WorkflowResponseDataAttributes"""
