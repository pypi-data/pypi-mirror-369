...
class TestProgrammeResponseData(unittest.TestCase):
    """ProgrammeResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammeResponseData:
        """Test ProgrammeResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammeResponseData`
        """
        model = ProgrammeResponseData()
        if include_optional:
            return ProgrammeResponseData(
                id = '0',
                type = 'programmes',
                attributes = openapi_client.models.programme_data_type.programmeDataType(
                    avatar = '0', 
                    title = '0', 
                    description = '0', 
                    web_page = '0', 
                ...
                relationships = openapi_client.models.programme_response_data_relationships.programmeResponse_data_relationships(
    ...
    def testProgrammeResponseData(self):
        """Test ProgrammeResponseData"""
