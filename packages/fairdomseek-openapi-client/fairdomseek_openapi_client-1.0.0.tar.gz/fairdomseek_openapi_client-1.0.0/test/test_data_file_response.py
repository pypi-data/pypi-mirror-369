...
class TestDataFileResponse(unittest.TestCase):
    """DataFileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFileResponse:
        """Test DataFileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFileResponse`
        """
        model = DataFileResponse()
        if include_optional:
            return DataFileResponse(
                data = openapi_client.models.data_file_response_data.dataFileResponse_data(
                    id = '0', 
                    type = 'data_files', 
