...
class TestSampleTypeResponseDataRelationships(unittest.TestCase):
    """SampleTypeResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleTypeResponseDataRelationships:
        """Test SampleTypeResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SampleTypeResponseDataRelationships`
        """
        model = SampleTypeResponseDataRelationships()
        if include_optional:
            return SampleTypeResponseDataRelationships(
    ...
    def testSampleTypeResponseDataRelationships(self):
        """Test SampleTypeResponseDataRelationships"""
