...
class TestAssayAttributesAssayClass(unittest.TestCase):
    """AssayAttributesAssayClass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayAttributesAssayClass:
        """Test AssayAttributesAssayClass
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayAttributesAssayClass`
        """
        model = AssayAttributesAssayClass()
        if include_optional:
            return AssayAttributesAssayClass(
                title = '0',
                key = '0',
                description = ''
            )
    ...
    def testAssayAttributesAssayClass(self):
        """Test AssayAttributesAssayClass"""
