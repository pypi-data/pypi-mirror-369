...
class TestPersonPostDataAttributes(unittest.TestCase):
    """PersonPostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonPostDataAttributes:
        """Test PersonPostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonPostDataAttributes`
        """
        model = PersonPostDataAttributes()
        if include_optional:
            return PersonPostDataAttributes(
                description = '0',
                first_name = '0',
                last_name = '0',
                email = '0',
    ...
    def testPersonPostDataAttributes(self):
        """Test PersonPostDataAttributes"""
