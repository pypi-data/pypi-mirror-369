...
class TestDocumentResponseData(unittest.TestCase):
    """DocumentResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentResponseData:
        """Test DocumentResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentResponseData`
        """
    ...
    def testDocumentResponseData(self):
        """Test DocumentResponseData"""
