...
class TestDocumentPatchDataRelationships(unittest.TestCase):
    """DocumentPatchDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentPatchDataRelationships:
        """Test DocumentPatchDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentPatchDataRelationships`
        """
        model = DocumentPatchDataRelationships()
        if include_optional:
            return DocumentPatchDataRelationships(
    ...
    def testDocumentPatchDataRelationships(self):
        """Test DocumentPatchDataRelationships"""
