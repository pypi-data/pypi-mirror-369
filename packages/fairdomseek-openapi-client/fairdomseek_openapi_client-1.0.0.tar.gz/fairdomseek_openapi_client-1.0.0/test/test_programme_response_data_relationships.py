...
class TestProgrammeResponseDataRelationships(unittest.TestCase):
    """ProgrammeResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammeResponseDataRelationships:
        """Test ProgrammeResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammeResponseDataRelationships`
        """
        model = ProgrammeResponseDataRelationships()
        if include_optional:
            return ProgrammeResponseDataRelationships(
    ...
    def testProgrammeResponseDataRelationships(self):
        """Test ProgrammeResponseDataRelationships"""
