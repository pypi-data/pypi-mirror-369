...
class TestProgrammePostDataRelationships(unittest.TestCase):
    """ProgrammePostDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePostDataRelationships:
        """Test ProgrammePostDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePostDataRelationships`
        """
        model = ProgrammePostDataRelationships()
        if include_optional:
            return ProgrammePostDataRelationships(
    ...
    def testProgrammePostDataRelationships(self):
        """Test ProgrammePostDataRelationships"""
