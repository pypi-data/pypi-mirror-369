...
class TestInvestigationResponse(unittest.TestCase):
    """InvestigationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvestigationResponse:
        """Test InvestigationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InvestigationResponse`
        """
        model = InvestigationResponse()
        if include_optional:
            return InvestigationResponse(
                data = openapi_client.models.investigation_response_data.investigationResponse_data(
                    id = '0', 
                    type = 'investigations', 
    ...
    def testInvestigationResponse(self):
        """Test InvestigationResponse"""
