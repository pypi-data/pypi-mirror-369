...
class TestProjectResponseDataAttributes(unittest.TestCase):
    """ProjectResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectResponseDataAttributes:
        """Test ProjectResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectResponseDataAttributes`
        """
        model = ProjectResponseDataAttributes()
        if include_optional:
            return ProjectResponseDataAttributes(
                avatar = '0',
                title = '0',
                description = '0',
                web_page = '0',
    ...
    def testProjectResponseDataAttributes(self):
        """Test ProjectResponseDataAttributes"""
