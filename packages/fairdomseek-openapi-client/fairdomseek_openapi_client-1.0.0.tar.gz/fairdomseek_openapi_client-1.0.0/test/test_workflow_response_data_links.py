...
class TestWorkflowResponseDataLinks(unittest.TestCase):
    """WorkflowResponseDataLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowResponseDataLinks:
        """Test WorkflowResponseDataLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowResponseDataLinks`
        """
        model = WorkflowResponseDataLinks()
        if include_optional:
            return WorkflowResponseDataLinks(
                var_self = '0',
                diagram = '0'
            )
        else:
    ...
    def testWorkflowResponseDataLinks(self):
        """Test WorkflowResponseDataLinks"""
