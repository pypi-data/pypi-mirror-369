    ...
    def make_instance(self, include_optional) -> CollectionItem:
        ...
        if include_optional:
            return CollectionItem(
                ...
                attributes = openapi_client.models.collection_item_attributes.collectionItem_attributes(
                    comment = '0', 
                    order = 56, ),
                relationships = openapi_client.models.collection_item_relationships.collectionItem_relationships(
                ...
                links = openapi_client.models.links.links(
                    self = '0', ),
                meta = openapi_client.models.collection_item_meta.collectionItemMeta(
                    base_url = '0', 
                    api_version = '0', 
