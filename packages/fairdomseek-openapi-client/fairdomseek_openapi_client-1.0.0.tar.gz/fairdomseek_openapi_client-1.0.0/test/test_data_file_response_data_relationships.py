...
class TestDataFileResponseDataRelationships(unittest.TestCase):
    """DataFileResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataFileResponseDataRelationships:
        """Test DataFileResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataFileResponseDataRelationships`
        """
        model = DataFileResponseDataRelationships()
        if include_optional:
            return DataFileResponseDataRelationships(
                ...
                investigations = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                studies = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                assays = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                ...
                events = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                file_template = openapi_client.models.single_reference.singleReference(
                    data = openapi_client.models.item_reference.itemReference(
                        id = '0', 
                        type = 'assays', ), ),
                placeholder = openapi_client.models.single_reference.singleReference(
                    data = openapi_client.models.item_reference.itemReference(
                        id = '0', 
                        type = 'assays', ), ),
                workflows = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
    ...
    def testDataFileResponseDataRelationships(self):
        """Test DataFileResponseDataRelationships"""
