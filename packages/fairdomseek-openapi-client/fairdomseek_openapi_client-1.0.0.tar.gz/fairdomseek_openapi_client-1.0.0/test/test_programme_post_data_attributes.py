...
class TestProgrammePostDataAttributes(unittest.TestCase):
    """ProgrammePostDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePostDataAttributes:
        """Test ProgrammePostDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePostDataAttributes`
        """
        model = ProgrammePostDataAttributes()
        if include_optional:
            return ProgrammePostDataAttributes(
                title = '0',
                description = '0',
                web_page = '0',
                funding_details = '0',
    ...
    def testProgrammePostDataAttributes(self):
        """Test ProgrammePostDataAttributes"""
