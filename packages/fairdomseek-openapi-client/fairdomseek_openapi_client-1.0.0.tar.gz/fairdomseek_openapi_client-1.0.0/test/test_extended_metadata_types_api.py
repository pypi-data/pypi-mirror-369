...
class TestExtendedMetadataTypesApi(unittest.TestCase):
    """ExtendedMetadataTypesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ExtendedMetadataTypesApi()

    def tearDown(self) -> None:
        pass

    def test_list_extended_metadata_types(self) -> None:
        """Test case for list_extended_metadata_types

        List extended metadata types
        """
        pass

    def test_read_extended_metadata_type(self) -> None:
        """Test case for read_extended_metadata_type
