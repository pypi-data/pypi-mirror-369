...
class TestCollectionPost(unittest.TestCase):
    """CollectionPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionPost:
        """Test CollectionPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionPost`
        """
        model = CollectionPost()
        if include_optional:
            return CollectionPost(
                data = openapi_client.models.collection_post_data.collectionPost_data(
                    type = 'collections', 
                    attributes = openapi_client.models.collection_post_data_attributes.collectionPost_data_attributes(
                        tags = [
                            '0'
                            ], 
                        title = '0', 
                    ...
                    relationships = openapi_client.models.collection_post_data_relationships.collectionPost_data_relationships(
