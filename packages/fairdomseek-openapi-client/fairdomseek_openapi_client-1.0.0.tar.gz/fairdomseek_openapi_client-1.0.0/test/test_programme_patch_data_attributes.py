...
class TestProgrammePatchDataAttributes(unittest.TestCase):
    """ProgrammePatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProgrammePatchDataAttributes:
        """Test ProgrammePatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProgrammePatchDataAttributes`
        """
        model = ProgrammePatchDataAttributes()
        if include_optional:
            return ProgrammePatchDataAttributes(
                title = '0',
                description = '0',
                web_page = '0',
                funding_details = '0',
    ...
    def testProgrammePatchDataAttributes(self):
        """Test ProgrammePatchDataAttributes"""
