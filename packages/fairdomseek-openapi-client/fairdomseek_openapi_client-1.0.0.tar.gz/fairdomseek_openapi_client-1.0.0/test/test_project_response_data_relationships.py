...
class TestProjectResponseDataRelationships(unittest.TestCase):
    """ProjectResponseDataRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectResponseDataRelationships:
        """Test ProjectResponseDataRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectResponseDataRelationships`
        """
        model = ProjectResponseDataRelationships()
        if include_optional:
            return ProjectResponseDataRelationships(
                ...
                collections = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                file_templates = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                ...
                project_administrators = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                pals = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                asset_housekeepers = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
                        ], ),
                asset_gatekeepers = openapi_client.models.multiple_references.multipleReferences(
                    data = [
                        openapi_client.models.item_reference.itemReference(
                            id = '0', 
                            type = 'assays', )
    ...
    def testProjectResponseDataRelationships(self):
        """Test ProjectResponseDataRelationships"""
