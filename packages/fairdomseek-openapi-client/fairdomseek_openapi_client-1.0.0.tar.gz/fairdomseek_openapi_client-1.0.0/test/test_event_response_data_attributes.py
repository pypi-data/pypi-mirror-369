...
class TestEventResponseDataAttributes(unittest.TestCase):
    """EventResponseDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventResponseDataAttributes:
        """Test EventResponseDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventResponseDataAttributes`
        """
        model = EventResponseDataAttributes()
        if include_optional:
            return EventResponseDataAttributes(
                title = '0',
                description = '0',
                url = '0',
                address = '0',
    ...
    def testEventResponseDataAttributes(self):
        """Test EventResponseDataAttributes"""
