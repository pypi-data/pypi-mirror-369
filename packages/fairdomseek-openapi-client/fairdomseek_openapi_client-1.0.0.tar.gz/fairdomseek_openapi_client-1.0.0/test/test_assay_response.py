...
class TestAssayResponse(unittest.TestCase):
    """AssayResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssayResponse:
        """Test AssayResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssayResponse`
        """
        model = AssayResponse()
        if include_optional:
            return AssayResponse(
                data = openapi_client.models.assay_response_data.assayResponse_data(
                    id = '0', 
                    type = 'assays', 
