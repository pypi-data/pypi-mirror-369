...
class TestContentBlobSlot(unittest.TestCase):
    """ContentBlobSlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContentBlobSlot:
        """Test ContentBlobSlot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentBlobSlot`
        """
        model = ContentBlobSlot()
        if include_optional:
            return ContentBlobSlot(
                url = '0',
                original_filename = '0',
                content_type = '0'
            )
