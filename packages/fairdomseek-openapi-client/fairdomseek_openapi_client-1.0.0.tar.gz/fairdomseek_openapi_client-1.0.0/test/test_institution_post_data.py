...
class TestInstitutionPostData(unittest.TestCase):
    """InstitutionPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstitutionPostData:
        """Test InstitutionPostData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionPostData`
        """
        model = InstitutionPostData()
        if include_optional:
            return InstitutionPostData(
                type = 'institutions',
    ...
    def testInstitutionPostData(self):
        """Test InstitutionPostData"""
