...
class TestProjectPatchDataAttributes(unittest.TestCase):
    """ProjectPatchDataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectPatchDataAttributes:
        """Test ProjectPatchDataAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectPatchDataAttributes`
        """
        model = ProjectPatchDataAttributes()
        if include_optional:
            return ProjectPatchDataAttributes(
                avatar = '0',
                title = '0',
                description = '0',
                web_page = '0',
    ...
    def testProjectPatchDataAttributes(self):
        """Test ProjectPatchDataAttributes"""
