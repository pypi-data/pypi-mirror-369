...
def get_pending_event_list(ws_config: WebServiceConfig, device_serial: str) -> WebServiceResult:
...
def dequeue_event(ws_config: WebServiceConfig, device_serial: str, agent_type: str) -> WebServiceResult:
...
def update_event_progress(ws_config: WebServiceConfig, event_id: int, device_serial: str, percent_complete: float) -> WebServiceResult:
...
def update_event(ws_config: WebServiceConfig, event_id: int, event_status: int, result: str, process_id: int, tag_string: str ='', tag_number: int = 0, attempt_number: int = 1) -> WebServiceResult:
