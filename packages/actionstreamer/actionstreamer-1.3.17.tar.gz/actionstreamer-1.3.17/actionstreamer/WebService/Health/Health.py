...
def create_health(ws_config: WebServiceConfig, device_serial: str, health_json: str) -> WebServiceResult:
...
def update_health(ws_config: WebServiceConfig, device_serial: str, health_json: str) -> WebServiceResult:
