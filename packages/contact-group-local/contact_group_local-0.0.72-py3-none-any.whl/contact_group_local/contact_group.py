...
class ContactGroups(GenericMapping, metaclass=MetaLogger, object=CONTACT_GROUP_PYTHON_PACKAGE_CODE_LOGGER_OBJECT):
    ...
    def __get_group_id_by_title(self, group_title: str) -> int or None:
        ...
        if group_dict:
            __get_group_id_by_title_result = group_dict["group_id"]
            return __get_group_id_by_title_result
        else:
            return None
    ...
    order_by: str = None
        ...
        self.logger.start("add_update_group_and_link_to_contact", object=start_logger_object)
        ...
        add_update_group_and_link_to_contact_result = {
            **upsert_result,
            "contact_id": contact_id,
            "contact_group_id": contact_group_id,
            "group_ml_ids_list": group_ml_ids
        }
        return add_update_group_and_link_to_contact_result
