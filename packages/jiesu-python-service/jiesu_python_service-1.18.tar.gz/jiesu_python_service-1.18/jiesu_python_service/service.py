...
## start virtual environment before developing
source venv/bin/activate

if this is first time, run this initialize the environment and install packages defined in setup.py:
python3 -m venv venv
source venv/bin/activate
pip install .
...
API token (password) for uploading to pypi is in Google password manager.
