"""
MeridianAlgo - Advanced Financial Analysis Platform
Comprehensive suite for stock analysis, portfolio management, and market intelligence

This platform provides:
- ML-powered stock predictions (Random Forest + Gradient Boosting + LSTM)
...
VERSION_INFO = {
    'version': __version__,
    'features': [
        'ML Stock Predictions (RF + GB + LSTM)',
