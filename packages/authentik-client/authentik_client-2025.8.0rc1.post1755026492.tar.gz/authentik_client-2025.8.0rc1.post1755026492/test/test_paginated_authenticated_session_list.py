        ...
        if include_optional:
            return PaginatedAuthenticatedSessionList(
                pagination = authentik_client.models.pagination.Pagination(
                    ...
                    end_index = 1.337, ),
                results = [
                    authentik_client.models.authenticated_session.AuthenticatedSession(
                        uuid = '', 
                        current = True, 
                        user_agent = authentik_client.models.authenticated_session_user_agent.AuthenticatedSession_user_agent(
                            device = authentik_client.models.authenticated_session_user_agent_device.AuthenticatedSession_user_agent_device(
                                brand = '', 
                                family = '', 
                                model = '', ), 
                            os = authentik_client.models.authenticated_session_user_agent_os.AuthenticatedSession_user_agent_os(
                                family = '', 
                                major = '', 
                                minor = '', 
                                patch = '', 
                                patch_minor = '', ), 
                            user_agent = authentik_client.models.authenticated_session_user_agent_user_agent.AuthenticatedSession_user_agent_user_agent(
                                family = '', 
                                major = '', 
                                minor = '', 
                                patch = '', ), 
                            string = '', ), 
                        geo_ip = authentik_client.models.authenticated_session_geo_ip.AuthenticatedSession_geo_ip(
                            continent = '', 
                            country = '', 
                            lat = 1.337, 
                            long = 1.337, 
                            city = '', ), 
                        asn = authentik_client.models.authenticated_session_asn.AuthenticatedSession_asn(
                            asn = 56, 
                            as_org = '', 
                            network = '', ), 
                        user = 56, 
