...
class TestSessionUser(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SessionUser:
        ...
        if include_optional:
            return SessionUser(
                user = authentik_client.models.user_self.UserSelf(
                    pk = 56, 
                    username = 'A', 
                    name = '', 
                    is_active = True, 
                    is_superuser = True, 
                    groups = [
                        authentik_client.models.user_self_groups.UserSelfGroups(
                            name = '', 
                            pk = '', )
                        ], 
                    email = '', 
                ...
                original = authentik_client.models.user_self.UserSelf(
                    pk = 56, 
                    username = 'A', 
                    name = '', 
                    is_active = True, 
