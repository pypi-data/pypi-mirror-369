...
class IdentificationChallengeResponseRequest(BaseModel):
    ...
    captcha_token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["component", "uid_field", "password", "captcha_token"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if captcha_token (nullable) is None
        # and model_fields_set contains the field
        if self.captcha_token is None and "captcha_token" in self.model_fields_set:
            _dict['captcha_token'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "captcha_token": obj.get("captcha_token")
        })
        return _obj
