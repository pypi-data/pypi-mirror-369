...
class FrameChallenge(BaseModel):
    ...
    component: Optional[StrictStr] = 'xak-flow-frame'
    response_errors: Optional[Dict[str, List[ErrorDetail]]] = None
    url: StrictStr
    loading_overlay: Optional[StrictBool] = False
    loading_text: StrictStr
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "url", "loading_overlay", "loading_text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "component": obj.get("component") if obj.get("component") is not None else 'xak-flow-frame',
            ...
            "url": obj.get("url"),
            "loading_overlay": obj.get("loading_overlay") if obj.get("loading_overlay") is not None else False,
            "loading_text": obj.get("loading_text")
        })
        return _obj
