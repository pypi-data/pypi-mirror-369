...
class AuthenticatorEmailChallenge(BaseModel):
    """
    Authenticator Email Setup challenge
    """ # noqa: E501
    flow_info: Optional[ContextualFlowInfo] = None
    component: Optional[StrictStr] = 'ak-stage-authenticator-email'
    response_errors: Optional[Dict[str, List[ErrorDetail]]] = None
    pending_user: StrictStr
    pending_user_avatar: StrictStr
    email: Optional[StrictStr] = None
    email_required: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "pending_user", "pending_user_avatar", "email", "email_required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "component": obj.get("component") if obj.get("component") is not None else 'ak-stage-authenticator-email',
            ...
            "email": obj.get("email"),
            "email_required": obj.get("email_required") if obj.get("email_required") is not None else True
        })
        return _obj
