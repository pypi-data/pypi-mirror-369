...
class PatchedAuthenticatorWebAuthnStageRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "flow_set", "configure_flow", "friendly_name", "user_verification", "authenticator_attachment", "resident_key_requirement", "device_type_restrictions", "max_attempts"]
