...
class SessionEndChallenge(BaseModel):
    """
    Challenge for ending a session
    """ # noqa: E501
    flow_info: Optional[ContextualFlowInfo] = None
    component: Optional[StrictStr] = 'ak-stage-session-end'
    ...
    application_launch_url: Optional[StrictStr] = None
    invalidation_flow_url: Optional[StrictStr] = None
    brand_name: StrictStr
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "pending_user", "pending_user_avatar", "application_name", "application_launch_url", "invalidation_flow_url", "brand_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "component": obj.get("component") if obj.get("component") is not None else 'ak-stage-session-end',
            ...
            "application_launch_url": obj.get("application_launch_url"),
            "invalidation_flow_url": obj.get("invalidation_flow_url"),
