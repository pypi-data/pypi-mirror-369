...
[← GitHub Repo](https://github.com/benbrastmckie/ModelChecker) | [General Docs →](https://github.com/benbrastmckie/ModelChecker/blob/master/Docs/README.md) | [Technical Docs →](https://github.com/benbrastmckie/ModelChecker/blob/master/Code/docs/README.md)
...
The framework defines semantic theories by extending the base [`SemanticDefaults`](https://github.com/benbrastmckie/ModelChecker/blob/master/Code/src/model_checker/models/semantic.py) class. For the full hyperintensional implementation, see [`logos/semantic.py`](https://github.com/benbrastmckie/ModelChecker/blob/master/Code/src/model_checker/theory_lib/logos/semantic.py):
...
The framework provides modular operators across five subtheories. See [`operators.py`](https://github.com/benbrastmckie/ModelChecker/blob/master/Code/src/model_checker/syntactic.py) for the base operator class:
