...
urlpatterns = [
    ...
    path("<int:pk>/changelog/", views.ChangeRequestChangelogView.as_view(), name="changerequest_changelog"),
    path("<int:pk>/journal/", views.ChangeRequestJournalView.as_view(), name="changerequest_journal"),
