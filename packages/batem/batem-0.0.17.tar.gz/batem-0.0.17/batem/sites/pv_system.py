...
def main():
    ...
    open_weather_map_json_reader = core.weather.SiteWeatherDataBuilder(location='Akkar_El_Atiqa', from_requested_stringdate='1/01/2023', to_requested_stringdate='31/12/2023',
                                                                       albedo=0.1, pollution=0.1, given_latitude_north_deg=34.54607406260623, given_longitude_east_deg=36.24159305617472)
