...
site_weather_data: SiteWeatherData = SiteWeatherDataBuilder(location=location, from_requested_stringdate='1/01/%i' % year, to_requested_stringdate='31/12/%i' %
                                                            year, given_latitude_north_deg=latitude, given_longitude_east_deg=longitude, albedo=.1).site_weather_data
