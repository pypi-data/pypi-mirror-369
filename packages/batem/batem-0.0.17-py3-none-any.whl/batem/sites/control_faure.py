...
print('Loading data...')
dp = DataProvider(location='Grenoble_Faure', latitude_deg_north=45.18851777751821, longitude_deg_east=5.733932073114256, starting_stringdate="1/1/2022", ending_stringdate="31/12/2022", bindings=bindings, albedo=0.2, pollution=0.1, number_of_levels=4)
...
dp.add_external_variable('PZcabinet', [occupancy[k] * (body_metabolism + occupant_consumption) + dp('Psun_window', k) for k in dp.ks])
...
# dp.add_external_variable('mode', hvac_modes())
...
dp.add_parameter('toilet:volume', volume_toilet)
