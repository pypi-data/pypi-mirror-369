...
class LaceClient:
    ...
    def attest(self, dataset_path: str, name: Optional[str] = None) -> str:
        ...
        print(f"🔒 Creating privacy-preserving attestation for: {dataset_path}")
        
        # Create bloom filter LOCALLY - data never leaves system!
        ...
        print(f"✅ Bloom filter created locally ({len(bloom_bytes)/(1024*1024):.2f} MB)")
        print(f"🔒 Privacy preserved: No raw data will be sent")
        ...
        print(f"   Privacy: No raw data left your system")
        print(f"   Bloom filter stored in cloud for verification")
