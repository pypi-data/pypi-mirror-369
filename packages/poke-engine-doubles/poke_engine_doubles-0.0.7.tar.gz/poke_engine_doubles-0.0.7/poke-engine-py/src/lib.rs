...
pub struct PySide {
    ...
    pub slot_a: PySideSlot,
    pub slot_b: PySideSlot,
}
...
impl PySide {
    ...
    #[pyo3(signature = (
        ...
        slot_a=PySideSlot::from(SideSlot::default()),
        slot_b=PySideSlot::from(SideSlot::default()),
...
impl From<SideSlot> for PySideSlot {
    fn from(other: SideSlot) -> Self {
        PySideSlot {
            ...
            switch_out_move_second_saved_move: other.switch_out_move_second_saved_move.serialize(),
        }
    }
}
...
impl Into<Pokemon> for PyPokemon {
    fn into(self) -> Pokemon {
        ...
        Pokemon {
            ...
            stellar_boosted_types: self
                .stellar_boosted_types
                .iter()
                .map(|t| PokemonType::from_str(t).unwrap())
                .collect(),
        }
    }
}
...
impl PyPokemon {
    ...
    #[pyo3(signature = (
        ...
        times_attacked=0,
        stellar_boosted_types=Vec::<String>::new(),
    ))]
    fn new(
        id: String,
        level: i8,
        ...
        tera_type: String,
        times_attacked: u16,
        stellar_boosted_types: Vec<String>,
    ) -> Self {
        if base_ability == "" {
...
#[derive(Clone)]
#[pyclass(name = "MctsSideResult", module = "poke_engine", get_all)]
...
#[derive(Clone)]
#[pyclass(name = "MctsResult", module = "poke_engine", get_all)]
struct PyMctsResult {
    side_one: Vec<PyMctsSideResult>,
    side_two: Vec<PyMctsSideResult>,
    iteration_count: u32,
}
    ...
    fn from(other: StateInstructions) -> Self {
        PyStateInstructions {
            ...
            instruction_list: other
                ...
                .collect(),
            end_of_turn_triggered: other.end_of_turn_triggered,
        }
    }
}
    ...
    fn into(self) -> StateInstructions {
        StateInstructions {
            ...
            instruction_list: self
                ...
                .map(|i| i.into())
                .collect(),
            end_of_turn_triggered: self.end_of_turn_triggered,
        }
    }
}
...
fn generate_instructions(
    ...
    let instructions = generate_instructions_from_move_pair(
        &mut state, &s1_a_move, &s1_b_move, &s2_a_move, &s2_b_move, true,
    );
