...
class Side:
    ...
    def __init__(
        ...
        slot_a: SideSlot = None,
        slot_b: SideSlot = None,
...
def generate_instructions(
    ...
    :param side_one_a_move: Move for side one slot A
    :param side_one_b_move: Move for side one slot B
    :param side_two_a_move: Move for side two slot A
    :param side_two_b_move: Move for side two slot B
...
def calculate_damage(
    ...
    :param py_state: The current game state
    :param attacking_side: Which side is attacking ("1" or "2")
    :param attacking_slot: Which slot is attacking ("a" or "b")
    :param target_side: Which side is the target ("1" or "2")
    :param target_slot: Which slot is the target ("a" or "b")
    :param attacker_move: The attacking move
    :param target_move: The target's move
