...
class RpmModulemdResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "arch": obj.get("arch"),
            "artifacts": OneOf.from_dict(obj["artifacts"]) if obj.get("artifacts") is not None else None,
            "dependencies": OneOf.from_dict(obj["dependencies"]) if obj.get("dependencies") is not None else None,
            "packages": obj.get("packages"),
            "profiles": OneOf.from_dict(obj["profiles"]) if obj.get("profiles") is not None else None,
