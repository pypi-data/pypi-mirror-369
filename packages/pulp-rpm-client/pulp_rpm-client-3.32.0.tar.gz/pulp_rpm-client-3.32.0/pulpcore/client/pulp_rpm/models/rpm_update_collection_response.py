...
class RpmUpdateCollectionResponse(BaseModel):
    """
    A Serializer for UpdateCollection.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(description="Collection name.")
    shortname: Optional[StrictStr] = Field(description="Collection short name.")
    module: Optional[Any] = Field(description="Collection modular NSVCA.")
    packages: Optional[List[Dict[str, Any]]] = Field(default=None, description="List of packages")
    __properties: ClassVar[List[str]] = ["name", "shortname", "module", "packages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "module": OneOf.from_dict(obj["module"]) if obj.get("module") is not None else None,
