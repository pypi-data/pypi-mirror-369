...
class ListSettlementPaymentsSort(str, Enum):
...
class ListSettlementPaymentsRequestTypedDict(TypedDict):
    ...
    sort: NotRequired[Nullable[ListSettlementPaymentsSort]]
    r"""Used for setting the direction of the result set. Defaults to descending order, meaning the results are ordered from
    newest to oldest.
    """
...
class ListSettlementPaymentsRequest(BaseModel):
    ...
    sort: Annotated[
        OptionalNullable[ListSettlementPaymentsSort],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""Used for setting the direction of the result set. Defaults to descending order, meaning the results are ordered from
    newest to oldest.
...
class ListSettlementPaymentsBadRequestDocumentationTypedDict(TypedDict):
...
class ListSettlementPaymentsBadRequestDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class ListSettlementPaymentsBadRequestLinksTypedDict(TypedDict):
    documentation: ListSettlementPaymentsBadRequestDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class ListSettlementPaymentsBadRequestLinks(BaseModel):
    documentation: ListSettlementPaymentsBadRequestDocumentation
    r"""The URL to the generic Mollie API error handling guide."""


class ListSettlementPaymentsHalJSONErrorData(BaseModel):
    status: int
    ...
    links: Annotated[
        ListSettlementPaymentsBadRequestLinks, pydantic.Field(alias="_links")
    ]
...
class ListSettlementPaymentsHalJSONError(ClientError):
    r"""An error response object."""

    data: ListSettlementPaymentsHalJSONErrorData
...
class ListSettlementPaymentsMode(str, Enum):
...
class ListSettlementPaymentsAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsAmount(BaseModel):
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
...
class ListSettlementPaymentsAmountRefundedTypedDict(TypedDict):
...
class ListSettlementPaymentsAmountRefunded(BaseModel):
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some
    payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the
    costs for a return shipment to the customer.
    """
...
class ListSettlementPaymentsAmountRemainingTypedDict(TypedDict):
...
class ListSettlementPaymentsAmountRemaining(BaseModel):
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
...
class ListSettlementPaymentsAmountCapturedTypedDict(TypedDict):
...
class ListSettlementPaymentsAmountCaptured(BaseModel):
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
...
class ListSettlementPaymentsAmountChargedBackTypedDict(TypedDict):
...
class ListSettlementPaymentsAmountChargedBack(BaseModel):
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not
    zero.
    """
...
class ListSettlementPaymentsSettlementAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsSettlementAmount(BaseModel):
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the
    currency your account is settled in.
...
class ListSettlementPaymentsLineType(str, Enum):
...
class ListSettlementPaymentsUnitPriceTypedDict(TypedDict):
...
class ListSettlementPaymentsUnitPrice(BaseModel):
    r"""The price of a single item including VAT.
...
class ListSettlementPaymentsDiscountAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsDiscountAmount(BaseModel):
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount
    type.
    """
...
class ListSettlementPaymentsTotalAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsTotalAmount(BaseModel):
    r"""The total amount of the line, including VAT and discounts.
...
class ListSettlementPaymentsVatAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsVatAmount(BaseModel):
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be
    calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
...
class ListSettlementPaymentsCategory(str, Enum):
    MEAL = "meal"
    ECO = "eco"
    GIFT = "gift"
...
class ListSettlementPaymentsInterval(str, Enum):
...
class ListSettlementPaymentsRecurringAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsRecurringAmount(BaseModel):
    r"""Total amount and currency of the recurring item."""
...
class ListSettlementPaymentsRecurringTypedDict(TypedDict):
    ...
    amount: NotRequired[ListSettlementPaymentsRecurringAmountTypedDict]
    r"""Total amount and currency of the recurring item."""
...
class ListSettlementPaymentsRecurring(BaseModel):
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout
    to inform the shopper of the details for recurring products in the payments.
    """
    ...
    amount: Optional[ListSettlementPaymentsRecurringAmount] = None
    r"""Total amount and currency of the recurring item."""
...
class ListSettlementPaymentsLineTypedDict(TypedDict):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    quantity: int
    r"""The number of items."""
    unit_price: ListSettlementPaymentsUnitPriceTypedDict
    r"""The price of a single item including VAT.
    ...
    The unit price can be zero in case of free items.
    """
    total_amount: ListSettlementPaymentsTotalAmountTypedDict
    r"""The total amount of the line, including VAT and discounts.
    ...
    The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
    """
    type: NotRequired[ListSettlementPaymentsLineType]
    r"""The type of product purchased. For example, a physical or a digital product.
    ...
    discount_amount: NotRequired[ListSettlementPaymentsDiscountAmountTypedDict]
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount
    type.
    """
    ...
    """
    vat_amount: NotRequired[ListSettlementPaymentsVatAmountTypedDict]
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be
    calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
    ...
    categories: NotRequired[List[ListSettlementPaymentsCategory]]
    ...
    recurring: NotRequired[ListSettlementPaymentsRecurringTypedDict]
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout
    to inform the shopper of the details for recurring products in the payments.
    """


class ListSettlementPaymentsLine(BaseModel):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    ...
    unit_price: Annotated[
        ListSettlementPaymentsUnitPrice, pydantic.Field(alias="unitPrice")
    ]
    r"""The price of a single item including VAT.
    ...
    total_amount: Annotated[
        ListSettlementPaymentsTotalAmount, pydantic.Field(alias="totalAmount")
    ]
    r"""The total amount of the line, including VAT and discounts.
    ...
    type: Optional[ListSettlementPaymentsLineType] = None
    r"""The type of product purchased. For example, a physical or a digital product.
    ...
    discount_amount: Annotated[
        Optional[ListSettlementPaymentsDiscountAmount],
    ...
    vat_amount: Annotated[
        Optional[ListSettlementPaymentsVatAmount], pydantic.Field(alias="vatAmount")
    ] = None
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be
    calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
    ...
    categories: Optional[List[ListSettlementPaymentsCategory]] = None
    r"""An array with the voucher categories, in case of a line eligible for a voucher. See the
    [Integrating Vouchers](integrating-vouchers) guide for more information.
    """
    ...
    recurring: Optional[ListSettlementPaymentsRecurring] = None
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout
    to inform the shopper of the details for recurring products in the payments.
    """


class ListSettlementPaymentsBillingAddressTypedDict(TypedDict):
...
class ListSettlementPaymentsBillingAddress(BaseModel):
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and
    conversion.
...
class ListSettlementPaymentsShippingAddressTypedDict(TypedDict):
...
class ListSettlementPaymentsShippingAddress(BaseModel):
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and
    conversion.
...
class ListSettlementPaymentsLocale(str, Enum):
...
class ListSettlementPaymentsMethod(str, Enum):
...
class ListSettlementPaymentsMetadataTypedDict(TypedDict):
    pass


class ListSettlementPaymentsMetadata(BaseModel):
    pass


ListSettlementPaymentsMetadataUnionTypedDict = TypeAliasType(
    "ListSettlementPaymentsMetadataUnionTypedDict",
    Union[ListSettlementPaymentsMetadataTypedDict, str, List[str]],
)
...
ListSettlementPaymentsMetadataUnion = TypeAliasType(
    "ListSettlementPaymentsMetadataUnion",
    Union[ListSettlementPaymentsMetadata, str, List[str]],
)
r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever
you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
"""
...
class ListSettlementPaymentsCaptureMode(str, Enum):
...
class ListSettlementPaymentsApplicationFeeAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsApplicationFeeAmount(BaseModel):
    r"""The fee that you wish to charge.
...
class ListSettlementPaymentsApplicationFeeTypedDict(TypedDict):
    ...
    amount: NotRequired[ListSettlementPaymentsApplicationFeeAmountTypedDict]
    r"""The fee that you wish to charge.
...
class ListSettlementPaymentsApplicationFee(BaseModel):
    r"""With Mollie Connect you can charge fees on payments that your app is processing on behalf of other Mollie
    merchants.
    ...
    amount: Optional[ListSettlementPaymentsApplicationFeeAmount] = None
    r"""The fee that you wish to charge.
...
class ListSettlementPaymentsRoutingMode(str, Enum):
    r"""Whether this entity was created in live mode or in test mode."""
...
class ListSettlementPaymentsRoutingAmountTypedDict(TypedDict):
...
class ListSettlementPaymentsRoutingAmount(BaseModel):
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
...
class ListSettlementPaymentsRoutingType(str, Enum):
    r"""The type of destination. Currently only the destination type `organization` is supported."""

    ORGANIZATION = "organization"


class ListSettlementPaymentsDestinationTypedDict(TypedDict):
...
class ListSettlementPaymentsDestination(BaseModel):
    r"""The destination of this portion of the payment."""
...
class ListSettlementPaymentsRoutingSelfTypedDict(TypedDict):
...
class ListSettlementPaymentsRoutingSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsRoutingPaymentTypedDict(TypedDict):
...
class ListSettlementPaymentsRoutingPayment(BaseModel):
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class ListSettlementPaymentsRoutingLinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: ListSettlementPaymentsRoutingSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: ListSettlementPaymentsRoutingPaymentTypedDict
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""


class ListSettlementPaymentsRoutingLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[ListSettlementPaymentsRoutingSelf, pydantic.Field(alias="self")]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsRoutingTypedDict(TypedDict):
    resource: str
    ...
    r"""Whether this entity was created in live mode or in test mode."""
    amount: ListSettlementPaymentsRoutingAmountTypedDict
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    destination: ListSettlementPaymentsDestinationTypedDict
    r"""The destination of this portion of the payment."""
    created_at: str
    r"""The date and time when the route was created. The date is given in ISO 8601 format."""
    links: ListSettlementPaymentsRoutingLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListSettlementPaymentsRouting(BaseModel):
    resource: str
    r"""Indicates the response contains a route object. Will always contain the string `route` for this endpoint."""
    ...
    links: Annotated[ListSettlementPaymentsRoutingLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListSettlementPaymentsSequenceType(str, Enum):
...
class ListSettlementPaymentsStatus(str, Enum):
...
class ListSettlementPaymentsStatusReasonTypedDict(TypedDict):
...
class ListSettlementPaymentsStatusReason(BaseModel):
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale
    payments.
...
class ListSettlementPaymentsPaymentSelfTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsPaymentSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsCheckoutTypedDict(TypedDict):
...
class ListSettlementPaymentsCheckout(BaseModel):
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
...
class ListSettlementPaymentsMobileAppCheckoutTypedDict(TypedDict):
...
class ListSettlementPaymentsMobileAppCheckout(BaseModel):
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
...
class ListSettlementPaymentsChangePaymentStateTypedDict(TypedDict):
...
class ListSettlementPaymentsChangePaymentState(BaseModel):
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different
    payment states.
...
class ListSettlementPaymentsDashboardTypedDict(TypedDict):
...
class ListSettlementPaymentsDashboard(BaseModel):
    r"""Direct link to the payment in the Mollie Dashboard."""
...
class ListSettlementPaymentsRefundsTypedDict(TypedDict):
...
class ListSettlementPaymentsRefunds(BaseModel):
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
...
class ListSettlementPaymentsChargebacksTypedDict(TypedDict):
...
class ListSettlementPaymentsChargebacks(BaseModel):
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this
    payment.
    """
...
class ListSettlementPaymentsCapturesTypedDict(TypedDict):
...
class ListSettlementPaymentsCaptures(BaseModel):
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
...
class ListSettlementPaymentsSettlementTypedDict(TypedDict):
...
class ListSettlementPaymentsSettlement(BaseModel):
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with.
    Not present if not yet settled.
    """
...
class ListSettlementPaymentsCustomerTypedDict(TypedDict):
...
class ListSettlementPaymentsCustomer(BaseModel):
    r"""The API resource URL of the [customer](get-customer)."""
...
class ListSettlementPaymentsMandateTypedDict(TypedDict):
...
class ListSettlementPaymentsMandate(BaseModel):
    r"""The API resource URL of the [mandate](get-mandate)."""
...
class ListSettlementPaymentsSubscriptionTypedDict(TypedDict):
...
class ListSettlementPaymentsSubscription(BaseModel):
    r"""The API resource URL of the [subscription](get-subscription)."""
...
class ListSettlementPaymentsOrderTypedDict(TypedDict):
...
class ListSettlementPaymentsOrder(BaseModel):
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an
    order.
    """
...
class ListSettlementPaymentsTerminalTypedDict(TypedDict):
...
class ListSettlementPaymentsTerminal(BaseModel):
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for
    point-of-sale payments.
    """
...
class ListSettlementPaymentsPaymentDocumentationTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsPaymentDocumentation(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsPaymentLinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: ListSettlementPaymentsPaymentSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    dashboard: ListSettlementPaymentsDashboardTypedDict
    r"""Direct link to the payment in the Mollie Dashboard."""
    checkout: NotRequired[ListSettlementPaymentsCheckoutTypedDict]
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
    mobile_app_checkout: NotRequired[ListSettlementPaymentsMobileAppCheckoutTypedDict]
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
    change_payment_state: NotRequired[ListSettlementPaymentsChangePaymentStateTypedDict]
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different
    payment states.
    ...
    chargeback for the test payment.
    """
    refunds: NotRequired[ListSettlementPaymentsRefundsTypedDict]
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    chargebacks: NotRequired[ListSettlementPaymentsChargebacksTypedDict]
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this
    payment.
    """
    captures: NotRequired[ListSettlementPaymentsCapturesTypedDict]
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
    settlement: NotRequired[ListSettlementPaymentsSettlementTypedDict]
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with.
    Not present if not yet settled.
    """
    customer: NotRequired[ListSettlementPaymentsCustomerTypedDict]
    r"""The API resource URL of the [customer](get-customer)."""
    mandate: NotRequired[ListSettlementPaymentsMandateTypedDict]
    r"""The API resource URL of the [mandate](get-mandate)."""
    subscription: NotRequired[ListSettlementPaymentsSubscriptionTypedDict]
    r"""The API resource URL of the [subscription](get-subscription)."""
    order: NotRequired[ListSettlementPaymentsOrderTypedDict]
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an
    order.
    """
    terminal: NotRequired[ListSettlementPaymentsTerminalTypedDict]
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for
    point-of-sale payments.
    """
    documentation: NotRequired[ListSettlementPaymentsPaymentDocumentationTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""


class ListSettlementPaymentsPaymentLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[ListSettlementPaymentsPaymentSelf, pydantic.Field(alias="self")]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    dashboard: ListSettlementPaymentsDashboard
    r"""Direct link to the payment in the Mollie Dashboard."""

    checkout: Optional[ListSettlementPaymentsCheckout] = None
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""

    mobile_app_checkout: Annotated[
        Optional[ListSettlementPaymentsMobileAppCheckout],
        pydantic.Field(alias="mobileAppCheckout"),
    ] = None
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""

    change_payment_state: Annotated[
        Optional[ListSettlementPaymentsChangePaymentState],
    ...
    refunds: Optional[ListSettlementPaymentsRefunds] = None
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""

    chargebacks: Optional[ListSettlementPaymentsChargebacks] = None
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this
    payment.
    """

    captures: Optional[ListSettlementPaymentsCaptures] = None
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""

    settlement: Optional[ListSettlementPaymentsSettlement] = None
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with.
    Not present if not yet settled.
    """

    customer: Optional[ListSettlementPaymentsCustomer] = None
    r"""The API resource URL of the [customer](get-customer)."""

    mandate: Optional[ListSettlementPaymentsMandate] = None
    r"""The API resource URL of the [mandate](get-mandate)."""

    subscription: Optional[ListSettlementPaymentsSubscription] = None
    r"""The API resource URL of the [subscription](get-subscription)."""

    order: Optional[ListSettlementPaymentsOrder] = None
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an
    order.
    """

    terminal: Optional[ListSettlementPaymentsTerminal] = None
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for
    point-of-sale payments.
    """

    documentation: Optional[ListSettlementPaymentsPaymentDocumentation] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""


class ListSettlementPaymentsPaymentOutputTypedDict(TypedDict):
    resource: str
    ...
    """
    amount: ListSettlementPaymentsAmountTypedDict
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    tip amount.
    """
    sequence_type: Nullable[ListSettlementPaymentsSequenceType]
    r"""**Only relevant for recurring payments.**
    ...
    links: ListSettlementPaymentsPaymentLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
    amount_refunded: NotRequired[ListSettlementPaymentsAmountRefundedTypedDict]
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some
    payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the
    costs for a return shipment to the customer.
    """
    amount_remaining: NotRequired[ListSettlementPaymentsAmountRemainingTypedDict]
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
    amount_captured: NotRequired[ListSettlementPaymentsAmountCapturedTypedDict]
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
    amount_charged_back: NotRequired[ListSettlementPaymentsAmountChargedBackTypedDict]
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not
    zero.
    """
    settlement_amount: NotRequired[ListSettlementPaymentsSettlementAmountTypedDict]
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the
    currency your account is settled in.
    ...
    local machine.
    """
    lines: NotRequired[Nullable[List[ListSettlementPaymentsLineTypedDict]]]
    ...
    """
    billing_address: NotRequired[ListSettlementPaymentsBillingAddressTypedDict]
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and
    conversion.
    ...
    Required for payment method `in3`, `klarna`, `billie` and `riverty`.
    """
    shipping_address: NotRequired[ListSettlementPaymentsShippingAddressTypedDict]
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and
    conversion.
    ...
    `country`.
    """
    locale: NotRequired[Nullable[ListSettlementPaymentsLocale]]
    r"""Allows you to preset the language to be used in the hosted payment pages shown to the customer. Setting a locale
    is highly recommended and will greatly improve your conversion rate. When this parameter is omitted the browser
    language will be used instead if supported by the payment method. You can provide any `xx_XX` format ISO 15897
    locale, but our hosted payment pages currently only support the specified languages.
    ...
    """
    method: NotRequired[Nullable[ListSettlementPaymentsMethod]]
    r"""The payment method used for this transaction. If a specific method was selected during payment initialization,
    this field reflects that choice.
    """
    ...
    """
    metadata: NotRequired[Nullable[ListSettlementPaymentsMetadataUnionTypedDict]]
    r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever
    you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
    """
    capture_mode: NotRequired[Nullable[ListSettlementPaymentsCaptureMode]]
    r"""Indicate if the funds should be captured immediately or if you want to [place a hold](https://docs.mollie.com/docs/place-a-hold-for-a-payment#/)
    and capture at a later time.
    ...
    application_fee: NotRequired[
        Nullable[ListSettlementPaymentsApplicationFeeTypedDict]
    ]
    r"""With Mollie Connect you can charge fees on payments that your app is processing on behalf of other Mollie
    merchants.
    ...
    `routing` parameter.
    """
    routing: NotRequired[Nullable[List[ListSettlementPaymentsRoutingTypedDict]]]
    ...
    status_reason: NotRequired[Nullable[ListSettlementPaymentsStatusReasonTypedDict]]
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale
    payments.
...
class ListSettlementPaymentsPaymentOutput(BaseModel):
    resource: str
    r"""Indicates the response contains a payment object. Will always contain the string `payment` for this endpoint."""
    ...
    sequence_type: Annotated[
        Nullable[ListSettlementPaymentsSequenceType],
    ...
    links: Annotated[ListSettlementPaymentsPaymentLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    amount_refunded: Annotated[
        Optional[ListSettlementPaymentsAmountRefunded],
    ...
    amount_remaining: Annotated[
        Optional[ListSettlementPaymentsAmountRemaining],
        pydantic.Field(alias="amountRemaining"),
    ] = None
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""

    amount_captured: Annotated[
        Optional[ListSettlementPaymentsAmountCaptured],
        pydantic.Field(alias="amountCaptured"),
    ] = None
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""

    amount_charged_back: Annotated[
        Optional[ListSettlementPaymentsAmountChargedBack],
    ...
    settlement_amount: Annotated[
        Optional[ListSettlementPaymentsSettlementAmount],
    ...
    lines: OptionalNullable[List[ListSettlementPaymentsLine]] = UNSET
    r"""Optionally provide the order lines for the payment. Each line contains details such as a description of the item
    ordered and its price.
    ...
    billing_address: Annotated[
        Optional[ListSettlementPaymentsBillingAddress],
    ...
    shipping_address: Annotated[
        Optional[ListSettlementPaymentsShippingAddress],
    ...
    locale: OptionalNullable[ListSettlementPaymentsLocale] = UNSET
    r"""Allows you to preset the language to be used in the hosted payment pages shown to the customer. Setting a locale
    is highly recommended and will greatly improve your conversion rate. When this parameter is omitted the browser
    language will be used instead if supported by the payment method. You can provide any `xx_XX` format ISO 15897
    locale, but our hosted payment pages currently only support the specified languages.
    ...
    method: OptionalNullable[ListSettlementPaymentsMethod] = UNSET
    r"""The payment method used for this transaction. If a specific method was selected during payment initialization,
    this field reflects that choice.
    """
    ...
    metadata: OptionalNullable[ListSettlementPaymentsMetadataUnion] = UNSET
    r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever
    you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
    """

    capture_mode: Annotated[
        OptionalNullable[ListSettlementPaymentsCaptureMode],
    ...
    application_fee: Annotated[
        OptionalNullable[ListSettlementPaymentsApplicationFee],
    ...
    routing: OptionalNullable[List[ListSettlementPaymentsRouting]] = UNSET
    r"""*This functionality is not enabled by default. Reach out to our partner management team if you wish to use it.*
    ...
    status_reason: Annotated[
        OptionalNullable[ListSettlementPaymentsStatusReason],
...
class ListSettlementPaymentsEmbeddedTypedDict(TypedDict):
    payments: NotRequired[List[ListSettlementPaymentsPaymentOutputTypedDict]]
    r"""An array of payment objects."""


class ListSettlementPaymentsEmbedded(BaseModel):
    payments: Optional[List[ListSettlementPaymentsPaymentOutput]] = None
    r"""An array of payment objects."""


class ListSettlementPaymentsSelfTypedDict(TypedDict):
...
class ListSettlementPaymentsSelf(BaseModel):
    r"""The URL to the current set of items."""
...
class ListSettlementPaymentsPreviousTypedDict(TypedDict):
...
class ListSettlementPaymentsPrevious(BaseModel):
    r"""The previous set of items, if available."""
...
class ListSettlementPaymentsNextTypedDict(TypedDict):
...
class ListSettlementPaymentsNext(BaseModel):
    r"""The next set of items, if available."""
...
class ListSettlementPaymentsDocumentationTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsDocumentation(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsLinksTypedDict(TypedDict):
    r"""Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field."""

    self_: NotRequired[ListSettlementPaymentsSelfTypedDict]
    r"""The URL to the current set of items."""
    previous: NotRequired[Nullable[ListSettlementPaymentsPreviousTypedDict]]
    r"""The previous set of items, if available."""
    next: NotRequired[Nullable[ListSettlementPaymentsNextTypedDict]]
    r"""The next set of items, if available."""
    documentation: NotRequired[ListSettlementPaymentsDocumentationTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""


class ListSettlementPaymentsLinks(BaseModel):
    r"""Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[
        Optional[ListSettlementPaymentsSelf], pydantic.Field(alias="self")
    ] = None
    r"""The URL to the current set of items."""

    previous: OptionalNullable[ListSettlementPaymentsPrevious] = UNSET
    r"""The previous set of items, if available."""

    next: OptionalNullable[ListSettlementPaymentsNext] = UNSET
    r"""The next set of items, if available."""

    documentation: Optional[ListSettlementPaymentsDocumentation] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class ListSettlementPaymentsResponseTypedDict(TypedDict):
    ...
    limit is 50 items.
    """
    embedded: NotRequired[ListSettlementPaymentsEmbeddedTypedDict]
    links: NotRequired[ListSettlementPaymentsLinksTypedDict]
    r"""Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field."""
...
class ListSettlementPaymentsResponse(BaseModel):
    ...
    embedded: Annotated[
        Optional[ListSettlementPaymentsEmbedded], pydantic.Field(alias="_embedded")
    ] = None

    links: Annotated[
        Optional[ListSettlementPaymentsLinks], pydantic.Field(alias="_links")
    ] = None
    r"""Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field."""
