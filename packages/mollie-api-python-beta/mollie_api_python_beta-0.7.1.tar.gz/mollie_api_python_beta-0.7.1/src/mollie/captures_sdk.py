...
class CapturesSDK(BaseSDK):
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.CreateCaptureRequestBody],
            ),
        ...
        if utils.match_response(http_res, "201", "application/hal+json"):
            return unmarshal_json_response(models.CreateCaptureResponse, http_res)
        if utils.match_response(http_res, "404", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.CreateCaptureNotFoundHalJSONErrorData, http_res
            )
            raise models.CreateCaptureNotFoundHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "422", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.CreateCaptureUnprocessableEntityHalJSONErrorData, http_res
            )
            raise models.CreateCaptureUnprocessableEntityHalJSONError(
    ...
    def list(
        ...
        *,
        ...
        embed: Optional[models.ListCapturesEmbed] = None,
        ...
        if utils.match_response(http_res, "400", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.ListCapturesBadRequestHalJSONErrorData, http_res
            )
            raise models.ListCapturesBadRequestHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "404", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.ListCapturesNotFoundHalJSONErrorData, http_res
            )
            raise models.ListCapturesNotFoundHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def get(
        ...
        *,
        payment_id: str,
        capture_id: str,
        embed: Optional[models.GetCaptureEmbed] = None,
        testmode: OptionalNullable[bool] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetCaptureResponse:
        r"""Get capture
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/hal+json"):
            return unmarshal_json_response(models.GetCaptureResponse, http_res)
        if utils.match_response(http_res, "404", "application/hal+json"):
            response_data = unmarshal_json_response(
                models.GetCaptureHalJSONErrorData, http_res
            )
            raise models.GetCaptureHalJSONError(response_data, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
