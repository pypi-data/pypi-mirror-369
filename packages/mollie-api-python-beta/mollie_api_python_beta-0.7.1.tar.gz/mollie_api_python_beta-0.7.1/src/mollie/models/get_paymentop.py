...
class GetPaymentInclude(str, Enum):
...
class GetPaymentEmbed(str, Enum):
...
class GetPaymentRequestTypedDict(TypedDict):
    ...
    include: NotRequired[Nullable[GetPaymentInclude]]
    r"""This endpoint allows you to include additional information via the `include` query string parameter."""
    embed: NotRequired[Nullable[GetPaymentEmbed]]
    r"""This endpoint allows embedding related API items by appending the
    following values via the `embed` query string parameter.
    """
...
class GetPaymentRequest(BaseModel):
    ...
    include: Annotated[
        OptionalNullable[GetPaymentInclude],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""This endpoint allows you to include additional information via the `include` query string parameter."""

    embed: Annotated[
        OptionalNullable[GetPaymentEmbed],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""This endpoint allows embedding related API items by appending the
    following values via the `embed` query string parameter.
...
class GetPaymentNotFoundDocumentationTypedDict(TypedDict):
...
class GetPaymentNotFoundDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetPaymentNotFoundLinksTypedDict(TypedDict):
    documentation: GetPaymentNotFoundDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class GetPaymentNotFoundLinks(BaseModel):
    documentation: GetPaymentNotFoundDocumentation
    r"""The URL to the generic Mollie API error handling guide."""


class GetPaymentHalJSONErrorData(BaseModel):
    status: int
    ...
    links: Annotated[GetPaymentNotFoundLinks, pydantic.Field(alias="_links")]
...
class GetPaymentHalJSONError(ClientError):
    r"""An error response object."""

    data: GetPaymentHalJSONErrorData
...
class GetPaymentLineType(str, Enum):
...
class GetPaymentCategory(str, Enum):
    MEAL = "meal"
    ECO = "eco"
    GIFT = "gift"
...
class GetPaymentInterval(str, Enum):
...
class GetPaymentRecurringAmountTypedDict(TypedDict):
...
class GetPaymentRecurringAmount(BaseModel):
    r"""Total amount and currency of the recurring item."""
...
class GetPaymentRecurringTypedDict(TypedDict):
    ...
    amount: NotRequired[GetPaymentRecurringAmountTypedDict]
    r"""Total amount and currency of the recurring item."""
...
class GetPaymentRecurring(BaseModel):
    ...
    amount: Optional[GetPaymentRecurringAmount] = None
    r"""Total amount and currency of the recurring item."""
...
class GetPaymentLineTypedDict(TypedDict):
    description: str
    ...
    The sum of all `totalAmount` values of all order lines should be equal to the full payment amount.
    """
    type: NotRequired[GetPaymentLineType]
    r"""The type of product purchased. For example, a physical or a digital product.
    ...
    categories: NotRequired[List[GetPaymentCategory]]
...
class GetPaymentLine(BaseModel):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    ...
    categories: Optional[List[GetPaymentCategory]] = None
    r"""An array with the voucher categories, in case of a line eligible for a voucher. See the
    [Integrating Vouchers](integrating-vouchers) guide for more information.
    """
...
class GetPaymentLocale(str, Enum):
...
class GetPaymentMethod(str, Enum):
...
class GetPaymentCaptureMode(str, Enum):
...
class GetPaymentApplicationFeeAmountTypedDict(TypedDict):
...
class GetPaymentApplicationFeeAmount(BaseModel):
    r"""The fee that you wish to charge.
...
class GetPaymentApplicationFeeTypedDict(TypedDict):
    ...
    amount: NotRequired[GetPaymentApplicationFeeAmountTypedDict]
    r"""The fee that you wish to charge.
...
class GetPaymentApplicationFee(BaseModel):
    ...
    amount: Optional[GetPaymentApplicationFeeAmount] = None
    r"""The fee that you wish to charge.
...
class GetPaymentRoutingMode(str, Enum):
    r"""Whether this entity was created in live mode or in test mode."""
...
class GetPaymentRoutingAmountTypedDict(TypedDict):
...
class GetPaymentRoutingAmount(BaseModel):
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
...
class GetPaymentRoutingType(str, Enum):
...
class GetPaymentRoutingSelfTypedDict(TypedDict):
...
class GetPaymentRoutingSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentRoutingLinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: GetPaymentRoutingSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: GetPaymentPaymentTypedDict
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""


class GetPaymentRoutingLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[GetPaymentRoutingSelf, pydantic.Field(alias="self")]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentRoutingTypedDict(TypedDict):
    ...
    r"""Whether this entity was created in live mode or in test mode."""
    amount: GetPaymentRoutingAmountTypedDict
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    ...
    links: GetPaymentRoutingLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class GetPaymentRouting(BaseModel):
    ...
    links: Annotated[GetPaymentRoutingLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class GetPaymentSequenceType(str, Enum):
...
class GetPaymentStatus(str, Enum):
...
class GetPaymentResponseTypedDict(TypedDict):
    ...
    local machine.
    """
    lines: NotRequired[Nullable[List[GetPaymentLineTypedDict]]]
    ...
    `country`.
    """
    locale: NotRequired[Nullable[GetPaymentLocale]]
    r"""Allows you to preset the language to be used in the hosted payment pages shown to the customer. Setting a locale
    is highly recommended and will greatly improve your conversion rate. When this parameter is omitted the browser
    language will be used instead if supported by the payment method. You can provide any `xx_XX` format ISO 15897
    locale, but our hosted payment pages currently only support the specified languages.
    ...
    """
    method: NotRequired[Nullable[GetPaymentMethod]]
    r"""The payment method used for this transaction. If a specific method was selected during payment initialization,
    this field reflects that choice.
    """
    ...
    you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB.
    """
    capture_mode: NotRequired[Nullable[GetPaymentCaptureMode]]
    r"""Indicate if the funds should be captured immediately or if you want to [place a hold](https://docs.mollie.com/docs/place-a-hold-for-a-payment#/)
    and capture at a later time.
...
class GetPaymentResponse(BaseModel):
    ...
    lines: OptionalNullable[List[GetPaymentLine]] = UNSET
    r"""Optionally provide the order lines for the payment. Each line contains details such as a description of the item
    ordered and its price.
    ...
    locale: OptionalNullable[GetPaymentLocale] = UNSET
    r"""Allows you to preset the language to be used in the hosted payment pages shown to the customer. Setting a locale
    is highly recommended and will greatly improve your conversion rate. When this parameter is omitted the browser
    language will be used instead if supported by the payment method. You can provide any `xx_XX` format ISO 15897
    locale, but our hosted payment pages currently only support the specified languages.
    ...
    method: OptionalNullable[GetPaymentMethod] = UNSET
    r"""The payment method used for this transaction. If a specific method was selected during payment initialization,
    this field reflects that choice.
    """
    ...
    capture_mode: Annotated[
        OptionalNullable[GetPaymentCaptureMode], pydantic.Field(alias="captureMode")
    ] = UNSET
    r"""Indicate if the funds should be captured immediately or if you want to [place a hold](https://docs.mollie.com/docs/place-a-hold-for-a-payment#/)
    and capture at a later time.
