...
from dcmfetch.qipynetdicom import (
    dcm_pat_level_find,
    dcm_stu_level_find,
    dcm_ser_level_find,
    dcm_img_level_find,
...
SRVARGS = ['--no-storage', '--pending-cget', '--bind', 'DCMQRSCP:11112', '--dicomdir', join(TESTDATA, 'DICOMDIR')]

class TestQIPyNetDicom(unittest.TestCase):
    """Tests for functions in qidpynetdicom.py"""
