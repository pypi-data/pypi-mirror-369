...
def input_dataset_parameter_task_with_files(param_dir: str | Path):
    ...
    parameter_data = DlnirspTestingParameters(
        ...
        # These values are valid for canonical data. See conftest.py for values that are used on PROD
        dlnirsp_linearization_saturation_threshold_jband=55000,
        dlnirsp_linearization_saturation_threshold_hband=45000,
    )
