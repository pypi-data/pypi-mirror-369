...
def test_single():
    ...
    test_filepath = source_meter_analysis.extract_readings_to_resistance_series(test_filepath, "data/converted")
...
def test_many():
    ...
    for file in files:
        out = source_meter_analysis.voltage_readings_to_resistance_series(file, "data/converted")
