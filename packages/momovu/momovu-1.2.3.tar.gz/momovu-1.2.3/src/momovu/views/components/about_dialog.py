...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self.setWindowTitle("About Momovu")
        self.setModal(True)
    ...
    def _setup_ui(self) -> None:
        ...
        # Title and version
        title_label = QLabel("<h2>Momovu</h2>")
        title_font = QFont()
        ...
        # Features
        features_text = """<p><b>Features:</b></p>
        <ul>
        ...
        # System information
        system_info_text = f"""<p><b>System Information:</b></p>
