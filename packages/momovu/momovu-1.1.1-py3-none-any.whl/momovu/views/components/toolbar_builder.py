...
class ToolbarBuilder:
    ...
    def _add_navigation_actions(self) -> None:
        ...
        if self.toolbar:
            ...
            self.actions["first_page"] = QAction("First", self.main_window)
            ...
            self.actions["first_page"].setToolTip("Go to first page (Home)")
            self.actions["first_page"].setShortcut("Home")
            self.toolbar.addAction(self.actions["first_page"])

            self.actions["prev_page"] = QAction("Previous", self.main_window)
            ...
            self.actions["next_page"].setToolTip("Go to next page")
            # Arrow key shortcuts removed - handled by zoom-aware logic in GraphicsView
            self.toolbar.addAction(self.actions["next_page"])

            self.actions["last_page"] = QAction("Last", self.main_window)
            ...
            self.actions["last_page"].setToolTip("Go to last page (End)")
    ...
    def _add_page_spinbox(self) -> None:
        ...
        if self.toolbar:
            ...
            spinbox.setToolTip("Current page number")
    ...
    def _add_num_pages_spinbox(self) -> None:
        ...
        if self.toolbar:
            ...
            spinbox.setToolTip("Number of pages for spine width calculation")
    ...
    def _add_zoom_actions(self) -> None:
        ...
        if self.toolbar:
            ...
            self.actions["zoom_in"] = QAction("Zoom In", self.main_window)
            ...
            self.actions["zoom_in"].setToolTip("Zoom in (Ctrl++)")
            self.actions["zoom_in"].setShortcut("Ctrl++")
            self.toolbar.addAction(self.actions["zoom_in"])

            self.actions["zoom_out"] = QAction("Zoom Out", self.main_window)
            ...
            self.actions["zoom_out"].setToolTip("Zoom out (Ctrl+-)")
            self.actions["zoom_out"].setShortcut("Ctrl+-")
            self.toolbar.addAction(self.actions["zoom_out"])

            self.actions["fit_page"] = QAction("Fit Page", self.main_window)
            icon = self._try_icons(
            ...
            self.actions["fit_page"].setToolTip("Fit page to window (Ctrl+0)")
