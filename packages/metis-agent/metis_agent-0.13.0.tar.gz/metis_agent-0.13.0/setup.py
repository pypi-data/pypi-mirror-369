...
setup(
    ...
    description="A comprehensive framework for building powerful AI agents with enhanced developer experience, intelligent project awareness, and enterprise-grade security",
