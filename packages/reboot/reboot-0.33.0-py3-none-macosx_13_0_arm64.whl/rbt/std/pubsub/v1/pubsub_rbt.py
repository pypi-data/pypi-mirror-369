...
class PubSubServicerTasksStub(_PubSubStub):
...
class PubSubSingletonServicer(PubSubBaseServicer):
    ...
    async def _Publish(
        ...
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Publish()",
    ...
    async def _Broker(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Broker()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
...
class PubSubServicer(PubSubBaseServicer):
    ...
    async def _Publish(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Publish()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Broker(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Broker()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
            ...
            async def Publish(
                ...
                *,
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return PubSubServicerTasksStub(
                        context=__context__,
