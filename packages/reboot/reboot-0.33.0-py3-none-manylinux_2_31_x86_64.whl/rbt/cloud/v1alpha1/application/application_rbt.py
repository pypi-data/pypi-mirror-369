...
IMPORT_reboot_versioning.check_generated_code_compatible("0.33.0")
...
class ApplicationSingletonServicer(ApplicationBaseServicer):
    ...
    async def _Create(
        ...
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Create()",
    ...
    async def _PushInfo(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.PushInfo()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Up(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Up()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
    ...
    async def _UpWorkflow(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.UpWorkflow()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
    ...
    async def _Down(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Down()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
    ...
    async def _DownWorkflow(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.DownWorkflow()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
    ...
    async def _RevisionStatus(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.RevisionStatus()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Logs(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Logs()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            responses = (
    ...
    async def _ActiveRevisions(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.ActiveRevisions()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Status(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Status()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _IsAdmin(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.IsAdmin()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
...
class ApplicationServicer(ApplicationBaseServicer):
    ...
    async def _Create(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Create()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _PushInfo(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.PushInfo()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Up(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Up()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _UpWorkflow(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.UpWorkflow()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Down(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Down()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _DownWorkflow(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.DownWorkflow()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _RevisionStatus(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.RevisionStatus()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _ActiveRevisions(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.ActiveRevisions()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Status(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Status()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _IsAdmin(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.IsAdmin()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
