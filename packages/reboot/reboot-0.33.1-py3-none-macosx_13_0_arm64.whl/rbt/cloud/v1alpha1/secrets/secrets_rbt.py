...
IMPORT_reboot_versioning.check_generated_code_compatible("0.33.1")
...
class SecretServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Write(
        ...
        *,
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.secrets.Secret.Write') {aborted}"
                        )
                elif (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Write') "
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SecretServicerTasks(
                    context=context,
                    state_ref=context._state_ref,
                ).Write(
                    request,
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.secrets.Secret.Read') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Read') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
    ...
    async def _Read(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='Read'
        )
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.secrets.Secret.Delete') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Delete') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse,
                )
        return await call()
...
class SecretBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret
        ) -> SecretBaseServicer.InlineWriterCallableResult:
            ...
    ...
    class WorkflowState:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: SecretBaseServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: SecretBaseServicer.InlineWriterCallable[SecretBaseServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[SecretBaseServicer.InlineWriterCallableResult],
        ) -> SecretBaseServicer.InlineWriterCallableResult:
            ...
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return await IMPORT_reboot_aio_workflows.at_least_once(
                        ...
                        context,
                        read,
                        type=rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret,
                    )
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: SecretBaseServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                method_name = f"Secret.{task.method_name} inline writer"
        ...
        def per_workflow(self, alias: IMPORT_typing.Optional[str] = None):
            return SecretBaseServicer.WorkflowState._Idempotently(
        ...
        class _Always:
            ...
            async def read(
                ...
                return await SecretBaseServicer.WorkflowState._Idempotently(
                    servicer=self._servicer,
                    alias=None,
        ...
        def always(self):
            return SecretBaseServicer.WorkflowState._Always(
                servicer=self._servicer,
            )
...
class SecretSingletonServicer(SecretBaseServicer):

    @property
    def state(self):
        return SecretBaseServicer.WorkflowState(
            servicer=self
        )
    ...
    async def _Write(
        ...
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Write()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.Write(context, request)
    ...
    async def _Read(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Read()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Delete(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Delete()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.Delete(context, request)




class SecretServicer(SecretBaseServicer):

    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret]
    ...
    _instances: dict[str, SecretServicer] = {}

    def _instance(self, state_id: str):
        instances = SecretServicer._instances
    ...
    @property
    def state(self) -> rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret:
        state = SecretServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = SecretServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret):
        state = SecretServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Write(
        ...
        SecretServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Write()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Write(context, request)
        finally:
            SecretServicer._workflow.set(False)
    ...
    async def _Read(
        ...
        # `_state is None`.
        assert SecretServicer._state.get() is None
        SecretServicer._state.set(state)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Read()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Read(context, request)
        finally:
            SecretServicer._state.set(None)
    ...
    async def _Delete(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Delete()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Delete(context, request)
        finally:
            SecretServicer._workflow.set(False)
...
Secret_UntilCallableType = IMPORT_typing.TypeVar('Secret_UntilCallableType')

class SecretSingleton:
    Servicer: IMPORT_typing.TypeAlias = SecretSingletonServicer
...
class Secret:
    ...
    singleton: IMPORT_typing.TypeAlias = SecretSingleton

    Effects: IMPORT_typing.TypeAlias = SecretBaseServicer.Effects
    ...
    class WeakReference(IMPORT_typing.Generic[Secret_ScheduleTypeVar]):
        ...
        def __init__(
            ...
            *,
            ...
            bearer_token: IMPORT_typing.Optional[str] = None,
            servicer: IMPORT_typing.Optional[SecretBaseServicer] = None,
        ):
                ...
                while True:
                    try:
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.cloud.v1alpha1.secrets.SecretMethods.Read' "
        ...
        class _Idempotently(IMPORT_typing.Generic[Secret_IdempotentlyScheduleTypeVar]):
            ...
            async def Read(
                ...
                return await __this__._weak_reference.Read(
                    __context__,
                    __options__,
                )
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Secret.WeakReference._Idempotently[Secret_ScheduleTypeVar]:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID, generated: bool = False) -> Secret.WeakReference._Idempotently[Secret_ScheduleTypeVar]:
            ...
        ...
        class _UntilChangesSatisfies(IMPORT_typing.Generic[Secret_UntilCallableType]):

            _idempotency_alias: str
            _context: IMPORT_reboot_aio_contexts.WorkflowContext
            _callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[Secret_UntilCallableType]]
            _type: type[Secret_UntilCallableType]
            ...
            def __init__(
                ...
                *,
                idempotency_alias: str,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[Secret_UntilCallableType]],
                type: type[Secret_UntilCallableType],
            ):
            ...
            async def satisfies(
                self,
                condition: IMPORT_typing.Callable[[Secret_UntilCallableType], bool],
            ):
        ...
        class _Until:
            ...
            _weak_reference: Secret.WeakReference
            _idempotency_alias: str
            ...
            def Read(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Secret.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
                ...
                return Secret.WeakReference._UntilChangesSatisfies(
        ...
        def until(self, alias: str):
            return Secret.WeakReference._Until(
                weak_reference=self,
            ...
            async def Write(
                ...
                *,
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return (await SecretServicerTasks(
                        context=__context__,
            ...
            *,
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'Write' is a workflow and can not be called from a '{type(__context__).__name__}'"
        ...
        async def Read(
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().Read(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                    )
        ...
        async def Delete(
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'Delete' is a workflow and can not be called from a '{type(__context__).__name__}'"
    ...
    class _Forall:
        ...
        async def Read(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
    ...
    @classmethod
    def forall(cls, ids: list[str]) -> Secret._Forall:
        return Secret._Forall(ids)
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID, generated: bool = False) -> Secret._ConstructIdempotently:
        ...
...
class SecretServicerNodeAdaptor(Secret.singleton.Servicer):
