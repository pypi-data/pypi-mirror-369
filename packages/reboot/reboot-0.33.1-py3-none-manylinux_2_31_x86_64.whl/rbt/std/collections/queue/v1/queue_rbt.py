...
class QueueSingletonServicer(QueueBaseServicer):
    ...
    async def _Enqueue(
        ...
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Enqueue()",
    ...
    async def _Dequeue(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Dequeue()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
...
class QueueServicer(QueueBaseServicer):
    ...
    async def _Enqueue(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Enqueue()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Dequeue(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Dequeue()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
        ...
        class _Idempotently(IMPORT_typing.Generic[Queue_IdempotentlyScheduleTypeVar]):
            ...
            async def Enqueue(
                ...
                *,
                ...
                items: IMPORT_typing.Optional[IMPORT_typing.Iterable[rbt.std.collections.queue.v1.queue_pb2.Item]] = None,
            ) -> rbt.std.collections.queue.v1.queue_pb2.EnqueueResponse:
                ...
                *,
                ...
                if items is not None and not isinstance(
                    ...
                    raise TypeError(
                        ...
                        f"of required type 'typing.Iterable[rbt.std.collections.queue.v1.queue_pb2.Item]'"
                    )
