...
class SubscriberAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        self._Toggle = Toggle
        self._WaitForDisconnect = WaitForDisconnect
        self._Status = Status
    ...
    async def WaitForDisconnect(
        ...
        *,
        ...
        return await (self._WaitForDisconnect or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.std.presence.subscriber.v1.subscriber_pb2.Subscriber, state),
            request=IMPORT_typing.cast(rbt.std.presence.subscriber.v1.subscriber_pb2.WaitForDisconnectRequest, request),
        )
...
class SubscriberSingletonServicer(SubscriberBaseServicer):
    ...
    async def _Connect(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Connect()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Toggle(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Toggle()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
    ...
    async def _WaitForDisconnect(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.WaitForDisconnect()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
...
class SubscriberServicer(SubscriberBaseServicer):
    ...
    async def _Connect(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Connect()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Toggle(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Toggle()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _WaitForDisconnect(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.WaitForDisconnect()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
