        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = PresenceServicerTasksStub(
                    context=context,
                    state_ref=context._state_ref,
                ).Subscribe(
                    request,
...
class PresenceServicerTasksStub(_PresenceStub):
...
class PresenceSingletonServicer(PresenceBaseServicer):
    ...
    async def _Subscribe(
        ...
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Subscribe()",
    ...
    async def _List(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.List()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Watch(
        ...
        # is traced using its fully-qualified Python name.
        with IMPORT_reboot_aio_tracing.span(
                name=f"{IMPORT_reboot_aio_tracing.full_type_name(self)}.Watch()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
...
class PresenceServicer(PresenceBaseServicer):
    ...
    async def _Subscribe(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Subscribe()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _List(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.List()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
    ...
    async def _Watch(
        ...
        try:
            ...
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    name=f"{IMPORT_reboot_aio_tracing.full_type_name(instance)}.Watch()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
            ...
            async def Subscribe(
                ...
                *,
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return PresenceServicerTasksStub(
                        context=__context__,
