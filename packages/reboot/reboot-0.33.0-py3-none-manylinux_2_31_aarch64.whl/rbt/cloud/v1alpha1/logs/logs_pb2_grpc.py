...
class ApplicationLogsMethods(object):
    ...
    def Ensure(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.cloud.v1alpha1.logs.ApplicationLogsMethods/Ensure',
    ...
    def RegisterConsensus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.cloud.v1alpha1.logs.ApplicationLogsMethods/RegisterConsensus',
    ...
    def Logs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/rbt.cloud.v1alpha1.logs.ApplicationLogsMethods/Logs',
...
class LogsProxy(object):
    ...
    def Ingest(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/rbt.cloud.v1alpha1.logs.LogsProxy/Ingest',
