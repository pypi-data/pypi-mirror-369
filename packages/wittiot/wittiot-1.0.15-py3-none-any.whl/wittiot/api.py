...
TYPE_CO2ABS_OUT =  "co2in_abs"
TYPE_CO2REL_OUT =  "co2in_rel"
TYPE_CO2TEMP_OUT = "co2in_tf"
TYPE_CO2HUMI_OUT = "co2in_humi"
...
class API:
    ...
    async def _request_loc_allinfo(self,) -> List[Dict[str, Any]]:
        ...
        if "wh25" in res_data:
            ld_co2in_tf=res_data["wh25"][0]["intemp"]
            ld_co2in_humi=res_data["wh25"][0]["inhumi"]
            ld_co2in_abs=res_data["wh25"][0]["abs"]
            ld_co2in_rel=res_data["wh25"][0]["rel"]
            ld_co2_co2_in=res_data["wh25"][0].get("CO2", "--")
            ld_co2_co224_in=res_data["wh25"][0].get("CO2_24H", "--")
        ...
        resjson={
            ...
            "co2in_abs":self.locval_topress(ld_co2in_abs,unit_press),
            "co2in_rel":self.locval_topress(ld_co2in_rel,unit_press),
            "co2in_tf":self.locval_totemp(ld_co2in_tf,unit_temp),
            "co2in_humi":self.locval_tohumi(ld_co2in_humi),
            "co2":ld_co2_co2,
