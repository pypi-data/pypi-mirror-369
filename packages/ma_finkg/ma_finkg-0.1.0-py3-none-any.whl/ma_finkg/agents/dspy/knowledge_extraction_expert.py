...
from utils import print_progress, get_elapsed_time, spinner
...
class DSPyREExpert:
    ...
    def extract_relations_by_type(self, text: str, relation_type: str, 
        ...
        head_type = relation_info.head_type
        tail_type = relation_info.tail_type
        
        head_entities = [e for e in entities if e.entity_type == head_type]
        tail_entities = [e for e in entities if e.entity_type == tail_type]
