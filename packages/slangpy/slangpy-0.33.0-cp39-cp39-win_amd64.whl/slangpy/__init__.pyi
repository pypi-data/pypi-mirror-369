...
class ComputeKernel(Kernel):
    ...
    def dispatch(self, thread_count: uint3param, vars: dict = {}, command_encoder: Optional[CommandEncoder] = None, queue: CommandQueueType = CommandQueueType.graphics, cuda_stream: NativeHandle = ..., **kwargs) -> None: ...
