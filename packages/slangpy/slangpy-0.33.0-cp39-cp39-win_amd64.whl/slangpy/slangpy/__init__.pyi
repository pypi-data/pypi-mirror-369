...
class NativeCallData(slangpy.Object):
    ...
    @logger.setter
    def logger(self, arg: Optional[slangpy.Logger]) -> None: ...
    ...
    def call_group_shape(self, arg: Optional[Shape]) -> None: ...
...
class TensorRef(NativeObject):
    ...
    @property
    def tensor(self) -> Optional[Annotated[ArrayLike, dict(device='cuda')]]:
        """N/A"""

    @tensor.setter
    def tensor(self, arg: Optional[Annotated[ArrayLike, dict(device='cuda')]]) -> None: ...
    ...
    def interop_buffer(self, arg: Optional[slangpy.Buffer]) -> None: ...
    ...
    @grad_in.setter
    def grad_in(self, arg: Optional[TensorRef]) -> None: ...
    ...
    @grad_out.setter
    def grad_out(self, arg: Optional[TensorRef]) -> None: ...
...
class StridedBufferView(NativeObject):
    ...
    def clear(self, cmd: Optional[slangpy.CommandEncoder] = None) -> None: ...

    def cursor(self, start: Optional[int] = None, count: Optional[int] = None) -> slangpy.BufferCursor: ...
...
class NativeNDBuffer(StridedBufferView):
    def __init__(self, device: slangpy.Device, desc: NativeNDBufferDesc, buffer: Optional[slangpy.Buffer] = None) -> None: ...
...
class NativeTensor(StridedBufferView):
    def __init__(self, desc: NativeTensorDesc, storage: slangpy.Buffer, grad_in: Optional[NativeTensor], grad_out: Optional[NativeTensor]) -> None: ...
    ...
    def with_grads(self, grad_in: Optional[NativeTensor] = None, grad_out: Optional[NativeTensor] = None, zero: bool = True) -> NativeTensor: ...

    def detach(self) -> NativeTensor: ...

class NativeTensorMarshall(NativeMarshall):
    def __init__(self, dims: int, writable: bool, slang_type: NativeSlangType, slang_element_type: NativeSlangType, element_layout: slangpy.TypeLayoutReflection, d_in: Optional[NativeTensorMarshall], d_out: Optional[NativeTensorMarshall]) -> None:
        """N/A"""
