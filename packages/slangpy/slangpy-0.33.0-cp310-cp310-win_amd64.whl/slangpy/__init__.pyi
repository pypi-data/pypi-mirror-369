...
build_dir: str = 'D:/a/slangpy/slangpy/build/pip/RelWithDebInfo'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 33

SGL_VERSION_PATCH: int = 0

SGL_VERSION: str = '0.33.0'

SGL_GIT_VERSION: str = 'commit: a85bf6b / branch: unknown'
...
class Feature(enum.IntEnum):
    ...
    acceleration_structure_spheres = 15

    acceleration_structure_linear_swept_spheres = 16

    ray_tracing = 17

    ray_query = 18

    shader_execution_reordering = 19

    ray_tracing_validation = 20

    timestamp_query = 21

    realtime_clock = 22

    cooperative_vector = 23

    cooperative_matrix = 24
    ...
    conservative_rasterization1 = 46

    conservative_rasterization2 = 47

    conservative_rasterization3 = 48

    programmable_sample_positions1 = 49

    programmable_sample_positions2 = 50

    shader_resource_min_lod = 51

    argument_buffer_tier2 = 52
...
class BufferCursor(Object):
    ...
    def write_from_numpy(self, data: object) -> None: ...
...
class Surface(Object):
    ...
    @property
    def config(self) -> SurfaceConfig | None:
...
class ComputeKernel(Kernel):
    ...
    def dispatch(self, thread_count: uint3param, vars: dict = {}, command_encoder: CommandEncoder | None = None, queue: CommandQueueType = CommandQueueType.graphics, cuda_stream: NativeHandle = ..., **kwargs) -> None: ...
...
class Device(Object):
    @overload
    def __init__(self, type: DeviceType = DeviceType.automatic, enable_debug_layers: bool = False, enable_cuda_interop: bool = False, enable_print: bool = False, enable_hot_reload: bool = True, enable_compilation_reports: bool = False, adapter_luid: Sequence[int] | None = None, compiler_options: SlangCompilerOptionsParam | None = None, shader_cache_path: str | os.PathLike | None = None, existing_device_handles: Sequence[NativeHandle] | None = None, label: str = '') -> None: ...
    ...
    @overload
    def create_buffer(self, size: int = 0, element_count: int = 0, struct_size: int = 0, resource_type_layout: object | None = None, format: Format = Format.undefined, memory_type: MemoryType = MemoryType.device_local, usage: BufferUsage = BufferUsage.none, default_state: ResourceState = ResourceState.undefined, label: str = '', data: ArrayLike | None = None) -> Buffer:
        """
        Create a new buffer.
