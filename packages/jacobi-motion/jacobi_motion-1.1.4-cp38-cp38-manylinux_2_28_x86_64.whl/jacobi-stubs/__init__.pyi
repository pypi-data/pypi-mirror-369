...
class RobotArm(Robot):
    """
    """
    def calculate_orientation_deviation(self, joint_position: list[float], target: typing_extensions.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)] = [0.0, 0.0, 1.0]) -> float:
        """
