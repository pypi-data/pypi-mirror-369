...
class ProcedureExecutionMetadata(_message.Message):
    __slots__ = ("title", "description", "labels", "properties", "created_by", "created_at", "updated_at", "started_at", "finished_at", "is_aborted")
    ...
    is_aborted: bool
    def __init__(self, title: _Optional[str] = ..., description: _Optional[str] = ..., labels: _Optional[_Iterable[str]] = ..., properties: _Optional[_Mapping[str, str]] = ..., created_by: _Optional[str] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., started_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., finished_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., is_aborted: bool = ...) -> None: ...
...
class ProcedureExecution(_message.Message):
    __slots__ = ("rid", "procedure_rid", "procedure_commit_id", "metadata", "graph", "variables")
    ...
    def __init__(self, rid: _Optional[str] = ..., procedure_rid: _Optional[str] = ..., procedure_commit_id: _Optional[str] = ..., metadata: _Optional[_Union[ProcedureExecutionMetadata, _Mapping]] = ..., graph: _Optional[_Union[ProcedureExecutionGraph, _Mapping]] = ..., variables: _Optional[_Mapping[str, ProcedureExecutionVariableValue]] = ...) -> None: ...
...
class SearchProcedureExecutionsResponse(_message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    procedure_executions: _containers.RepeatedCompositeFieldContainer[ProcedureExecution]
    next_page_token: str
    def __init__(self, procedure_executions: _Optional[_Iterable[_Union[ProcedureExecution, _Mapping]]] = ..., next_page_token: _Optional[str] = ...) -> None: ...
