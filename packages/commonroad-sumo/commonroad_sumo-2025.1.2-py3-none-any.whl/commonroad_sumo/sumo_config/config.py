...
class SumoConfig(DefaultConfig):
    ...
    presimulation_steps = (
        0  # number of time steps before simulation with ego vehicle starts
    )
    ...
    departure_interval_vehicles = Interval(0, 1000)
    ...
    veh_params = {
        ...
        "maxSpeed": {
            ...
            ObstacleType.MOTORCYCLE: 200 / 3.6,
        },
    }
