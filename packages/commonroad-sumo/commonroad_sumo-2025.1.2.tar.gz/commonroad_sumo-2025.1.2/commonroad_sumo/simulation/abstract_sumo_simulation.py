...
class AbstractSumoSimulation(ABC):
    ...
    def simulation_loop(self) -> None:
        ...
        try:
            # The simulation starts at -dt time step. To get all obstacles into the simulation
            # we must therefore first perform one step.
            # After this step, the simulation is at time step 0.0.
