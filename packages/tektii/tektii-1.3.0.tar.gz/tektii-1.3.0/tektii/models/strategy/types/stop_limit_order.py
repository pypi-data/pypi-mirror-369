"""Strategy stop limit order model."""
...
class StopLimitOrder(BaseModel):
    ...
    def to_broker_proto(self) -> "broker_common_pb2.StopLimitOrder":
        ...
        proto.limit_price.CopyFrom(broker_decimal_to_precise(self.limit_price))
        return proto

    @classmethod
    def from_broker_proto(cls, proto: "broker_common_pb2.StopLimitOrder") -> StopLimitOrder:
        """Create from broker service proto."""
        return cls(
            stop_price=broker_precise_to_decimal(proto.stop_price),
            limit_price=broker_precise_to_decimal(proto.limit_price),
        )
