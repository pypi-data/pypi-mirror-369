...
from broker.v1 import broker_common_pb2 as broker_pb2
...
def precise_decimal_to_decimal(precise: "broker_pb2.PreciseDecimal") -> Decimal:
...
def decimal_to_precise_decimal(value: Decimal, service: str = "strategy") -> "broker_pb2.PreciseDecimal":
    ...
    return broker_pb2.PreciseDecimal(value=scaled_value, scale=scale)


def optional_precise_decimal_to_decimal(precise: Optional["broker_pb2.PreciseDecimal"]) -> Optional[Decimal]:
