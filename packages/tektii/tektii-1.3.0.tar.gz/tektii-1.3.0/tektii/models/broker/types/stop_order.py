"""Stop order configuration model."""
...
class StopOrder(BaseModel):
    ...
    def to_proto(self) -> "broker_common_pb2.StopOrder":
    ...
    @classmethod
    def from_proto(cls, proto: "broker_common_pb2.StopOrder") -> StopOrder:
        """Create from protobuf message."""
        return cls(stop_price=precise_decimal_to_decimal(proto.stop_price))
