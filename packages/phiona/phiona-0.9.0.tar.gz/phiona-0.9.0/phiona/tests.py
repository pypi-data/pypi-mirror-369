...
track_id = add_new_file(access_token, r"C:\Users\Carl\Downloads\drive-download-20250603T085118Z-1-001\Misery Business - Paramore.mp3", 'BP', 'Paramore', '', '', '')
...
song_id = playlist_info['song_info'][-1]['id']
