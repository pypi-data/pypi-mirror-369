...
from .models import Map, Tag, Anchor, Config
from django import forms
from import_export.admin import ImportExportModelAdmin
from django_object_actions import DjangoObjectActions, action
from .services import get_map, get_anchor, get_tag, service_manager


# Register your models here.
@admin.register(Anchor)
class AnchorAdmin(DjangoObjectActions, admin.ModelAdmin):
    list_display = ("id", "name", "map", "is_online", "x", "y", "z")
    changelist_actions = ('get_anchor_button',)
    list_filter = ['is_online', "map"]
...
class MapAdmin(DjangoObjectActions, admin.ModelAdmin):
    list_display = ("id", "name", "floor", "wms", "layer_name", "bounds")
...
class ConfigAdmin(DjangoObjectActions, ImportExportModelAdmin):
