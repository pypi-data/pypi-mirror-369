...
def audited(
    operation: str | AuditOperation,
    entity_type: str,
    entity_id_param: str = "customer_id",
    capture_before_state: bool = False,
    capture_after_state: bool = False,
    before_state_extractor: Callable[..., dict[str, Any]] | None = None,
    after_state_extractor: Callable[..., dict[str, Any]] | None = None,
) -> Callable[[F], F]:
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(self: Any, *args: Any, **kwargs: Any) -> Any:
            ...
            audit_logger: AuditLogger | None = getattr(self, "audit_logger", None)
            if not audit_logger:
...
def _extract_default_after_state(result: Any) -> dict[str, Any] | None:
