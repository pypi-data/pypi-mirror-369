...
class StripeManager:
    ...
    def create_customer(
        ...
        try:
            ...
            return {
                ...
                "created": datetime.fromtimestamp(stripe_customer.created, tz=UTC),
            }
    ...
    def get_customer(self, stripe_customer_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            return {
                ...
                "created": datetime.fromtimestamp(customer.created, tz=UTC),
    ...
    def create_invoice(
        ...
        try:
            ...
            return {
                ...
                "created": datetime.fromtimestamp(invoice.created, tz=UTC).isoformat(),
    ...
    def get_invoice(self, stripe_invoice_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            return {
                ...
                "currency": invoice.currency.upper(),
                "status": invoice.status,
                "created": datetime.fromtimestamp(invoice.created, tz=UTC),
    ...
    def get_payment_intent(self, payment_intent_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            return {
                ...
                "created": datetime.fromtimestamp(intent.created, tz=UTC),
    ...
    @retry_with_backoff(**ServiceRetryConfigs.STRIPE.to_dict())
    def list_invoices(
        self, stripe_customer_id: str, limit: int = 10, starting_after: str | None = None
    ) -> list[dict[str, Any]]:
    ...
    @retry_with_backoff(**ServiceRetryConfigs.STRIPE.to_dict())
    def get_payment_method(self, stripe_customer_id: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            result = {
                ...
                "created": datetime.fromtimestamp(payment_method.created, tz=UTC),
            }
