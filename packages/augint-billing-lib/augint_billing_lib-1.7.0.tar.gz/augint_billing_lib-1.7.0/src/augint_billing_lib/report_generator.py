...
class ReportGenerator:
    ...
    def __init__(self, table_name: str | None = None, stripe_manager: Any | None = None):
    ...
    def generate_billing_report(
        ...
        period_start, period_end = get_billing_period_bounds(datetime(year, month, 1, tzinfo=UTC))
    ...
    def generate_customer_summary(
        ...
        summary["generated_at"] = datetime.now(UTC).isoformat()  # type: ignore[assignment]
