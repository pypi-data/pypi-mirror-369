...
class TestPaymentProfileSorting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.payment_profiles = [
            {"sys_id": 1, "email_address": "test1@example.com", "card_number": "1234", "expiration_date": "2024-12", "status": "active"},
            {"sys_id": 2, "email_address": "test1@example.com", "card_number": "1234", "expiration_date": "2024-06", "status": "active"},
            {"sys_id": 3, "email_address": "test1@example.com", "card_number": "1234", "expiration_date": None, "status": "active"},
            {"sys_id": 4, "email_address": "test1@example.com", "card_number": "1234", "expiration_date": "2025-01", "status": "active"},
            {"sys_id": 5, "email_address": "test1@example.com", "card_number": "1234", "expiration_date": None, "status": "active"},
        ]
    ...
    def test_original_error_reproduction(self):
        ...
        self.assertIn("'<' not supported between instances of 'NoneType'", str(context.exception))
    ...
    def test_safe_sorting_with_none_last(self):
        ...
        non_none_dates = [p["expiration_date"] for p in sorted_profiles if p["expiration_date"] is not None]
        self.assertEqual(non_none_dates, ["2024-06", "2024-12", "2025-01"])
        
        # Check that None values come last
        none_dates = [p["expiration_date"] for p in sorted_profiles if p["expiration_date"] is None]
