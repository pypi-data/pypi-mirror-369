...
class TestDatabaseUtils(unittest.TestCase):
    ...
    def test_safe_sort_rows_with_default(self):
        ...
        sorted_data = safe_sort_rows(self.sample_data, "date", 
                                   none_handling="default", default_value="1900-01")
    ...
    def test_payment_profile_scenario(self):
        ...
        payment_profiles = [
            {"sys_id": 1, "email_address": "test@example.com", "card_number": "1234", 
             "expiration_date": "2024-12", "status": "active"},
            {"sys_id": 2, "email_address": "test@example.com", "card_number": "1234", 
             "expiration_date": "2024-06", "status": "active"},
            {"sys_id": 3, "email_address": "test@example.com", "card_number": "1234", 
             "expiration_date": None, "status": "active"},
            {"sys_id": 4, "email_address": "other@example.com", "card_number": "5678", 
             "expiration_date": "2025-01", "status": "active"},
            {"sys_id": 5, "email_address": "other@example.com", "card_number": "5678", 
             "expiration_date": None, "status": "active"},
        ]
