"""
Setup script for mypy-boto3-arc-region-switch.
...
setup(
    ...
    version="1.40.10",
    packages=["mypy_boto3_arc_region_switch"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 ARCRegionswitch 1.40.10 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"mypy_boto3_arc_region_switch": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
