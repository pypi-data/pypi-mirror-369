<a id="mypy-boto3-arc-region-switch"></a>
...
[boto3 ARCRegionswitch 1.40.10](https://pypi.org/project/boto3/) compatible
...
- Install `boto3-stubs[arc-region-switch]` in your environment:
...
- Install `boto3-stubs[arc-region-switch]` with services you use in your
  environment:
...
`mypy-boto3-arc-region-switch` dependency in production. However, there is an
...
`mypy_boto3_arc_region_switch.paginator` module contains type annotations for
all paginators.
...
`mypy_boto3_arc_region_switch.waiter` module contains type annotations for all
waiters.
...
`mypy_boto3_arc_region_switch.literals` module contains literals extracted from
shapes that can be used in user code for type checking.

Full list of `ARCRegionswitch` Literals can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_arc_region_switch/literals/).
...
`mypy_boto3_arc_region_switch.type_defs` module contains structures and shapes
assembled to typed dictionaries and unions for additional type checking.

Full list of `ARCRegionswitch` TypeDefs can be found in
[docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_arc_region_switch/type_defs/).
...
`mypy-boto3-arc-region-switch` version is the same as related `boto3` version
and follows
...
[boto3 docs](https://youtype.github.io/boto3_stubs_docs/mypy_boto3_arc_region_switch/)
