...
class TokenizationContractCallParamsData(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = TokenizationContractCallParamsData.model_construct()
        error_messages = []
        match = 0
        # validate data type: TokenizationEvmContractCallParams
        if not isinstance(v, TokenizationEvmContractCallParams):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        return instance
        # deserialize data into TokenizationEvmContractCallParams
        try:
            instance.actual_instance = TokenizationEvmContractCallParams.from_json(json_str)
            match += 1
