...
class TokenizationBurnEstimateFeeParams(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["source", "burns", "operation_type", "token_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in burns (list)
        _items = []
        if self.burns:
            for _item in self.burns:
                if _item:
