...
class SettlementDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currency", "token_id", "chain_id", "merchant_id", "amount", "settled_amount", "status", "bank_account", "transactions", "created_timestamp", "updated_timestamp", "crypto_address_id", "payout_channel", "acquiring_type", "settlement_request_id", "order_ids"]
