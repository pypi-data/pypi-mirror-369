...
class TokenizationTokenPermissionParams(BaseModel):
    ...
    burner: Optional[List[StrictStr]] = Field(default=None, description="List of addresses for the burner role.")
    ...
    __properties: ClassVar[List[str]] = ["admin", "minter", "burner", "manager", "pauser", "salvager", "upgrader"]
