...
class TokenizationMintEstimateFeeParams(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in mints (list)
        _items = []
        if self.mints:
            for _item in self.mints:
                if _item:
