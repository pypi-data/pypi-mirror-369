...
class StatementItem(BaseModel):
    ...
    hold: bool
    amount: float
    operation_amount: int = Field(validation_alias='operationAmount')
    currency_code: int = Field(validation_alias='currencyCode')
    commission_rate: int = Field(validation_alias='commissionRate')
    cashback_amount: int = Field(validation_alias='cashbackAmount')
    balance: float
    comment: str = None
