...
class Credentials:
    ...
    def __init__(self, client_id: str, client_secret: str, token_url: str):
        ...
        self.audience = os.getenv("CRIBLMGMTPLANE_AUDIENCE", "https://publicapi.cribl.cloud") # Set default audience here
...
class ClientCredentialsHook(SDKInitHook, BeforeRequestHook, AfterErrorHook):
    ...
    def get_credentials(self, hook_ctx: HookContext) -> Optional[Credentials]:
        ...
        if hook_ctx.operation_id == "v1.workspaces.createWorkspace":
            return self.get_credentials_v1_workspaces_create_workspace(security)
        if hook_ctx.operation_id == "v1.workspaces.listWorkspaces":
            return self.get_credentials_v1_workspaces_list_workspaces(security)
        if hook_ctx.operation_id == "v1.workspaces.updateWorkspace":
            return self.get_credentials_v1_workspaces_update_workspace(security)
        if hook_ctx.operation_id == "v1.workspaces.deleteWorkspace":
            return self.get_credentials_v1_workspaces_delete_workspace(security)
        if hook_ctx.operation_id == "v1.workspaces.getWorkspace":
            return self.get_credentials_v1_workspaces_get_workspace(security)
    ...
    def get_credentials_v1_workspaces_create_workspace(
        self, security: Any
    ...
    def get_credentials_v1_workspaces_list_workspaces(
        self, security: Any
    ) -> Optional[Credentials]:
        if security is None or security.oauth2 is None:
            return None
    ...
    def get_credentials_v1_workspaces_update_workspace(
        self, security: Any
    ) -> Optional[Credentials]:
        if security is None or security.oauth2 is None:
            return None
    ...
    def get_credentials_v1_workspaces_delete_workspace(
        self, security: Any
    ) -> Optional[Credentials]:
        if security is None or security.oauth2 is None:
            return None
    ...
    def get_credentials_v1_workspaces_get_workspace(
        self, security: Any
    ) -> Optional[Credentials]:
        if security is None or security.oauth2 is None:
            return None
