...
def _write_canonical_splits(sup: SalesUniversePair, settings: dict, verbose: bool=False):
    ...
    if verbose:
        ...
        print(f"Checking A = ")
        print(df_sales_in["sale_year"].value_counts())
    ...
    if verbose:
        ...
        print(f"Checking = ")
        print(df_sales["sale_year"].value_counts())
...
def _perform_canonical_split(
    ...
    print(f"Look back date = {look_back_date}")
    ...
    print(f"Sale years vacant = ")
    print(df_v["sale_year"].value_counts())

    print(f"Sale years improved = ")
    print(df_i["sale_year"].value_counts())
    ...
    if verbose:
        ...
        print(f"----> Test set years:")
        print(df_test["sale_year"].value_counts())
