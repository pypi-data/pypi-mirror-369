...
class AlertsRequest(_message.Message):
    __slots__ = ("tenant", "meters", "skip", "limit")
    ...
    skip: int
    limit: int
    def __init__(self, tenant: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., meters: _Optional[_Iterable[str]] = ..., skip: _Optional[int] = ..., limit: _Optional[int] = ...) -> None: ...
