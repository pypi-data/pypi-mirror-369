...
async def list_parsers_api_v1_parsers__get(
...
async def register_parser_api_v1_parsers_register_post(
...
async def get_parser_api_v1_parsers__parser_id__get(
...
async def delete_parser_api_v1_parsers__parser_id__delete(
    parser_id: str, authorization: Optional[str] = None, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def execute_parser_command_api_v1_parsers__parser_id__commands_post(
    parser_id: str,
...
async def get_parser_status_api_v1_parsers__parser_id__status_get(
    parser_id: str, authorization: Optional[str] = None, api_config_override: Optional[APIConfig] = None
) -> SuccessResponse:
    api_config = api_config_override if api_config_override else APIConfig()
