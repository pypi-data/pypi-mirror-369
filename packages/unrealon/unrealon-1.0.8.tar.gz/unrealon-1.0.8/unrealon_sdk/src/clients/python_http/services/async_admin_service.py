...
async def broadcast_message_api_v1_admin_broadcast_post(
...
async def manage_maintenance_mode_api_v1_admin_maintenance_post(
...
async def get_maintenance_status_api_v1_admin_maintenance_status_get(
...
async def get_admin_service_stats_api_v1_admin_stats_get(
    authorization: Optional[str] = None, api_config_override: Optional[APIConfig] = None
