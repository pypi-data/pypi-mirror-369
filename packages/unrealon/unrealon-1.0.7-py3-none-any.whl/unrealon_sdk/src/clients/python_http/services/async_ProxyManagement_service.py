...
async def list_proxies_api_v1_proxies__get(
...
async def cleanup_expired_proxies_api_v1_proxies_maintenance_cleanup_post(
...
async def sync_proxies_api_v1_proxies_maintenance_sync_get(
    authorization: Optional[str] = None, api_config_override: Optional[APIConfig] = None
) -> SuccessResponse:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def purchase_proxies_api_v1_proxies_procurement_purchase_post(
...
async def report_blocked_proxy_api_v1_proxies_rotation_block_post(
...
async def request_proxy_rotation_api_v1_proxies_rotation_request_post(
...
async def get_proxy_statistics_api_v1_proxies_statistics_get(
    authorization: Optional[str] = None, api_config_override: Optional[APIConfig] = None
) -> Dict[str, Any]:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_proxy_details_api_v1_proxies__proxy_id__get(
...
async def record_proxy_usage_api_v1_proxies__proxy_id__usage_post(
    proxy_id: str,
