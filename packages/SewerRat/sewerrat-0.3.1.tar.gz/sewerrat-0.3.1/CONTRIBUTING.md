...
Welcome to `SewerRat` contributor's guide.
...
If you experience bugs or general issues with `SewerRat`, please have a look
...
You can help improve `SewerRat` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`SewerRat` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `SewerRat`'s files. While this mechanism can
...
```
conda create -n SewerRat python=3 six virtualenv pytest pytest-cov
conda activate SewerRat
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/SewerRat.git
   cd SewerRat
   ```
...
5. Install [pre-commit]:
   ...
   `SewerRat` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/SewerRat
[issue tracker]: https://github.com/<USERNAME>/SewerRat/issues
