...
class SimulatorJob(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_insight_agent", b"_insight_agent", "_test_suite", b"_test_suite", "insight_agent", b"insight_agent", "test_suite", b"test_suite"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_insight_agent", b"_insight_agent", "_test_suite", b"_test_suite", "agent", b"agent", "id", b"id", "inputs", b"inputs", "insight_agent", b"insight_agent", "test_suite", b"test_suite"]) -> None: ...
    @typing.overload
