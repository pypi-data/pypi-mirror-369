...
class CloudHelper:
    ...
    def upload_to_cloud(self, bucket_name, file_name, file_type=None):
        ...
        if self.path:
            ...
            if file_type == "csv":
                ...
                blob.upload_from_string(pkl.dumps(self.obj), content_type="application/octet-stream")
    ...
    def download_from_cloud(self, gs_filepath, file_type=None, use_polars: bool = False):
        """
        ...
        try:
            ...
            if not blob.exists():
                warnings.warn(f"File not found @ {gs_filepath}. Returning empty DataFrame.")
