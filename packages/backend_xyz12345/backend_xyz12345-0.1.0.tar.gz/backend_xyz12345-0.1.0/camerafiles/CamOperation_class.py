...
class CameraOperation:
    ...
    def __init__(self, obj_cam, st_device_list, n_connect_num=0, b_open_device=False, b_start_grabbing=False,
        ...
        self.gain = gain
        self.trigger_instance = 'TriggerMode'
    ...
    def Open_device(self):
        if not self.b_open_device:
            ...
            ret = self.obj_cam.MV_CC_SetEnumValue("TriggerMode", MV_TRIGGER_MODE_ON)#MV_TRIGGER_MODE_OFF)
            if ret != 0:
    ...
    def Set_trigger_mode(self, is_trigger_mode, hardware_trigger = False):
        ...
        if 'continous' == is_trigger_mode:
            self.trigger_instance = 'continous'
    ...
    def Work_thread(self, winHandle):
        ...
        while True:
            ...
            if None != stOutFrame.pBufAddr:
                ...
                # numArray = cv2.rotate(numArray,cv2.ROTATE_90_COUNTERCLOCKWISE)
