        ...
        **kwargs,
        ...
        try:
            request_model = GetAdCountListRequest(
                ...
                # 媒体和投手参数
                media=self._get_api_value("media", media) or [],
                toushou=self._get_api_value("media_buyers", media_buyers) or [],
                # 账户和状态参数
                self_cid=cids or [],
                ad_status=self._get_api_value("ad_statuses", ad_statuses) or [],
                # 创意和广告组参数
