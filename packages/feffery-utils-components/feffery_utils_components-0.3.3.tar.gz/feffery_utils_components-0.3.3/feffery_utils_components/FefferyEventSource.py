...
- errorEvent (dict; optional):
    ...
    def __init__(
        ...
        events: typing.Optional[typing.Sequence[str]] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'key', 'url', 'events', 'immediate', 'autoReconnect', 'status', 'data', 'event', 'operation', 'errorEvent']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'key', 'url', 'events', 'immediate', 'autoReconnect', 'status', 'data', 'event', 'operation', 'errorEvent']
...
setattr(FefferyEventSource, "__init__", _explicitize_args(FefferyEventSource.__init__))
