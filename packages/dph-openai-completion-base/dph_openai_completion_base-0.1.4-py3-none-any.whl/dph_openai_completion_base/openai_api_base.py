...
from openai.types.shared_params.response_format_json_schema import ResponseFormatJSONSchemaBase

class ResponseFormatJSONSchema(ResponseFormatJSONSchemaBase):
    def __init__(self, schema):
        super().__init__(type="json_schema", json_schema=schema)
