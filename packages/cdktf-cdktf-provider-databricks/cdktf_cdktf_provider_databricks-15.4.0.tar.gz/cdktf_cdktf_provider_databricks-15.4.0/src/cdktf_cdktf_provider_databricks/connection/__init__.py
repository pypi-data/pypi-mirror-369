...
class Connection(
    ...
    def __init__(
        ...
        *,
        ...
        environment_settings: typing.Optional[typing.Union["ConnectionEnvironmentSettings", typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        :param comment: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#comment Connection#comment}.
        :param connection_type: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#connection_type Connection#connection_type}.
        :param environment_settings: environment_settings block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#environment_settings Connection#environment_settings}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#id Connection#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#name Connection#name}.
        :param options: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#options Connection#options}.
        :param owner: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#owner Connection#owner}.
        :param properties: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#properties Connection#properties}.
        :param read_only: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#read_only Connection#read_only}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Connection that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#import import section} in the documentation of this resource for the id to use
    ...
    @jsii.member(jsii_name="putEnvironmentSettings")
    def put_environment_settings(
        ...
        *,
        ...
        '''
        :param environment_version: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#environment_version Connection#environment_version}.
        :param java_dependencies: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.87.1/docs/resources/connection#java_dependencies Connection#java_dependencies}.
        '''
        value = ConnectionEnvironmentSettings(
            environment_version=environment_version,
            java_dependencies=java_dependencies,
        )

        return typing.cast(None, jsii.invoke(self, "putEnvironmentSettings", [value]))
    ...
    @jsii.member(jsii_name="resetEnvironmentSettings")
    def reset_environment_settings(self) -> None:
        return typing.cast(None, jsii.invoke(self, "resetEnvironmentSettings", []))
    ...
    @builtins.property
    @jsii.member(jsii_name="environmentSettings")
    def environment_settings(self) -> "ConnectionEnvironmentSettingsOutputReference":
        return typing.cast("ConnectionEnvironmentSettingsOutputReference", jsii.get(self, "environmentSettings"))
    ...
    @builtins.property
    @jsii.member(jsii_name="environmentSettingsInput")
    def environment_settings_input(
        self,
    ) -> typing.Optional["ConnectionEnvironmentSettings"]:
        return typing.cast(typing.Optional["ConnectionEnvironmentSettings"], jsii.get(self, "environmentSettingsInput"))
...
class ConnectionConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if isinstance(environment_settings, dict):
            environment_settings = ConnectionEnvironmentSettings(**environment_settings)
        if __debug__:
            ...
            check_type(argname="argument environment_settings", value=environment_settings, expected_type=type_hints["environment_settings"])
        ...
        if environment_settings is not None:
            self._values["environment_settings"] = environment_settings
        if id is not None:
            self._values["id"] = id
        if name is not None:
    ...
    @builtins.property
    def environment_settings(self) -> typing.Optional["ConnectionEnvironmentSettings"]:
        ...
        '''
        result = self._values.get("environment_settings")
        return typing.cast(typing.Optional["ConnectionEnvironmentSettings"], result)
...
@jsii.data_type(
    jsii_type="@cdktf/provider-databricks.connection.ConnectionEnvironmentSettings",
    jsii_struct_bases=[],
    name_mapping={
...
class ConnectionEnvironmentSettings:
    def __init__(
        self,
        *,
        environment_version: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2da360c4bbca10c134daad29794d0f4c60d2aefb14856ec7cb120d0b9d70e9b8)
    ...
    def __repr__(self) -> str:
        return "ConnectionEnvironmentSettings(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class ConnectionEnvironmentSettingsOutputReference(
    _cdktf_9a9027ec.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@cdktf/provider-databricks.connection.ConnectionEnvironmentSettingsOutputReference",
):
    def __init__(
        self,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b147104fdd357784ccdb07384bb019808381931cd399cf9009e3dce47e3762f2)
    ...
    def environment_version(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__327701309e1a4a13c8ac1fb89e9652af3552d6506bcb902acbc305d79534a2f7)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def java_dependencies(self, value: typing.List[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__a71db5bb826f8545a9c166dcb9843890dacabd8035b4a7fd7ef5edec53b082eb)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "javaDependencies", value) # pyright: ignore[reportArgumentType]

    @builtins.property
    @jsii.member(jsii_name="internalValue")
    def internal_value(self) -> typing.Optional[ConnectionEnvironmentSettings]:
        return typing.cast(typing.Optional[ConnectionEnvironmentSettings], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[ConnectionEnvironmentSettings],
    ) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__41b5f4592dbda47d49d910a4dd71ac098a99a35b048fea4c06a6d2779a0f184d)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
__all__ = [
    ...
    "ConnectionEnvironmentSettingsOutputReference",
...
def _typecheckingstub__2da360c4bbca10c134daad29794d0f4c60d2aefb14856ec7cb120d0b9d70e9b8(
    *,
    environment_version: typing.Optional[builtins.str] = None,
    java_dependencies: typing.Optional[typing.Sequence[builtins.str]] = None,
) -> None:
...
def _typecheckingstub__b147104fdd357784ccdb07384bb019808381931cd399cf9009e3dce47e3762f2(
    terraform_resource: _cdktf_9a9027ec.IInterpolatingParent,
    terraform_attribute: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__327701309e1a4a13c8ac1fb89e9652af3552d6506bcb902acbc305d79534a2f7(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__a71db5bb826f8545a9c166dcb9843890dacabd8035b4a7fd7ef5edec53b082eb(
    value: typing.List[builtins.str],
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__41b5f4592dbda47d49d910a4dd71ac098a99a35b048fea4c06a6d2779a0f184d(
    value: typing.Optional[ConnectionEnvironmentSettings],
) -> None:
    """Type checking stubs"""
    pass
