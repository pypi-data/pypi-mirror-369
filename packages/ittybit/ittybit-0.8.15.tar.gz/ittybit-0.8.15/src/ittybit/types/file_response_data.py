...
from .file_response_data_kind import FileResponseDataKind
from .file_response_data_object import FileResponseDataObject
from .file_response_data_status import FileResponseDataStatus


class FileResponseData(UncheckedBaseModel):
    id: str
    media_id: str
