...
from ..types.automations_list_response_meta_type import AutomationsListResponseMetaType


class AutomationsListResponseMetaParams(typing_extensions.TypedDict):
    ...
    type: typing_extensions.NotRequired[AutomationsListResponseMetaType]
