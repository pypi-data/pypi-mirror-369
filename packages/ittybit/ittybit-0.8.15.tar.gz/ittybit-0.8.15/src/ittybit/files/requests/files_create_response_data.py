...
from ..types.files_create_response_data_kind import FilesCreateResponseDataKind
from ..types.files_create_response_data_object import FilesCreateResponseDataObject
from ..types.files_create_response_data_status import FilesCreateResponseDataStatus


class FilesCreateResponseDataParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesCreateResponseDataObject
    kind: FilesCreateResponseDataKind
    type: str
    ...
    created: dt.datetime
    updated: dt.datetime
    status: FilesCreateResponseDataStatus
