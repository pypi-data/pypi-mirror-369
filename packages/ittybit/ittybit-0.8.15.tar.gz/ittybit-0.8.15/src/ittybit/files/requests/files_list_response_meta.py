...
from ..types.files_list_response_meta_type import FilesListResponseMetaType


class FilesListResponseMetaParams(typing_extensions.TypedDict):
    ...
    type: typing_extensions.NotRequired[FilesListResponseMetaType]
