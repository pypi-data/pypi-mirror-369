...
from ..types.files_update_response_data_kind import FilesUpdateResponseDataKind
from ..types.files_update_response_data_object import FilesUpdateResponseDataObject
from ..types.files_update_response_data_status import FilesUpdateResponseDataStatus


class FilesUpdateResponseDataParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesUpdateResponseDataObject
    kind: FilesUpdateResponseDataKind
    type: str
    ...
    created: dt.datetime
    updated: dt.datetime
    status: FilesUpdateResponseDataStatus
