...
from ..types.files_list_response_data_item_kind import FilesListResponseDataItemKind
from ..types.files_list_response_data_item_object import FilesListResponseDataItemObject
from ..types.files_list_response_data_item_status import FilesListResponseDataItemStatus


class FilesListResponseDataItemParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesListResponseDataItemObject
    kind: FilesListResponseDataItemKind
    type: str
    ...
    created: dt.datetime
    updated: dt.datetime
    status: FilesListResponseDataItemStatus
