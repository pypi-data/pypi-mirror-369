...
from ..types.files_get_response_data_object import FilesGetResponseDataObject
from ..types.files_get_response_data_status import FilesGetResponseDataStatus


class FilesGetResponseDataParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FilesGetResponseDataObject
    ...
    created: dt.datetime
    updated: dt.datetime
    status: FilesGetResponseDataStatus
