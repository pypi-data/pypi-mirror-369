...
from ..types.file_response_data_kind import FileResponseDataKind
from ..types.file_response_data_object import FileResponseDataObject
from ..types.file_response_data_status import FileResponseDataStatus


class FileResponseDataParams(typing_extensions.TypedDict):
    id: str
    media_id: str
    object: FileResponseDataObject
    kind: FileResponseDataKind
    type: str
