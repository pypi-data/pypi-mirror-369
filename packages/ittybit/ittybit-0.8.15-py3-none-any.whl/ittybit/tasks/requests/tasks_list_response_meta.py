...
from ..types.tasks_list_response_meta_type import TasksListResponseMetaType


class TasksListResponseMetaParams(typing_extensions.TypedDict):
    ...
    type: typing_extensions.NotRequired[TasksListResponseMetaType]
