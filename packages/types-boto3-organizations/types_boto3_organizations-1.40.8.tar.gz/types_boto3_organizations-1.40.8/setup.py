"""
Setup script for types-boto3-organizations.
...
setup(
    ...
    description="Type annotations for boto3 Organizations 1.40.8 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"types_boto3_organizations": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
