...
class MithrilProvider(IProvider):
    ...
    def __init__(
        ...
        try:
            ...
            try:
                # Attach resolver to task service for initial Task builds
                self._task_service._ssh_resolver = self._ssh_endpoint_resolver  # type: ignore[attr-defined]
            except Exception:
                pass
        except Exception:
    ...
    def submit_task(
        ...
        try:
            ...
            if self._pricing.is_price_validation_error(e):
                ...
                # Delegate to TaskService for instance type name resolution
                instance_name = self._task_service._get_instance_type_name(instance_type_id)
    ...
    def get_task_status(self, task_id: str) -> TaskStatus:
        ...
        # Delegate to TaskService for robust status mapping
        return self._task_service._map_mithril_status_to_enum(mithril_status)
