...
Currently supports API key authentication (via the `MITHRIL_API_KEY` environment
variable or configured provider settings).
"""
...
class Authenticator:
    ...
    def authenticate(self) -> str:
        ...
        raise AuthenticationError(
            "No valid authentication method available. Set MITHRIL_API_KEY."
        )
