    ...
    def call_detector(cls, images, params):
        ...
        for image, image_path in images:
            ...
            if resize_h < target_h:
                ...
                image_resized = cv2.copyMakeBorder(img, 0, pad_bottom, 0, 0, cv2.BORDER_CONSTANT, value=(255, 255, 255))
            if resize_w < target_w:
                pad_right = target_w - resize_w
                image_resized = cv2.copyMakeBorder(img, 0, 0, 0, pad_right, cv2.BORDER_CONSTANT, value=(255, 255, 255))
