...
class DetResizeForTest(object):
    ...
    def resize_image_type13(self, img):
    ...
    def resize_image_type1(self, img):
        ...
        if self.keep_ratio:
            ...
            resize_h = int(ori_h * scale)
            resize_w = int(ori_w * scale)
            ...
            if resize_w < target_w:
                ...
                img = cv2.copyMakeBorder(img, 0, 0, 0, pad_right, cv2.BORDER_CONSTANT, value=(255,255,255))
            ratio_h =  ratio_w = scale
        else:
            img = cv2.resize(img, (target_w, target_h))
            ratio_h = target_h / ori_h
            ratio_w = target_w / ori_w
        print(f"resize_image_type1: {ratio_h}, { ratio_w}")
        return img, [ratio_h, ratio_w]
