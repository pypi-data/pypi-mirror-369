...
class PredictBase(object):
    ...
    def get_onnx_session(self, model_dir, use_gpu):
        # 使用gpu
        if use_gpu:
            providers = ['CUDAExecutionProvider']#[('CUDAExecutionProvider',{"cudnn_conv_algo_search": "DEFAULT"})]#,'CPUExecutionProvider']
        else:
            providers =['CPUExecutionProvider']

        session_options = onnxruntime.SessionOptions()
        session_options.intra_op_num_threads = 1  # Set number of CPU cores
