...
class TransformerEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.fc = nn.Sequential(
            NN_FCBNRL_MM(hidden_size, dim_high, use_RL=False),
        )

    def network_single(self, num_input_dim, hidden_size, num_layers, dim_high=500, nn_type='nn'):
        """
        ...
        if nn_type == 'resnet':
            ...
            layers.append(NN_FCBNRL_MM(hidden_size, dim_high, use_RL=False))
...
class DMTEVT_model(LightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        dim_high = self.hparams.dim_high
        ...
        self.vis = self.InitNetworkMLP(
            NS=[dim_high*num_use_moe, 500, vis_dim],
            last_relu=False, use_DO=False)
        # Embedding layer for experts
        self.exp = nn.Embedding(self.hparams.num_use_moe, dim_high)
