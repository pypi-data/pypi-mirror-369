...
def load_lightning_ckpt_into_model(model, ckpt_path, device):
...
class DMTLearn:
    ...
    def ckpt_transform(self, data, ckpt, neighbors_index=None, return_high_dim=False):
        ...
        # print('start fit')
        # self.fit(dm)
        self.model = load_lightning_ckpt_into_model(self.model, ckpt, self.device)
