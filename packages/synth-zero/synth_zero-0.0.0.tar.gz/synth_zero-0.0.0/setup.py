...
version_file = 'synth_zero/version.py'
...
if __name__ == '__main__':
    ...
    setup(
        ...
        version=get_version(),
        description=
        'Synth-Zero: Synthetic Data Generation & Multi-Step RL for Reasoning & Tool Use',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='wangxingjun778',
        author_email='wangxingjun778@163.com',
        keywords='Synthetic Data, Reinforcement Learning, Tool Learning, LLM, Multimodal',
        url='https://github.com/wangxingjun778/Synth-Zero',
        ...
        entry_points={
            'console_scripts': ['synth-zero=synth_zero.cli.cli:run_cmd']
        },
