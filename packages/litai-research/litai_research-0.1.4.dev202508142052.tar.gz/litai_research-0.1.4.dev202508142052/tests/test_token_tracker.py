...
class TestTokenTracker:
    ...
    def test_token_tracker_initialization(self, token_tracker: TokenTracker, config: Config) -> None:
    ...
    def test_session_summary(self, token_tracker: TokenTracker) -> None:
        ...
        assert summary == {"total": 0, "small_model": 0, "large_model": 0, "requests": 0}
    ...
    def test_persistent_storage(self, token_tracker: TokenTracker, config: Config) -> None:
    ...
    def test_track_usage_error_handling(self, token_tracker: TokenTracker, monkeypatch) -> None:
