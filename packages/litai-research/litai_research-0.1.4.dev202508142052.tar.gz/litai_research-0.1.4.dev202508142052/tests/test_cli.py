...
from litai.cli import add_paper, clear_search_results, find_papers, list_papers, show_search_results
...
class TestCumulativeSearch:
    ...
    def test_show_search_results_backward_compatibility(self, sample_papers, capsys):
        ...
        assert "Search History:" not in captured.out  # No history shown without metadata
