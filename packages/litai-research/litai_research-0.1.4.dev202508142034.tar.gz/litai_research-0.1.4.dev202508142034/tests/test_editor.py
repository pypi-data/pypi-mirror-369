...
class TestEditorConfiguration:
    ...
    def test_set_editor_invalid(self, config: Config) -> None:
        ...
        with patch('litai.editor.validate_editor', return_value=False):
            with pytest.raises(ValueError, match="Editor 'invalid' is not supported or not available"):
...
class TestEditorOpening:
    ...
    def test_open_in_editor_file_not_exists(self, temp_dir: Path, config: Config) -> None:
    ...
    def test_open_in_editor_command_not_found(self, test_file: Path, config: Config) -> None:
    ...
    def test_open_in_editor_subprocess_error(self, test_file: Path, config: Config) -> None:
    ...
    def test_open_in_editor_with_args(self, test_file: Path, config: Config) -> None:
        ...
        with patch('subprocess.run', return_value=mock_result) as mock_run:
            with patch('shutil.which', return_value="/usr/bin/code"):
                ...
                mock_run.assert_called_once_with(["code", "--wait", str(test_file)], check=True)
    
    def test_open_in_editor_custom_editor(self, test_file: Path, config: Config) -> None:
        ...
        with patch('subprocess.run', return_value=mock_result) as mock_run:
            with patch('shutil.which', return_value="/usr/bin/custom-editor"):
                ...
                mock_run.assert_called_once_with(["custom-editor", str(test_file)], check=True)
    
    def test_open_in_editor_custom_editor_not_found(self, test_file: Path, config: Config) -> None:
...
class TestEditorFallback:
    ...
    def test_open_in_editor_with_fallback_success(self, test_file: Path, config: Config) -> None:
    ...
    def test_open_in_editor_with_fallback_nano(self, test_file: Path, config: Config) -> None:
    ...
    def test_open_in_editor_with_fallback_vi(self, test_file: Path, config: Config) -> None:
    ...
    def test_open_in_editor_with_fallback_all_fail(self, test_file: Path, config: Config) -> None:
    ...
    def test_open_in_editor_with_fallback_nano_fails(self, test_file: Path, config: Config) -> None:
