...
class TestTimedOperation:
    ...
    def test_timed_operation_basic_usage(self, caplog):
        ...
        timing_records = [r for r in caplog.records if "operation_timing" in str(r.message)]
    ...
    def test_timed_operation_without_threshold(self, caplog):
        ...
        timing_records = [r for r in debug_records if "operation_timing" in str(r.message)]
    ...
    def test_timed_operation_with_threshold_under_limit(self, caplog):
        ...
        with caplog.at_level("DEBUG"), timed_operation("under_threshold", threshold_ms=100.0):
        ...
        timing_records = [r for r in debug_records if "operation_timing" in str(r.message)]
        slow_records = [r for r in warning_records if "slow_operation" in str(r.message)]
    ...
    def test_timed_operation_with_threshold_over_limit(self, caplog):
        ...
        with caplog.at_level("DEBUG"), timed_operation("over_threshold", threshold_ms=10.0):
    ...
    def test_timed_operation_logs_on_exception(self, caplog):
        ...
        with caplog.at_level("DEBUG"), pytest.raises(ValueError), timed_operation("failing_operation"):
            time.sleep(0.01)
    ...
    def test_timed_operation_exception_with_threshold_exceeded(self, caplog):
        ...
        with caplog.at_level("DEBUG"), pytest.raises(ValueError), timed_operation("slow_failing_operation", threshold_ms=10.0):
    ...
    def test_timed_operation_zero_threshold_logs_debug(self, caplog):
        ...
        with caplog.at_level("DEBUG"), timed_operation("zero_threshold", threshold_ms=0.0):
            time.sleep(0.001)
