...
class TokenTracker:
    ...
    def track_usage(self, usage: TokenUsage) -> None:
        ...
        try:
            ...
            logger.debug("token_usage_tracked", 
                        model=usage.model,
    ...
    def get_session_summary(self) -> dict[str, int]:
        ...
        small_total = sum(u.input_tokens + u.output_tokens 
                         for u in self.session_usage if u.model_size == "small")
        large_total = sum(u.input_tokens + u.output_tokens 
                         for u in self.session_usage if u.model_size == "large")
    ...
    def _load_stats(self) -> TokenStats:
        ...
        try:
            ...
            logger.info("token_stats_loaded", 
                       total_tokens=stats.total_tokens,
                       total_requests=stats.total_requests)
            return stats
        except Exception as e:
            logger.error("failed_to_load_token_stats", error=str(e), using_defaults=True)
            return TokenStats()
    ...
    def _save_stats(self) -> None:
        ...
        try:
            ...
            logger.debug("token_stats_saved", 
