...
class StandardCapabilityName(str, Enum):
    """
    Enum representing the standard capabilities we expect most connectors to provide.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of StandardCapabilityName from a JSON string"""
