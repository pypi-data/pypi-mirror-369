...
class ApplicationAccount(BaseModel):
    """
    Model containing information about an application an account has access to
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationAccount from a dict"""
        if obj is None:
            return None
