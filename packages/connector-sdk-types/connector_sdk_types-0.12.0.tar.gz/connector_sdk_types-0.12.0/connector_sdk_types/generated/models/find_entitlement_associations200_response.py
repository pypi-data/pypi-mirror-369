...
FINDENTITLEMENTASSOCIATIONS200RESPONSE_ANY_OF_SCHEMAS = [
    "ErrorResponse",
    "FindEntitlementAssociationsResponse",
]
...
class FindEntitlementAssociations200Response(BaseModel):
    """
    FindEntitlementAssociations200Response
    """

    anyof_schema_1_validator: Optional[FindEntitlementAssociationsResponse] = None
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ErrorResponse, FindEntitlementAssociationsResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = {"ErrorResponse", "FindEntitlementAssociationsResponse"}
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FindEntitlementAssociations200Response.model_construct()
        error_messages = []
        if not isinstance(v, FindEntitlementAssociationsResponse):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `FindEntitlementAssociationsResponse`"
            )
        else:
            return v
        ...
        if error_messages:
            raise ValueError(
                "No match found when setting the actual_instance in FindEntitlementAssociations200Response with anyOf schemas: ErrorResponse, FindEntitlementAssociationsResponse. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        error_messages = []
        try:
            instance.actual_instance = FindEntitlementAssociationsResponse.from_json(json_str)
            return instance
        ...
        if error_messages:
            raise ValueError(
                "No match found when deserializing the JSON string into FindEntitlementAssociations200Response with anyOf schemas: ErrorResponse, FindEntitlementAssociationsResponse. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
    ...
    def to_dict(
        self,
    ) -> Optional[Union[Dict[str, Any], ErrorResponse, FindEntitlementAssociationsResponse]]:
