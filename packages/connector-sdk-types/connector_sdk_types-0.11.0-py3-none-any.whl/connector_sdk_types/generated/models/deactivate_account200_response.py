...
from connector_sdk_types.generated.models.deactivate_account_response import DeactivateAccountResponse
from connector_sdk_types.generated.models.error_response import ErrorResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field
DEACTIVATEACCOUNT200RESPONSE_ANY_OF_SCHEMAS = ['DeactivateAccountResponse', 'ErrorResponse']
from pydantic import model_serializer

class DeactivateAccount200Response(BaseModel):
    """
    DeactivateAccount200Response
    """
    anyof_schema_1_validator: Optional[DeactivateAccountResponse] = None
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[DeactivateAccountResponse, ErrorResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = {'DeactivateAccountResponse', 'ErrorResponse'}
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = DeactivateAccount200Response.model_construct()
        error_messages = []
        if not isinstance(v, DeactivateAccountResponse):
            error_messages.append(f'Error! Input type `{type(v)}` is not `DeactivateAccountResponse`')
        else:
            return v
        if not isinstance(v, ErrorResponse):
            ...
            return v
        if error_messages:
            raise ValueError('No match found when setting the actual_instance in DeactivateAccount200Response with anyOf schemas: DeactivateAccountResponse, ErrorResponse. Details: ' + ', '.join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        error_messages = []
        try:
            instance.actual_instance = DeactivateAccountResponse.from_json(json_str)
            return instance
        ...
        try:
            ...
            error_messages.append(str(e))
        if error_messages:
            raise ValueError('No match found when deserializing the JSON string into DeactivateAccount200Response with anyOf schemas: DeactivateAccountResponse, ErrorResponse. Details: ' + ', '.join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], DeactivateAccountResponse, ErrorResponse]]:
