...
def mitm_dataframes_into_pm4py_ocel(mitm_dataframes: MITMDataFrames):
    assert mitm_dataframes.header.mitm == MITM.OCEL2
...
def mitm_data_into_pm4py_ocel(mitm_data: MITMData):
