"""
🎯 Typst Engine - Clean Implementation
=====================================
Optimized Typst engine with system CLI integration
"""
...
class TypstEngine:
    """
    Clean Typst engine using system CLI
    Focused on reliability and markdown→Typst conversion
    """
    ...
    def generate(self, 
        ...
        try:
            ...
            self.logger.error(f"Typst generation error: {e}")
            raise
