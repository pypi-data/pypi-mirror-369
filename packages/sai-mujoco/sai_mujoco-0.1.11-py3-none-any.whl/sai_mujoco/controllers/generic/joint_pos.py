...
from sai_mujoco.controllers.controller import Controller
from sai_mujoco.utils.control_utils import set_goal_position
    ...
    def __init__(
        ...
        **kwargs,  # does nothing; used so no error raised when dict is passed with extra terms used previously
        ...
        if self.input_type == "absolute":
            assert self.impedance_mode == "fixed", (
                "Absolute input type is only supported for fixed impedance mode."
            )
