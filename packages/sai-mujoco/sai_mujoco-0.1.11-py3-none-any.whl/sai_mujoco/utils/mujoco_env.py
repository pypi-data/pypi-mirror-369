...
class MujocoEnv(gym.Env):
    ...
    def __init__(
        ...
        self.sim = self._initialize_simulation(mj_model)
    ...
    def _initialize_simulation(self, model) -> MjSim:
        """
    ...
    def reset(
        ...
        *,
        ...
        ob = self.reset_model(deterministic=deterministic)
    ...
    def reset_model(self, deterministic: bool = False) -> NDArray[np.float64]:
        """
