...
def test_root_to_dataframe():
    assert (
        pid_data.root_to_dataframe(
            "root://eoslhcb.cern.ch//eos/lhcb/grid/prod/lhcb/anaprod/lhcb/LHCb/Collision15/PIDCALIB.ROOT/00064787/0000/00064787_00000037_1.pidcalib.root",  # noqa: E501
...
def test_get_tree_paths():
    ...
    assert pid_data.get_tree_paths("Mu", "Turbo15-MagUp-Mu", ["Tree1", "Tree2"]) == [
        "Tree1/DecayTree",
        "Tree2/DecayTree",
    ]
...
def test_get_relevant_branch_names():
    ...
    with pytest.raises(KeyError):
        pid_data.get_relevant_branch_names(["DLLp > 4 & probe_PIDp > 4"], ["P", "ETA"])

    assert pid_data.get_relevant_branch_names(
        ["test_DLL != 4"], ["special_var"], ["raw_var > 0"]
    ) == {
        "sWeight": "probe_sWeight",
        "test_DLL": "test_DLL",
        "special_var": "special_var",
