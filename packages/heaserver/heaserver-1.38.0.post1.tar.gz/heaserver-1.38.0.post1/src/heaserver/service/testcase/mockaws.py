...
from ..db.database import query_fixtures, Database

from ..db.aws import S3, S3Manager, create_client, S3ObjectPermissionContext
...
from heaobject.root import DesktopObjectDict, DesktopObject, PermissionContext, DesktopObjectTypeVar
...
class MockS3WithMockMongo(S3, MockMongo):
    ...
    def __init__(self, config: Optional[ConfigParser], mongo: MockMongo | None = None, **kwargs):
