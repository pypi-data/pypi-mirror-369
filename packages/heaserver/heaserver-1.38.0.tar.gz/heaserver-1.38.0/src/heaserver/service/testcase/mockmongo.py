...
from heaobject.root import DesktopObject, DesktopObjectDict, desktop_object_from_dict, DesktopObjectTypeVar, PermissionContext
...
class MockMongo(MockDatabase, InMemoryDatabase, Mongo):
    ...
    async def put(self, request: web.Request, obj: DesktopObject, collection: str,
                  context: PermissionContext | None = None) -> UpdateResult | None:
        """
