...
class zrod:
    ...
    def __init__(self):
        ...
        try:
            self.SetClientVersion(str.encode("py"), ver[0], ver[1], ver[2], 0)
        except:
            self.SetClientVersion(str.encode("pyERR"), 0, 0, 0, 0)
            print("Version Error")
        #end try
    #end __init__()
    ...
    def SetClientVersion(self, platform, major, minor, revision, build): return(libzrod.SetClientVersion(self.instance, platform, major, minor, revision, build))
