...
<div style="display: flex; align-items: center; padding: 20px;">
  <img src="https://github.com/speedyk-005/chunklet/blob/main/logo.png?raw=true" alt="Chunklet Logo" style="width: 20vw; height: 20vw; max-width: 300px; max-height: 300px;">
