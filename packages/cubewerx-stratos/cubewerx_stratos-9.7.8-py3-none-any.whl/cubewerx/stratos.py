# $Id: stratos.py 79381 2025-08-12 19:01:27Z pomakis $
...
class Stratos:
    ...
    def removeCubeSTOR(self, cubestor: CubeSTOR | str) -> bool:
        """Removes the specified CubeSTOR database from the Stratos
...
class Collection:
    ...
    def title(self) -> str | None:
        """The title of this collection, or None."""
        return None # TODO: implement

    @property
    def description(self) -> str | None:
        """A brief textual description of this collection, or None."""
        return None # TODO: implement
    ...
    def addSourceImages(self):
        """TODO: implement"""
        pass #TODO: implement

    def removeSourceImages(self):
        """TODO: implement"""
        pass #TODO: implement
...
class Layer:
        ...
        if isinstance(stylesJson, list):
            for styleJson in stylesJson:
                style = Style(styleJson, self.__stylesUrl,
                    self.canBeManaged, self.__authorizationToken)
    ...
    def title(self) -> str | None:
        ...
        it by setting it to the empty string None) will automatically
        update the server."""
        return self.__title
    ...
    def description(self) -> str | None:
        ...
        this (or clearing it by setting it to the empty string None)
        will automatically update the server."""
        return self.__description
    ...
    def tileUpdateProgress(self) -> float:
        ...
        # Make sure we don't hit the server more then twice a second.
    ...
    def removeSourceImage(self, sourceImage: SourceImage | str,
                          updateTiles: bool = False):
        """Removes a source image from this layer, regardless of whether
        or not they're in a specific collection.  This can only be done
        if `canBeManaged` and `isCoverage`.  Also note that this does not
        update the wgs84Extent property of the `Layer` object.
    ...
    def removeSourceImages(self, sourceImages: list[SourceImage|str],
                           updateTiles: bool = False):
        """Removes one or more source images from this layer, regardless
    ...
    def getStyle(self, styleId: str) -> Style | None:
        """Returns the style with the specified ID, or None if this
    ...
    def removeStyle(self, style: Style | str) -> bool:
        """Removes the specified style from this layer.  This can only
    ...
    def updateTiles(self, sequential: bool = False,
        ...
        Args:
            ...
            showProgress: Whether or not to report the tile update
                progress.  Only relevant if sequential=True.
        """
...
class MultilingualString(collections.UserDict):
    ...
    def __init__(self, value: str | dict[str,str]):
      """Create a new multilinguial string.
