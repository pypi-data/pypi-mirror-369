...
def _allreduce(framework, tensor, op, group=None, dist=None, log=None):
    if framework == 'pytorch':
...
def _reduce(framework, tensor, op, group=None, dist=None,log=None  ):
    if framework == 'pytorch':
        if group is None:
            smallest_rank = 0
        else:
...
def _broadcast(framework, tensor,  op, group=None, dist=None, log=None   ):
    if framework == 'pytorch':
        if group is None:
            smallest_rank = 0
        else:
...
def _allgather(framework, tensor , op=None, group=None, dist=None, log=None  ):
    if framework == 'pytorch':
...
def _gather(framework, tensor, op=None, group=None, dist=None, log=None):
    if framework == 'pytorch':
        if group is None:
            smallest_rank = 0
        else:
...
def _scatter(framework, tensor, op=None, group=None, dist=None,log=None):
    if framework == 'pytorch':
        if group is None:
            smallest_rank = 0
        else:
...
def _reduce_scatter(framework, tensor, op, group=None, dist=None,log=None):
    if framework == 'pytorch':
        world_size = dist.get_world_size(group)
...
def _all_to_all(framework, tensor, op=None, group=None, dist=None,log=None):
    if framework == 'pytorch':
        world_size = dist.get_world_size(group)
...
def _all_to_all_single(framework, tensor, op=None, group=None, dist=None, log=None):
    if framework == 'pytorch':
...
def _barrier(framework, tensor, op=None, group=None, dist=None,log=None):
    if framework == 'pytorch':
