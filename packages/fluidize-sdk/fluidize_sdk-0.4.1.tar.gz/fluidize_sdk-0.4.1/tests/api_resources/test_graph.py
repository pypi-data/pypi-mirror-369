...
class TestGraph:
    ...
    def test_method_list_simulations(self, client: FluidizeSDK) -> None:
        graph = client.graph.list_simulations(
            sim_global=True,
        )
        assert_matches_type(GraphListSimulationsResponse, graph, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_list_simulations(self, client: FluidizeSDK) -> None:
        response = client.graph.with_raw_response.list_simulations(
            sim_global=True,
        )
    ...
    def test_streaming_response_list_simulations(self, client: FluidizeSDK) -> None:
        with client.graph.with_streaming_response.list_simulations(
            sim_global=True,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncGraph:
    ...
    async def test_method_list_simulations(self, async_client: AsyncFluidizeSDK) -> None:
        graph = await async_client.graph.list_simulations(
            sim_global=True,
        )
        assert_matches_type(GraphListSimulationsResponse, graph, path=["response"])
    ...
    async def test_raw_response_list_simulations(self, async_client: AsyncFluidizeSDK) -> None:
        response = await async_client.graph.with_raw_response.list_simulations(
            sim_global=True,
        )
    ...
    async def test_streaming_response_list_simulations(self, async_client: AsyncFluidizeSDK) -> None:
        async with async_client.graph.with_streaming_response.list_simulations(
            sim_global=True,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
