...
from ..types.graph_list_simulations_response import GraphListSimulationsResponse
...
class GraphResource(SyncAPIResource):
    ...
    def insert_node(
        ...
        *,
        query_id: str,
        body_id: str,
        data: graph_insert_node_params.Data,
        position: graph_insert_node_params.Position,
        type: str,
        description: str | NotGiven = NOT_GIVEN,
        label: str | NotGiven = NOT_GIVEN,
        location: str | NotGiven = NOT_GIVEN,
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform(
                    {"sim_global": sim_global}, graph_list_simulations_params.GraphListSimulationsParams
                ),
            ),
            cast_to=GraphListSimulationsResponse,
        )
