...
- `types-aioboto3-lite[full]` - Type annotations for all 412 services in one
  package (recommended).
- `types-aioboto3-lite[all]` - Type annotations for all 412 services in
  separate packages.
...
- `types-aioboto3-lite[acm-pca]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[aiops]` - Type annotations for
...
- `types-aioboto3-lite[bedrock-agent-runtime]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[bedrock-agentcore]` - Type annotations for
  [BedrockAgentCoreDataPlaneFrontingLayer](https://youtype.github.io/types_aioboto3_docs/types_aiobotocore_bedrock_agentcore/)
  service.
- `types-aioboto3-lite[bedrock-agentcore-control]` - Type annotations for
...
- `types-aioboto3-lite[evidently]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[evs]` - Type annotations for
...
- `types-aioboto3-lite[gamelift]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[gameliftstreams]` - Type annotations for
...
- `types-aioboto3-lite[iot-jobs-data]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[iot-managed-integrations]` - Type annotations for
...
- `types-aioboto3-lite[keyspaces]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[keyspacesstreams]` - Type annotations for
...
- `types-aioboto3-lite[migrationhubstrategy]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[mpa]` - Type annotations for
...
- `types-aioboto3-lite[observabilityadmin]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[odb]` - Type annotations for
...
- `types-aioboto3-lite[s3tables]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[s3vectors]` - Type annotations for
...
- `types-aioboto3-lite[ssm-contacts]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[ssm-guiconnect]` - Type annotations for
...
- `types-aioboto3-lite[workspaces]` - Type annotations for
  ...
  service.
- `types-aioboto3-lite[workspaces-instances]` - Type annotations for
