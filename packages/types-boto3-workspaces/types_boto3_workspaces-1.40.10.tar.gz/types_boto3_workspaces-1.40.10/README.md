...
[boto3 WorkSpaces 1.40.10](https://pypi.org/project/boto3/) compatible with
...
- Install `types-boto3[workspaces]` in your environment:
...
- Install `types-boto3[workspaces]` with services you use in your environment:
...
`types-boto3-workspaces` dependency in production. However, there is an issue
...
from types_boto3_workspaces import WorkSpacesClient
...
`types_boto3_workspaces.paginator` module contains type annotations for all
paginators.
