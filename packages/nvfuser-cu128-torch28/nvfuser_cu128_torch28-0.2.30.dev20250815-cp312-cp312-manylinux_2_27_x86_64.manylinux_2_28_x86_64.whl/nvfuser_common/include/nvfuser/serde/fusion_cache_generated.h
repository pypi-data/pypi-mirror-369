...
inline const RecordType (&EnumValuesRecordType())[71] {
...
inline const char *EnumNameRecordType(RecordType e) {
  if (::flatbuffers::IsOutRange(e, RecordType::Base, RecordType::TopKOp)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const RecordData (&EnumValuesRecordData())[23] {
...
inline const char *EnumNameRecordData(RecordData e) {
  if (::flatbuffers::IsOutRange(e, RecordData::NONE, RecordData::ScaledOp)) return "";
  const size_t index = static_cast<size_t>(e);
