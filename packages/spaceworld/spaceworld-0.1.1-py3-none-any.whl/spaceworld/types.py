...
type DynamicCommand = Annotated[
    Callable[..., UserAny],
    "Represents any user's command with an arbitrary signature"
]
...
type AttributeType = Annotated[
    type[UserAny],
    "Annotation for any attributes"
]

type Arg = Annotated[
    str,
    "The CLI argument can be a positional, named flag, or Boolean flag."
]

type Args = Annotated[
    list[Arg],
    "Unprepared args. Represents a tuple of strings"
]

type TupleArgs = Annotated[
    tuple[Arg, ...],
    "A tuple of untrained arguments"
]
...
type NewArgs = Annotated[
    list[UserAny],
    "Prepared arguments by args after conversion in annotations"
]

type NewKwargs = Annotated[
    dict[str, UserAny],
    "Prepared arguments by kwargs after conversion in annotations"
]

type CacheType = Annotated[
    tuple[Args, NewKwargs, Kwargs],
    "Annotation for the argument cache"
]
