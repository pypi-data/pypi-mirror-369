...
class TestAnnotationManager:
    ...
    @pytest.mark.parametrize("enum, arg, expected, expect_error", [
    ...
    @pytest.mark.parametrize("annotation, arg, expected", [
    ...
    @pytest.mark.parametrize("arguments, expected_args, expected_kwargs", [
        (("arg1", "arg2"), ["arg1", "arg2"], {}),
        (("file.txt", "--flag"), ["file.txt"], {"flag": True}),

        (("--verbose",), [], {"verbose": True}),
        (("--no-verbose",), [], {"verbose": False}),
        (("--enable-logging", "--no-cache"), [], {"enable_logging": True, "cache": False}),
        ...
        (("file.txt", "--user=guest", "-vV", "--no-color"), ["file.txt"],
         {"user": "guest", "v": False, "color": False}),
        (("-abC", "--timeout=30", "input.txt"), ["input.txt"], {"a": True, "b": True, "c": False, "timeout": "30"}),
