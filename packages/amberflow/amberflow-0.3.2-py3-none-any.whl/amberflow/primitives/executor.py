...
from amberflow.primitives import dirpath_t, filepath_t, DataMover, RsyncMover, _run_command
...
class Executor(ABC):
    ...
    @staticmethod
    def run_command(command: str, cwd: dirpath_t, logger: Logger, env: Optional[dict] = None,
...
class RemoteExecutor(Executor):
    ...
    data_mover: Optional[DataMover]
    initialized: bool
    __slots__ = Executor.__slots__ + ("remote_server", "remote_base_dir", "local_base_dir", "data_mover")

    def __init__(self, remote_server: Optional[str] = None, remote_base_dir: Optional[dirpath_t] = None,
                 local_base_dir: Optional[dirpath_t] = None, data_mover: Optional[DataMover] = None):
        super().__init__()
        ...
        default_data_mover = None if remote_server is None else RsyncMover(remote_server)
