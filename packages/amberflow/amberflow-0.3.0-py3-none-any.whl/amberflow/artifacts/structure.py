...
from amberflow.artifacts.baseartifact import BaseArtifactFile
...
@fileartifact
class ComplexNucleicAcidLigandPDB(BaseComplexStructureFile):
    prefix: str = "complex"
    suffix: str = ".pdb"
    tags: tuple = ("nucleicacid", "ligand")
...
class ComplexProteinLigandReferenceRestart(BaseComplexProteinLigandStructureReferenceFile):
    prefix: str = "complex"
    suffix: str = ".rst7"
    tags: tuple = ("protein", "ligand", "reference")
