...
Operational modes reference for Gemini Code SuperGemini framework.
...
Meta-cognitive analysis and SuperGemini framework troubleshooting system.

## Purpose

Meta-cognitive analysis mode that enables Gemini Code to step outside normal operational flow to examine its own reasoning, decision-making processes, chain of thought progression, and action sequences for self-awareness and optimization.
...
- **Integration**: Seamless SuperGemini framework compliance