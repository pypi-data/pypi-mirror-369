...
Intelligent routing system for Gemini Code SuperGemini framework.
...
|---------|------------|---------|----------------|------------|
| "analyze architecture" | complex | infrastructure | architect persona, --seq, Context7 | 95% |
...
| "fix bug" | moderate | any | analyzer persona, --seq | 85% |
| "optimize performance" | complex | backend | performance persona, --seq, Playwright | 90% |
...
- Performance issues → --persona-performance + --focus performance + --seq
