"""
Type annotations for workspaces-instances service literal definitions.

[Documentation](https://youtype.github.io/types_boto3_docs/types_boto3_workspaces_instances/literals/)
...
Usage::
    ...
    data: AmdSevSnpEnumType = "disabled"
    ```
"""
...
HostnameTypeEnumType = Literal["ip-name", "resource-name"]
...
ListInstanceTypesPaginatorName = Literal["list_instance_types"]
...
ResourceTypeEnumType = Literal["instance", "network-interface", "spot-instances-request", "volume"]
SpotInstanceTypeEnumType = Literal["one-time", "persistent"]
TenancyEnumType = Literal["dedicated", "default", "host"]
VolumeTypeEnumType = Literal["gp2", "gp3", "io1", "io2", "sc1", "st1", "standard"]
WorkspacesInstancesServiceName = Literal["workspaces-instances"]
ServiceName = Literal[
    "accessanalyzer",
    "account",
    "acm",
