...
get_proapi_origin = cycle(("http://pro.api.115.com", "https://proapi.115.com")).__next__
get_webapi_origin = cycle(("http://web.api.115.com", "https://webapi.115.com")).__next__
...
def complete_proapi(
    ...
    if not app and path.startswith("/open/") and base_url == "http://pro.api.115.com":
        base_url = "https://proapi.115.com"
...
class P115Client(P115OpenClient):
    ...
    def fs_makedirs_app(
        ...
        **request_kwargs, 
        ...
        POST http://pro.api.115.com/app/chrome/add_path
