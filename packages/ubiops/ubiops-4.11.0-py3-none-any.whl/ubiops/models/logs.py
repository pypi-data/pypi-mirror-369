...
class Logs(object):
    ...
    def instance_id(self):
        """
        Gets the instance_id of this Logs

        :return: the instance_id of this Logs
        :rtype: str
        """
    ...
    def instance_id(self, instance_id):
        """
        Sets the instance_id of this Logs

        :param instance_id: the instance_id of this Logs
        :type: str
        """

        if self.client_side_validation and (instance_id is not None and not isinstance(instance_id, str)):
            raise ValueError("Parameter `instance_id` must be a string")
    ...
    def process_id(self):
        """
        Gets the process_id of this Logs

        :return: the process_id of this Logs
        :rtype: int
        """
    ...
    def process_id(self, process_id):
        """
        Sets the process_id of this Logs

        :param process_id: the process_id of this Logs
        :type: int
        """

        if self.client_side_validation and (process_id is not None and not isinstance(process_id, int)):
            raise ValueError("Parameter `process_id` must be an integer")
