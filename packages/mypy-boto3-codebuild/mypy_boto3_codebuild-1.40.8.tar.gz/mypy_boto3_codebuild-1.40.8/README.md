...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-codebuild)](https://pypistats.org/packages/mypy-boto3-codebuild)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 CodeBuild 1.40.8](https://pypi.org/project/boto3/)
...
`mypy-boto3-codebuild` dependency in production. However, there is an issue in
