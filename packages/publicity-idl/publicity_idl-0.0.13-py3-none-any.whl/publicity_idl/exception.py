...
def raise_with_cause(cause: Exception, good_exception: GoodException):
    new_exc = copy.deepcopy(good_exception)
    good_exception.with_cause(cause)
    raise good_exception
