...
def test_ray_sgpr_ensemble(test_data_dict, ray_fix, cmd_options):
    # Tolerances:
    ...
    for result_dict in result_dicts:
        for attribute_name in ["X", "Xm", "alpha", "ensemble_alpha", "priors_per_atom", "mean_energy"]:
