...
def run_behave():
    ...
    config_args = load_config(declared_args.pop(CONFIG_PARAM), declared_args.pop(CONFIG_ENCODING_PARAM))
    ...
    args_for_env = {key: value for key, value in args.items() if key not in declared_keys}
