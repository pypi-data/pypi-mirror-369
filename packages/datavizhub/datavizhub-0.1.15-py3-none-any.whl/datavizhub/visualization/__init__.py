...
def register_cli(subparsers: Any) -> None:
    ...
    # timeseries
    p_ts = subparsers.add_parser("timeseries", help="Visualization: render a time series from CSV or NetCDF")
    ...
    p_vid = subparsers.add_parser("compose-video", help="Compose a directory of frames into MP4 (requires ffmpeg)")
    ...
    p_int = subparsers.add_parser("interactive", help="Render interactive HTML (folium or plotly)")
