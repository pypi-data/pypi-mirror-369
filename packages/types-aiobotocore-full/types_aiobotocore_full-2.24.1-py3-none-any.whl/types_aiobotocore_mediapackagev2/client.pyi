...
class Mediapackagev2Client(AioBaseClient):
    ...
    async def reset_channel_state(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#reset_channel_state)
        """
    ...
    async def reset_origin_endpoint_state(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mediapackagev2/client/#reset_origin_endpoint_state)
        """
