"""
Type annotations for mpa service literal definitions.

[Documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_mpa/literals/)
...
Usage::
    ...
    data: ActionCompletionStrategyType = "AUTO_COMPLETION_UPON_APPROVAL"
    ```
"""
...
IdentitySourceStatusType = Literal["ACTIVE", "CREATING", "DELETING", "ERROR"]
IdentitySourceTypeType = Literal["IAM_IDENTITY_CENTER"]
IdentityStatusType = Literal["ACCEPTED", "INVALID", "PENDING", "REJECTED"]
ListApprovalTeamsPaginatorName = Literal["list_approval_teams"]
