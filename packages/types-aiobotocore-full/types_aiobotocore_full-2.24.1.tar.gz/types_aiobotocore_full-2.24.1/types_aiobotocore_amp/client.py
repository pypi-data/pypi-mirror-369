...
class PrometheusServiceClient(AioBaseClient):
    ...
    async def create_query_logging_configuration(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/client/#create_query_logging_configuration)
        """
    ...
    async def delete_query_logging_configuration(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/client/#delete_query_logging_configuration)
        """
    ...
    async def describe_query_logging_configuration(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/client/#describe_query_logging_configuration)
        """
    ...
    async def describe_workspace_configuration(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/client/#describe_workspace_configuration)
        """
    ...
    async def update_query_logging_configuration(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_amp/client/#update_query_logging_configuration)
        """
