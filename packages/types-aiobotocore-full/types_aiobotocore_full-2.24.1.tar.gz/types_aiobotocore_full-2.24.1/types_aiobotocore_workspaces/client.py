...
class WorkSpacesClient(AioBaseClient):
    ...
    async def modify_endpoint_encryption_mode(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_workspaces/client/#modify_endpoint_encryption_mode)
        """
