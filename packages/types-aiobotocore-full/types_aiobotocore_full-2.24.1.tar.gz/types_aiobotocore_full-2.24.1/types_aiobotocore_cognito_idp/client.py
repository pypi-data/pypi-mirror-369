...
class CognitoIdentityProviderClient(AioBaseClient):
    ...
    async def get_tokens_from_refresh_token(
        ...
        [Show types-aiobotocore-full documentation](https://youtype.github.io/types_aiobotocore_docs/types_aiobotocore_cognito_idp/client/#get_tokens_from_refresh_token)
        """
