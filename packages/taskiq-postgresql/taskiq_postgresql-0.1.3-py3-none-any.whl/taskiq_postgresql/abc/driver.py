...
class QueryDriver(ABC):
    ...
    def __init__(
        ...
        **connection_kwargs: Any,
        ...
        self.comment_column_query = CommentColumnQuery(self.table_name)
        self.get_column_comment_query = GetColumnCommentQuery(self.table_name)
    ...
    @abstractmethod
    async def comment_column(self, column: Column, comment: str) -> Any:
        """Comment a column."""

    @abstractmethod
    async def get_column_comment(self, column: Column) -> str:
        """Get the comment of a column."""

    @abstractmethod
    async def comment_table(self, comment: str) -> Any:
        """Comment a table."""

    @abstractmethod
    async def get_table_comment(self) -> str:
        """Get the comment of a table."""

    @abstractmethod
    async def get_table_columns_data(
        self, columns: Optional[Sequence[Column]] = None
    ) -> list[Column]:
        """Get the data of a table columns."""
