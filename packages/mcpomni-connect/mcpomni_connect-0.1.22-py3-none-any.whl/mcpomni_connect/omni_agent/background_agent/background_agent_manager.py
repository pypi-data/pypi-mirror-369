...
from mcpomni_connect.omni_agent.background_agent.background_agents import (
    BackgroundOmniAgent,
)
from mcpomni_connect.omni_agent.background_agent.task_registry import TaskRegistry
from mcpomni_connect.omni_agent.background_agent.scheduler_backend import (
    APSchedulerBackend,
)
...
class BackgroundAgentManager:
    ...
    def __init__(
        ...
        Args:
            memory_store: Optional shared memory store for all agents
            event_router: Optional shared event router for all agents
        """
        self.memory_store = memory_store or MemoryRouter(memory_store_type="memory")
    ...
    def get_manager_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "event_store": self.event_router.get_event_store_info(),
    ...
    def get_all_event_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "shared_memory_store": self.memory_store.get_memory_store_info(),
        }
