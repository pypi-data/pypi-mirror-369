...
class MixedTriQuadMesh3dF32:
    ...
    """
    @property
    def vertices(self) -> numpy.typing.NDArray[numpy.float32]:
        r"""
        nx3 array of vertex positions, copies data
        """
    @property
    def cells(self) -> builtins.list[builtins.list[builtins.int]]:
        r"""
...
class MixedTriQuadMeshWithDataF32:
    ...
    """
    @property
    def mesh(self) -> MixedTriQuadMesh3dF32:
        r"""
...
class MixedTriQuadMeshWithDataF64:
    ...
    """
    @property
    def mesh(self) -> MixedTriQuadMesh3dF64:
        r"""
        Clone of the contained mesh
        """
