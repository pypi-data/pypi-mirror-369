...
class AnsibleAnsibleCollectionDeprecatedResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnsibleAnsibleCollectionDeprecatedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnsibleAnsibleCollectionDeprecatedResponse from a dict"""
        if obj is None:
            return None
