...
class PaginatedCollectionVersionSearchListResponseList(BaseModel):
    """
    PaginatedCollectionVersionSearchListResponseList
    """ # noqa: E501
    meta: Optional[PaginatedCollectionResponseListMeta] = None
    links: Optional[PaginatedCollectionResponseListLinks] = None
    data: Optional[List[CollectionVersionSearchListResponse]] = None
    __properties: ClassVar[List[str]] = ["meta", "links", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaginatedCollectionVersionSearchListResponseList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaginatedCollectionVersionSearchListResponseList from a dict"""
        if obj is None:
            return None
