...
class RepositoriesAnsibleApi:
    ...
    def _add_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}add_role/',
    ...
    def copy_collection_version(
        ...
        :param ansible_ansible_repository_href: (required)
        :type ansible_ansible_repository_href: str
        :param collection_version_copy_move: (required)
        :type collection_version_copy_move: CollectionVersionCopyMove
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._copy_collection_version_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            collection_version_copy_move=collection_version_copy_move,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def copy_collection_version_with_http_info(
        self,
        ansible_ansible_repository_href: StrictStr,
        collection_version_copy_move: CollectionVersionCopyMove,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    @validate_call
    def copy_collection_version_without_preload_content(
        self,
        ansible_ansible_repository_href: StrictStr,
        collection_version_copy_move: CollectionVersionCopyMove,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    def _copy_collection_version_serialize(
        self,
        ansible_ansible_repository_href,
        ...
        # process the form parameters
        # process the body parameter
        if collection_version_copy_move is not None:
            _body_params = collection_version_copy_move
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}copy_collection_version/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create(
        ...
        :param ansible_ansible_repository: (required)
        :type ansible_ansible_repository: AnsibleAnsibleRepository
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            ansible_ansible_repository=ansible_ansible_repository,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "AnsibleAnsibleRepositoryResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ansible_ansible_repository is not None:
            _body_params = ansible_ansible_repository
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/repositories/ansible/ansible/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{ansible_ansible_repository_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedansibleAnsibleRepositoryResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedansibleAnsibleRepositoryResponseList]:
        """List ansible repositorys
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_ansible_repository_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def mark(
        ...
        :param ansible_ansible_repository_href: (required)
        :type ansible_ansible_repository_href: str
        :param ansible_repository_mark: (required)
        :type ansible_repository_mark: AnsibleRepositoryMark
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._mark_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            ansible_repository_mark=ansible_repository_mark,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def mark_without_preload_content(
        self,
        ansible_ansible_repository_href: StrictStr,
        ansible_repository_mark: AnsibleRepositoryMark,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    def _mark_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ansible_repository_mark is not None:
            _body_params = ansible_repository_mark
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}mark/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _modify_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}modify/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def move_collection_version(
        ...
        _param = self._move_collection_version_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            collection_version_copy_move=collection_version_copy_move,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
    ...
    @validate_call
    def move_collection_version_with_http_info(
        self,
        ansible_ansible_repository_href: StrictStr,
        collection_version_copy_move: CollectionVersionCopyMove,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    @validate_call
    def move_collection_version_without_preload_content(
        self,
        ansible_ansible_repository_href: StrictStr,
        collection_version_copy_move: CollectionVersionCopyMove,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    def _move_collection_version_serialize(
        self,
        ansible_ansible_repository_href,
        collection_version_copy_move,
        x_task_diagnostics,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}move_collection_version/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_ansible_repository_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        ...
        :param ansible_ansible_repository_href: (required)
        :type ansible_ansible_repository_href: str
        :param patchedansible_ansible_repository: (required)
        :type patchedansible_ansible_repository: PatchedansibleAnsibleRepository
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            patchedansible_ansible_repository=patchedansible_ansible_repository,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedansible_ansible_repository is not None:
            _body_params = patchedansible_ansible_repository
    ...
    def _rebuild_metadata_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}rebuild_metadata/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sign(
        ...
        :param ansible_ansible_repository_href: (required)
        :type ansible_ansible_repository_href: str
        :param ansible_repository_signature: (required)
        :type ansible_repository_signature: AnsibleRepositorySignature
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._sign_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            ansible_repository_signature=ansible_repository_signature,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _sign_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ansible_repository_signature is not None:
            _body_params = ansible_repository_signature
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}sign/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sync(
        ...
        :param ansible_ansible_repository_href: (required)
        :type ansible_ansible_repository_href: str
        :param ansible_repository_sync_url: (required)
        :type ansible_repository_sync_url: AnsibleRepositorySyncURL
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._sync_serialize(
            ansible_ansible_repository_href=ansible_ansible_repository_href,
            ansible_repository_sync_url=ansible_repository_sync_url,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _sync_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ansible_repository_sync_url is not None:
            _body_params = ansible_repository_sync_url
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}sync/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def unmark_without_preload_content(
        self,
        ansible_ansible_repository_href: StrictStr,
        ansible_repository_mark: AnsibleRepositoryMark,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
    ...
    def _unmark_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}unmark/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_ansible_repository_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
