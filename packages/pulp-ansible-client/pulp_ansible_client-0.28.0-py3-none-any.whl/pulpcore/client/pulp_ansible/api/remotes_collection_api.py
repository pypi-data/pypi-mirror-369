...
class RemotesCollectionApi:
    ...
    def add_role(
        self,
        ansible_collection_remote_href: StrictStr,
        ...
        _param = self._add_role_serialize(
            ansible_collection_remote_href=ansible_collection_remote_href,
    ...
    def _add_role_serialize(
        ...
        if ansible_collection_remote_href is not None:
            _path_params['ansible_collection_remote_href'] = ansible_collection_remote_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_collection_remote_href}add_role/',
    ...
    def create(
        self,
        ansible_collection_remote: AnsibleCollectionRemote,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param ansible_collection_remote: (required)
        :type ansible_collection_remote: AnsibleCollectionRemote
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            ansible_collection_remote=ansible_collection_remote,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "AnsibleCollectionRemoteResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ansible_collection_remote is not None:
            _body_params = ansible_collection_remote
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/pulp/api/v3/remotes/ansible/collection/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{ansible_collection_remote_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        url: Annotated[Optional[StrictStr], Field(description="Filter results where url matches value")] = None,
        url__contains: Annotated[Optional[StrictStr], Field(description="Filter results where url contains value")] = None,
        url__icontains: Annotated[Optional[StrictStr], Field(description="Filter results where url contains value")] = None,
        url__in: Annotated[Optional[List[StrictStr]], Field(description="Filter results where url is in a comma-separated list of values")] = None,
        ...
        :type q: str
        :param url: Filter results where url matches value
        :type url: str
        :param url__contains: Filter results where url contains value
        :type url__contains: str
        :param url__icontains: Filter results where url contains value
        :type url__icontains: str
        :param url__in: Filter results where url is in a comma-separated list of values
        :type url__in: List[str]
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedansibleCollectionRemoteResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedansibleCollectionRemoteResponseList]:
        """List collection remotes
    ...
    def _list_serialize(
        ...
        if url__contains is not None:
            
            _query_params.append(('url__contains', url__contains))
            
        if url__icontains is not None:
            
            _query_params.append(('url__icontains', url__icontains))
            
        if url__in is not None:
            
            _query_params.append(('url__in', url__in))
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_collection_remote_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{ansible_collection_remote_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        self,
        ansible_collection_remote_href: StrictStr,
        patchedansible_collection_remote: PatchedansibleCollectionRemote,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param ansible_collection_remote_href: (required)
        :type ansible_collection_remote_href: str
        :param patchedansible_collection_remote: (required)
        :type patchedansible_collection_remote: PatchedansibleCollectionRemote
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            ansible_collection_remote_href=ansible_collection_remote_href,
            patchedansible_collection_remote=patchedansible_collection_remote,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedansible_collection_remote is not None:
            _body_params = patchedansible_collection_remote
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_collection_remote_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_collection_remote_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{ansible_collection_remote_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
