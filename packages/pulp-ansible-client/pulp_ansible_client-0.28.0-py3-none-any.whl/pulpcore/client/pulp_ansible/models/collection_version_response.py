...
class CollectionVersionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["version", "href", "created_at", "updated_at", "requires_ansible", "marks", "artifact", "collection", "download_url", "name", "namespace", "signatures", "metadata", "git_url", "git_commit_sha", "manifest", "files"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionVersionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionVersionResponse from a dict"""
        if obj is None:
            return None
