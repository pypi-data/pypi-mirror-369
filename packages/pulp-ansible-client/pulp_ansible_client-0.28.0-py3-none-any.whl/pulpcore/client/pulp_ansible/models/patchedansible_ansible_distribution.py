...
class PatchedansibleAnsibleDistribution(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["base_path", "content_guard", "name", "repository", "repository_version", "pulp_labels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedansibleAnsibleDistribution from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedansibleAnsibleDistribution from a dict"""
        if obj is None:
            return None
