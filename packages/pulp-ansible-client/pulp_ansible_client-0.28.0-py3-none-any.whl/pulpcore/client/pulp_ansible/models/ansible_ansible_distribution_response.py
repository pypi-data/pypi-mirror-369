...
class AnsibleAnsibleDistributionResponse(BaseModel):
    """
    ...
    client_url: Optional[StrictStr] = Field(default=None, description="The URL of a Collection content source.")
    pulp_labels: Optional[Dict[str, Optional[StrictStr]]] = None
    __properties: ClassVar[List[str]] = ["pulp_href", "pulp_created", "base_path", "content_guard", "name", "repository", "repository_version", "client_url", "pulp_labels"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnsibleAnsibleDistributionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnsibleAnsibleDistributionResponse from a dict"""
        if obj is None:
            return None
