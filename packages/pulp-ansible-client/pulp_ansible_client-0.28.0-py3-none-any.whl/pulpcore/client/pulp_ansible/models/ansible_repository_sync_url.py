...
class AnsibleRepositorySyncURL(BaseModel):
    """
    ...
    optimize: Optional[StrictBool] = Field(default=True, description="Whether to optimize sync or not.")
    __properties: ClassVar[List[str]] = ["remote", "mirror", "optimize"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnsibleRepositorySyncURL from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnsibleRepositorySyncURL from a dict"""
        if obj is None:
            return None
