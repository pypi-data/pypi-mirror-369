...
class PatchedansibleAnsibleRepository(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "name", "description", "retain_repo_versions", "remote", "last_synced_metadata_time", "gpgkey", "private"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedansibleAnsibleRepository from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_synced_metadata_time (nullable) is None
        # and model_fields_set contains the field
        if self.last_synced_metadata_time is None and "last_synced_metadata_time" in self.model_fields_set:
            _dict['last_synced_metadata_time'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedansibleAnsibleRepository from a dict"""
        if obj is None:
            return None
