...
class AnsibleAnsibleNamespaceMetadata(BaseModel):
    """
    ...
    links: Optional[List[NamespaceLink]] = Field(default=None, description="Labeled related links.")
    avatar: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = Field(default=None, description="Optional avatar image for Namespace")
    __properties: ClassVar[List[str]] = ["name", "company", "email", "description", "resources", "links", "avatar"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnsibleAnsibleNamespaceMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnsibleAnsibleNamespaceMetadata from a dict"""
        if obj is None:
            return None
