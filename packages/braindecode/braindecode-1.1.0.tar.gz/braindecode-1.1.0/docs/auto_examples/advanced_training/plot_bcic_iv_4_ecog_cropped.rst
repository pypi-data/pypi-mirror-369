...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/Users/baristim/Projects/braindecode-1/examples/advanced_training/plot_bcic_iv_4_ecog_cropped.py", line 48, in <module>
        dataset = BCICompetitionIVDataset4(subject_ids=[subject_id])
                  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: plot_bcic_iv_4_ecog_cropped.zip <plot_bcic_iv_4_ecog_cropped.zip>`
