...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/Users/baristim/Projects/braindecode-1/examples/applied_examples/plot_bcic_iv_4_ecog_trial.py", line 51, in <module>
        dataset = BCICompetitionIVDataset4(subject_ids=[subject_id])
                  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      File "/Users/baristim/Projects/braindecode-1/braindecode/datasets/bcicomp.py", line 56, in __init__
        data_path = self.download()
                    ^^^^^^^^^^^^^^^
      File "/Users/baristim/Projects/braindecode-1/braindecode/datasets/bcicomp.py", line 117, in download
        unpack_archive(data_path, osp.dirname(destination))
      File "/Users/baristim/miniforge3/envs/braindecode-official/lib/python3.12/shutil.py", line 1351, in unpack_archive
        func(filename, extract_dir, **kwargs)
      File "/Users/baristim/miniforge3/envs/braindecode-official/lib/python3.12/shutil.py", line 1238, in _unpack_zipfile
        raise ReadError("%s is not a zip file" % filename)
    shutil.ReadError: /Users/baristim/mne_data/MNE-bcicompetitionivdataset4-data/BCI_Competion4_dataset4_data_fingerflexions/BCI_Competion4_dataset4_data_fingerflexions/BCI_Competion4_dataset4_data_fingerflexions.zip is not a zip file
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: plot_bcic_iv_4_ecog_trial.zip <plot_bcic_iv_4_ecog_trial.zip>`
