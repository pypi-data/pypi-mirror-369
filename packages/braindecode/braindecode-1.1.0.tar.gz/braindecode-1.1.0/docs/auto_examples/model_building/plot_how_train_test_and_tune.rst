...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    <braindecode.datasets.moabb.MOABBDataset object at 0x100b31ac0>
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -------  ----------------  ------------  ------  ------
          1            0.2500        1.6341  0.0006  0.2735
          2            0.2500        1.3826  0.0000  0.2778
    Test acc: 25.00%
...
.. GENERATED FROM PYTHON SOURCE LINES 389-413
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    -------  ----------------  ------------  -----------  ----------------  ------------  ------  ------
          1            0.3217        1.1762       0.2931            0.2931        4.9089  0.0006  0.2359
          2            0.3391        1.1504       0.3276            0.3276        4.2914  0.0000  0.2421
    Test acc: 26.74%
...
.. GENERATED FROM PYTHON SOURCE LINES 420-466
...
.. GENERATED FROM PYTHON SOURCE LINES 472-492
...
.. GENERATED FROM PYTHON SOURCE LINES 492-531
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.2652        1.1800  0.0006  0.2036
          2            0.2739        1.0704  0.0000  0.2069
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.2739        1.1930  0.0006  0.2035
          2            0.2957        1.0587  0.0000  0.2068
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.3609        1.2132  0.0006  0.2087
          2            0.3565        1.0497  0.0000  0.2051
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.2900        1.1381  0.0006  0.2094
          2            0.2987        1.0374  0.0000  0.2050
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.3766        1.1175  0.0006  0.2056
          2            0.3723        1.0434  0.0000  0.2051
...
.. GENERATED FROM PYTHON SOURCE LINES 534-602
...
.. GENERATED FROM PYTHON SOURCE LINES 634-669
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Fitting 1 folds for each of 2 candidates, totalling 2 fits
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.3304        1.3693  0.0063  0.2075
          2            0.3913        1.3278  0.0000  0.2029
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.2783        1.2240  0.0006  0.2124
          2            0.2913        1.0090  0.0000  0.2051
      epoch    train_accuracy    train_loss      lr     dur
    -------  ----------------  ------------  ------  ------
          1            0.2674        1.1834  0.0006  0.2692
          2            0.2743        1.0415  0.0000  0.2753
...
.. GENERATED FROM PYTHON SOURCE LINES 681-699
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 34.029 seconds)
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: plot_how_train_test_and_tune.zip <plot_how_train_test_and_tune.zip>`
