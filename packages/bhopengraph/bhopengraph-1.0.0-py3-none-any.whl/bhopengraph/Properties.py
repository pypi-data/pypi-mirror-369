...
class Properties(object):
    ...
    def set_property(self, key: str, value):
        ...
        Args:
          ...
          - value: Property value (must be primitive type: str, int, float, bool, None)
        """
        if self._is_valid_property_value(value):
            self._properties[key] = value
        else:
            raise ValueError(f"Property value must be a primitive type (str, int, float, bool, None), got {type(value)}")
