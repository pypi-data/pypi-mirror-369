...
class Kinematics(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::Kinematics class."""
...
class Actuation(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::Actuation class."""
...
class MuscleAnalysis(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::MuscleAnalysis class."""
    ...
    def allocateStorageObjects(self):
        r"""allocateStorageObjects(MuscleAnalysis self)"""
...
class InverseDynamics(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::InverseDynamics class."""
...
class StaticOptimization(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::StaticOptimization class."""
...
class ForceReporter(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::ForceReporter class."""
    ...
    def getForcesTable(self):
        r"""getForcesTable(ForceReporter self) -> TimeSeriesTable"""
...
class PointKinematics(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::PointKinematics class."""
...
class BodyKinematics(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::BodyKinematics class."""
...
class JointReaction(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::JointReaction class."""
    ...
    def getForcesFileName(self):
        r"""getForcesFileName(JointReaction self) -> std::string const &"""
    ...
    def getJointNames(self):
        r"""getJointNames(JointReaction self) -> ArrayStr"""
    ...
    def getOnBody(self):
        r"""getOnBody(JointReaction self) -> ArrayStr"""
    ...
    def getInFrame(self):
        r"""getInFrame(JointReaction self) -> ArrayStr"""
...
class StatesReporter(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::StatesReporter class."""
...
class InducedAccelerations(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::InducedAccelerations class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(InducedAccelerations self, Model aModel=None) -> InducedAccelerations

        Parameters
        ----------
        aModel: OpenSim::Model *

        __init__(InducedAccelerations self, std::string const & aFileName) -> InducedAccelerations

        Parameters
        ----------
        aFileName: std::string const &

        __init__(InducedAccelerations self, InducedAccelerations aObject) -> InducedAccelerations
...
class ProbeReporter(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::ProbeReporter class."""
...
class OutputReporter(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::OutputReporter class."""
...
class IMUDataReporter(opensim.simulation.Analysis):
    r"""Proxy of C++ OpenSim::IMUDataReporter class."""
