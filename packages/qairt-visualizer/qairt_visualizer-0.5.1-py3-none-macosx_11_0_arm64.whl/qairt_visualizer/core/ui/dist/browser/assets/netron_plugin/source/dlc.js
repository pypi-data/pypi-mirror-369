...
dlc.Value = class {
    ...
    constructor(name, type, initializer, tensor) { // QAIRT Netron: Add tensor param
        ...
        const encodingInfo = quantizationData?.qInfo || quantizationData?.axisQInfo?.qInfo || enc_infos;
        if (quantizationData?.type !== 0x7FFFFFFF) { // Enum for undefined encoding type
