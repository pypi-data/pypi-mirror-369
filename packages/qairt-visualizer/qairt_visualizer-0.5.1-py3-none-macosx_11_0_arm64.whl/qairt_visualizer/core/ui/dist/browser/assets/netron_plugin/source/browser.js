...
host.BrowserHost = class {
    ...
    async view(view) {
        ...
        await age();
        // QAIRT Netron: Disable consent to prevent cookies pop-up
        // await consent();
        await telemetry();
        await capabilities();
    }
    ...
    async start() {
        ...
        this.document.addEventListener('dragover', (e) => {
            e.preventDefault();
            e.dataTransfer.dropEffect = 'none'; // QAIRT Netron: Disable droppable icon effect
        });
        ...
        this.document.body.addEventListener('drop', (e) => {
            e.preventDefault();
            // QAIRT Netron: Disable drag and drop
    ...
    async message(message, alert, action) {
        return new Promise((resolve) => {
            ...
            if (alert) {
                ...
                // QAIRT Netron: Always hide the Netron logo
