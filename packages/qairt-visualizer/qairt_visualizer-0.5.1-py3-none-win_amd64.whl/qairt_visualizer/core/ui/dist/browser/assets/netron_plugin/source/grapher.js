...
// QAIRT Netron: Import visualizer modules
import qsubgraph from './qais/qsubgraph.js';
...
grapher.Graph = class {
    ...
    // QAIRT Netron: Allow nodes to be set externally
    set nodes(nodes) {
        this._nodes = nodes;
    }
    ...
    // QAIRT Netron: Allow edges to be set externally
    set edges(edges) {
        this._edges = edges;
    }
    ...
    async layout(worker) {
        ...
        for (const key of this.nodes.keys()) {
            ...
            if (this.children(key).length === 0) {
                ...
                // QAIRT Netron: Render markers indicating hidden edges in the subgraph
                qsubgraph.renderHiddenEdgesMarkers(node);
            }
        }
        return '';
    }
...
grapher.Argument = class {
    ...
    build(document, parent) {
        ...
        // QAIRT Netron: Remove showing argument details page
        // if (this.focus) {
