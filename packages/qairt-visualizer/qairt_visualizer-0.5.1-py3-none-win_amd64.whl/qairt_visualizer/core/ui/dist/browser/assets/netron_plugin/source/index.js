...
window.exports.preload = function(callback) {
    ...
    // QAIRT Netron: Load custom modules
    // Note: Please make sure that two dependent files/modules should not be added in the same module array + correct sequence is followed
    const addQAISModules = () => {
      modules.push(
        [ './qais/qgraph-toolkit', './qais/qsummary-panel' ],
        [ './qais/qsubgraph' ],
        [ './qais/qcontrol' ]
      );
    };
