...
DEFAULT_SETTINGS = {
    ...
    'min_dispersion_km': 10, 
    'max_dispersion_km': 300
}

DEFAULT_WAREHOUSE_SKU_ALLOCATIONS = [
    # Warehouse 1: 100% of Light_Item, 100% of Medium_Item, 100% of Heavy_Item
    [50, 50, 50],
    # Warehouse 2: 0% of Light_Item, 0% of Medium_Item, 0% of Heavy_Item  
    [50, 50, 50],
    # Warehouse 3: 0% of Light_Item, 0% of Medium_Item, 0% of Heavy_Item
    [0, 0, 0]
]
