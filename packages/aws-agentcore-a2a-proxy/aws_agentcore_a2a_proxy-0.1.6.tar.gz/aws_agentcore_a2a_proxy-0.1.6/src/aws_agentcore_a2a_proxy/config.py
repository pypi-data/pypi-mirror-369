...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            host=host,
            port=port,
            expose_host=os.getenv("EXPOSE_HOST", host),  # Defaults to host if not specified
            expose_port=int(os.getenv("EXPOSE_PORT", str(port))),  # Defaults to port if not specified
