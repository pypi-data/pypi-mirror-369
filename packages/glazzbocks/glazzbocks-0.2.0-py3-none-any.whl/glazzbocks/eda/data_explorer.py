...
class DataExplorer:
    ...
    def numeric_summary(self, return_df=False):
        """
        Summarizes numeric columns with statistics (mean, median, skewness, outlier percentage, etc.)
        and missing values.
        ...
        for col in numeric_cols:
            ...
            outlier_pct[col] = (len(outliers) / len(numeric_df)) * 100
        ...
        summary_df["Outlier (%)"] = summary_df["Outlier (%)"].map("{:.2f}".format)
