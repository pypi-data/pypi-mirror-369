...
class MetroConnectPort(BaseModel):
    """
    Metro Connect Port
    """ # noqa: E501
    href: Optional[StrictStr] = None
    type: Optional[StrictStr] = Field(default=None, description="Port Type")
    uuid: Optional[StrictStr] = None
    location: Optional[SimplifiedLocation] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["href", "type", "uuid", "location"]
