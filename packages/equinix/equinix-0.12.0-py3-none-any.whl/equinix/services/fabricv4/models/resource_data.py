...
class ResourceData(BaseModel):
    ...
    ResourceData
    """ # noqa: E501
    href: Optional[StrictStr] = Field(default=None, description="Cloud Event asset href")
    uuid: Optional[StrictStr] = Field(default=None, description="Cloud Event asset uuid")
