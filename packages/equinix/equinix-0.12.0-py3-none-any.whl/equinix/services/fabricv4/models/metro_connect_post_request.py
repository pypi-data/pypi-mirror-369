...
class MetroConnectPostRequest(BaseModel):
    """
    Create Metro Connect
    """ # noqa: E501
    type: StrictStr = Field(description="Metro Connect Type")
    bandwidth: StrictInt = Field(description="Bandwidth in Mbps")
    connectivity_destination_type: MetroConnectPostRequestConnectivityDestinationType = Field(alias="connectivityDestinationType")
    a_side: MetroConnectASide = Field(alias="aSide")
    z_side: MetroConnectZSide = Field(alias="zSide")
    order: Optional[MetroConnectOrder] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "bandwidth", "connectivityDestinationType", "aSide", "zSide", "order", "project", "account", "notifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectivityDestinationType": obj.get("connectivityDestinationType"),
            "aSide": MetroConnectASide.from_dict(obj["aSide"]) if obj.get("aSide") is not None else None,
            "zSide": MetroConnectZSide.from_dict(obj["zSide"]) if obj.get("zSide") is not None else None,
            "order": MetroConnectOrder.from_dict(obj["order"]) if obj.get("order") is not None else None,
