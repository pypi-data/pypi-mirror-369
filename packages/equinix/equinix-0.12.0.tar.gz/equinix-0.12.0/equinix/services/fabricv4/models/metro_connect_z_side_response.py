...
class MetroConnectZSideResponse(BaseModel):
    """
    Metro Connection ZSide configuration
    """ # noqa: E501
    patch_panel: Optional[MetroConnectPatchPanel] = Field(default=None, alias="patchPanel")
    port: Optional[MetroConnectPort] = None
    loas: Optional[List[PortLoa]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["patchPanel", "port", "loas"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of patch_panel
        if self.patch_panel:
            _dict['patchPanel'] = self.patch_panel.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patchPanel": MetroConnectPatchPanel.from_dict(obj["patchPanel"]) if obj.get("patchPanel") is not None else None,
            "port": MetroConnectPort.from_dict(obj["port"]) if obj.get("port") is not None else None,
