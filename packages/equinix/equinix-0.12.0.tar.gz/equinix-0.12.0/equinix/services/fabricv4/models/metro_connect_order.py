...
class MetroConnectOrder(BaseModel):
    """
    Metro Connect Order
    """ # noqa: E501
    ...
    uuid: Optional[StrictStr] = Field(default=None, description="Equinix-assigned order identifier, this is a derived response attribute")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["purchaseOrderNumber", "orderId", "customerReferenceId", "orderNumber", "uuid"]
