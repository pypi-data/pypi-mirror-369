<div align="left">
  ...
  [![Version](https://img.shields.io/badge/version-2.0.6-green)](https://pypi.org/project/purechainlib/)
...
**Note:** Version 2.0.6+ automatically handles Web3 middleware configuration. No manual imports or patches needed!
...
PureChain SDK includes **scientifically-validated carbon footprint tracking** - the first blockchain SDK with built-in environmental impact measurement.
