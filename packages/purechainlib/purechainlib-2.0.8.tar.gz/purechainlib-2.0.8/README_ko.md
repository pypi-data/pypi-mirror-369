<div align="left">
  ...
  [![Version](https://img.shields.io/badge/version-2.0.8-green)](https://pypi.org/project/purechainlib/)
...
**참고:** 버전 2.0.8+는 Web3 미들웨어 구성을 자동으로 처리합니다. 수동 임포트나 패치가 필요 없습니다!
...
- **한국어 문서**: [README_ko.md 다운로드](https://github.com/purechainlib/purechainlib-python/blob/main/README_ko.md)
