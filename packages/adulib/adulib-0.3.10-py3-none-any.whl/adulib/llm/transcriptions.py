"""See the [`litellm` documention](https://docs.litellm.ai/docs/audio_transcription)."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../pts/api/llm/09_transcriptions.pct.py.

# %% auto 0
__all__ = ['transcription', 'sig', 'text_completion', 'async_text_completion']

# %% ../../../pts/api/llm/09_transcriptions.pct.py 3
import inspect
...
# %% ../../../pts/api/llm/09_transcriptions.pct.py 11
transcription = _llm_func_factory(
    func=litellm.transcription,
...
# %% ../../../pts/api/llm/09_transcriptions.pct.py 14
...
# %% ../../../pts/api/llm/09_transcriptions.pct.py 17
