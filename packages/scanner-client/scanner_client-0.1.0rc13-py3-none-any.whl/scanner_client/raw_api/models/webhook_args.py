...
if TYPE_CHECKING:
    from ..models.webhook_args_headers import WebhookArgsHeaders


T = TypeVar("T", bound="WebhookArgs")
...
class WebhookArgs:
    ...
    Attributes:
        url (str):
        headers (Union[Unset, WebhookArgsHeaders]):
    ...
    url: str
    headers: Union[Unset, "WebhookArgsHeaders"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_headers, Unset):
            ...
            headers = WebhookArgsHeaders.from_dict(_headers)
        ...
        webhook_args.additional_properties = d
        return webhook_args
