...
FORM1099PROCCESSRESULTPROCESSEDFORMSINNER_ONE_OF_SCHEMAS = ["Form1042S", "Form1095B", "Form1099Div", "Form1099Int", "Form1099K", "Form1099Misc", "Form1099Nec", "Form1099R"]

class Form1099ProccessResultProcessedFormsInner(BaseModel):
    """
    ...
    oneof_schema_3_validator: Optional[Form1099Div] = None
    # data type: Form1099Int
    oneof_schema_4_validator: Optional[Form1099Int] = None
    # data type: Form1099K
    oneof_schema_5_validator: Optional[Form1099K] = None
    # data type: Form1099Misc
    oneof_schema_6_validator: Optional[Form1099Misc] = None
    # data type: Form1099Nec
    oneof_schema_7_validator: Optional[Form1099Nec] = None
    # data type: Form1099R
    oneof_schema_8_validator: Optional[Form1099R] = None
    actual_instance: Optional[Union[Form1042S, Form1095B, Form1099Div, Form1099Int, Form1099K, Form1099Misc, Form1099Nec, Form1099R]] = None
    one_of_schemas: Set[str] = { "Form1042S", "Form1095B", "Form1099Div", "Form1099Int", "Form1099K", "Form1099Misc", "Form1099Nec", "Form1099R" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = Form1099ProccessResultProcessedFormsInner.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Form1099ProccessResultProcessedFormsInner with oneOf schemas: Form1042S, Form1095B, Form1099Div, Form1099Int, Form1099K, Form1099Misc, Form1099Nec, Form1099R. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Form1099ProccessResultProcessedFormsInner with oneOf schemas: Form1042S, Form1095B, Form1099Div, Form1099Int, Form1099K, Form1099Misc, Form1099Nec, Form1099R. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Form1099ProccessResultProcessedFormsInner with oneOf schemas: Form1042S, Form1095B, Form1099Div, Form1099Int, Form1099K, Form1099Misc, Form1099Nec, Form1099R. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Form1099ProccessResultProcessedFormsInner with oneOf schemas: Form1042S, Form1095B, Form1099Div, Form1099Int, Form1099K, Form1099Misc, Form1099Nec, Form1099R. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Form1042S, Form1095B, Form1099Div, Form1099Int, Form1099K, Form1099Misc, Form1099Nec, Form1099R]]:
