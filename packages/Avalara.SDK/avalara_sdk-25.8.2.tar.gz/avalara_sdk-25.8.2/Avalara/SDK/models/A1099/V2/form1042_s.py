...
class Form1042S(BaseModel):
    ...
    Form1042S
    """ # noqa: E501
    unique_form_id: Optional[StrictStr] = Field(default=None, alias="uniqueFormId")
    recipient_date_of_birth: Optional[datetime] = Field(default=None, alias="recipientDateOfBirth")
    recipient_giin: Optional[StrictStr] = Field(default=None, alias="recipientGiin")
    recipient_foreign_tin: Optional[StrictStr] = Field(default=None, alias="recipientForeignTin")
    lob_code: Optional[StrictStr] = Field(default=None, alias="lobCode")
    income_code: Optional[StrictStr] = Field(default=None, alias="incomeCode")
    gross_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="grossIncome")
    withholding_indicator: Optional[StrictStr] = Field(default=None, alias="withholdingIndicator")
    tax_country_code: Optional[StrictStr] = Field(default=None, alias="taxCountryCode")
    exemption_code_chap3: Optional[StrictStr] = Field(default=None, alias="exemptionCodeChap3")
    exemption_code_chap4: Optional[StrictStr] = Field(default=None, alias="exemptionCodeChap4")
    tax_rate_chap3: Optional[StrictStr] = Field(default=None, alias="taxRateChap3")
    withholding_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="withholdingAllowance")
    federal_tax_withheld: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="federalTaxWithheld")
    tax_not_deposited_indicator: Optional[StrictBool] = Field(default=None, alias="taxNotDepositedIndicator")
    academic_indicator: Optional[StrictBool] = Field(default=None, alias="academicIndicator")
    tax_withheld_other_agents: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="taxWithheldOtherAgents")
    amount_repaid: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="amountRepaid")
    tax_paid_agent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="taxPaidAgent")
    ...
    primary_withholding_agent: Optional[PrimaryWithholdingAgent] = Field(default=None, alias="primaryWithholdingAgent")
    intermediary_or_flow_through: Optional[IntermediaryOrFlowThrough] = Field(default=None, alias="intermediaryOrFlowThrough")
