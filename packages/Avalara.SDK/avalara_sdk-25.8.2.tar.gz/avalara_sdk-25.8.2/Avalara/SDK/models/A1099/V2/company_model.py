...
class CompanyModel(BaseModel):
    ...
    CompanyModel
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Company ID")
    user_id: Optional[StrictInt] = Field(default=None, description="User ID associated with the company", alias="userId")
    account_id: Optional[StrictInt] = Field(default=None, description="Account ID associated with the company", alias="accountId")
    created_at: Optional[datetime] = Field(default=None, description="Record creation timestamp", alias="createdAt")
    updated_at: Optional[datetime] = Field(default=None, description="Record last update timestamp", alias="updatedAt")
