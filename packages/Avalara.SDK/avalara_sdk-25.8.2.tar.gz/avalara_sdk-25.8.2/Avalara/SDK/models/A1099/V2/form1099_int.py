...
class Form1099Int(BaseModel):
    ...
    Form1099Int
    """ # noqa: E501
    interest_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="interestIncome")
    early_withdrawal_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="earlyWithdrawalPenalty")
    us_savings_bonds_interest: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="usSavingsBondsInterest")
    ...
    foreign_country: Optional[StrictStr] = Field(default=None, alias="foreignCountry")
    tax_exempt_interest: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="taxExemptInterest")
    specified_private_activity_bond_interest: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="specifiedPrivateActivityBondInterest")
    market_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="marketDiscount")
    bond_premium: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="bondPremium")
    bond_premium_on_treasury_obligations: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="bondPremiumOnTreasuryObligations")
    bond_premium_on_tax_exempt_bond: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="bondPremiumOnTaxExemptBond")
    tax_exempt_bond_cusip_number: Optional[StrictStr] = Field(default=None, alias="taxExemptBondCusipNumber")
