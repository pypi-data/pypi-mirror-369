...
class Form1099IntRequest(BaseModel):
    """
    Form1099IntRequest
    """ # noqa: E501
    interest_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Interest Income", alias="interestIncome")
    early_withdrawal_penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Early Withdrawl Penalty", alias="earlyWithdrawalPenalty")
    us_savings_bonds_interest: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Interest on U.S. Savings Bonds and Treasury obligations", alias="usSavingsBondsInterest")
    ...
    foreign_country: Optional[StrictStr] = Field(default=None, description="Foreign country or U.S. possession", alias="foreignCountry")
    tax_exempt_interest: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax-Exempt Interest", alias="taxExemptInterest")
    specified_private_activity_bond_interest: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Specified Private activity", alias="specifiedPrivateActivityBondInterest")
    market_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Market Discount", alias="marketDiscount")
    bond_premium: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bond Premium", alias="bondPremium")
    bond_premium_on_treasury_obligations: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bond Premium on Treasury obligations", alias="bondPremiumOnTreasuryObligations")
    bond_premium_on_tax_exempt_bond: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bond Premium on tax exempt bond", alias="bondPremiumOnTaxExemptBond")
    tax_exempt_bond_cusip_number: Optional[StrictStr] = Field(default=None, description="Tax exempt bond CUSIP no.", alias="taxExemptBondCusipNumber")
