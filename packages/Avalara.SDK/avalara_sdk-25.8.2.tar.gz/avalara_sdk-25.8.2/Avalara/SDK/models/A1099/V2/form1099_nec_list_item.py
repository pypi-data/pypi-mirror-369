...
class Form1099NecListItem(BaseModel):
    """
    1099-NEC - Nonemployee compensation
    """ # noqa: E501
    nonemployee_compensation: Union[StrictFloat, StrictInt] = Field(description="Nonemployee compensation", alias="nonemployeeCompensation")
