...
class SubscriptionListResponse(BaseModel):
    ...
    """ # noqa: E501
    recordset_count: Optional[StrictInt] = Field(default=None, description="The total count of records in the dataset.", alias="recordsetCount")
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to the next page of results.", alias="@nextLink")
    value: Optional[List[SubscriptionDetail]] = Field(default=None, description="The list of subscriptions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SubscriptionDetail.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
