...
class DocumentFetch(BaseModel):
    ...
    event_date_time: Optional[StrictStr] = Field(default=None, description="The date and time when the inbound document was accepted by the Avalara E-Invoicing Platform", alias="eventDateTime")
    __properties: ClassVar[List[str]] = ["id", "status", "eventDateTime"]
