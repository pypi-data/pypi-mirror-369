...
class TaxIdentifierResponseValue(BaseModel):
    """
    TaxIdentifierResponseValue
    """ # noqa: E501
    identifier_type: Optional[StrictStr] = Field(default=None, description="Type of the identifier.", alias="identifierType")
    identifier: Optional[StrictStr] = Field(default=None, description="The tax identifier of the company.")
    ...
    __properties: ClassVar[List[str]] = ["identifierType", "identifier", "extensions"]
