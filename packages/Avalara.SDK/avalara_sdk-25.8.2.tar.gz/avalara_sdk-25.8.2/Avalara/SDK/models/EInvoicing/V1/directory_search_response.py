...
class DirectorySearchResponse(BaseModel):
    ...
    next_link: Optional[StrictStr] = Field(default=None, description="The next page link to get the next set of results.", alias="@nextLink")
    value: Optional[List[DirectorySearchResponseValueInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DirectorySearchResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
