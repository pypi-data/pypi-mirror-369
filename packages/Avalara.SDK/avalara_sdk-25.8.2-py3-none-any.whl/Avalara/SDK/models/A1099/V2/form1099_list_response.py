...
class Form1099ListResponse(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[Form1099ListResponseValueInner]] = Field(default=None, description="List of Form 1099 responses")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Form1099ListResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
