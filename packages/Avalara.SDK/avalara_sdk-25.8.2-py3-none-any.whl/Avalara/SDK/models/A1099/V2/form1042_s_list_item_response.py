...
class Form1042SListItemResponse(BaseModel):
    """
    ...
    primary_withholding_agent: Optional[PrimaryWithholdingAgentResponse] = Field(default=None, description="Primary withholding agent information", alias="primaryWithholdingAgent")
    intermediary_or_flow_through: Optional[IntermediaryOrFlowThroughResponse] = Field(default=None, description="Intermediary or flow-through entity information", alias="intermediaryOrFlowThrough")
