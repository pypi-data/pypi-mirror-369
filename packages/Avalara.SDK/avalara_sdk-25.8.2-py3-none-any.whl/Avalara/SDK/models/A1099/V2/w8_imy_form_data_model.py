...
class W8ImyFormDataModel(BaseModel):
    """
    W-8 IMY form
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of the form, always W8IMY for this model.")
    ...
    tin: Optional[StrictStr] = Field(default=None, description="The taxpayer identification number (TIN) of the employee.")
