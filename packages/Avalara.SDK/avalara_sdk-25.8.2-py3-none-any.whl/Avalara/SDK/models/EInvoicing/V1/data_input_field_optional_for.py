...
class DataInputFieldOptionalFor(BaseModel):
    """
    Array of CountryMandate names for which this field is optional.
    """ # noqa: E501
    country_mandate: Optional[StrictStr] = Field(default=None, alias="countryMandate")
    __properties: ClassVar[List[str]] = ["countryMandate"]
