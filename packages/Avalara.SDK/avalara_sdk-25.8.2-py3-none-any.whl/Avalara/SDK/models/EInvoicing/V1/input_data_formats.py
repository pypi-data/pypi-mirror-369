...
class InputDataFormats(BaseModel):
    """
    Format and version used when inputting the data
    """ # noqa: E501
    format: Optional[StrictStr] = Field(default=None, description="Document format")
    versions: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["format", "versions"]
