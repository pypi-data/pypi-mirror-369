...
class DocumentFetchRequestDataInner(BaseModel):
    """
    DocumentFetchRequestDataInner
    """ # noqa: E501
    key: StrictStr = Field(description="Descriptor of the identifier")
    value: StrictStr = Field(description="Value of the identifier")
