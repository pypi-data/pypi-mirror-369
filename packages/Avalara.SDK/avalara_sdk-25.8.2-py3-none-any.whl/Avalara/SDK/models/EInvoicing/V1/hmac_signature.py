...
class HmacSignature(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="HMAC key for authentication")
    algorithm: StrictStr = Field(description="HMAC algorithm for authentication")
    __properties: ClassVar[List[str]] = ["key", "algorithm"]
