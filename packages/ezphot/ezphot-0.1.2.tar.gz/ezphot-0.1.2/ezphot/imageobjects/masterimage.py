...
from ezphot.configuration import TIPConfig
from ezphot.helper import Helper
from ezphot.imageobjects import Logger
...
class MasterImage(BaseImage):
    ...
    def copy(self) -> "MasterImage":
        """
        Return an in-memory deep copy of this MasterImage instance,
        without writing to disk or changing the file path.
        Equivalent to dict.copy() or Table.copy().
        """
    ...
    def write(self):
        """Write CalibrationImage data to FITS file."""
