...
async def exists_today(collection, ticker: str, 기준시각: datetime, day_tz=timezone.utc) -> bool:
    """
    존재 여부만 필요할 때: True/False
    """
    return (await find_today_doc(collection, ticker, 기준시각, day_tz)) is not None
