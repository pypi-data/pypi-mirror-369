...
async def search_companies_with_apollo_page(
    ...
    # -----------------------------------
        ...
        dynamic_payload = {
            ...
            "organization_industries": query.organization_industries or [],
            "organization_industry_tag_ids": query.organization_industry_tag_ids or [],
            "organization_num_employees_ranges": (
                query.organization_num_employees_ranges
                or [f"{query.min_employees or 1},{query.max_employees or 1000}"]
                if query.min_employees or query.max_employees
                else []
            ),
        }
