...
class FileSearchApp:
    ...
    def _configure_theme(self):
        ...
        self.colors = {
            ...
            'scrollbar_thumb': '#2d2d2d',   # Scrollbar thumb - more subtle
            'scrollbar_track': '#1e1e1e',   # Scrollbar track - blend with background
        ...
        # Configure PanedWindow style for resizable panels
    ...
    def _create_widgets(self):
        ...
        self.query_entry = tk.Entry(self.top_frame, 
        ...
        self.files_frame = tk.Frame(self.left_panel, bg=self.colors['bg_light'])
        ...
        self.files_scrollbar = tk.Scrollbar(self.files_frame,
                                          ...
                                          activebackground=self.colors['scrollbar_thumb'],
        ...
        # Content text widget
        self.content_frame = tk.Frame(self.right_panel, bg=self.colors['bg_light'])
        ...
        self.content_scrollbar_v = tk.Scrollbar(self.content_frame,
                                              bg=self.colors['scrollbar_track'],
                                              troughcolor=self.colors['scrollbar_track'],
                                              activebackground=self.colors['scrollbar_thumb'],
                                              highlightbackground=self.colors['scrollbar_track'],
        ...
        self.content_scrollbar_h = tk.Scrollbar(self.content_frame,
        ...
        self.logs_text_frame = tk.Frame(self.logs_frame, bg=self.colors['bg_light'])
        ...
        self.logs_scrollbar = tk.Scrollbar(self.logs_text_frame,
                                         bg=self.colors['scrollbar_track'],
                                         troughcolor=self.colors['scrollbar_track'],
                                         activebackground=self.colors['scrollbar_thumb'],
                                         highlightbackground=self.colors['scrollbar_track'],
    ...
    def _configure_layout(self):
        ...
        # Middle frame layout - using PanedWindow
        ...
        self.logs_label.pack(anchor=tk.W, pady=(0, 2))
        self.logs_frame.pack(fill=tk.X)
    ...
    def _on_fetch_click(self):
        ...
        self._log_message(f"Fetching files for query: {query}", LogLevel.DEBUG)
        
        # Show busy cursor and disable button
    ...
    def _fetch_success(self, folder: Path, files: List[Path]):
        ...
        self._log_message(f"Successfully loaded {len(files)} files from {folder}", LogLevel.INFO)

    def _fetch_error(self, error_msg: str):
        """Handle fetch error."""
        self._log_message(f"Fetch error: {error_msg}", LogLevel.ERROR)
    ...
    def _on_file_select(self, event):
        ...
        self._log_message(f"Loading file: {filename}", LogLevel.DEBUG)
        ...
        try:
            ...
            self._log_message(f"Successfully loaded file: {filename}", LogLevel.INFO)
