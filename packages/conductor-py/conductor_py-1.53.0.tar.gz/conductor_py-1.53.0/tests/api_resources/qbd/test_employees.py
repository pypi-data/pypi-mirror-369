    ...
    def test_method_create_with_all_params(self, client: Conductor) -> None:
        employee = client.qbd.employees.create(
            ...
            employee_payroll={
                ...
                "pay_period": "weekly",
                "sick_hours": {
                    "accrual_period": "accrues_per_paycheck",
                    "accrual_start_date": parse_date("2024-01-01"),
                    "hours_accrued_per_period": "PT8H0M",
                    "hours_available": "PT8H30M",
                    "hours_used": "PT2H45M",
                    "maximum_hours": "PT80H0M",
                    "resets_hours_each_year": False,
                },
                "use_time_data_to_create_paychecks": "uses_time_data",
                "vacation_hours": {
                    "accrual_period": "accrues_per_paycheck",
                    "accrual_start_date": parse_date("2024-01-01"),
                    "hours_accrued_per_period": "PT8H0M",
