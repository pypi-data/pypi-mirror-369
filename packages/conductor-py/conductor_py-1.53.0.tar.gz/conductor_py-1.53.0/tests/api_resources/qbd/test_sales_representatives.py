...
class TestSalesRepresentatives:
    ...
    def test_raw_response_create(self, client: Conductor) -> None:
        ...
        sales_representative = response.parse()
        assert_matches_type(SalesRepresentative, sales_representative, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Conductor) -> None:
        response = client.qbd.sales_representatives.with_raw_response.retrieve(
            id="80000001-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    def test_streaming_response_retrieve(self, client: Conductor) -> None:
        with client.qbd.sales_representatives.with_streaming_response.retrieve(
            id="80000001-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: Conductor) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.qbd.sales_representatives.with_raw_response.retrieve(
                id="",
                conductor_end_user_id="end_usr_1234567abcdefg",
            )
    ...
    def test_raw_response_update(self, client: Conductor) -> None:
        response = client.qbd.sales_representatives.with_raw_response.update(
            id="80000001-1234567890",
            revision_number="1721172183",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    def test_streaming_response_update(self, client: Conductor) -> None:
        with client.qbd.sales_representatives.with_streaming_response.update(
            id="80000001-1234567890",
            revision_number="1721172183",
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
    ...
    def test_path_params_update(self, client: Conductor) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.qbd.sales_representatives.with_raw_response.update(
                id="",
                revision_number="1721172183",
                conductor_end_user_id="end_usr_1234567abcdefg",
            )
    ...
    def test_raw_response_list(self, client: Conductor) -> None:
        response = client.qbd.sales_representatives.with_raw_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    def test_streaming_response_list(self, client: Conductor) -> None:
        with client.qbd.sales_representatives.with_streaming_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSalesRepresentatives:
    ...
    async def test_raw_response_create(self, async_client: AsyncConductor) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        sales_representative = await response.parse()
        assert_matches_type(SalesRepresentative, sales_representative, path=["response"])
    ...
    async def test_method_retrieve(self, async_client: AsyncConductor) -> None:
        sales_representative = await async_client.qbd.sales_representatives.retrieve(
            id="80000001-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
        assert_matches_type(SalesRepresentative, sales_representative, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncConductor) -> None:
        response = await async_client.qbd.sales_representatives.with_raw_response.retrieve(
            id="80000001-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncConductor) -> None:
        async with async_client.qbd.sales_representatives.with_streaming_response.retrieve(
            id="80000001-1234567890",
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncConductor) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.qbd.sales_representatives.with_raw_response.retrieve(
                id="",
                conductor_end_user_id="end_usr_1234567abcdefg",
            )
    ...
    async def test_method_update(self, async_client: AsyncConductor) -> None:
        sales_representative = await async_client.qbd.sales_representatives.update(
            id="80000001-1234567890",
            revision_number="1721172183",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    async def test_raw_response_update(self, async_client: AsyncConductor) -> None:
        response = await async_client.qbd.sales_representatives.with_raw_response.update(
            id="80000001-1234567890",
            revision_number="1721172183",
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncConductor) -> None:
        async with async_client.qbd.sales_representatives.with_streaming_response.update(
            id="80000001-1234567890",
            revision_number="1721172183",
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
    ...
    async def test_path_params_update(self, async_client: AsyncConductor) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.qbd.sales_representatives.with_raw_response.update(
                id="",
                revision_number="1721172183",
                conductor_end_user_id="end_usr_1234567abcdefg",
            )
    ...
    async def test_method_list(self, async_client: AsyncConductor) -> None:
        sales_representative = await async_client.qbd.sales_representatives.list(
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
        assert_matches_type(SalesRepresentativeListResponse, sales_representative, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncConductor) -> None:
        response = await async_client.qbd.sales_representatives.with_raw_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncConductor) -> None:
        async with async_client.qbd.sales_representatives.with_streaming_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
