...
from conductor.types.qbd import DeletedTransactionListResponse
...
class TestDeletedTransactions:
    ...
    def test_raw_response_list(self, client: Conductor) -> None:
        ...
        deleted_transaction = response.parse()
        assert_matches_type(DeletedTransactionListResponse, deleted_transaction, path=["response"])
...
class TestAsyncDeletedTransactions:
    ...
    async def test_raw_response_list(self, async_client: AsyncConductor) -> None:
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        deleted_transaction = await response.parse()
        assert_matches_type(DeletedTransactionListResponse, deleted_transaction, path=["response"])
