...
class TestConductor:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "conductor/_legacy_response.py",
                        "conductor/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "conductor/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: Conductor) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Conductor(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(CONDUCTOR_BASE_URL="http://localhost:5000/from/env"):
            client = Conductor(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Conductor(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Conductor(
    ...
    def test_base_url_trailing_slash(self, client: Conductor) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Conductor) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Conductor) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Conductor(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Conductor(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Conductor(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("conductor._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/quickbooks-desktop/invoices").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Conductor, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.qbd.invoices.with_raw_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.qbd.invoices.with_raw_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg", extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncConductor:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncConductor) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(CONDUCTOR_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncConductor(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncConductor) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncConductor) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncConductor) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncConductor(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncConductor(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncConductor, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.qbd.invoices.with_raw_response.list(
            conductor_end_user_id="end_usr_1234567abcdefg", extra_headers={"x-stainless-retry-count": Omit()}
        )
