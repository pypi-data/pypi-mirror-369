...
class CommitmentInput(BaseModel):
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "segments": [CommitmentSegmentInput.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        }
        return _obj
