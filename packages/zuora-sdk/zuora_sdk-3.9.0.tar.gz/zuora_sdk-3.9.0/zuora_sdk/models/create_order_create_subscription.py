...
class CreateOrderCreateSubscription(BaseModel):
    """
    ...
    unique_token: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="uniqueToken of the subscription to set relatedSubscriptionNumber in OLI within same order. Unique token should be a unique value for more than one create sub order action within same order. ", alias="uniqueToken")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["billToContactId", "invoiceSeparately", "invoiceTemplateId", "newSubscriptionOwnerAccount", "notes", "paymentTerm", "sequenceSetId", "soldToContactId", "shipToContactId", "subscribeToProducts", "subscribeToRatePlans", "subscriptionNumber", "subscriptionOwnerAccountNumber", "invoiceOwnerAccountNumber", "terms", "currency", "invoiceGroupNumber", "communicationProfileId", "uniqueToken"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "subscribeToProducts": [CreateSubscribeToProduct.from_dict(_item) for _item in obj["subscribeToProducts"]] if obj.get("subscribeToProducts") is not None else None,
            "subscribeToRatePlans": [CreateOrderRatePlanOverride.from_dict(_item) for _item in obj["subscribeToRatePlans"]] if obj.get("subscribeToRatePlans") is not None else None,
