...
class CommitmentOutput(BaseModel):
    ...
    segments: Optional[List[CommitmentOutputSegmentsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "commitmentNumber", "type", "segments"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "type": obj.get("type"),
            "segments": [CommitmentOutputSegmentsInner.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        }
        return _obj
