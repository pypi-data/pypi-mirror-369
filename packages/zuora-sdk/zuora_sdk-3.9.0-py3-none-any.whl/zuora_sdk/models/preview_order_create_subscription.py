...
class PreviewOrderCreateSubscription(BaseModel):
    ...
    bill_to_contact_id: Optional[StrictStr] = Field(default=None, description="The ID of the bill-to contact associated with the subscription.  **Note**:    - If you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.    - If you have the Flexible Billing Attributes feature enabled, and you do not specify this field in the request or you select **Default Contact from Account** for this field during subscription creation, the value of this field is automatically set to `null` in the response body. ", alias="billToContactId")
    ...
    new_subscription_owner_account: Optional[PreviewOrderSubscriptionOwnerAccount] = Field(default=None, alias="newSubscriptionOwnerAccount")
    ...
    sold_to_contact_id: Optional[StrictStr] = Field(default=None, description="The ID of the sold-to contact associated with the subscription.  **Note**:    - If you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Bill_customers_at_subscription_level/Flexible_Billing_Attributes\" target=\"_blank\">Flexible Billing Attributes</a> feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.    - If you have the Flexible Billing Attributes feature enabled, and you do not specify this field in the request or you select **Default Contact from Account** for this field during subscription creation, the value of this field is automatically set to `null` in the response body. ", alias="soldToContactId")
    ...
    subscribe_to_rate_plans: Optional[List[PreviewOrderRatePlanOverride]] = Field(default=None, description="List of rate plans associated with the subscription. ", alias="subscribeToRatePlans")
    ...
    currency: Optional[Annotated[str, Field(strict=True, max_length=3)]] = Field(default=None, description="The code of currency that is used for this subscription. If the currency is not selected, the default currency from the account will be used. All subscriptions in the same order must use the same currency. The currency for a subscription cannot be changed.  **Note**: This field is available only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Bill_your_customers/Flexible_Billing/Multiple_Currencies\" target=\"_blank\">Multiple Currencies</a> feature enabled.  ")
    ...
    __properties: ClassVar[List[str]] = ["billToContactId", "invoiceSeparately", "invoiceTemplateId", "newSubscriptionOwnerAccount", "notes", "paymentTerm", "sequenceSetId", "soldToContactId", "shipToContactId", "subscribeToRatePlans", "subscriptionNumber", "subscriptionOwnerAccountNumber", "invoiceOwnerAccountNumber", "terms", "communicationProfileId", "currency", "invoiceGroupNumber"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "newSubscriptionOwnerAccount": PreviewOrderSubscriptionOwnerAccount.from_dict(obj["newSubscriptionOwnerAccount"]) if obj.get("newSubscriptionOwnerAccount") is not None else None,
            "notes": obj.get("notes"),
            ...
            "subscribeToRatePlans": [PreviewOrderRatePlanOverride.from_dict(_item) for _item in obj["subscribeToRatePlans"]] if obj.get("subscribeToRatePlans") is not None else None,
            ...
            "terms": PreviewOrderCreateSubscriptionTerms.from_dict(obj["terms"]) if obj.get("terms") is not None else None,
