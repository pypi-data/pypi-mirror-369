...
class UpsertUpdateCommitmentInput(BaseModel):
    """
    ...
    action: ActionType
    commitment_number: StrictStr = Field(description="The number of the Commitment.", alias="commitmentNumber")
    name: Optional[StrictStr] = Field(default=None, description="The value to update. Set to null to clear the existing value.")
    description: Optional[StrictStr] = Field(default=None, description="The value to update. Set to null to clear the existing value.")
    default_association_rule: Optional[AssociationRule] = Field(default=None, alias="defaultAssociationRule")
    custom_fields: Optional[Dict[str, Any]] = Field(default=None, description="Container for custom fields of an commitment Segment object.", alias="customFields")
    segments: Optional[List[UpsertCommitmentSegmentInput]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["action", "commitmentNumber", "name", "description", "defaultAssociationRule", "customFields", "segments"]
    ...
    def to_alias_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "segments": [UpsertCommitmentSegmentInput.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        }
        return _obj
