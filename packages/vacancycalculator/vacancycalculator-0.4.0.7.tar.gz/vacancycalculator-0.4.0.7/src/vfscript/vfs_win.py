...
# ---------- Función común de render (3D opcional + 2D si fig no es None) ----------
def render_dump_to(plotter: QtInteractor, fig, dump_path: str):
    """Dibuja celda + puntos; si fig es None, NO dibuja la vista 2D."""
