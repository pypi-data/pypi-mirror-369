"""
Entity Type Models for Graphiti MCP Server

This module contains the entity type models that define the structure
for different types of entities that can be stored in the graph.
"""
