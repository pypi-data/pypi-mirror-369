...
""")
    ...
    try:
        ...
        print(f"✅ Valid file analysis: SUCCESS (found {len(result.elements)} elements)")
    ...
    try:
        ...
        print(f"✅ TableFormatTool valid file: SUCCESS")
    except Exception as e:
    ...
    try:
        ...
        print(f"✅ TableFormatTool path traversal: BLOCKED")
    ...
    try:
        ...
        print(f"✅ UniversalAnalyzeTool valid file: SUCCESS")
    except Exception as e:
    ...
    except Exception as e:  # Catch broader exception types
        print(f"✅ UniversalAnalyzeTool path traversal: BLOCKED")
    ...
    for pattern in dangerous_patterns:
        ...
        print(f"{status}: '{pattern}' - {error_msg if not is_safe else 'Pattern is safe'}")
