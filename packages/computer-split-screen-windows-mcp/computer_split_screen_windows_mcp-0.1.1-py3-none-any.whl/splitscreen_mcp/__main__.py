...
@mcp.tool("left-two-thirds", description="Left two-thirds (2/3)")
def left_two_thirds() -> TextContent:
    left_two_thirds_window_win()
    return ok("left-two-thirds: done")

@mcp.tool("right-two-thirds", description="Right two-thirds (2/3)")
def right_two_thirds() -> TextContent:
    right_two_thirds_window_win()
