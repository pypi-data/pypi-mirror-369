...
class Arquivos():
    ...
    def ler_csv(self, arquivo_csv, linha_inicio=0, colunas_desejadas=None, delimiter=';', quantidade_linhas_lidas=None):
        """
        ...
        :type delimiter: str
        :param quantidade_linhas: Número máximo de linhas de dados a ler (ignora após esse limite).
        :type quantidade_linhas: int or None
