...
The system supports authentication configuration via environment variables:
...
This value is automatically loaded by the `get_auth_value()` function in `niteco/opal_rest_tool/rest_models.py:43`.
