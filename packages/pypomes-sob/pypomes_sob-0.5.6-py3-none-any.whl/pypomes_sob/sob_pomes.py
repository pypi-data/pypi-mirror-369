...
class PySob:
    ...
    def insert(self,
        ...
        rec: tuple[Any] = db_insert(errors=errors,
                                    insert_stmt=f"INSERT INTO {tbl_name}",
    ...
    def delete(self,
        ...
        result: int = db_delete(errors=errors,
                                delete_stmt=f"DELETE FROM {tbl_name}",
    ...
    def retrieve(errors: list[str] = None,
                 load_references: list[type] = None,
                 table_alias: str = None,
                 table_joins: str = None,
                 where_clause: str = None,
                 where_vals: tuple = None,
        ...
        if not errors:
            ...
            if not errors:
                ...
                for rec in recs:
                    ...
                    sob._is_new = False
                    if load_references:
                        sob.load_references(load_references,
                                            errors=errors,
                                            db_engine=db_engine,
                                            db_conn=db_conn)
                    if errors:
