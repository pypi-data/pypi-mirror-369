...
class DtoGenericResponseDtoAlgorithmDatasetEvaluationResp(BaseModel):
    """
    DtoGenericResponseDtoAlgorithmDatasetEvaluationResp
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Status code")
    data: Optional[DtoAlgorithmDatasetEvaluationResp] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoAlgorithmDatasetEvaluationResp.from_dict(obj.get("data")) if obj.get("data") is not None else None,
