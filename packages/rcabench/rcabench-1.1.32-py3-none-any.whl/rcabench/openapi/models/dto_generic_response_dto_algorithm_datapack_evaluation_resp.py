...
class DtoGenericResponseDtoAlgorithmDatapackEvaluationResp(BaseModel):
    ...
    data: Optional[DtoAlgorithmDatapackEvaluationResp] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoAlgorithmDatapackEvaluationResp.from_dict(obj.get("data")) if obj.get("data") is not None else None,
