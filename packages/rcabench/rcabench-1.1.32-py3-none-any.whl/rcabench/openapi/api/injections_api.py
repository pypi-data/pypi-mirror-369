...
class InjectionsApi:
    ...
    @validate_call
    def api_v2_injections_by_label_get(
        self,
        key: Annotated[StrictStr, Field(description="Label key")],
        value: Annotated[StrictStr, Field(description="Label value")],
        include_task: Annotated[Optional[StrictBool], Field(description="Include related task")] = None,
        ...
        :param key: Label key (required)
        :type key: str
        :param value: Label value (required)
        :type value: str
        :param include_task: Include related task
        ...
        _param = self._api_v2_injections_by_label_get_serialize(
            key=key,
            value=value,
    ...
    @validate_call
    def api_v2_injections_by_label_get_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="Label key")],
        value: Annotated[StrictStr, Field(description="Label value")],
        include_task: Annotated[Optional[StrictBool], Field(description="Include related task")] = None,
    ...
    @validate_call
    def api_v2_injections_by_label_get_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="Label key")],
        value: Annotated[StrictStr, Field(description="Label value")],
        include_task: Annotated[Optional[StrictBool], Field(description="Include related task")] = None,
    ...
    def _api_v2_injections_by_label_get_serialize(
        self,
        key,
        value,
        include_task,
        ...
        if include_task is not None:
            ...
            _query_params.append(('include_task', include_task))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/injections/by-label',
