...
def expect_column_equal_concatenation(
    ...
    :param table: the pyarrow table to test.
    :param target_column: the column to compare with the concatenation of the columns.
    :param columns: the list of columns to concatenate.
    :param separator: the separator to use when concatenating the columns.
    :return: a boolean.
    """
...
def expect_column_mean_greater_than(table: pa.Table, column_name: str, value: float) -> bool:
    ...
    :param table: the pyarrow table to test.
    :param column_name: the column to calculate the mean of.
    :param value: the value to compare the mean with.
    :return: a boolean.
    """
...
def expect_column_some_null(table: pa.Table, column_name: str) -> bool:
    ...
    :param table: the pyarrow table to test.
    :param column_name: the column to test.
    :return: a boolean.
    """
...
def expect_column_accepted_values(table: pa.Table, column_name: str, accepted_values: list) -> bool:
    ...
    :param table: the pyarrow table to test.
    :param column_name: the column to test.
    :param accepted_values: the list of accepted values.
    :return: a boolean.
    """
