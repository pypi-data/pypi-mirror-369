...
from pyarccli.default_cmd_datas import lang, name, helpConfig, helpHandler, unknownConfig, unknownHandler


def generateModuleHandler(
    lang: str,
    name: str,
    value: Any,
...
config = [
    {
        ...
        "shortname": "gm",
        "description": {
            'fr': "Cette commande permet de generer un module pour notre projet",
            'en': "This command generates a module for our project.",
        },
        "hasValue": True,
        'handler': generateModuleHandler,
    },
    {
        "name": "destination",
        "shortname": "dest",
...
arcCmder(
    name = 'pyarccli-generate-config-file',
    config = config,
    lang = lang,
