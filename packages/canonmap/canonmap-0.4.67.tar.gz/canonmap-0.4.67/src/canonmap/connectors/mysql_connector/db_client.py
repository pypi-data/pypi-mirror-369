...
class DBClient:
    ...
    def generate_schema(
        ...
        for table_name in tables:
            ...
            cols = self._connector.execute_query(
                """
            ...
            for c in cols:
                ...
                example_rows = self._connector.execute_query(examples_sql)
                example_values = [r.get("val") for r in example_rows]
        ...
        if save_location:
            save_path = os.path.abspath(save_location)
