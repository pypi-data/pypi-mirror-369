...
class EEGGraphProcessor:
    def __init__(
        ...
        *,
        ...
        :param edf_loader: EDF loader object with edf_file_path and name attributes
        :param output_dir: Output directory path. If None, defaults to 'graph_representation' 
                          subdirectory in the same directory as the EDF file (subject directory)
        :param window_size: Size of analysis windows in samples. If None, defaults to sampling frequency
        :param adj_window_size: Size for adjacency matrix computation in samples (default: 20,000)
        :param window_step_ratio: Step ratio for sliding windows (default: 0.125)
        """
        ...
        # Default to subject directory (same as EDF file location)
    ...
    def generate_graphs_from_edf(self) -> None:
        ...
        out_path = graphs_dir / f"{self.filename}.pickle"
