...
class WebhookControllerApi(object):
    ...
    def create_webhook_for_ai_transformer(self, transformer_id, create_webhook_options, **kwargs):  # noqa: E501
        """Attach a WebHook URL to an AI transformer  # noqa: E501

        Get notified whenever AI transformation pipeline converts and email or SMS into structured data via a WebHook URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_webhook_for_ai_transformer(transformer_id, create_webhook_options, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str transformer_id: (required)
        :param CreateWebhookOptions create_webhook_options: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_webhook_for_ai_transformer_with_http_info(transformer_id, create_webhook_options, **kwargs)  # noqa: E501

    def create_webhook_for_ai_transformer_with_http_info(self, transformer_id, create_webhook_options, **kwargs):  # noqa: E501
        """Attach a WebHook URL to an AI transformer  # noqa: E501

        Get notified whenever AI transformation pipeline converts and email or SMS into structured data via a WebHook URL.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_webhook_for_ai_transformer_with_http_info(transformer_id, create_webhook_options, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_webhook_for_ai_transformer" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'transformer_id' is set
        if self.api_client.client_side_validation and ('transformer_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['transformer_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `transformer_id` when calling `create_webhook_for_ai_transformer`")  # noqa: E501
        # verify the required parameter 'create_webhook_options' is set
        if self.api_client.client_side_validation and ('create_webhook_options' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_webhook_options'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `create_webhook_options` when calling `create_webhook_for_ai_transformer`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'transformer_id' in local_var_params:
            path_params['transformerId'] = local_var_params['transformer_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ai-transformers/{transformerId}/webhooks', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_all_webhook_results(self, **kwargs):  # noqa: E501
        ...
        :param str ai_transformer_id: AI Transformer ID
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_all_webhook_results_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'phone_id' in local_var_params and local_var_params['phone_id'] is not None:  # noqa: E501
            query_params.append(('phoneId', local_var_params['phone_id']))  # noqa: E501
        if 'ai_transformer_id' in local_var_params and local_var_params['ai_transformer_id'] is not None:  # noqa: E501
            query_params.append(('aiTransformerId', local_var_params['ai_transformer_id']))  # noqa: E501
    ...
    def get_all_webhooks(self, **kwargs):  # noqa: E501
        ...
        :param datetime since: Filter by created at after the given timestamp
        :param str inbox_id: Filter by inboxId
        :param str ai_transformer_id: Filter by aiTransformerId
        :param str phone_id: Filter by phoneId
        :param datetime before: Filter by created at before the given timestamp
        :param str health: Filter by webhook health
        :param str event_type: Optional event type
