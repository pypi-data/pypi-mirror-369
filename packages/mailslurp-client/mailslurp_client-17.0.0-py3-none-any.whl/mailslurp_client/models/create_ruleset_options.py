...
class CreateRulesetOptions(object):
    ...
    def __init__(self, scope=None, action=None, target=None, local_vars_configuration=None):  # noqa: E501
        """CreateRulesetOptions - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def scope(self):
        """Gets the scope of this CreateRulesetOptions.  # noqa: E501
        ...
        :return: The scope of this CreateRulesetOptions.  # noqa: E501
        :rtype: str
        """
        return self._scope
    ...
    def scope(self, scope):
        """Sets the scope of this CreateRulesetOptions.

        What type of emails actions to apply ruleset to. Either `SENDING_EMAILS` or `RECEIVING_EMAILS` will apply action and target to any sending or receiving of emails respectively.  # noqa: E501

        :param scope: The scope of this CreateRulesetOptions.  # noqa: E501
        :type: str
        """
    ...
    @property
    def action(self):
        """Gets the action of this CreateRulesetOptions.  # noqa: E501
        ...
        :return: The action of this CreateRulesetOptions.  # noqa: E501
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """Sets the action of this CreateRulesetOptions.

        Action to be taken when the ruleset matches an email for the given scope. For example: `BLOCK` action with target `*` and scope `SENDING_EMAILS` blocks sending to all recipients. Note `ALLOW` takes precedent over `BLOCK`. `FILTER_REMOVE` is like block but will remove offending email addresses during a send or receive event instead of blocking the action.  # noqa: E501

        :param action: The action of this CreateRulesetOptions.  # noqa: E501
        :type: str
        """
    ...
    @property
    def target(self):
        """Gets the target of this CreateRulesetOptions.  # noqa: E501
        ...
        :return: The target of this CreateRulesetOptions.  # noqa: E501
        :rtype: str
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this CreateRulesetOptions.

        Target to match emails with. Can be a wild-card type pattern or a valid email address. For instance `*@gmail.com` matches all gmail addresses while `test@gmail.com` matches one address exactly. The target is applied to every recipient field email address when `SENDING_EMAILS` is the scope and is applied to sender of email when `RECEIVING_EMAILS`.  # noqa: E501

        :param target: The target of this CreateRulesetOptions.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateRulesetOptions):
            return False
