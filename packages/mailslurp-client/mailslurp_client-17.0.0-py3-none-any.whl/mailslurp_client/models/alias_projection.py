...
class AliasProjection(object):
    ...
    def __init__(self, user_id=None, inbox_id=None, email_address=None, created_at=None, updated_at=None, use_threads=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
