...
class SentEmailProjection(object):
    ...
    def __init__(self, id=None, thread_id=None, in_reply_to=None, _from=None, sender=None, recipients=None, subject=None, user_id=None, attachments=None, inbox_id=None, created_at=None, to=None, cc=None, bcc=None, message_id=None, virtual_send=None, body_excerpt=None, text_excerpt=None, body_md5_hash=None, local_vars_configuration=None):  # noqa: E501
