...
class TrackingPixelProjection(object):
    ...
    def __init__(self, user_id=None, sent_email_id=None, inbox_id=None, created_at=None, recipient=None, seen=None, seen_at=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
