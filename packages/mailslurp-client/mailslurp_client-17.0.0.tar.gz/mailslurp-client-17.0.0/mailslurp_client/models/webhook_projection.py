...
class WebhookProjection(object):
    ...
    def __init__(self, url=None, password=None, username=None, user_id=None, inbox_id=None, event_name=None, created_at=None, updated_at=None, health_status=None, ai_transformer_id=None, ai_transform_id=None, phone_number_id=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
        ...
        if ai_transformer_id is not None:
            self.ai_transformer_id = ai_transformer_id
    ...
    @property
    def ai_transformer_id(self):
        """Gets the ai_transformer_id of this WebhookProjection.  # noqa: E501


        :return: The ai_transformer_id of this WebhookProjection.  # noqa: E501
        :rtype: str
        """
        return self._ai_transformer_id

    @ai_transformer_id.setter
    def ai_transformer_id(self, ai_transformer_id):
        """Sets the ai_transformer_id of this WebhookProjection.


        :param ai_transformer_id: The ai_transformer_id of this WebhookProjection.  # noqa: E501
        :type: str
        """

        self._ai_transformer_id = ai_transformer_id
