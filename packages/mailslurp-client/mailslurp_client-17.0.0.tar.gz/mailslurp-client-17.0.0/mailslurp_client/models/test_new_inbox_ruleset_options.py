...
class TestNewInboxRulesetOptions(object):
    ...
    def __init__(self, inbox_ruleset_test_options=None, create_ruleset_options=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._create_ruleset_options = None
        self.discriminator = None

        self.inbox_ruleset_test_options = inbox_ruleset_test_options
        self.create_ruleset_options = create_ruleset_options
    ...
    @property
    def create_ruleset_options(self):
        """Gets the create_ruleset_options of this TestNewInboxRulesetOptions.  # noqa: E501


        :return: The create_ruleset_options of this TestNewInboxRulesetOptions.  # noqa: E501
        :rtype: CreateRulesetOptions
        """
        return self._create_ruleset_options

    @create_ruleset_options.setter
    def create_ruleset_options(self, create_ruleset_options):
        """Sets the create_ruleset_options of this TestNewInboxRulesetOptions.


        :param create_ruleset_options: The create_ruleset_options of this TestNewInboxRulesetOptions.  # noqa: E501
        :type: CreateRulesetOptions
        """
        if self.local_vars_configuration.client_side_validation and create_ruleset_options is None:  # noqa: E501
            raise ValueError("Invalid value for `create_ruleset_options`, must not be `None`")  # noqa: E501

        self._create_ruleset_options = create_ruleset_options
