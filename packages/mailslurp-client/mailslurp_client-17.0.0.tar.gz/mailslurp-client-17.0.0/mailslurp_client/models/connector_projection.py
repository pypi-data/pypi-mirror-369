...
class ConnectorProjection(object):
    ...
    def __init__(self, enabled=None, user_id=None, inbox_id=None, email_address=None, created_at=None, name=None, id=None, local_vars_configuration=None):  # noqa: E501
