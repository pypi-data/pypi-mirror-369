...
class PhoneMessageThreadProjection(object):
    ...
    def __init__(self, other_phone_number=None, last_message_direction=None, last_body=None, last_created=None, phone_number=None, phone_number_id=None, local_vars_configuration=None):  # noqa: E501
