...
class Cd:
    encoding: str
    @classmethod
    def from_file(cls, file: BufferedReader | TextIOWrapper, encoding: str = "utf-8") -> "Cd": ...
    @classmethod
    def from_str(cls, string: str) -> "Cd": ...
    @classmethod
    def from_path(cls, path: PathLike[str] | str, encoding: str = "utf-8") -> "Cd": ...
    @property
    def cdtext(self) -> CDText: ...
    @property
    def rem(self) -> Rem: ...
    @property
    def mode(self) -> DiscMode | None: ...
    @property
...
class Track:
    ...
    @property
    def submode(self) -> TrackSubMode | None: ...
