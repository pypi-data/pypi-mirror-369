...
class VrmV1JobsIngestGet200ResponseRecordsInner(BaseModel):
    """
    Job details
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["apiVersion", "columnDelimiter", "concurrencyMode", "contentType", "contentUrl", "createdById", "createdDate", "id", "jobType", "lineEnding", "object", "operation", "state", "systemModstamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VrmV1JobsIngestGet200ResponseRecordsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VrmV1JobsIngestGet200ResponseRecordsInner from a dict"""
        if obj is None:
            return None
