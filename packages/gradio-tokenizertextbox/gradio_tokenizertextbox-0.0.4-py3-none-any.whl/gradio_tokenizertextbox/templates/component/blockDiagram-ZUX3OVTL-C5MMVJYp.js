import { g as de } from "./chunk-UIWBPB2F-CFAfTUxS.js";
import { _ as d, E as at, d as R, e as ge, l as L, y as ue, A as pe, c as z, ai as fe, R as xe, S as ye, O as be, aj as Z, ak as Yt, al as we, u as tt, k as me, am as Le, an as xt, ao as Se, i as Tt } from "./mermaid.core-lmjvBPHT.js";
import { c as ve } from "./clone-DaPrv_nO.js";
import { G as Ee } from "./graph-CUB8EsGt.js";
import { c as _e } from "./channel-B__xzK7O.js";
var yt = function() {
...
yt.parser = yt;
var ke = yt, V = /* @__PURE__ */ new Map(), St = [], bt = /* @__PURE__ */ new Map(), Ct = "color", Bt = "fill", De = "bgFill", Ht = ",", Ne = z(), ct = /* @__PURE__ */ new Map(), Te = /* @__PURE__ */ d((e) => me.sanitizeText(e, Ne), "sanitizeText"), Ce = /* @__PURE__ */ d(function(e, t = "") {
  let r = ct.get(e);
  r || (r = { id: e, styles: [], textStyles: [] }, ct.set(e, r)), t != null && t.split(Ht).forEach((n) => {
    const i = n.replace(/([^;]*);/, "$1").trim();
    if (RegExp(Ct).exec(n)) {
      const s = i.replace(Bt, De).replace(Ct, Bt);
      r.textStyles.push(s);
    }
    r.styles.push(i);
  });
...
}, "addStyle2Node"), Ie = /* @__PURE__ */ d(function(e, t) {
  ...
  const r = e.flat(), n = [];
  for (const i of r) {
    if (i.label && (i.label = Te(i.label)), i.type === "classDef") {
      Ce(i.id, i.css);
      continue;
    }
    if (i.type === "applyClass") {
      Ie(i.id, (i == null ? void 0 : i.styleClass) ?? "");
      continue;
    }
    if (i.type === "applyStyles") {
      i != null && i.stylesStr && Be(i.id, i == null ? void 0 : i.stylesStr);
      continue;
    }
  ...
  t.children = n;
}, "populateBlockDatabase"), vt = [], rt = { id: "root", type: "composite", children: [], columns: -1 }, Oe = /* @__PURE__ */ d(() => {
  L.debug("Clear called"), ue(), rt = { id: "root", type: "composite", children: [], columns: -1 }, V = /* @__PURE__ */ new Map([["root", rt]]), vt = [], ct = /* @__PURE__ */ new Map(), St = [], bt = /* @__PURE__ */ new Map();
}, "clear");
function Xt(e) {
...
var It = 0, Re = /* @__PURE__ */ d(() => (It++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + It), "generateId"), ze = /* @__PURE__ */ d((e) => {
...
}, "getColumns"), Me = /* @__PURE__ */ d(() => [...V.values()], "getBlocksFlat"), Fe = /* @__PURE__ */ d(() => vt || [], "getBlocks"), We = /* @__PURE__ */ d(() => St, "getEdges"), Pe = /* @__PURE__ */ d((e) => V.get(e), "getBlock"), Ye = /* @__PURE__ */ d((e) => {
  V.set(e.id, e);
}, "setBlock"), He = /* @__PURE__ */ d(() => console, "getLogger"), Ke = /* @__PURE__ */ d(function() {
  return ct;
}, "getClasses"), Xe = {
  ...
  clear: Oe,
  generateId: Re
}, Ue = Xe, nt = /* @__PURE__ */ d((e, t) => {
  const r = _e, n = r(e, "r"), i = r(e, "g"), a = r(e, "b");
  return pe(n, i, a, t);
  ...
  ${de()}
`, "getStyles"), Ve = je, Ge = /* @__PURE__ */ d((e, t, r, n) => {
  t.forEach((i) => {
    sr[i](e, r, n);
  });
}, "insertMarkers"), Ze = /* @__PURE__ */ d((e, t, r) => {
...
}, "composition"), Je = /* @__PURE__ */ d((e, t, r) => {
  ...
  cross: rr,
  barb: ar
}, ir = Ge, Wt, Pt, I = ((Pt = (Wt = z()) == null ? void 0 : Wt.block) == null ? void 0 : Pt.padding) ?? 8;
function Vt(e, t) {
...
function ot(e, t, r = 0, n = 0) {
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    if (u < r) {
      L.debug(
        `Detected to small sibling: abc95 ${e.id} siblingWidth ${r} siblingHeight ${n} width ${u}`
      ), u = r, w = n;
...
var lr = /* @__PURE__ */ d(async (e, t, r, n) => {
...
}, "createLabel"), j = lr, cr = /* @__PURE__ */ d((e, t, r, n, i) => {
...
}, "addEdgeMarker"), mt = {}, P = {}, hr = /* @__PURE__ */ d(async (e, t) => {
  const r = z(), n = Z(r.flowchart.htmlLabels), i = t.labelType === "markdown" ? Yt(
    ...
    r
  ) : await j(t.label, t.labelStyle), a = e.insert("g").attr("class", "edgeLabel"), s = a.insert("g").attr("class", "label");
  ...
  let o;
  if (t.startLabelLeft) {
    const f = await j(t.startLabelLeft, t.labelStyle), h = e.insert("g").attr("class", "edgeTerminals"), y = h.insert("g").attr("class", "inner");
  ...
  if (t.startLabelRight) {
    const f = await j(t.startLabelRight, t.labelStyle), h = e.insert("g").attr("class", "edgeTerminals"), y = h.insert("g").attr("class", "inner");
  ...
  if (t.endLabelLeft) {
    const f = await j(t.endLabelLeft, t.labelStyle), h = e.insert("g").attr("class", "edgeTerminals"), y = h.insert("g").attr("class", "inner");
    o = y.node().appendChild(f);
    const b = f.getBBox();
    y.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"), h.node().appendChild(f), P[t.id] || (P[t.id] = {}), P[t.id].endLeft = h, et(o, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const f = await j(t.endLabelRight, t.labelStyle), h = e.insert("g").attr("class", "edgeTerminals"), y = h.insert("g").attr("class", "inner");
    o = y.node().appendChild(f);
    const b = f.getBBox();
...
var dr = /* @__PURE__ */ d((e, t) => {
  ...
  const n = z(), { subGraphTitleTotalMargin: i } = we(n);
  if (e.label) {
    const a = mt[e.id];
    let s = e.x, l = e.y;
    if (r) {
  ...
  return i >= s || a >= l;
}, "outsideNode"), ur = /* @__PURE__ */ d((e, t, r) => {
...
}, "cutPathAtIntersect"), pr = /* @__PURE__ */ d(function(e, t, r, n, i, a, s) {
  let l = r.points;
  ...
  const { x: m, y: E } = fe(r), D = xe().x(m).y(E).curve(b);
  let v;
  switch (r.thickness) {
    case "normal":
  ...
  let k = "";
  (z().flowchart.arrowMarkerAbsolute || z().state.arrowMarkerAbsolute) && (k = be(!0)), cr(T, r, k, s, i);
  let N = {};
  ...
  return t;
}, "expandAndDeduplicateDirections"), xr = /* @__PURE__ */ d((e, t, r) => {
  const n = fr(e), i = 2, a = t.height + 2 * r.padding, s = a / i, l = t.width + 2 * s + r.padding, o = r.padding / 2;
...
function ee(e, t, r) {
  ...
  for (var o = n - e.width / 2 - s, f = i - e.height / 2 - l, h = 0; h < t.length; h++) {
    var y = t[h], b = t[h < t.length - 1 ? h + 1 : 0], m = wr(
      e,
      r,
      { x: o + y.x, y: f + y.y },
      { x: o + b.x, y: f + b.y }
...
var vr = /* @__PURE__ */ d(async (e, t) => {
...
}, "note"), Er = vr, zt = /* @__PURE__ */ d((e) => e ? " " + e : "", "formatClass"), K = /* @__PURE__ */ d((e, t) => `${t || "node default"}${zt(e.classes)} ${zt(
  e.class
  ...
  const { shapeSvg: r, bbox: n } = await F(e, t, void 0, !0), i = 2, a = n.height + 2 * t.padding, s = a / i, l = n.width + 2 * s + t.padding, o = xr(t.directions, n, t), f = G(r, l, a, o);
  return f.attr("style", t.style), B(t, f), t.intersect = function(h) {
    return C.polygon(t, o, h);
  }, r;
...
}, "lean_left"), Br = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: r, bbox: n } = await F(
    e,
    t,
    K(t, void 0),
...
}, "trapezoid"), Ir = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: r, bbox: n } = await F(
    e,
    t,
    K(t, void 0),
...
var Fr = /* @__PURE__ */ d(async (e, t) => {
  ...
  const f = s.node().appendChild(await j(o, t.labelStyle, !0, !0));
...
function kt(e, t, r = !1) {
  ...
  const o = Se((n == null ? void 0 : n.styles) ?? []), f = n.label, h = n.size ?? { width: 0, height: 0, x: 0, y: 0 };
  return {
...
async function se(e, t, r) {
  ...
  if (r.getBlock(n.id).type !== "space") {
    const a = at();
    await re(e, n, { config: a }), t.intersect = n == null ? void 0 : n.intersect, jr(n);
  }
}
...
var Vr = /* @__PURE__ */ d(function(e, t) {
...
}, "getClasses"), Gr = /* @__PURE__ */ d(async function(e, t, r, n) {
  ...
  ir(f, ["point", "circle", "cross"], n.type, t);
  ...
  if (await ne(E, y, s), await le(E, m, b, s, t), D) {
    ...
    ge(f, k, N, !!x), L.debug("Here Bounds", D, v), f.attr(
      "viewBox",
