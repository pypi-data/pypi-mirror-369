import { a as xe, b as Yt, g as At, d as Te, c as ye, e as Ee } from "./chunk-WZLT4MVT-DUS2yEbR.js";
import { I as be } from "./chunk-BQPDZTM5-Cv10evbe.js";
import { _ as u, n as me, c as $, d as Lt, l as G, j as Zt, e as we, f as ve, k as I, b as Gt, s as Ie, p as Le, a as _e, g as Pe, q as Ae, y as ke, i as _t, u as Y, L as ot, M as bt, N as Qt, Z as Ne, O as Se, P as jt, E as Ct } from "./mermaid.core-DfWOIJXY.js";
var Ot = function() {
  var e = /* @__PURE__ */ u(function(ht, w, L, P) {
    for (L = L || {}, P = ht.length; P--; L[ht[P]] = w) ;
    return L;
  }, "o"), t = [1, 2], c = [1, 3], s = [1, 4], a = [2, 4], i = [1, 9], n = [1, 11], h = [1, 13], d = [1, 14], r = [1, 16], f = [1, 17], E = [1, 18], g = [1, 24], T = [1, 25], m = [1, 26], v = [1, 27], A = [1, 28], O = [1, 29], S = [1, 30], B = [1, 31], D = [1, 32], F = [1, 33], q = [1, 34], X = [1, 35], tt = [1, 36], z = [1, 37], H = [1, 38], W = [1, 39], M = [1, 41], J = [1, 42], K = [1, 43], Z = [1, 44], et = [1, 45], N = [1, 46], y = [1, 4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 48, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], _ = [4, 5, 16, 50, 52, 53], Q = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 50, 52, 53, 54, 59, 60, 61, 62, 70], at = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 49, 50, 52, 53, 54, 59, 60, 61, 62, 70], k = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 48, 50, 52, 53, 54, 59, 60, 61, 62, 70], qt = [4, 5, 13, 14, 16, 18, 21, 23, 29, 30, 31, 33, 35, 36, 37, 38, 39, 41, 43, 44, 46, 47, 50, 52, 53, 54, 59, 60, 61, 62, 70], it = [68, 69, 70], ct = [1, 122], Nt = {
    ...
    performAction: /* @__PURE__ */ u(function(w, L, P, b, R, l, Et) {
      var p = l.length - 1;
      switch (R) {
        case 3:
...
var Me = Ot, Re = {
  ...
  addProperties(t, c) {
    const s = this.getActor(t);
    try {
      const a = _t(c.text, $()), i = JSON.parse(a);
...
`, "getStyles"), Ve = Be, ut = 18 * 2, $t = "actor-top", te = "actor-bottom", Ye = "actor-box", Xt = "actor-man", Wt = /* @__PURE__ */ u(function(e, t) {
  return Te(e, t);
}, "drawRect"), We = /* @__PURE__ */ u(function(e, t, c, s, a) {
...
}, "fixLifeLineHeights"), qe = /* @__PURE__ */ u(function(e, t, c, s) {
  var T, m;
  const a = s ? t.stopy : t.starty, i = t.x + t.width / 2, n = a + t.height, h = e.append("g").lower();
  var d = h;
  s || (nt++, Object.keys(t.links || {}).length && !c.forceMenus && d.attr("onclick", Fe(`actor${nt}_popup`)).attr("cursor", "pointer"), d.append("line").attr("id", "actor" + nt).attr("x1", i).attr("y1", n).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name), d = h.append("g"), t.actorCnt = nt, t.links != null && d.attr("id", "root-" + nt));
  const r = At();
  var f = "actor";
  ...
  if (t.rectData = r, (m = t.properties) != null && m.icon) {
    ...
    v.charAt(0) === "@" ? ye(d, r.x + r.width - 20, r.y + 10, v.substr(1)) : Ee(d, r.x + r.width - 20, r.y + 10, v);
  }
  ...
  let g = t.height;
  if (E.node) {
    const v = E.node().getBBox();
    t.height = v.height, g = v.height;
  }
  return g;
}, "drawActorTypeParticipant"), ze = /* @__PURE__ */ u(function(e, t, c, s) {
...
}, "drawActorTypeActor"), He = /* @__PURE__ */ u(async function(e, t, c, s) {
  switch (t.type) {
    case "actor":
      return await ze(e, t, c, s);
    case "participant":
      return await qe(e, t, c, s);
  }
}, "drawActor"), Ke = /* @__PURE__ */ u(function(e, t, c) {
  const a = e.append("g");
  ae(a, t), t.name && Ft(c)(
    t.name,
    a,
...
}, "drawBox"), Ue = /* @__PURE__ */ u(function(e) {
  return e.append("g");
}, "anchorElement"), Ge = /* @__PURE__ */ u(function(e, t, c, s, a) {
...
}, "drawActivation"), Xe = /* @__PURE__ */ u(async function(e, t, c, s) {
  const {
    boxMargin: a,
    boxTextMargin: i,
    labelBoxHeight: n,
    ...
    messageFontSize: r,
    messageFontWeight: f
  } = s, E = e.append("g"), g = /* @__PURE__ */ u(function(v, A, O, S) {
    return E.append("line").attr("x1", v).attr("y1", A).attr("x2", O).attr("y2", S).attr("class", "loopLine");
  }, "drawLoopLine");
  ...
  if (t.sectionTitles !== void 0) {
    for (const [v, A] of Object.entries(t.sectionTitles))
      if (A.message) {
        T.text = A.message, T.x = t.startx + (t.stopx - t.startx) / 2, T.y = t.sections[v].y + a + i, T.class = "loopText", T.anchor = "middle", T.valign = "middle", T.tspan = !1, T.fontFamily = d, T.fontSize = r, T.fontWeight = f, T.wrap = t.wrap, ot(T.text) ? (t.starty = t.sections[v].y, await Pt(E, T, t)) : yt(E, T);
        let O = Math.round(
          m.map((S) => (S._groups || S)[0][0].getBBox().height).reduce((S, B) => S + B)
        );
        t.sections[v].height += O - (a + i);
      }
  }
...
}, "insertDatabaseIcon"), Ze = /* @__PURE__ */ u(function(e) {
...
}, "insertComputerIcon"), Qe = /* @__PURE__ */ u(function(e) {
  ...
  function t(i, n, h, d, r, f, E, g) {
    const { actorFontSize: T, actorFontFamily: m, actorFontWeight: v } = g, [A, O] = Qt(T), S = i.split(I.lineBreakRegex);
    for (let B = 0; B < S.length; B++) {
      const D = B * A - A * (S.length - 1) / 2, F = n.append("text").attr("x", h + r / 2).attr("y", d).style("text-anchor", "middle").style("font-size", O).style("font-weight", v).style("font-family", m);
  ...
  function c(i, n, h, d, r, f, E, g) {
    ...
    v.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, T, h, d, r, f, E, g), a(v, E);
  }
  u(c, "byFo");
  ...
  function t(a, i, n, h, d, r, f, E) {
    const { actorFontSize: g, actorFontFamily: T, actorFontWeight: m } = E, v = a.split(I.lineBreakRegex);
    for (let A = 0; A < v.length; A++) {
      const O = A * g - g * (v.length - 1) / 2, S = i.append("text").attr("x", n).attr("y", h).style("text-anchor", "start").style("font-size", g).style("font-weight", m).style("font-family", T);
      S.append("tspan").attr("x", n).attr("dy", O).text(v[A]), S.attr("y", h + r / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), s(S, f);
    }
  }
  u(t, "byTspan");
...
u(ie, "boundMessage");
var is = /* @__PURE__ */ u(async function(e, t, c, s) {
  ...
  let a = 0, i = 0;
  for (const n of c) {
    const h = t.get(n), d = cs(h), r = C.drawPopup(
      e,
      h,
      d,
      o,
...
var os = /* @__PURE__ */ u(async function(e, t, c, s) {
  ...
  x.init(), G.debug(s.db);
  const r = a === "sandbox" ? h.select(`[id="${t}"]`) : Lt(`[id="${t}"]`), f = s.db.getActors(), E = s.db.getCreatedActors(), g = s.db.getDestroyedActors(), T = s.db.getBoxes();
  let m = s.db.getActorKeys();
  const v = s.db.getMessages(), A = s.db.getDiagramTitle(), O = s.db.hasAtLeastOneBox(), S = s.db.hasAtLeastOneBoxWithTitle(), B = await le(f, v, s);
  ...
  for (const y of v) {
    ...
    switch (y.type) {
      case s.db.LINETYPE.NOTE:
        x.resetVerticalPos(), Q = y.noteModel, await rs(r, Q);
        break;
  ...
  for (const y of tt)
    await is(r, y.messageModel, y.lineStartY, s);
...
var ls = /* @__PURE__ */ u(async function(e, t, c) {
...
}, "buildNoteModel"), hs = /* @__PURE__ */ u(function(e, t, c) {
  if (![
  ...
  let d = h ? a : s, r = h ? i : n;
  const f = Math.abs(i - n) > 2, E = /* @__PURE__ */ u((v) => h ? -v : v, "adjustValue");
...
}, "buildMessageModel"), ds = /* @__PURE__ */ u(async function(e, t, c, s) {
  const a = {}, i = [];
  let n, h, d;
  for (const r of e) {
    switch (r.type) {
    ...
    r.placement !== void 0 ? (h = await ls(r, t, s), r.noteModel = h, i.forEach((E) => {
    ...
    })) : (d = hs(r, t, s), r.msgModel = d, d.startx && d.stopx && i.length > 0 && i.forEach((E) => {
