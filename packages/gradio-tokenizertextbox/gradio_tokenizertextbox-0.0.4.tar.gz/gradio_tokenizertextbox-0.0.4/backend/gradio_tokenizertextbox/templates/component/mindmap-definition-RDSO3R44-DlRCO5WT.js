import { _ as S, l as z, c as at, H as Nt, V as Dt, F as tt, i as et, W as mt, X as Ot, Y as At, d as It, ak as Ct, N as Rt } from "./mermaid.core-lmjvBPHT.js";
import { c as pt } from "./cytoscape.esm-C2cgT2B2.js";
import { c as ot, g as xt } from "./Index-DTUgAySR.js";
...
`);
  ...
  const v = g.node().getBBox(), [n] = Rt(y.fontSize);
...
function Lt(I, w) {
  return new Promise((f) => {
    const m = It("body").append("div").attr("id", "cy").attr("style", "display:none"), y = pt({
...
` + I);
  ...
  for (let f = 0; f < I.THEME_COLOR_LIMIT; f++)
    I["lineColor" + f] = I["lineColor" + f] || I["cScaleInv" + f], mt(I["lineColor" + f]) ? I["lineColor" + f] = Ot(I["lineColor" + f], 20) : I["lineColor" + f] = At(I["lineColor" + f], 20);
  for (let f = 0; f < I.THEME_COLOR_LIMIT; f++) {
    const m = "" + (17 - 3 * f);
    w += `
