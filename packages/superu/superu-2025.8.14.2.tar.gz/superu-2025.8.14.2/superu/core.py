...
class PlutoWrapper:
    def __init__(self, api_key, assistants):
        ...
        self.pluto_url = "pluto-ws.superu.ai:5000"

    def create_call(self , voice_id , model=None , assistant_id=None , system_prompt=None , first_message=None , language_clue="en-US" , background_audio=False):
        if model == "pluto_1.1":
            self.pluto_url = "pluto_1_1_ws.superu.ai:5000"
        if not voice_id:
