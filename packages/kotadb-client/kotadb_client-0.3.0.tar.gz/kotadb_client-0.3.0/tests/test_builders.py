...
from kotadb.validated_types import ValidatedPath, ValidatedTitle, ValidatedDocumentId
...
class TestUpdateBuilder:
    ...
    def test_tag_replacement(self):
        ...
        updates = (UpdateBuilder()
                  .add_tag("to_be_replaced")
                  .replace_tags(["new_tag1", "new_tag2"])
                  .build())
